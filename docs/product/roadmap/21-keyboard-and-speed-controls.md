# Keyboard and Speed Controls

**Purpose:** Define the roadmap bet for keyboard and speed controls in this area.  
...
- Keyboard and Speed Controls becomes a concrete next-step planning surface instead of an implied future direction.
