# Curriculum Bridge to DataToolkit

**Purpose:** Define the roadmap bet for curriculum bridge to datatoolkit in this area.  
...
- Curriculum Bridge to DataToolkit becomes a concrete next-step planning surface instead of an implied future direction.
