# Search and Concept Entrypoints

**Purpose:** Define the roadmap bet for search and concept entrypoints in this area.  
...
- Search and Concept Entrypoints becomes a concrete next-step planning surface instead of an implied future direction.
