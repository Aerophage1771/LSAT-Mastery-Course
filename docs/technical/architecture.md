...
- Export contracts:
  - `canonical-course` is the lossless JSON serialization boundary for course content
  - `interchange-course` is the derived, simplified JSON contract used by DataToolkit
...
- Canonical route modules are `1-56`.
