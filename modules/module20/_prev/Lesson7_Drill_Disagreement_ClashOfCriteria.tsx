...
export const Lesson7_Drill_Disagreement_ClashOfCriteria: Lesson = {
  id: '20-7',
  title: 'Drill: Disagreement (Clash of Criteria) (PT-103-S-2-Q-24)',
  questionPolicy: 'repository_required',
  content: [
    {
      type: 'paragraph',
      text: 'This advanced question tests your ability to identify a disagreement over principles or criteria. The speakers largely agree on the facts of the situation but clash over the standard that should be used to make a judgment, a common pattern in high-difficulty questions.',
    },
    {
      type: 'paragraph',
      text: 'Treat this as the module\'s hard **criteria disagreement** drill. The challenge is not finding an explicit contradiction in the facts. It is identifying which standard each speaker treats as decisive, then asking which proposition one speaker would treat as central and the other would reject as non-central.',
    },
    {
      type: 'paragraph',
      text: 'Questions like this become easier if you use the commitment ladder before the overlap test. First ask what standard each speaker treats as decisive. Only then evaluate the answer choices. That prevents you from mistaking a conceded side point for the actual point at issue.',
    },
    { type: 'hr' },
    { type: 'hr' },
    {
    ...
    {
      type: 'paragraph',
      text: 'The core disagreement is not about the sculpture itself, but about which framework to use when making the decision. Both speakers accept the same evidence and even agree on one key interpretation, yet reach opposite conclusions because they prioritize different values.',
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Apply the "Truth Test" to each answer choice, determining what each speaker would say about the statement.',
    },
    {
      type: 'breakdown',
