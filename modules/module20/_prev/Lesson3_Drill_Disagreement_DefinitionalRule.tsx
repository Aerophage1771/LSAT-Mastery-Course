...
export const Lesson3_Drill_Disagreement_DefinitionalRule: Lesson = {
  id: '20-3',
  title: 'Drill: Disagreement (Definitional Rule) (PT-122-S-2-Q-1)',
  questionPolicy: 'repository_required',
  content: [
    { type: 'h2', text: 'Definitional Rule Disagreement' },
    {
      type: 'paragraph',
      text: 'A Definitional Rule Disagreement occurs when one speaker lays down a categorical rule -- "Any X with property P is automatically bad" -- and the second speaker presents a counterexample that satisfies P yet is claimed to be good. The speakers do not dispute the facts; they dispute the **rule** used to evaluate those facts.',
    },
    {
      type: 'paragraph',
      text: 'This pattern appears whenever the dialogue hinges on whether a single characteristic is sufficient to determine quality, value, or classification. Recognizing the rule-versus-counterexample structure lets you cut straight to the correct answer.',
    },
    {
      type: 'paragraph',
      text: 'This is also a commitment-ladder question. Ilana states the rule explicitly. Gustav never says the exact answer choice verbatim, but his praise of Carver while conceding the somberness of the stories commits him to rejecting Ilana\'s rule.',
    },
    { type: 'hr' },
    ...
    {
      type: 'paragraph',
      text: "Both speakers accept the same factual premise -- Carver's stories are somber and pessimistic. The conflict is over what that premise **means** for quality. Ilana treats it as dispositive proof of inferiority; Gustav treats it as one trait among many that does not preclude excellence.",
    },
    {
      type: 'callout',
      title: 'Commitment Ladder Check',
      variant: 'tip',
      text: 'Ask what each speaker must believe about the rule. Ilana is explicitly committed to "somber and pessimistic -> inferior." Gustav is implicitly committed to denying that rule because he says Carver is one of the finest writers while conceding the somberness of the stories.',
    },
    ...
    {
      type: 'paragraph',
      text: 'For choice (D), Ilana\'s commitment is explicit: "sure sign of inferior writing" means she cannot accept that somber stories are well written. Gustav\'s commitment is implicit but necessary: "one of the finest writers" paired with "Granted, his stories are characterized by somberness" forces him to accept that well-written stories can be somber and pessimistic. Both speakers are genuinely committed, so the answer is confirmed.',
    },
    { type: 'hr' },
    {
      type: 'callout',
      title: 'Key Takeaway',
      variant: 'summary',
      text: 'When one speaker establishes a categorical rule ("Any X is bad") and the second speaker concedes X but argues the subject is good, the point at issue is the validity of the rule itself. Run the commitment ladder first, then apply the Overlap Test to the rule-level proposition -- can something be X and still be good? -- and you will find the correct answer.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Definitional Rule Disagreement"
        },
        {
          "type": "paragraph",
          "text": "A Definitional Rule Disagreement occurs when one speaker lays down a categorical rule -- \"Any X with property P is automatically bad\" -- and the second speaker presents a counterexample that satisfies P yet is claimed to be good. The speakers do not dispute the facts; they dispute the **rule** used to evaluate those facts."
        ...
        },
        {
          ...
          "id": "PT-122-S-2-Q-1",
          "questionType": "Point at Issue",
          "stimulus": "**Ilana:** Carver's stories are somber and pessimistic, which is a sure sign of inferior writing. I have never read a single story of his that ends happily.\n**Gustav:** Carver was one of the finest writers of the past 30 years. Granted, his stories are characterized by somberness and pessimism, but they are also wryly humorous, compassionate, and beautifully structured.",
          "question": "On the basis of their statements, Ilana and Gustav are committed to disagreeing over whether",
          "options": [
            "(A) Carver's stories are truly compassionate",
            "(B) Carver's stories are pessimistic in their vision",
        ...
        {
          "type": "h4",
          "text": "Step 2: Identify the Core Conflict"
        },
        {
          "type": "paragraph",
          "text": "Both speakers accept the same factual premise -- Carver's stories are somber and pessimistic. The conflict is over what that premise **means** for quality. Ilana treats it as dispositive proof of inferiority; Gustav treats it as one trait among many that does not preclude excellence."
        ...
        },
        {
          ...
          "title": "Key Takeaway",
          "variant": "summary",
          "text": "When one speaker establishes a categorical rule (\"Any X is bad\") and the second speaker concedes X but argues the subject is good, the point at issue is the validity of the rule itself. Apply the Overlap Test to the rule-level proposition -- can something be X and still be good? -- and you will find the correct answer."
        }
      ],
    },
  },
