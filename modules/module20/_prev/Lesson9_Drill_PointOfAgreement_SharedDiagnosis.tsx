...
export const Lesson9_Drill_PointOfAgreement_SharedDiagnosis: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'First, break down each speaker\'s argument to understand their starting points and conclusions. In a "Shared Diagnosis" question, the speakers\' conclusions will oppose each other on the surface, but they share a common underlying premise or observation that you must identify.',
    },
    {
      type: 'breakdown',
    ...
    {
      type: 'paragraph',
      text: 'The speakers agree on the primary symptom (nostalgia) and the underlying diagnosis (current problems), but they disagree on the specific cause or nature of those problems. This is the hallmark of a "Shared Diagnosis" pattern: same evidence, same general conclusion about the present, different specific interpretations.',
    },
    {
      type: 'list',
      items: [
