...
export const Lesson4_Drill_Disagreement_ExplanatoryCause: Lesson = {
  id: '20-4',
  title: 'Drill: Disagreement (Explanatory Cause) (PT-104-S-1-Q-1)',
  questionPolicy: 'repository_required',
  content: [
    {
      type: 'paragraph',
      text: "This drill focuses on a common and challenging type of disagreement: the **Explanatory Cause Dispute**. In these arguments, both speakers accept the same observed facts but offer competing explanations for *why* those facts are the way they are. The surface-level data isn't contested; what's contested is the causal story behind it.",
    },
    {
      type: 'paragraph',
      text: 'Treat this as a hard **indirect stance** drill. Freeman never needs to say "Powell is wrong because private companies are not more efficient" in those exact words. It is enough that Freeman is committed to a rival explanation that displaces Powell\'s explanation as the reason for the lower cost.',
    },
    {
      type: 'callout',
      title: 'Core Concept: Explanatory Cause Disagreement',
      variant: 'tip',
      text: 'When two speakers agree on WHAT is happening but disagree about WHY it is happening, you are looking at an explanatory cause dispute. Speaker A says "the cause is X," Speaker B says "no, the cause is Y." The correct answer will frame the conflict as a dispute over the *reason* for the agreed-upon phenomenon.',
    },
    {
      type: 'paragraph',
      text: 'This is a good reminder that disagreement is often indirect. Freeman does not need to say "private companies are not efficient" in those exact words. It is enough that his explanation rejects Powell\'s explanation as the reason for the lower cost.',
    },
    { type: 'hr' },
    ...
    {
      type: 'paragraph',
      text: "Break down each speaker's argument into its core components. Notice they share the same factual premise but diverge on the explanation.",
    },
    {
      type: 'breakdown',
    ...
    {
      type: 'callout',
      title: 'Commitment Ladder Check',
      variant: 'tip',
      text: 'Powell is explicitly committed to efficiency as the explanation. Freeman is explicitly committed to customer selection as the explanation, and that commitment is enough to reject Powell\'s explanation without requiring him to deny every possible sense of "efficiency." This is exactly why the commitment ladder comes before the overlap test on hard questions: the disagreement is real even though one speaker\'s NO is indirect rather than word-for-word.',
    },
    { type: 'h4', text: 'Step 3: Evaluation' },
    {
      type: 'paragraph',
      text: 'Apply the "Truth Test" to each answer choice. What is the specific issue where one speaker would say "This is the reason" and the other would say "No, that\'s not the reason"?',
    },
    {
      type: 'breakdown',
      ...
      items: [
        ...
        {
          title: '(B)',
          text: '*   **Powell:** The reason is that they "work more efficiently."\n*   **Freeman:** The reason is that they "exclude the potential customers whom they judge to be the most costly to serve." He explicitly rejects Powell\'s reason ("Your conclusion is unwarranted").\n*   *Result:* **Correct.** This is the precise point of dispute -- the *explanation* for the observed facts. The commitment ladder matters here because Freeman rejects Powell\'s causal story even though he never needs to utter the exact negation of Powell\'s wording.',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
    ...
    { type: 'hr' },
    {
      ...
      title: 'Key Takeaway',
      variant: 'summary',
      text: 'When one speaker provides an explanation for a set of facts, and the second speaker offers an alternative explanation, the point of disagreement is the *reason* for those facts. Freeman does not deny the data Powell presents; he reinterprets it, offering a different cause for the same effect. Your task is to identify the answer that frames the conflict as a dispute over that causal explanation, not over a side issue one speaker merely mentions. Hard questions in this family are often solved by recognizing that an indirect commitment can still be a full commitment.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "paragraph",
          "text": "The core of the disagreement is not *what* is happening, but *why* it is happening."
        },
        {
          "type": "list",
          "items": [
