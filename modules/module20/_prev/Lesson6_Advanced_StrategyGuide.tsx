...
export const Lesson6_Advanced_StrategyGuide: Lesson = {
  id: '20-6',
  title: 'Advanced: Hardest Agree/Disagree Questions',
  questionPolicy: 'none',
  content: [
    { type: 'h3', text: 'Advanced: Hardest Agree/Disagree Questions' },
    {
      type: 'paragraph',
      text: 'Easy Agree/Disagree questions involve direct, explicit contradictions. The hardest questions, however, are rarely so straightforward. They conceal the point of contention or consensus within layers of abstraction, unstated assumptions, referential ambiguity, indirect stance, or competing frameworks. This guide covers the major difficulty factors, the commitment risks they create, and a challenging practice question.',
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'Hard-Question Workflow',
      text: 'On the hardest Point at Issue questions, use the same sequence every time: (1) identify what each speaker explicitly says, (2) run the commitment ladder, (3) clarify any repeated term or conditional phrase that may hide referential ambiguity, and only then (4) run the overlap test. If you skip that order, you will start treating suggestion as commitment.',
    },
    { type: 'hr' },
    { type: 'h3', text: 'Three Difficulty Factors' },
    {
      type: 'paragraph',
      text: 'Understanding *why* certain Agree/Disagree questions are harder than others is the first step to mastering them. The difficulty of any question in this category can be traced back to three factors, often working in combination.',
    },
    { type: 'h4', text: 'Factor 1: Referential Ambiguity and Indirect Stance' },
    {
      type: 'paragraph',
      text: 'Sometimes both speakers appear to discuss the same thing, but a key noun, standard, or conditional phrase shifts meaning across the dialogue. Other times one speaker never states the disputed proposition directly; the stance must be reconstructed from what their argument commits them to. These are the questions on which students start over-crediting suggestion as commitment.',
    },
    {
      type: 'list',
      items: [
        '**The Strategic Insight:** Ask what each term refers to *in that speaker\'s argument*. Do not assume two speakers mean the same thing by "benefit," "good," "autonomous," or "effective" just because the word repeats.',
        '**Indirect stance test:** If a speaker never states the proposition directly, ask whether denying it would break their reasoning. If not, you are dealing with suggestion or silence, not commitment.',
        '**Recognition cue:** The answer choice paraphrases the dialogue at a more abstract level. That is where referential ambiguity and weak implication traps usually hide.',
      ],
    },
    {
      type: 'callout',
      variant: 'default',
      title: 'Ambiguity Stress Test',
      text: 'When a hard answer choice repeats a familiar word from the dialogue, ask two questions before you score it: "What does this term mean for Speaker 1?" and "What does it mean for Speaker 2?" If the referent, criterion, or conditional trigger shifts, the apparent overlap may be fake.',
    },
    { type: 'h4', text: 'Factor 2: The Clash of Criteria' },
    {
      type: 'paragraph',
      text: 'This pattern occurs when speakers agree on the facts of a situation but use different standards to evaluate those facts, leading to opposite conclusions. Their disagreement is not about *what is*, but about *what matters*.',
    },
    {
      type: 'list',
      items: [
    ...
    { type: 'h4', text: 'Factor 3: The Definitional Dispute' },
    {
      type: 'paragraph',
      text: 'Here, the entire argument hinges on the definition of a key term. The speakers propose conflicting rules, often involving necessary or sufficient conditions, and the point at issue is a direct test of their competing definitions.',
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Conditional and criteria-based disputes are where the commitment ladder matters most. The correct answer often sounds more abstract than the dialogue because it restates the commitment in rule form. That is fine. What matters is whether the abstraction is *forced* by the speakers\' arguments.',
    },
    { type: 'h4', text: 'Bonus Factor: Consensus in Conflict (The Hardest "Agree" Questions)' },
    {
      type: 'paragraph',
      text: "These questions are challenging because the speakers' final conclusions are often diametrically opposed. The point of agreement is not an obvious fact but a deeper, structural element of their arguments -- a shared assumption that both must hold for their arguments to be coherent.",
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'paragraph',
      text: "The single most dangerous trap on hard Agree/Disagree questions is the **Implicit Commitment Trap**. This occurs when a speaker's stated position logically *implies* agreement or disagreement on a point that the speaker never directly addresses. The test-makers exploit the gap between what a speaker explicitly says and what their position logically commits them to.",
    },
    {
      type: 'callout',
      title: 'What Makes It a Trap',
      variant: 'tip',
      text: 'A speaker doesn\'t have to say "I agree" or "I disagree" for their position to commit them. If Speaker A argues that "all effective policies require public input," Speaker A is *implicitly committed* to the claim that a policy enacted without public input cannot be effective -- even though they never said those words. The test will offer answer choices that test this implicit commitment.',
    },
    { type: 'h4', text: 'How the Trap Works' },
    {
      type: 'paragraph',
      text: 'Consider a dialogue where Speaker 1 argues that digital art isn\'t "real" art because it doesn\'t require physical skill, and Speaker 2 argues that a particular digital piece is a masterwork. Speaker 2 never explicitly says "digital art is real art," but their position *logically requires* that belief. The test may offer an answer choice like "Whether a work can be considered art does not depend solely on the physical skill required to produce it." Speaker 1 would deny this; Speaker 2 is implicitly committed to affirming it.',
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Apply the strategies above to this challenging dialogue. Pay particular attention to what each speaker is *implicitly committed* to.',
    },
    ...
    {
      type: 'paragraph',
      text: 'On the hardest questions, multiple difficulty factors combine. Use these strategies to cut through the complexity.',
    },
    {
      type: 'table',
      headers: ['Strategy', 'When to Use It', 'What to Look For'],
      rows: [
        [
          'Framework Comparison',
          'Speakers reach opposite conclusions from the same facts',
          'Different criteria or standards of evaluation; the answer choice will name the criterion one speaker treats as decisive and the other ignores',
        ],
        [
          'Implicit Commitment Extraction',
          "A speaker's argument implies a belief they never state",
          'Contrapositives of stated claims, logical prerequisites of conclusions, or the unstated "because" behind a speaker\'s position',
        ],
        [
          'Shared Foundation Search',
          '"Agree" questions where speakers seem to disagree on everything',
          'The unstated premise both arguments require to be coherent -- often a belief about causation, human nature, or the relevance of a category',
        ],
      ],
    },
    {
      type: 'callout',
      title: 'Final Strategic Principle',
      variant: 'summary',
      text: 'The hardest Agree/Disagree questions reward you for reading *between* the lines. Always ask: "What must each speaker believe that they haven\'t said?" Then ask what each disputed term or condition means inside that speaker\'s framework. The gap between what is stated and what is logically required is where the test-makers hide the correct answer. Master the art of extracting implicit commitments, resolving referential ambiguity, and naming the decisive criterion, and you will consistently find the point at issue even in the most complex dialogues.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h4",
          "text": "Factor 1: The Clash of Criteria"
        },
        {
          "type": "paragraph",
          "text": "This pattern occurs when speakers agree on the facts of a situation but use different standards to evaluate those facts, leading to opposite conclusions. Their disagreement is not about *what is*, but about *what matters*."
        ...
        {
          "type": "h4",
          "text": "Factor 2: The Definitional Dispute"
        },
        {
          "type": "paragraph",
          "text": "Here, the entire argument hinges on the definition of a key term. The speakers propose conflicting rules, often involving necessary or sufficient conditions, and the point at issue is a direct test of their competing definitions."
        ...
        {
          "type": "h4",
          "text": "Factor 3: Consensus in Conflict (The Hardest \"Agree\" Questions)"
        },
        {
          "type": "paragraph",
          "text": "These questions are challenging because the speakers' final conclusions are often diametrically opposed. The point of agreement is not an obvious fact but a deeper, structural element of their arguments -- a shared assumption that both must hold for their arguments to be coherent."
        ...
        {
          "type": "h3",
          "text": "The Implicit Commitment Trap"
        },
        {
          "type": "paragraph",
          "text": "The single most dangerous trap on hard Agree/Disagree questions is the **Implicit Commitment Trap**. This occurs when a speaker's stated position logically *implies* agreement or disagreement on a point that the speaker never directly addresses. The test-makers exploit the gap between what a speaker explicitly says and what their position logically commits them to."
        ...
        {
          "type": "h3",
          "text": "Advanced Practice: Hard Question"
        },
        {
          "type": "paragraph",
          "text": "Apply the strategies above to this challenging dialogue. Pay particular attention to what each speaker is *implicitly committed* to."
        ...
        {
          "type": "diff-note",
          "text": "HIGH PRIORITY: The question-card for the Martinez/Chandra dialogue is missing. The analysis references answer choices (A)-(E) but the student never sees the stimulus, stem, or options. Add the question-card here.",
          "variant": "comment"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h3",
          "text": "Analysis of Advanced Question"
        },
        {
          "type": "h4",
          "text": "Step 1: Deconstruction"
        },
        {
          "type": "breakdown",
          "labels": {
        ...
        {
          "type": "h4",
          "text": "Step 2: Identifying the Implicit Commitment Trap"
        },
        {
          "type": "paragraph",
          "text": "Martinez never explicitly says \"manufacturing emissions don't matter.\" But his argument is built entirely on operational emissions (tailpipe output). By framing the issue solely in terms of what happens *after* the buses are running, he is implicitly committed to the view that the manufacturing process is not the relevant consideration. Chandra's entire rebuttal hinges on making manufacturing emissions the *central* consideration."
        ...
        {
          "type": "h3",
          "text": "Advanced Strategies for Complex Dialogues"
        },
        {
          "type": "paragraph",
          "text": "On the hardest questions, multiple difficulty factors combine. Use these strategies to cut through the complexity."
