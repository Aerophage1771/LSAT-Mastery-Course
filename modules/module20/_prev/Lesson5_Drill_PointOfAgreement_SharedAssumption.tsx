...
export const Lesson5_Drill_PointOfAgreement_SharedAssumption: Lesson = {
  id: '20-5',
  title: 'Drill: Point of Agreement (Shared Assumption) (PT-127-S-2-Q-2)',
  questionPolicy: 'repository_required',
  content: [
    {
      type: 'paragraph',
      text: 'This drill focuses on the "Point of Agreement" question type. These questions challenge you to look past the obvious surface disagreement to find a deeper, unstated assumption that both speakers must hold for their respective arguments to make sense.',
    },
    {
      type: 'callout',
      title: 'Core Concept: Shared Assumption Agreement',
      variant: 'tip',
      text: "Even when two speakers propose opposite solutions, their arguments often rest on the same foundational model of how the world works. The shared assumption is the unstated belief that ENABLES their disagreement. Without it, their arguments wouldn't be on the same topic at all. When you find what both speakers take for granted, you've found the point of agreement.",
    },
    {
      type: 'paragraph',
      text: 'This is where the commitment ladder protects you from picking surface overlap. The correct answer will usually sit on the "necessary implication" rung, not in the speakers\' explicit wording. Your job is to identify the belief both arguments require.',
    },
    { type: 'hr' },
    ...
    {
      type: 'paragraph',
      text: "Break down each speaker's argument to its core logic. Pay special attention to the *mechanism* each speaker relies on.",
    },
    {
      type: 'breakdown',
    ...
    {
      type: 'paragraph',
      text: 'While the speakers propose opposite solutions (punishment vs. opportunity), their solutions operate on the same underlying model of human behavior.',
    },
    {
      type: 'list',
      items: [
    ...
    },
    {
      ...
      variant: 'tip',
      text: 'Neither speaker says "people are capable of choosing whether or not to commit crimes" word-for-word. But both arguments collapse without that idea. That makes the statement a necessary implication and therefore a real commitment for both speakers.',
    },
    { type: 'h4', text: 'Step 3: Evaluation' },
    {
      type: 'paragraph',
      text: 'Apply the "Truth Test" for an **AGREE** question. The correct answer must be a statement that both speakers would affirm is true.',
    },
    {
      type: 'breakdown',
    ...
    { type: 'hr' },
    {
      ...
      title: 'Key Takeaway',
      variant: 'summary',
      text: 'In "Point of Agreement" questions, don\'t get distracted by the obvious conflict. The correct answer is often an underlying assumption that both speakers must accept for their arguments to be coherent. Run the commitment ladder and look for the belief both arguments require, even if neither speaker says it outright.',
    },
  ],
  alternates: {
    diff: {
