...
export const Lesson8_Drill_Disagreement_DefinitionalClash: Lesson = {
  id: '20-8',
  title: 'Drill: Disagreement (Definitional Clash) (PT-108-S-2-Q-11)',
  questionPolicy: 'repository_required',
  content: [
    {
      type: 'paragraph',
      text: "This question tests your ability to navigate a disagreement that is purely abstract and definitional. The entire conflict hinges on the necessary and sufficient conditions for a key term. To solve this, you must translate the speakers' positions into formal logical rules and then test the answer choices against those rules.",
    },
    {
      type: 'paragraph',
      text: 'Treat this as the module\'s hard drill for referential ambiguity and conditional disagreement. Both speakers use the same label, "genuinely autonomous discipline," but the label points to different criteria in each argument. The commitment ladder keeps you from confusing shared vocabulary with shared standards.',
    },
    {
      type: 'callout',
      title: 'Why This One Is Hard',
      variant: 'tip',
      text: 'The speakers sound as if they are talking about the same concept in the same way, but they are not. Shared vocabulary is not shared commitment. Mario ties autonomy to domain; Lucy ties autonomy to methodology. Until you separate those conditions, the overlap test will misfire.',
    },
    { type: 'hr' },
    { type: 'hr' },
    {
    ...
    {
      type: 'paragraph',
      text: 'The conflict is a classic logical dispute over necessary vs. sufficient conditions for the same term. Lucy does not simply counter Mario with an opinion; she provides a structural counterexample (philosophy) that undercuts his rule while establishing her own.',
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'callout',
      title: 'Hard-Question Check',
      variant: 'tip',
      text: 'This question is difficult because the disagreement is not stated as a simple yes/no dispute. You have to restate each rule, test a hypothetical case, and then ask what each speaker is committed to saying about that case. That is exactly the kind of hard conditional disagreement where the commitment ladder must come before the overlap test.',
    },
    { type: 'h4', text: 'Step 3: Evaluate Each Choice' },
    {
      type: 'paragraph',
      text: 'Apply the "Truth Test" using the full language of the conditional rules you\'ve identified.',
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          ...
          text: 'Mario: **False.** According to his rule, if a field "lacks a domain of inquiry all its own," it is automatically disqualified. The presence of a unique methodology is irrelevant to his strict requirement. Lucy: **True.** According to her rule, if a field "has a unique methodology," that is sufficient to make it autonomous. The fact that it lacks a unique domain does not disqualify it, which is the entire point of her philosophy example. This scenario produces opposite outcomes from their conflicting rules, so it passes both the conditional-logic test and the commitment-ladder test.',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
