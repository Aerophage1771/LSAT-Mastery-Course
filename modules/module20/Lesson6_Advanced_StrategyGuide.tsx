...
export const Lesson6_Advanced_StrategyGuide: Lesson = {
  ...
  content: [
    ...
    { type: 'paragraph', text: "Easy Agree/Disagree questions involve direct, explicit contradictions. The hardest questions, however, are rarely so straightforward. They conceal the point of contention or consensus within layers of abstraction, unstated assumptions, or competing frameworks. This guide focuses on the three most challenging patterns you will encounter." },
    { type: 'hr' },
    { type: 'h4', text: "1. The Clash of Criteria" },
    ...
    { type: 'hr' },
    { type: 'h4', text: "2. The Definitional Dispute" },
    ...
    { type: 'hr' },
    { type: 'h4', text: "3. Consensus in Conflict (The Hardest \"Agree\" Questions)" },
    ...
    { type: 'list', items: [
        ...
        "**Strategic Tip:** For difficult \"Agree\" questions, look for the unstated foundation of the argument. Pay close attention to neutral language like \"affects,\" \"influences,\" or \"is a factor in,\" as these words can often capture a shared belief in a causal link without specifying the conflicting outcomes."
    ]}
  ]
};
