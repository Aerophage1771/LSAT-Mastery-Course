...
export const Lesson1_Introduction: Lesson = {
  ...
  questionPolicy: 'none',
  content: [
    { type: 'h2', text: 'MODULE 12: Necessary Assumption' },
    {
      type: 'paragraph',
      text: '**Question Goal**\n\n**Identify the smallest unstated premise the author must believe for the argument to stay standing.** In other words, which statement is so essential that if it were false, the argument would lose the link, block, or standard it needs? You are not looking for a statement that proves the conclusion. You are looking for the statement the argument cannot survive without.',
    },
    ...
    {
      type: 'paragraph',
      text: 'Necessary Assumption (NA) is one of the **highest-frequency question types** on the LSAT Logical Reasoning section. It appears roughly **2\u20133 times per scored section**, making it one of the most tested skills on the entire exam. NA questions also span the full difficulty range \u2014 you will see easy ones in the first quarter of a section and very hard ones in the final quarter.',
    },
    {
      type: 'paragraph',
      text: 'Beyond frequency, NA questions test **deep logical discipline**. They demand that you (1) identify the gap in an argument, (2) separate what is merely helpful from what is actually required, (3) distinguish a necessary assumption from a full sufficient bridge, and (4) use the Negation Test as a confirmation tool rather than a magical shortcut. These are the same skills that underpin Flaw, Weaken, Strengthen, and Sufficient Assumption questions. Mastering NA will raise your accuracy across the entire Logical Reasoning section.',
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'Frequency & Difficulty',
      text: 'Expect **2\u20133 Necessary Assumption questions per scored section**, appearing at all difficulty levels. Because NA rewards careful force-setting over intuition, students who learn to ask "required, merely helpful, or fully sufficient?" consistently outperform those who just chase the strongest-sounding answer.',
    },
    ...
    {
      type: 'paragraph',
      text: 'NA stems are distinctive because they use language of **requirement** and **dependence**. The question asks what the argument *relies on*, *requires*, *depends on*, or *presupposes*. This language signals that you are looking for something the argument cannot function without \u2014 not something that would make the conclusion certain. Learn to distinguish these stems from Sufficient Assumption stems (which ask what would make the conclusion "follow logically") and Strengthen stems (which ask what would "most support" the conclusion).',
    },
    {
      type: 'table',
      ...
      rows: [
        [
          ...
          '"**relies on**" \u2014 the argument needs this to work',
        ],
        [
          '"The argument depends on assuming which one of the following?"',
          '"**depends on assuming**" \u2014 required belief',
        ],
        [
          '"Which one of the following is an assumption required by the argument?"',
          '"**required by**" \u2014 without it, the argument fails',
        ],
        [
          '"The conclusion above follows only if which one of the following is assumed?"',
          '"**only if**" \u2014 the assumption is necessary for the logic',
        ],
        ['"The argument presupposes that..."', '"**presupposes**" \u2014 taken for granted, must be true'],
        [
          '"The argument is most vulnerable to criticism if which one of the following is NOT assumed?"',
          '"**NOT assumed**" \u2014 the assumption whose absence would be fatal',
        ],
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'Consider this illustrative argument: A new city ordinance requires all restaurants to post calorie counts on their menus. The city council argues that this will reduce obesity rates, because studies show that when people are informed about calorie content, they tend to choose lower-calorie options.',
    },
    {
      type: 'paragraph',
      text: 'The evidence establishes that calorie posting leads to **lower-calorie choices**, but the conclusion is about **obesity reduction**. The argument never states that choosing lower-calorie options actually contributes to reducing obesity. That unstated bridge \u2014 modest, defensive, and fatal if denied \u2014 is the kind of necessary assumption you are looking for.',
    },
    ...
    {
      type: 'paragraph',
      text: 'The remaining lessons in Module 12 will build your Necessary Assumption toolkit step by step:',
    },
    {
      type: 'process',
      title: 'Module Roadmap',
      steps: [
        '**Foundations** \u2014 The force-standard model (Necessary vs. Strengthener vs. Sufficient), the Negation Test, reasoning-family diagnostics, and common NA patterns.',
        '**Step-by-Step Guide** \u2014 A repeatable process for working through any NA question under timed conditions.',
        '**Pattern Drills** \u2014 Deep practice on Key Ingredient, Definitional Gap, Only Way, Closed Universe, Source Fallacy, False Dichotomy, and more.',
        '**Advanced Drills** \u2014 Forced Choice, Blocking Third Party, Behavioral Link, and Definitional Standard patterns.',
...

    {
      ...
      variant: 'summary',
      title: 'Key Takeaway',
      text: "Necessary Assumption asks for the **minimum unstated premise** the argument cannot survive without. The correct answer is typically modest and defensive \u2014 it protects one weak point rather than proving the conclusion. Don't confuse NA with Strengthen (merely helpful) or Sufficient Assumption (guarantees the conclusion). Budget your time, set the force standard first, and use the Negation Test as a confirmation tool, not a starting point.",
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "MODULE 11: Necessary Assumption"
        },
        {
          "type": "paragraph",
        ...
        },
        {
          ...
          "title": "Frequency & Difficulty",
          "variant": "tip",
          "text": "Expect **2–3 Necessary Assumption questions per scored section**, appearing at all difficulty levels. Because NA rewards careful analysis over intuition, students who learn the Negation Test consistently outperform those who rely on gut feeling. This is one of the most learnable question types on the LSAT."
        },
        {
          "type": "hr"
        },
        ...
        },
        {
          ...
          "rows": [
            ...
            [
              ...
              "\"**presupposes**\" — taken for granted, must be true"
            ],
            [
              "\"The argument is most vulnerable to criticism if which one of the following is NOT assumed?\"",
              "\"**NOT assumed**\" — the assumption whose absence would be fatal"
        ...
        {
          "type": "h2",
          "text": "Necessary vs. Sufficient Assumption"
        },
        {
          "type": "paragraph",
          "text": "Students frequently confuse Necessary Assumption and Sufficient Assumption because both question types deal with unstated assumptions. However, the two question types ask fundamentally different things. Mixing them up is one of the most common — and most costly — mistakes in Logical Reasoning."
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              ...
              "A premise that is **REQUIRED** — without it, the argument falls apart",
              "A premise that is **ENOUGH** — with it, the argument succeeds completely"
            ],
            [
              "Degree of support",
              "Minimal — the answer only needs to be something the argument cannot survive without",
              "Complete — the conclusion must be logically guaranteed once you add the answer"
            ],
            [
              "Answer strength",
              "Often **modest or narrow** — just enough to keep the argument alive",
              "Often **broad or strong** — a powerful rule that sweeps in the conclusion"
            ],
            [
              "Defining test",
              "**Negation Test:** Deny the answer → argument collapses",
              "**SA Equation:** Premises + Answer → Conclusion is 100% guaranteed"
            ],
            [
              "Stem language",
        ...
        {
          "type": "paragraph",
          "text": "The Negation Test is the **single most powerful tool** for solving Necessary Assumption questions. It is a formal verification method — not a guess-and-check shortcut. The logic behind it is airtight: **if a statement is truly necessary, the argument cannot function without it.** Therefore, if you negate the statement (make it false) and the argument still works, the statement was not necessary."
        },
        {
          "type": "process",
        ...
        {
          "type": "paragraph",
          "text": "The key word is **destroys**. Slight weakening is not enough. For the Negation Test to confirm a necessary assumption, the negation must make the argument’s conclusion illogical, unsupported, or self-contradictory."
        },
        {
          "type": "h4",
          "text": "Negation Reference"
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "\"All X are Y\"",
              "text": "\"Some X are not Y\" (not \"No X are Y\" — that is too strong)"
            },
            {
              "title": "\"Some X are Y\"",
              "text": "\"No X are Y\""
            ...
            {
              "title": "\"X always causes Y\"",
              "text": "\"X does not always cause Y\""
            },
            {
              "title": "\"X is the only way to achieve Y\"",
              "text": "\"X is not the only way to achieve Y\""
            },
            {
              "title": "\"No X are Y\"",
              "text": "\"Some X are Y\""
        ...
        },
        {
          ...
          "variant": "tip",
          "text": "The most common error is negating too strongly. The negation of \"All dogs are mammals\" is **\"Some dogs are not mammals\"** — not \"No dogs are mammals.\" Over-negating will make almost any answer choice seem necessary, which defeats the purpose of the test. Always use the **minimal logical opposite**."
        },
        {
          "type": "hr"
        },
        ...
        {
          "type": "paragraph",
          "text": "Let's apply everything from this lesson to a complete Necessary Assumption question."
        },
        {
          "type": "paragraph",
    ...
    glance: {
      label: 'At a Glance',
      content: [
        { type: 'h3', text: 'Sufficient Assumption — At a Glance' },
        {
          type: 'paragraph',
          text: '**Goal:** Find the answer choice that, combined with the stated premises, makes the conclusion logically airtight — no exceptions. **Frequency:** ~5% of LR questions (1--2 per scored section), often at higher difficulty.',
        },
        {
          type: 'table',
          headers: ['Stem Pattern', 'Core Skill', 'Common Trap'],
          rows: [
            ['"...the conclusion follows logically if which is assumed?"', 'Formal gap closure', 'Necessary-only answer (too weak)'],
            ['"...if assumed, enables the conclusion to be properly drawn?"', 'Formal gap closure', 'Strengthener that leaves wiggle room'],
            ['"...the conclusion is properly inferred if which is true?"', 'Formal gap closure', 'Out-of-scope concept'],
            ['"...which, if true, would make the argument logically valid?"', 'Formal gap closure', 'Premise repeater'],
          ],
        },
        {
          type: 'blockquote',
          text: '"Every student who completes the advanced seminar passes the certification exam. Jia is enrolled in the advanced seminar; therefore, Jia will pass the certification exam."',
        },
        {
          type: 'paragraph',
          text: 'The gap: enrollment is not completion. The sufficient assumption is that Jia will complete the seminar — once added to the premises, the conclusion is guaranteed.',
        },
        { type: 'h4', text: "What's in This Module" },
        {
          type: 'list',
          items: [
            'Foundations: force standard, negation test, reasoning families',
            'Step-by-Step: five-step method for timed conditions',
            'Pattern Drills: concept link, exclusivity, chain, and more',
            'Advanced Drills: binary, normative bridge, general principle',
