...
export const Lesson4_Question22: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-4-P-4-Q-22', questionType: 'Relationship', passageTitle: 'Cosmic Justice', passage: passageText, question: `Passage A differs from passage B in that passage A is more`, options: [
    ...
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
      ...
      { title: "(B) inflammatory", text: "Passage A's tone is academic and detached. Passage B uses stronger language like 'foolishly' and discusses 'innocent people,' which could be seen as more emotionally charged. If anything, B is more inflammatory.", badge: 'Reversed Relationship', badgeColor: "red" },
      { title: "(C) technical", text: "Neither passage is overly technical, but Passage A is certainly not *more* technical than Passage B's discussion of legal processes.", badge: 'Partial Connection', badgeColor: "red" },
      { title: "(D) narrative", text: "Neither passage tells a story; they are both argumentative essays.", badge: 'Wrong Elements', badgeColor: "red" },
      { title: "(E) adversarial", text: "Both passages are adversarial toward the idea of implementing cosmic justice. This is a shared quality, not a point of difference.", badge: 'Too Strong', badgeColor: "red" }
    ]},
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-4-P-4-Q-22"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Passage A differs from passage B in that passage A is more"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks us to compare the styles of the passages. Passage A discusses cosmic justice in a theoretical, philosophical manner without specific examples. Passage B grounds its discussion in a concrete example (a criminal trial) and its real-world consequences."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) abstract",
              "text": "This perfectly describes Passage A. Its argument uses general principles and concepts. Passage B is much more concrete. Therefore, Passage A is 'more abstract.'",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B) inflammatory",
              "text": "Passage A's tone is academic and detached. Passage B uses stronger language like 'foolishly' and discusses 'innocent people,' which could be seen as more emotionally charged. If anything, B is more inflammatory.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) technical",
              "text": "Neither passage is overly technical, but Passage A is certainly not *more* technical than Passage B's discussion of legal processes.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) narrative",
              "text": "Neither passage tells a story; they are both argumentative essays.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) adversarial",
              "text": "Both passages are adversarial toward the idea of implementing cosmic justice. This is a shared quality, not a point of difference.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
