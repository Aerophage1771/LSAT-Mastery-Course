...
export const Lesson7_Question27: Lesson = {
  ...
  content: [
    ...
    { type: 'h3', text: "Question 27: Approach Breakdown (PT-141-S-1-P-4-Q-27)" },
    ...
    { type: 'options', items: [
      "(A) Passage A espouses a general view without providing details, while passage B sketches an argument that it does not necessarily endorse. (Correct)",
    ...
    { type: 'paragraph', text: "This approach question should be resolved by matching each choice to what the passage actually establishes. Use the opening and closing claims as scope anchors, then select the option that satisfies the stem without unsupported assumptions." },
    ...
    { type: 'breakdown', labels: { title: "Option", text: "Analysis" }, items: [
      { title: "(A) Passage A espouses a general view without providing details, while passage B sketches an argument that it does not necessarily endorse.", text: "This choice accurately captures the nuances of both passages. Passage A does present a \"general view\" (the theory) without specific application \"details.\" Passage B \"sketches an argument,\" and the phrasing \"one natural way of reasoning\" suggests the author \"does not necessarily endorse\" it as their own final position, but rather presents it as a logical line of thought. This is a very strong fit. Additional check: this is strongest because it directly satisfies the stem while preserving the passage's scope and emphasis.", badge: "Correct", badgeColor: "green" },
      { title: "(B) Passage A argues for the superiority of one view over competing views, while passage B considers only a single view.", text: "Passage A does not mention or argue against any \"competing views.\" It simply presents one theory. Additional check: trap type is unsupported inference, because the passage never supplies the missing support.", badge: "Incorrect", badgeColor: "red" },
      { title: "(C) Passage A invokes commonly held principles to support a policy recommendation, while passage B relies on the views of established authorities to support its claims.", text: "Passage A is a philosophical theory, not a \"policy recommendation.\" Passage B builds its case on a logical argument, not on an appeal to \"established authorities.\" Additional check: this option misses the stem by adding assumptions or emphasis that the passage does not support.", badge: "Incorrect", badgeColor: "red" },
      { title: "(D) Passage A briefly states a view and then provides an argument for it, while passage B provides a detailed statement of a view but no argument.", text: "This mischaracterizes both. Passage A explains a view but provides little in the way of an argument *for* it against other views. Passage B provides a very clear and structured \"argument.\" Additional check: trap type is distorted emphasis, because it recasts the claim in a non-equivalent form.", badge: "Incorrect", badgeColor: "red" },
      { title: "(E) Passage A provides an argument in support of a view, while passage B attempts to undermine a view.", text: "Passage B does the opposite of undermining a view; it builds a strong argument *in support of* the view that Native American land claims are just. Additional check: trap type is reversal/contradiction, because it flips the passage's direction or conclusion.", badge: "Incorrect", badgeColor: "red" }
    ]}
  ]
};
