...
export const Lesson6_Question24: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-4-P-4-Q-24', questionType: 'Phrase Meaning', passageTitle: 'Cosmic Justice', passage: passageText, question: `In passage B, which one of the following is an example of “inputs” as that term is used in the second paragraph of passage A?`, options: [
    ...
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
      { title: "(A) fair rules", text: "Describes the legal process, not a personal background factor of the individual being judged.", badge: 'Dictionary Trap', badgeColor: "red" },
      { title: "(B) unjust trial", text: "Describes the quality of the legal process, not an 'input' related to the defendant.", badge: 'Partial Meaning', badgeColor: "red" },
      { title: "(C) impartial processes", text: "Describes the method of traditional justice, not a personal 'input.'", badge: 'Wrong Connotation', badgeColor: "red" },
      ...
      { title: "(E) innocent people", text: "'Innocent people' in Passage B are the victims of the consequences of the legal system's actions. This is an 'output,' not an 'input.'", badge: 'Wrong Context', badgeColor: "red" }
    ]},
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-4-P-4-Q-24"
        },
        {
          "type": "blockquote",
          "text": "**Question:** In passage B, which one of the following is an example of “inputs” as that term is used in the second paragraph of passage A?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "Passage A defines 'inputs' as the background factors that precede an action, which are contrasted with 'outputs, or consequences.' We need to find something in Passage B that fits this definition."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) fair rules",
              "text": "Describes the legal process, not a personal background factor of the individual being judged.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) unjust trial",
              "text": "Describes the quality of the legal process, not an 'input' related to the defendant.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) impartial processes",
              "text": "Describes the method of traditional justice, not a personal 'input.'",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) traumatic childhood",
              "text": "This is a perfect match. A 'traumatic childhood' is a quintessential 'input'—a complex background factor from a person's history, distinct from the 'output' (the crime).",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(E) innocent people",
              "text": "'Innocent people' in Passage B are the victims of the consequences of the legal system's actions. This is an 'output,' not an 'input.'",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
