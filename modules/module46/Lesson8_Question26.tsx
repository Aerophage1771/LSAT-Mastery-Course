...
export const Lesson8_Question26: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-4-P-4-Q-26', questionType: 'Passage Principle', passageTitle: 'Cosmic Justice', passage: passageText, question: `The discussion in passage A, but not the discussion in passage B, relies on which one of the following principles?`, options: [
    ...
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
      { title: "(A) One should refrain from action when one lacks complete information.", text: "This is a premise in Passage A's argument, but not the core principle that connects the premise of impossibility to the conclusion of not attempting.", badge: 'Too Specific', badgeColor: "red" },
      { title: "(B) Whether a punishment is fair matters less than whether it deters crime.", text: "This principle is central to Passage B, not Passage A.", badge: 'Too Broad', badgeColor: "red" },
      { title: "(C) Although we should aim at perfect justice, we should recognize that we cannot attain it.", text: "This contradicts Passage A's conclusion that we should *not* aim for perfect (cosmic) justice.", badge: 'Wrong Domain', badgeColor: "red" },
      { title: "(D) One should not pass judgment on an action unless one knows all of the factors that influenced it.", text: "This describes the standard for cosmic justice itself, a standard Passage A argues against trying to meet.", badge: 'Partial Match', badgeColor: "red" },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-4-P-4-Q-26"
        },
        {
          "type": "blockquote",
          "text": "**Question:** The discussion in passage A, but not the discussion in passage B, relies on which one of the following principles?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks for an unstated rule that Passage A's logic depends on, but Passage B's does not. Passage A's logic is: Cosmic justice is impossible for humans, therefore we should not attempt it. Passage B's logic is: Cosmic justice is a foolish concept with harmful consequences, therefore we should not attempt it."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) One should refrain from action when one lacks complete information.",
              "text": "This is a premise in Passage A's argument, but not the core principle that connects the premise of impossibility to the conclusion of not attempting.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) Whether a punishment is fair matters less than whether it deters crime.",
              "text": "This principle is central to Passage B, not Passage A.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) Although we should aim at perfect justice, we should recognize that we cannot attain it.",
              "text": "This contradicts Passage A's conclusion that we should *not* aim for perfect (cosmic) justice.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) One should not pass judgment on an action unless one knows all of the factors that influenced it.",
              "text": "This describes the standard for cosmic justice itself, a standard Passage A argues against trying to meet.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) If a goal is known to be impossible, then it should not be attempted.",
              "text": "**Passage A:** Yes, this is the precise unstated rule that lets the author move from 'cosmic justice is impossible' to 'we should not attempt it.'\n**Passage B:** No, its argument is about the goal being harmful, not impossible. This principle distinguishes the two arguments perfectly.",
              "badge": "Correct",
              "badgeColor": "green"
            }
          ]
