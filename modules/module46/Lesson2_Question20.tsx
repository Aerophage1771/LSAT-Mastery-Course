...
export const Lesson2_Question20: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-4-P-4-Q-20', questionType: 'Title', passageTitle: 'Cosmic Justice', passage: passageText, question: `Which one of the following pairs of titles would be most appropriate for passage A and passage B, respectively?`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Title', text: 'The correct title must capture both the main subject AND scope. Specific enough to distinguish this passage from similar ones.' },
    ...
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
      ...
      { title: "(B) “Sowell’s Theory of Justice” / “The Key to Deterrence”", text: "**Title for A:** Too broad. The passage only introduces one term from Sowell.\n**Title for B:** Too narrow. Deterrence is mentioned only in the final sentence as one negative consequence.", badge: 'Too Narrow', badgeColor: "red" },
      { title: "(C) “Just Deserts” / “Fair and Unfair Disadvantages”", text: "**Title for A:** Misleading. The passage's point is that humans *cannot* determine 'just deserts.'\n**Title for B:** Too vague. It omits the crucial concept of 'traditional justice' and the central contrast.", badge: 'Too Broad', badgeColor: "red" },
      { title: "(D) “A Critique of Sowell” / “Traditional Justice Writ Large”", text: "**Title for A:** Inaccurate. The author is applying Sowell's concept, not criticizing it.\n**Title for B:** Contradicts the text, which states cosmic justice is 'fundamentally different' from traditional justice, not a larger version of it.", badge: 'Misleading Focus', badgeColor: "red" },
      { title: "(E) “The Impossibility of Achieving Cosmic Justice” / “Fair Trials versus Justice as Impartial Process”", text: "**Title for A:** A strong and accurate title, making this a tempting distractor.\n**Title for B:** Fatally flawed. The passage presents a 'fair trial' as an *example* of 'justice as impartial process,' not as something in opposition to it. It also omits cosmic justice entirely.", badge: 'Partial Coverage', badgeColor: "red" }
    ]},
    { type: 'callout', variant: 'summary', title: 'Key Takeaway', text: 'The best title is neither too broad to be meaningless nor too narrow to miss major sections.' },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-4-P-4-Q-20"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following pairs of titles would be most appropriate for passage A and passage B, respectively?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks us to select the most appropriate pair of titles. A fitting title must concisely capture the central argument of its passage."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) “Cosmic Justice Meets Human Limitations” / “Fairness as Process versus Cosmic Fairness”",
              "text": "**Title for A:** 'Cosmic Justice Meets Human Limitations' is an excellent summary. The entire passage is about the collision between the abstract concept and practical human reality.\n**Title for B:** 'Fairness as Process versus Cosmic Fairness' is equally strong. 'Fairness as Process' is an accurate description of traditional justice, and 'versus' highlights the central contrast.\n**Verdict:** Both titles are highly accurate.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B) “Sowell’s Theory of Justice” / “The Key to Deterrence”",
              "text": "**Title for A:** Too broad. The passage only introduces one term from Sowell.\n**Title for B:** Too narrow. Deterrence is mentioned only in the final sentence as one negative consequence.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) “Just Deserts” / “Fair and Unfair Disadvantages”",
              "text": "**Title for A:** Misleading. The passage's point is that humans *cannot* determine 'just deserts.'\n**Title for B:** Too vague. It omits the crucial concept of 'traditional justice' and the central contrast.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) “A Critique of Sowell” / “Traditional Justice Writ Large”",
              "text": "**Title for A:** Inaccurate. The author is applying Sowell's concept, not criticizing it.\n**Title for B:** Contradicts the text, which states cosmic justice is 'fundamentally different' from traditional justice, not a larger version of it.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) “The Impossibility of Achieving Cosmic Justice” / “Fair Trials versus Justice as Impartial Process”",
              "text": "**Title for A:** A strong and accurate title, making this a tempting distractor.\n**Title for B:** Fatally flawed. The passage presents a 'fair trial' as an *example* of 'justice as impartial process,' not as something in opposition to it. It also omits cosmic justice entirely.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
