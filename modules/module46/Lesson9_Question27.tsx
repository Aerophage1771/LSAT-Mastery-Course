...
export const Lesson9_Question27: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-4-P-4-Q-27', questionType: 'Author Viewpoint', passageTitle: 'Cosmic Justice', passage: passageText, question: `Which one of the following is a view advanced by the author of passage A with which the author of passage B would be most likely to agree?`, options: [
    ...
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
      { title: "(A) It is sometimes possible for the legal system to take unmerited disadvantages into account...", text: "Author A says this is 'impossible' to do correctly. Author B calls it 'foolish.' Both disagree.", badge: 'Misattribution', badgeColor: "red" },
      { title: "(B) ...human law should strive for it...", text: "This is the exact position both authors argue against.", badge: 'Too Extreme', badgeColor: "red" },
      { title: "(C) Impartial legal processes are a better means of achieving cosmic justice...", text: "Author B presents these as two competing, fundamentally different concepts, not as two means to the same end.", badge: 'Out of Scope', badgeColor: "red" },
      ...
      { title: "(E) Human legal systems can in theory achieve cosmic justice...", text: "Author A says this is 'impossible.' Author B says it is 'foolish.' A direct contradiction of both views.", badge: 'Partial Match', badgeColor: "red" }
    ]},
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-4-P-4-Q-27"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following is a view advanced by the author of passage A with which the author of passage B would be most likely to agree?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "We need a point of agreement. Author A concludes we should judge based on 'outputs, or consequences,' not 'inputs.' Author B concludes that focusing on 'unmerited disadvantages' (inputs) has bad consequences and that justice should be about process. Both reject focusing on inputs in favor of a system concerned with actions and their real-world results."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) It is sometimes possible for the legal system to take unmerited disadvantages into account...",
              "text": "Author A says this is 'impossible' to do correctly. Author B calls it 'foolish.' Both disagree.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) ...human law should strive for it...",
              "text": "This is the exact position both authors argue against.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) Impartial legal processes are a better means of achieving cosmic justice...",
              "text": "Author B presents these as two competing, fundamentally different concepts, not as two means to the same end.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) Human law should be concerned with the consequences of human actions, not with the myriad of factors that influence human actions.",
              "text": "**Consequences:** Author A endorses judging 'outputs, or consequences.' Author B is concerned with consequences like deterrence.\n**Not Factors:** Author A rejects 'inputs.' Author B rejects considering 'unmerited disadvantages.' This statement captures a core conclusion shared by both.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(E) Human legal systems can in theory achieve cosmic justice...",
              "text": "Author A says this is 'impossible.' Author B says it is 'foolish.' A direct contradiction of both views.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
