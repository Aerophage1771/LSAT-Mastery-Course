...
export const Lesson5_Question23: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-4-P-4-Q-23', questionType: 'Analogy', passageTitle: 'Cosmic Justice', passage: passageText, question: `Which one of the following is most analogous to the kind of approach both authors criticize?`, options: [
    ...
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
      { title: "(A) A local library charges children lower fines...", text: "This is a simple, rule-based policy applied to broad categories, not an individualized 'cosmic' calculation.", badge: 'Topic Match Trap', badgeColor: "red" },
      ...
      { title: "(C) In assigning employee parking spaces, management takes into account an employee’s rank...", text: "This describes a system based on clear, objective rules (rank, seniority), which is analogous to 'traditional justice,' not cosmic justice.", badge: 'Wrong Structure', badgeColor: "red" },
      { title: "(D) An employer... is forced by a court to hire qualified older employees.", text: "This is an example of traditional justice at work—applying a legal process to correct a specific violation of a rule.", badge: 'Partial Match', badgeColor: "red" },
      { title: "(E) A university admits students based not just on academic achievement, but also on documented extracurricular activities...", text: "Extracurriculars are typically seen as part of a student's record of achievement ('outputs'), not uncontrollable 'inputs' like a traumatic childhood.", badge: 'Wrong Scope', badgeColor: "red" }
    ]},
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-4-P-4-Q-23"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following is most analogous to the kind of approach both authors criticize?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "The approach criticized by both authors is the attempt to implement 'cosmic justice,' which involves going beyond objective criteria ('outputs' or 'process') to factor in an individual's unique background and circumstances ('inputs' or 'unmerited disadvantages'). We need an analogy where a decision-maker does this."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) A local library charges children lower fines...",
              "text": "This is a simple, rule-based policy applied to broad categories, not an individualized 'cosmic' calculation.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) In assigning grades, a teacher takes into account... background factors unique to individual students.",
              "text": "This is a perfect analogy. The 'written assignments' are the objective outputs/process. The 'background factors' are the unmerited disadvantages/inputs. The teacher is attempting the 'complicated calculus' of cosmic justice.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(C) In assigning employee parking spaces, management takes into account an employee’s rank...",
              "text": "This describes a system based on clear, objective rules (rank, seniority), which is analogous to 'traditional justice,' not cosmic justice.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) An employer... is forced by a court to hire qualified older employees.",
              "text": "This is an example of traditional justice at work—applying a legal process to correct a specific violation of a rule.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
