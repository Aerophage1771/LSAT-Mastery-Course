...
export const Lesson3_Question21: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-4-P-4-Q-21', questionType: 'Inference', passageTitle: 'Cosmic Justice', passage: passageText, question: `Which one of the following is mentioned in passage B, but not in passage A?`, options: [
      "(A) punishment [7.0%]",
    ...
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
      { title: "(A) punishment", text: "Passage A mentions 'rewards and **punishments**.' Passage B discusses mitigating **punishment**. Mentioned in both.", badge: 'Too Extreme', badgeColor: "red" },
      ...
      { title: "(C) rewards", text: "Passage A mentions '**rewards** and punishments.' Passage B does not mention 'rewards.' Mentioned in A, not in B.", badge: 'Out of Scope', badgeColor: "red" },
      { title: "(D) legal systems", text: "Passage A mentions 'human **legal systems**.' Mentioned in A.", badge: 'Misattribution', badgeColor: "red" },
      { title: "(E) human limitations", text: "Passage A's central theme is 'inherent **human limitations**.' Passage B does not mention this. Mentioned in A, not in B.", badge: 'Unsupported Leap', badgeColor: "red" }
    ]},
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-4-P-4-Q-21"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following is mentioned in passage B, but not in passage A?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This is a detail-finding question. We must scan both passages for each term. The correct answer will be present in B and absent in A."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) punishment",
              "text": "Passage A mentions 'rewards and **punishments**.' Passage B discusses mitigating **punishment**. Mentioned in both.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) trials",
              "text": "Passage A discusses 'legal systems' abstractly but never uses the word 'trials.' Passage B uses 'trials' multiple times as a central example. Mentioned in B, not in A.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(C) rewards",
              "text": "Passage A mentions '**rewards** and punishments.' Passage B does not mention 'rewards.' Mentioned in A, not in B.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) legal systems",
              "text": "Passage A mentions 'human **legal systems**.' Mentioned in A.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) human limitations",
              "text": "Passage A's central theme is 'inherent **human limitations**.' Passage B does not mention this. Mentioned in A, not in B.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
