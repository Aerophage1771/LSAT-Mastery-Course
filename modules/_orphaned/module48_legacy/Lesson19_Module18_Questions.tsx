...
export const Lesson19_Module18_Questions: Lesson = {
  id: "48-19",
  title: "Module 19: Must Be False",
  content: [
    { type: 'h2', text: "Module 19: Must Be False" },
    {
      type: 'accordion',
      title: "Drill: Conditional Breakers (PT-103-S-1-Q-13) (PT-103-S-1-Q-13)",
      content: [
        { type: 'paragraph', text: "Question Type: Must Be False" },
        { type: 'h4', text: 'Stimulus' },
        { type: 'blockquote', text: "Some people think that in every barrel of politicians there are only a few rotten ones. But if deceit is a quality of rottenness, I believe all effective politicians are rotten. They must be deceitful in order to do the job properly. Someone who is scrupulously honest about obeying the rules of society will never be an effective politician." },
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Assuming that the author's statements are accurate, which one of the following statements CANNOT be true?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Drill: Quantifier Clashes (PT-113-S-3-Q-8) (PT-113-S-3-Q-8)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Exclusive Boundaries (PT-102-S-4-Q-15) (PT-102-S-4-Q-15)",
      content: [
        { type: 'h4', text: 'Stimulus' },
