...
export const Lesson9_Module9_Questions: Lesson = {
  ...
  content: [
    ...
    {
      type: 'accordion',
      title: "Drill: Strengthening Causal Claims (PT-128-S-3-Q-1) (PT-128-S-3-Q-1)",
      content: [
        { type: 'paragraph', text: "Question Type: Strengthen" },
    ...
    {
      type: 'accordion',
      title: "Drill: Strengthening Arguments with Numbers (PT-111-S-3-Q-4) (PT-111-S-3-Q-4)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Strengthening Comparative Claims (PT-106-S-3-Q-9) (PT-106-S-3-Q-9)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: The Defender (PT-127-S-2-Q-14) (PT-127-S-2-Q-14)",
      content: [
        { type: 'paragraph', text: "Question Type: Strengthen" },
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Bridging Conceptual Gaps (PT-101-S-3-Q-23) (PT-101-S-3-Q-23)",
      content: [
        { type: 'paragraph', text: "Question Type: Strengthen" },
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Strengthening Qualified Claims (PT-125-S-4-Q-20) (PT-125-S-4-Q-20)",
      content: [
        { type: 'paragraph', text: "Question Type: Strengthen" },
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Strengthening by Analogy (PT-112-S-4-Q-20) (PT-112-S-4-Q-20)",
      content: [
        { type: 'paragraph', text: "Question Type: Strengthen" },
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: The Dose-Response Pattern (PT-120-S-1-Q-26) (PT-120-S-1-Q-26)",
      content: [
        { type: 'paragraph', text: "Question Type: Strengthen" },
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Strengthen EXCEPT (PT-113-S-2-Q-20) (PT-113-S-2-Q-20)",
      content: [
        { type: 'paragraph', text: "Question Type: Strengthen" },
        { type: 'h4', text: 'Stimulus' },
