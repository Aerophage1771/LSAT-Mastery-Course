...
export const Lesson11_Module10_Questions: Lesson = {
  id: "48-11",
  title: "Module 11: Sufficient Assumption",
  content: [
    { type: 'h2', text: "Module 11: Sufficient Assumption" },
    {
      type: 'accordion',
      title: "Drill: The Concept Link (PT-120-S-1-Q-12) (PT-120-S-1-Q-12)",
      content: [
        { type: 'paragraph', text: "Question Type: Sufficient Assumption" },
        { type: 'h4', text: 'Stimulus' },
        { type: 'blockquote', text: "All known living things are made of the same basic kinds of matter, are carbon based, and are equipped with genetic codes. So human life has the same origin as all other known life." },
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "The conclusion follows logically if which one of the following is assumed?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Drill: The Binary Assumption (PT-123-S-2-Q-23) (PT-123-S-2-Q-23)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "The philosopher’s conclusion follows logically if which one of the following is assumed?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Drill: The Chain of Logic (PT-135-S-2-Q-15) (PT-135-S-2-Q-15)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        { type: 'blockquote', text: "**Economist:** A country’s rapid emergence from an economic recession requires substantial new investment in that country’s economy. Since people’s confidence in the economic policies of their country is a precondition for any new investment, countries that put collective goals before individuals’ goals cannot emerge quickly from an economic recession." },
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Which one of the following, if assumed, enables the economist’s conclusion to be properly drawn?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Drill: The Chain of Logic Part 2 (PT-120-S-4-Q-15) (PT-114-S-1-Q-1)",
      content: [
        { type: 'paragraph', text: "Question Type: Sufficient assumption" },
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "The conclusion drawn by the physician follows logically if which one of the following is assumed?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Drill: The Chain of Logic Part 2 (PT-120-S-4-Q-15) (PT-112-S-1-Q-18)",
      content: [
        { type: 'paragraph', text: "Question Type: Sufficient assumption" },
        { type: 'h4', text: 'Stimulus' },
        { type: 'blockquote', text: "Moderate exercise lowers the risk of blockage of the arteries due to blood clots, since anything that lowers blood cholesterol levels also lowers the risk of hardening of the arteries, which in turn lowers the risk of arterial blockage due to blood clots; and, if the data reported in a recent study are correct, moderate exercise lowers blood cholesterol levels." },
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "The conclusion drawn above follows logically if which one of the following is assumed?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Drill: The Either/Or Bridge (PT-119-S-4-Q-19) (PT-119-S-4-Q-19)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        { type: 'blockquote', text: "Anger in response to insults is unreasonable, for insults are merely assertions that someone has undesirable characteristics. If such an assertion is false, the insulted party ought to pity the ignorance prompting the insult. If it is true, the insulted party should be grateful for such useful information." },
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Which one of the following, if assumed, enables the argument’s conclusion to be properly drawn?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Drill: The Normative Bridge (PT-140-S-3-Q-14) (PT-140-S-3-Q-14)",
      content: [
        { type: 'h4', text: 'Stimulus' },
