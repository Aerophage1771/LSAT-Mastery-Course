...
export const Lesson14_Module13_Questions: Lesson = {
  id: "48-14",
  title: "Module 14: Principle-Apply",
  content: [
    { type: 'h2', text: "Module 14: Principle-Apply" },
    {
      type: 'accordion',
      ...
      content: [
        ...
        { type: 'paragraph', text: "Which one of the following is an application of the politician's principle of taxation?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Drill: Contrapositive Application (PT-106-S-1-Q-10) (PT-106-S-1-Q-10)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Definitional Checklist (PT-123-S-2-Q-7) (PT-123-S-2-Q-7)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Advanced Application (PT-119-S-2-Q-21) (PT-119-S-2-Q-21)",
      content: [
        { type: 'h4', text: 'Stimulus' },
