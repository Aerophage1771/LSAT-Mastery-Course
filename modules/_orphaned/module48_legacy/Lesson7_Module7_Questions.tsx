...
export const Lesson7_Module7_Questions: Lesson = {
  id: "48-7",
  ...
  content: [
    ...
    {
      type: 'accordion',
      title: "Drill: Rank vs. Raw Number (PT-112-S-1-Q-24) (PT-112-S-1-Q-24)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        { type: 'blockquote', text: "**Columnist:** George Orwell’s book *1984* has exercised much influence on a great number of this newspaper’s readers. One thousand readers were surveyed and asked to name the one book that had the most influence on their lives. The book chosen most often was the Bible; *1984* was second." },
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "The answer to which one of the following questions would most help in evaluating the columnist’s argument?" },
        {
          type: 'options',
          items: [
