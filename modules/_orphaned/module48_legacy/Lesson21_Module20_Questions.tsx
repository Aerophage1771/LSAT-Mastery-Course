...
export const Lesson21_Module20_Questions: Lesson = {
  id: "48-21",
  title: "Module 21: Agree/Disagree (Point at Issue)",
  content: [
    { type: 'h2', text: "Module 21: Agree/Disagree (Point at Issue)" },
    {
      type: 'accordion',
      title: "Drill: Disagreement (Definitional Rule) (PT-122-S-2-Q-1) (PT-122-S-2-Q-1)",
      content: [
        { type: 'paragraph', text: "Question Type: Point at Issue" },
    ...
    {
      type: 'accordion',
      title: "Drill: Disagreement (Explanatory Cause) (PT-104-S-1-Q-1) (PT-104-S-1-Q-1)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Point of Agreement (Shared Assumption) (PT-127-S-2-Q-2) (PT-127-S-2-Q-2)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Disagreement (Clash of Criteria) (PT-103-S-2-Q-24) (PT-103-S-2-Q-24)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Disagreement (Definitional Clash) (PT-108-S-2-Q-11) (PT-108-S-2-Q-11)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Point of Agreement (Shared Diagnosis) (PT-116-S-2-Q-19) (PT-116-S-2-Q-19)",
      content: [
        { type: 'h4', text: 'Stimulus' },
