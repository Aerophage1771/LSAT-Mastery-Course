...
export const Lesson3_Module3_Questions: Lesson = {
  id: "48-3",
  ...
  content: [
    ...
    {
      type: 'accordion',
      title: "Lesson 1: Refutation by Analogy (PT-107-S-3-Q-3) (PT-107-S-3-Q-3)",
      content: [
    ...
    {
      type: 'accordion',
      title: "Lesson 2: Process of Elimination (PT-101-S-2-Q-3) (PT-101-S-2-Q-3)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "The argument derives its conclusion by" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Lesson 3: Refutation by Counterexample (PT-112-S-1-Q-1) (PT-112-S-1-Q-1)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Ruth uses which one of the following argumentative techniques in countering Joanna's argument?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Lesson 4: Highlighting Negative Consequences (PT-110-S-3-Q-8) (PT-110-S-3-Q-8)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Dr. Carabella uses which one of the following strategies in responding to Dr. Jones?" },
        {
          type: 'options',
          items: [
            ...
            "(B) describing the application of the technology discussed by Dr. Jones as one step that initiates a process that leads to an undesirable end (Correct)",
    ...
    {
      type: 'accordion',
      title: "Advanced Lesson 1: Challenging an Assumption (PT-127-S-2-Q-9) (PT-127-S-2-Q-9)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "In the exchange above, the function of Craig's comment is to" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Advanced Lesson 2: Proof by Contradiction (PT-105-S-2-Q-21) (PT-105-S-2-Q-21)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Which one of the following most accurately describes the method of reasoning the cold sufferer uses to reach the conclusion of the argument?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Advanced Lesson 3: Challenging an Assumption (Part 2) (PT-124-S-2-Q-12) (PT-124-S-2-Q-12)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Campisi counters Yang's argument by" },
        {
          type: 'options',
          items: [
