...
export const Lesson1_Module1_Questions: Lesson = {
  id: "48-1",
  ...
  content: [
    ...
    {
      type: 'accordion',
      title: "Lesson 1: Premises vs. Conclusions (PT-107-S-4-Q-15)",
      content: [
        { type: 'paragraph', text: "Question Type: Argument Part" },
    ...
    {
      type: 'accordion',
      title: "Lesson 2: The Intermediate Conclusion (PT-112-S-4-Q-13)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Lesson 3: The Opposing Viewpoint (PT-129-S-2-Q-13)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Advanced Lesson: Concessions (PT-131-S-2-Q-18)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Advanced Lesson: The Phenomenon (PT-131-S-2-Q-7)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Advanced Lesson: Counterfactual Rebuttal (PT-125-S-4-Q-15)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Advanced Lesson: Context Statements (PT-108-S-2-Q-22)",
      content: [
        { type: 'h4', text: 'Stimulus' },
