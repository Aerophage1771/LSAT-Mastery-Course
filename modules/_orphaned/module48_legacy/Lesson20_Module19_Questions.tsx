...
export const Lesson20_Module19_Questions: Lesson = {
  id: "48-20",
  title: "Module 20: Paradox/Explain",
  content: [
    ...
    {
      type: 'accordion',
      title: "Drill: Selection Bias (PT-103-S-1-Q-20) (PT-103-S-1-Q-20)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Causal Mechanisms (PT-122-S-4-Q-11) (PT-122-S-4-Q-11)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        { type: 'blockquote', text: "**Consumer activist:** When antilock brakes were first introduced, it was claimed that they would significantly reduce the incidence of multiple-car collisions, thereby saving lives. Indeed, antilock brakes have reduced the incidence of multiple-car collisions. I maintain, however, that to save lives, automobile manufacturers ought to stop equipping cars with them." },
        { type: 'h4', text: 'Question' },
    ...
    {
      type: 'accordion',
      title: "Drill: The Hidden Distinction (PT-105-S-1-Q-25) (PT-105-S-1-Q-25)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: The Counterintuitive Causal Web (PT-103-S-1-Q-23) (PT-103-S-1-Q-23)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Flawed Logic in  (PT-124-S-3-Q-22)",
      content: [
        { type: 'h4', text: 'Stimulus' },
