...
export const Lesson13_Module12_Questions: Lesson = {
  ...
  content: [
    ...
    {
      type: 'accordion',
      title: "Drill: Strengthening with an Efficiency Principle (PT-112-S-1-Q-15) (PT-112-S-1-Q-15)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Strengthening with a Principle of Accountability (PT-114-S-2-Q-4) (PT-114-S-2-Q-4)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Strengthening a  (PT-113-S-2-Q-22)",
      content: [
        { type: 'h4', text: 'Stimulus' },
