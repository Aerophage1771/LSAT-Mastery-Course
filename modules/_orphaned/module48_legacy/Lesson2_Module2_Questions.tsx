...
export const Lesson2_Module2_Questions: Lesson = {
  id: "48-2",
  ...
  content: [
    ...
    {
      type: 'accordion',
      title: "Lesson 1: The Rebuttal (PT-105-S-1-Q-1) (PT-105-S-1-Q-1)",
      content: [
        ...
        { type: 'paragraph', text: "Which one of the following most accurately expresses the main point of the argument?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Lesson 2: The Prescription (PT-122-S-4-Q-7) (PT-122-S-4-Q-7)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Which one of the following most accurately expresses the main conclusion of the editorialist's argument?" },
        {
          type: 'options',
          items: [
            ...
            "(C) The effects on humans from the chemicals in treated lumber should be studied. (Correct)",
    ...
    {
      type: 'accordion',
      title: "Lesson 3: The Explanation (PT-128-S-2-Q-13) (PT-128-S-2-Q-13)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Which one of the following most accurately expresses the main conclusion of the scientist's argument?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Advanced: The Intermediate Conclusion Trap (PT-116-S-3-Q-23) (PT-116-S-3-Q-23)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Which one of the following most accurately expresses the main conclusion of the argument above?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Advanced: The Background Principle Trap (PT-130-S-1-Q-13) (PT-130-S-1-Q-13)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Which one of the following most accurately expresses the conclusion drawn in the argument above?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Advanced: Specific Judgment vs. General Rule (PT-123-S-3-Q-12) (PT-123-S-3-Q-12)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Which one of the following most accurately expresses the conclusion drawn in the argument?" },
        {
          type: 'options',
          items: [
