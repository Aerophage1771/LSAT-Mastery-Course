...
export const Lesson15_Module14_Questions: Lesson = {
  id: "48-15",
  title: "Module 15: Principle-Generalization",
  content: [
    { type: 'h2', text: "Module 15: Principle-Generalization" },
    {
      ...
      content: [
        ...
        { type: 'paragraph', text: "The situation described above most closely conforms to which one of the following propositions?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Drill: Unintended Consequences (PT-124-S-1-Q-5) (PT-124-S-1-Q-5)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        { type: 'blockquote', text: "As a result of modern medicine, more people have been able to enjoy long and pain-free lives. But the resulting increase in life expectancy has contributed to a steady increase in the proportion of the population that is of advanced age. This population shift is creating potentially devastating financial problems for some social welfare programs." },
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Which one of the following propositions is most precisely exemplified by the situation presented above?" },
        {
          type: 'options',
          items: [
