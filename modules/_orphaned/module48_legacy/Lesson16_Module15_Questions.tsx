...
export const Lesson16_Module15_Questions: Lesson = {
  id: "48-16",
  title: "Module 16: Fill in the Blank",
  content: [
    { type: 'h2', text: "Module 16: Fill in the Blank" },
    {
      type: 'accordion',
      title: "Drill: Mechanistic Chain (PT-102-S-2-Q-3) (PT-102-S-2-Q-3)",
      content: [
        { type: 'paragraph', text: "Question Type: Fill in the Blank" },
        ...
        { type: 'paragraph', text: "Which one of the following most logically completes the argument?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Drill: Analogy (PT-123-S-2-Q-3) (PT-123-S-2-Q-3)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Problem and Solution (PT-125-S-2-Q-7) (PT-125-S-2-Q-7)",
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: "Drill: Philosophical Rebuttal (PT-114-S-1-Q-19) (PT-114-S-1-Q-19)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Which one of the following most logically completes the essayist’s argument?" },
        {
          type: 'options',
          items: [
    ...
    {
      type: 'accordion',
      title: "Drill: Conditional Logic and Paradox (PT-123-S-3-Q-16) (PT-123-S-3-Q-16)",
      content: [
        { type: 'h4', text: 'Stimulus' },
        ...
        { type: 'h4', text: 'Question' },
        { type: 'paragraph', text: "Which one of the following most logically completes the philosopher’s argument?" },
        {
          type: 'options',
          items: [
