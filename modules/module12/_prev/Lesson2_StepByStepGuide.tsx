...
export const Lesson2_StepByStepGuide: Lesson = {
  id: '12-2',
  title: 'Step-by-Step: Principle: Strengthen',
  questionPolicy: 'none',
  content: [
    { type: 'h2', text: 'Step-by-Step: Principle: Strengthen' },
    {
      type: 'paragraph',
      text: 'This lesson provides a complete, repeatable method for solving any Principle: Strengthen question. The goal is the same every time: understand the author\'s argument, find the logical leap, abstract the general rule that would justify that leap, complete the application from the case to that rule, and then match it to the answer choices. Each step below includes concrete guidance, tips for tricky situations, and key insights.',
    },
    ...
    { type: 'h3', text: 'Overview' },
    {
      ...
      steps: [
        ...
        '**Step 4 - Complete the Application:** Translate the abstract rule back onto the specific case. Identify the trigger, case facts, bridge, and verdict before you evaluate the choices.',
        '**Step 5 - Match the Answer:** Scan the choices for the principle that best matches your pre-phrase and completed application. Verify that it bridges the specific gap you identified.',
      ],
    },
    {
      type: 'table',
      headers: ['Shared Term', 'How It Works in Module 13'],
      rows: [
        ['**Trigger**', 'The general condition built into the principle answer choice.'],
        ['**Case Facts**', 'The concrete details from the stimulus.'],
        ['**Bridge**', 'The application move showing that these facts satisfy the trigger.'],
        ['**Verdict**', 'The conclusion or judgment the principle supports once the trigger is activated.'],
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'Before you can find the principle, you must understand the argument. Read the stimulus and identify two things:',
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Pay close attention to the **nature** of the conclusion. Is it a value judgment ("X is wrong")? A recommendation ("X should be done")? A classification ("X counts as Y")? A prediction ("X will happen")? The type of conclusion tells you what type of principle you need — and helps you avoid answers that address a different kind of judgment.',
    },
    {
      type: 'callout',
      variant: 'default',
    ...
    {
      type: 'paragraph',
      text: 'This is the most critical step. Pinpoint the gap between the evidence and the conclusion. Ask yourself: *"How does the author get from these specific facts to that specific judgment? What kind of general rule is the author silently relying on?"*',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'table',
      headers: ['Leap Type', 'The Evidence Is About...', 'The Conclusion Is About...', 'The Principle Must...'],
      rows: [
        [
          '**Fact → Value**',
          'What *is* the case (descriptive facts)',
          'What *should be* the case (moral/ethical judgment)',
          'Bridge the "is-ought" gap — state that this type of fact warrants this type of judgment',
        ],
        [
          '**Means → End**',
          'A method or strategy that achieves an intermediate result',
          'A recommendation to pursue that method',
          'State that achieving this type of result justifies choosing this type of method',
        ],
        [
          '**Role → Duty**',
          "A person's position, authority, or relationship",
          'An obligation or responsibility that person has',
          'State that occupying this type of role entails this type of duty',
        ],
        [
          '**Features → Category**',
          'Characteristics or properties of something',
          'A classification or label applied to it',
          'State that these types of features qualify something for this type of category',
        ],
        [
          '**Comparison → Choice**',
          'Comparative evaluation of options',
          'A recommendation to choose one option over another',
          'State that this type of comparative advantage justifies this type of choice',
        ],
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'Once you classify the leap, you have a powerful prediction about the *type* of principle the correct answer will express. This is the foundation of your pre-phrase.',
    },
    ...
    {
      type: 'table',
      headers: ['Leap Type', 'Pre-phrase Template'],
      rows: [
        ['Fact → Value', '"If [this type of fact] is true, then [this type of value judgment] is warranted."'],
        [
          'Means → End',
          '"One should choose [this type of means] when it is the most effective way to achieve [this type of end]."',
        ],
    ...
    { type: 'h2', text: 'Step 4: Complete the Application' },
    {
      type: 'paragraph',
      text: 'Before you look at the answer choices, run the missing rule back through the case. This is the Module 13 move that keeps Principle: Strengthen from collapsing into either Module 11 or Module 14. You are not building a custom airtight bridge from scratch, and you are not merely checking whether a ready-made rule already fits. You are asking how a **broad rule** would operate on **these facts**.',
    },
    {
      type: 'process',
      title: 'Complete the Application Protocol',
      steps: [
        '**Name the trigger.** What general condition would activate the principle?',
        '**State the case facts.** Which concrete details in the stimulus are supposed to satisfy that trigger?',
        '**Say the bridge out loud.** Explain, in one sentence, why those facts count as an instance of the trigger.',
        '**State the verdict.** Once the trigger is met, what judgment does the rule produce?',
      ],
    },
    {
      type: 'table',
      headers: ['Question Type', 'What You Build', 'What Counts as Success'],
      rows: [
        [
          '**Sufficient Assumption**',
          'The exact missing premise',
          'Premises + answer make the conclusion guaranteed',
        ],
        [
          '**Principle: Strengthen**',
          'A broad rule plus its application to this case',
          'The rule justifies or strongly supports the reasoning once the facts satisfy the trigger',
        ],
        [
          '**Principle-Apply**',
          'No new rule - only a checklist match',
          'The case facts already satisfy the given rule\'s trigger and verdict',
        ],
      ],
    },
    {
      ...
      text: 'If your candidate answer feels too custom and narrow, you are drifting into Sufficient Assumption. If it feels like you are simply checking whether facts match a rule that is already given, you are drifting into Principle-Apply. Module 13 lives between those poles: identify the broad rule, then complete the application from the case facts to the verdict.',
    },

    { type: 'hr' },

    { type: 'h2', text: 'Step 5: Match the Answer' },
    {
      type: 'paragraph',
      text: 'Scan the choices for the principle that best matches your pre-phrase and completed application. The correct answer will be a general, abstract statement that, when applied to the specific facts in the stimulus, makes the conclusion follow in the way the stem requires.',
    },
    { type: 'paragraph', text: 'To confirm your choice, apply this two-part verification:' },
    {
      ...
      items: [
        ...
        '**Check the strength standard:** Does the principle justify or strongly support the conclusion without your having to smuggle in another custom premise? If you still need extra tailoring, it is not the right bridge.',
      ],
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "diff-note",
          "text": "Website lesson 12-2 evaluated as standalone content. Key issues: (1) no try-it-first prompt before the pharmaceutical worked example; (2) worked example has no question-card — students cannot practice Step 4 against real answer choices; (3) overlap with 12-1 on leap types and pre-phrasing; (4) wrong answer patterns table duplicates Reference Guide content.",
          "variant": "comment"
        },
        {
          "type": "h2",
          "text": "The 4-Step Method for Principle: Strengthen Questions"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "diff-note",
          "text": "The leap type taxonomy table below (Fact → Value, Means → End, etc.) is introduced in Lesson 12-1's worked example and repeated here. The mastery course version of this lesson adds a dedicated 5th leap type (Comparison → Choice) and cross-references Module 10/14 vocabulary, which adds genuine depth. The website version introduces the same table without that context.",
          "variant": "comment"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h2",
          "text": "Step 3: Abstract the Principle Needed (Pre-phrasing)"
        },
        {
          "type": "paragraph",
          "text": "Before looking at the answer choices, formulate the general rule that the author must believe to make their argument work. This is the most important habit for Principle: Strengthen accuracy."
        ...
        {
          "type": "paragraph",
          "text": "To pre-phrase effectively, perform a **two-part abstraction:**"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h4",
          "text": "Pre-phrase Templates by Leap Type"
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            ...
            [
              "Role → Duty",
              "\"Anyone who occupies [this type of role] has an obligation to [this type of duty].\""
            ],
            [
              "Features → Category",
              "\"Anything that has [these types of features] qualifies as [this category].\""
            ],
            [
              "Comparison → Choice",
              "\"When [this type of option] is better than all alternatives, one should choose it.\""
            ]
          ]
        },
        {
        ...
        {
          "type": "paragraph",
          "text": "Scan the choices for the principle that best matches your pre-phrase. The correct answer will be a general, abstract statement that, when applied to the specific facts in the stimulus, makes the conclusion follow."
        },
        {
          "type": "paragraph",
          "text": "To confirm your choice, apply this two-part verification:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "diff-note",
          "text": "The five wrong answer patterns table below (Contradiction, Scope Shift, Premise Restatement, Mistaken Reversal, Partial Justification) is repeated in the Reference Guide (12-7) in a more detailed breakdown format. One location should own this content. {{!Consider removing this table from 12-2 and keeping it only in the Reference Guide, or vice versa.!}}",
          "variant": "comment"
        },
        {
          "type": "h2",
        ...
        {
          "type": "paragraph",
          "text": "{{+**Try this:** Before reading the walkthrough, apply Steps 1–3 yourself. (1) Identify the consumer advocate's conclusion. (2) Name the logical gap — what kind of leap does the argument make? (3) Pre-phrase the principle you would need to bridge that gap. Then continue to the analysis below.+}}"
        },
        {
          "type": "diff-note",
          "text": "This worked example has no question-card and no answer choices. Students cannot practice Step 4 (evaluating and eliminating choices) at all. {{+Add a question-card with five answer choices to this example so students can complete the full 4-step method.+}}",
          "variant": "comment"
        },
        {
          "type": "paragraph",
      ...
      content: [
        {
          ...
          variant: 'tip',
          title: 'Target',
          text: '**Target:** 1:20 per Principle: Strengthen question',
        },
        {
          type: 'process',
          title: 'The 5-Step Method',
          steps: [
            '**Find the Conclusion** — Isolate the main claim and the evidence supporting it. Note the *type* of conclusion: value judgment, recommendation, blame, or classification.',
            '**Identify the Leap** — Find the gap between evidence and conclusion. What domain shift does the argument make? Classify the leap type to predict the principle type.',
            '**Abstract the Principle** — Generalize the gap into a broad rule. Replace specific facts with general categories, specific judgments with general verdicts. Ask: "Would this rule apply to other cases?"',
            '**Complete the Application** — Before checking answers, identify the trigger, case facts, bridge, and verdict. This keeps Principle: Strengthen distinct from Sufficient Assumption and Principle-Apply.',
            '**Match the Answer** — Scan choices for the principle matching your pre-phrase. Verify by plugging stimulus facts back into the general rule.',
          ],
        },
        {
          type: 'table',
          headers: ['Leap Type', 'Evidence Domain', 'Conclusion Domain', 'Principle Template'],
          rows: [
            ['**Fact -> Value**', 'Descriptive facts', 'Moral/ethical judgment', '"If [fact type], then [judgment] is warranted."'],
            ['**Means -> End**', 'Method or strategy', 'Recommendation to pursue it', '"Choose the means most effective at [end]."'],
            ['**Role -> Duty**', 'Position or authority', 'Obligation or responsibility', '"Anyone in [role] has a duty to [action]."'],
            ['**Features -> Category**', 'Characteristics', 'Classification or label', '"Anything with [features] qualifies as [category]."'],
            ['**Comparison -> Choice**', 'Comparative evaluation', 'Recommendation', '"When [option] outperforms all alternatives, choose it."'],
            ['**Concession -> Best Available**', 'Two flawed options', 'One is preferable', '"Better to err on the side of [A] than [B]."'],
          ],
        },
        {
          type: 'callout',
