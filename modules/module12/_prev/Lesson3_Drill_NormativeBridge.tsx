  ...
  content: [
    ...
    { type: 'h4', text: 'Common Normative Bridge Variations' },
    {
      ...
      rows: [
        ...
        [
          'An entity has a certain characteristic',
          'The entity deserves a certain treatment',
          'Characteristic → Deserved treatment',
        ],
      ],
    },
    ...
    {
      type: 'paragraph',
      text: "Let's dissect the argument layer by layer, identifying each logical move the pacifist makes.",
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          title: '"It is immoral to do anything that causes harm to another person."',
          text: "This is the foundational moral premise — a broad ethical rule. The pacifist starts by asserting a universal normative standard: harm-causing actions are immoral. This will serve as the argument's starting point.",
        },
        {
          title: '"But, since using force causes harm to another person..."',
          text: 'This is a factual bridge premise. It connects the act of "using force" to the category of "causing harm." This allows the pacifist to apply the moral rule from premise 1 to the specific action of using force. At this point, the implied intermediate conclusion is: *using force is immoral* (because it causes harm, and causing harm is immoral).',
        },
        {
          title: '"...it is also immoral to threaten to use force, even when such a threat is made in self-defense."',
          text: 'This is the main conclusion. The pacifist extends the moral judgment about *using force* to *threatening to use force*. Notice the word "also" — it signals that the same moral quality (immorality) that applies to using force is now being applied to the threat of force. This is the argument\'s critical logical leap.',
        },
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'Steps 1–3 are logically sound. But Step 4 introduces a new concept — *threatening* to do something — and declares it immoral on the basis that the *act itself* is immoral. The argument never provides a rule that connects the morality of an action to the morality of a threat to perform that action. This is the gap.',
    },
    {
      type: 'callout',
      variant: 'default',
      title: 'Classifying the Gap',
      text: 'This is a **Normative Bridge** gap, but of a specific subtype: the argument moves from one moral judgment ("using force is immoral") to a *related* moral judgment ("threatening to use force is immoral"). The bridge needed is not fact-to-value, but value-to-value: a principle stating that the moral status of an action transfers to the moral status of threatening that action.',
    },

    { type: 'h4', text: 'Step 3: Pre-phrase the Principle' },
    {
      type: 'paragraph',
      text: 'The argument needs a general rule that connects the morality of an act to the morality of threatening to perform that act. In abstract terms:',
    },
    { type: 'paragraph', text: '***"If doing X is immoral, then threatening to do X is also immoral."***' },
    {
      type: 'paragraph',
      text: 'This principle, if valid, would close the gap perfectly: the pacifist has established that using force is immoral, and this bridge principle would automatically extend that moral judgment to the *threat* of using force.',
    },
    ...
    { type: 'h4', text: 'Step 4: Complete the Application' },
    {
      ...
      rows: [
        ['**Trigger**', 'Threatening to do something that is immoral is itself immoral.'],
        ['**Case Facts**', 'The pacifist\'s premises establish that using force is immoral because it causes harm.'],
        ['**Bridge**', 'If using force is immoral, then threatening to use force falls inside the trigger.'],
        ['**Verdict**', 'Threatening to use force is immoral, even in self-defense.'],
      ],
    },
    {
      type: 'paragraph',
      text: 'This is the classic Module 13 pseudo-sufficient feel: once the right general rule is applied, the conclusion is nearly complete. But the answer is still a broad transfer principle, not a custom one-off premise about this pacifist alone.',
    },
      ...
      items: [
        {
          title:
            '(A) Given the potential harm caused by the use of force, the line between use of force in self-defense and the aggressive use of force is always vague.',
          text: "This principle addresses the *distinction between types of force* — defensive vs. aggressive. But the pacifist's argument does not rely on blurring this distinction. The pacifist's logic is absolute: *all* threats of force are immoral, regardless of whether the force is defensive or aggressive. The argument doesn't need the line between these types to be vague; it declares the entire category immoral.\n\n**Why it fails:** It addresses an irrelevant distinction. The gap is between the morality of *acting* and the morality of *threatening*, not between types of force.",
          badge: 'Irrelevant Distinction',
          badgeColor: 'red',
        },
        {
          title: '(B) It is immoral to threaten to do what it is immoral to do.',
          text: 'This matches our pre-phrase almost exactly. The pacifist has established that using force is immoral (an action). This principle states that *threatening* to perform an immoral action is itself immoral. Applied to the argument:\n\n1. Using force is immoral (established by the argument).\n2. Threatening to do what is immoral is itself immoral (this principle).\n3. Therefore, threatening to use force is immoral (the conclusion).\n\nThe principle provides the exact bridge between the morality of the act and the morality of the threat.',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title: '(C) It is immoral to do anything that causes more harm than good.',
          text: 'The pacifist uses a strict, absolute standard: causing *any* harm is immoral. This answer introduces a different, more flexible standard based on a cost-benefit analysis ("more harm than good"). Under this principle, causing harm could be moral if it also produces sufficient good — which directly contradicts the pacifist\'s absolute premise.\n\n**Why it fails:** It replaces the pacifist\'s strict standard with a utilitarian one. The principle is about a different moral framework, not the gap in this argument.',
          badge: 'Mismatched Standard',
          badgeColor: 'red',
        },
        {
          title: '(D) Whether a threat made in self-defense is immoral depends on the circumstances.',
          text: "This principle directly *undermines* the pacifist's conclusion. The pacifist argues that threatening to use force is immoral *even when* the threat is made in self-defense — an absolute claim that ignores circumstances. This answer says the opposite: circumstances matter. If valid, it would weaken, not strengthen, the argument.\n\n**Why it fails:** It is a Contradiction trap. It justifies the opposing position.",
          badge: 'Contradiction',
          badgeColor: 'red',
        },
        {
          title: '(E) It is immoral to carry out a threat if making the threat is itself immoral.',
          text: 'This principle gets the logical direction *backward*. The pacifist\'s argument flows from the morality of the *act* to the morality of the *threat*:\n\n**Argument\'s direction:** Act is immoral → Threat is immoral\n\n**This answer\'s direction:** Threat is immoral → Carrying out the threat is immoral\n\nChoice (E) goes from threat to act; the argument goes from act to threat. Even if (E) is true, it does not help the pacifist get from "using force is immoral" to "threatening to use force is immoral."\n\n**Why it fails:** It is a Reversal trap — correct topic, wrong logical direction.',
          badge: 'Reversal Trap',
          badgeColor: 'red',
        },
      ],
    ...
    {
      type: 'table',
      headers: ['Answer', 'What It Addresses', 'Does It Bridge Act → Threat?'],
      rows: [
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "How to Spot a Normative Bridge Gap"
        },
        {
          "type": "paragraph",
          "text": "Use this quick diagnostic:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h4",
          "text": "Common Normative Bridge Variations"
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              "An action causes harm",
              "The action is immoral",
              "Harm → Moral wrongness"
            ],
            [
              "A policy has a certain effect",
              "The policy should be rejected",
              "Negative effect → Policy rejection"
            ],
            [
              "A person has a certain motive",
              "The person is blameworthy",
              "Bad motive → Moral culpability"
            ],
            [
              "A rule produces unfairness",
              "The rule should be changed",
              "Unfairness → Obligation to reform"
            ],
            [
              "An entity has a certain characteristic",
              "The entity deserves a certain treatment",
        ...
        {
          "type": "h3",
          "text": "Drill: The Normative Bridge (PT-117-S-4-Q-2)"
        },
        {
          "type": "h4",
          "text": "The Problem"
        ...
        {
          "type": "paragraph",
          "text": "The argument establishes a clear chain up to a certain point:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "***\"If doing X is immoral, then threatening to do X is also immoral.\"***"
        },
        {
          "type": "paragraph",
          "text": "This principle, if valid, would close the gap perfectly: the pacifist has established that using force is immoral, and this bridge principle would automatically extend that moral judgment to the *threat* of using force."
        ...
        },
        {
          ...
          "items": [
            {
              "title": "(A) Given the potential harm caused by the use of force, the line between use of force in self-defense and the aggressive use of force is always vague.",
              "text": "This principle addresses the *distinction between types of force* — defensive vs. aggressive. But the pacifist's argument does not rely on blurring this distinction. The pacifist's logic is absolute: *all* threats of force are immoral, regardless of whether the force is defensive or aggressive. The argument doesn't need the line between these types to be vague; it declares the entire category immoral.\n\n**Why it fails:** It addresses an irrelevant distinction. The gap is between the morality of *acting* and the morality of *threatening*, not between types of force.",
              "badge": "Irrelevant Distinction",
              "badgeColor": "red"
            },
        ...
        },
        {
          ...
          "rows": [
            ...
            [
              "**(B)**",
              "**Moral transfer from act to threat**",
              "**Yes — bridges the gap directly ✓**"
            ],
            [
              "(C)",
              "Cost-benefit moral standard",
              "No — different moral framework"
            ],
            [
              "(D)",
              "Circumstance-dependent morality",
              "No — contradicts the conclusion"
            ],
            [
              "(E)",
              "Moral transfer from threat to act",
              "No — reverses the direction"
            ]
          ]
        },
        {
