...
export const Lesson1_Introduction: Lesson = {
  ...
  content: [
    ...
    {
      type: 'callout',
      text: '**Identify the general rule or broad philosophy that, if valid, provides the strongest support for the argument\'s conclusion.** What is the "law" that connects the specific facts of the case to the author\'s reasoning?',
      variant: 'goal',
    },
    { type: 'hr' },
