...
export const Lesson7_Question20: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-114-S-3-Q-20', questionType: 'Inference', passageTitle: 'Historical Sociology', passage: passageText, question: `Based on the passage, which one of the following is the LEAST illustrative example of the effect of a contingency upon an individual?`, options: [
    ...
    { 
      ...
      items: [
        { title: "(A)", text: "Experiencing political injustice is a significant social condition that can profoundly shape one's identity and motivate major life actions, such as working for reform. This is a strong example.", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(B)", text: "Being raised in an agricultural region is a key social and economic condition that directly influences one's skills, opportunities, and career path—a major life decision. This is a good example.", badge: 'Out of Scope', badgeColor: "red" },
        ...
        { title: "(D)", text: "The religion one is raised in is a powerful social and ideological contingency that shapes personal identity, beliefs, and major life choices. This is a classic example.", badge: 'Misattribution', badgeColor: "red" },
        { title: "(E)", text: "The passage specifically lists 'the condition of our household’s economy' as a contingency. Growing up in hardship can deeply affect a person's values and identity, leading to significant life decisions. This is a very illustrative example.", badge: 'Unsupported Leap', badgeColor: "red" }
    ]
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question 20 Breakdown"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Based on the passage, which one of the following is the LEAST illustrative example of the effect of a contingency upon an individual?"
        },
        {
          "type": "options",
          "items": [
        ...
        },
        {
          ...
          "title": "Prediction",
          "variant": "tip",
          "text": "The passage defines 'contingencies' as deep, identity-forming social factors that shape our capacities and partially determine our major actions. We are looking for the example that is the most trivial and least illustrative of this profound influence."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "Experiencing political injustice is a significant social condition that can profoundly shape one's identity and motivate major life actions, such as working for reform. This is a strong example.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "Being raised in an agricultural region is a key social and economic condition that directly influences one's skills, opportunities, and career path—a major life decision. This is a good example.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "This is the correct answer. Deciding to visit friends in another town is a simple, everyday choice. It does not illustrate the deep, identity-forming influence of a contingency that shapes one's 'capacities' and 'partially determines the sorts of actions' one can perform in a larger historical sense. It is a trivial decision compared to the others.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(D)",
              "text": "The religion one is raised in is a powerful social and ideological contingency that shapes personal identity, beliefs, and major life choices. This is a classic example.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "The passage specifically lists 'the condition of our household’s economy' as a contingency. Growing up in hardship can deeply affect a person's values and identity, leading to significant life decisions. This is a very illustrative example.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
