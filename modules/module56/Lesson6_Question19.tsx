...
export const Lesson6_Question19: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-114-S-3-Q-19', questionType: 'Purpose of Paragraph', passageTitle: 'Historical Sociology', passage: passageText, question: `The primary function of the first paragraph of the passage is to`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Purpose of Paragraph', text: 'Read the question stem carefully. Return to the passage for direct evidence before evaluating answer choices.' },
    ...
    { 
      ...
      items: [
        { title: "(A)", text: "The paragraph introduces Abrams's concept, but it doesn't argue for its 'merits' or advantages. It simply presents the idea and the problem it is meant to solve.", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(B)", text: "This is too broad. The paragraph introduces the core concept, but the subsequent paragraphs provide the specific 'details' of its application to history, such as 'contingencies' and the four-part research method.", badge: 'Out of Scope', badgeColor: "red" },
        { title: "(C)", text: "The paragraph does not mention any potential criticisms or challenges to Abrams's theory. It describes a challenge *that Abrams's theory aims to overcome*.", badge: 'Partial Match', badgeColor: "red" },
        { title: "(D)", text: "While it introduces the key term 'structuring,' the paragraph's main function is much broader than just defining terms. It establishes the entire intellectual problem that motivates Abrams's work.", badge: 'Misreading', badgeColor: "red" },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "blockquote",
          "text": "**Question:** The primary function of the first paragraph of the passage is to"
        },
        {
          "type": "options",
          "items": [
        ...
        },
        {
          ...
          "title": "Prediction",
          "variant": "tip",
          "text": "The first paragraph introduces a problem in sociology (one-sided approaches) and then presents Abrams's solution ('structuring'). This problem-solution setup serves as the foundation or 'basis' for his entire theory, which is then applied to history in the rest of the passage."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "The paragraph introduces Abrams's concept, but it doesn't argue for its 'merits' or advantages. It simply presents the idea and the problem it is meant to solve.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "This is too broad. The paragraph introduces the core concept, but the subsequent paragraphs provide the specific 'details' of its application to history, such as 'contingencies' and the four-part research method.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "The paragraph does not mention any potential criticisms or challenges to Abrams's theory. It describes a challenge *that Abrams's theory aims to overcome*.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "While it introduces the key term 'structuring,' the paragraph's main function is much broader than just defining terms. It establishes the entire intellectual problem that motivates Abrams's work.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "This is correct. The first paragraph explains the problem (the 'one-sided approaches' in sociology) that Abrams's theory is designed to solve. It then introduces his core idea of 'structuring' as the solution. This establishes the intellectual foundation, or 'basis,' for his entire conception of historical sociology.",
              "badge": "Correct",
              "badgeColor": "green"
            }
          ]
