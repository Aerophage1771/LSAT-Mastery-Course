...
export const Lesson5_Question18: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-114-S-3-Q-18', questionType: 'Analogy', passageTitle: 'Historical Sociology', passage: passageText, question: `Which one of the following is most analogous to the ideal work of a historical sociologist as outlined by Abrams?`, options: [
    ...
    { 
      ...
      items: [
        ...
        { title: "(B)", text: "This lacks a broader social context and focuses solely on the individual patient's medical history and future, not on the interaction between an individual and wider social forces.", badge: 'Topic Match Trap', badgeColor: "red" },
        { title: "(C)", text: "This is an analysis of a work of fiction, not a real historical event. It also fails to analyze the event's consequences for both history and the individual, instead comparing the novel to other books.", badge: 'Wrong Structure', badgeColor: "red" },
        { title: "(D)", text: "This is a forward-looking business report, not a historical analysis. It misses the key elements of social context and the past consequences of a specific event.", badge: 'Partial Match', badgeColor: "red" },
        { title: "(E)", text: "This scenario ends with speculation about a different outcome ('what might have been'). Abrams's method focuses on analyzing the actual consequences of an event, not imagining alternate histories.", badge: 'Wrong Scope', badgeColor: "red" }
    ]
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following is most analogous to the ideal work of a historical sociologist as outlined by Abrams?"
        },
        {
          "type": "options",
          "items": [
        ...
        },
        {
          ...
          "title": "Prediction",
          "variant": "tip",
          "text": "This is an analogy question. We must find a scenario that mirrors Abrams's four-part method: (1) describe the event, (2) explain the social context, (3) summarize the individual agent's history, and (4) analyze the consequences for both the larger system and the individual."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "This is a perfect analogy. The journalist's report follows all four steps: (1) event: bill enactment, (2) context: why the bill was needed, (3) agent: legislator's biography, and (4) consequences: effect on society (history) and the legislator's career (individual).",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B)",
              "text": "This lacks a broader social context and focuses solely on the individual patient's medical history and future, not on the interaction between an individual and wider social forces.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "This is an analysis of a work of fiction, not a real historical event. It also fails to analyze the event's consequences for both history and the individual, instead comparing the novel to other books.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "This is a forward-looking business report, not a historical analysis. It misses the key elements of social context and the past consequences of a specific event.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "This scenario ends with speculation about a different outcome ('what might have been'). Abrams's method focuses on analyzing the actual consequences of an event, not imagining alternate histories.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
