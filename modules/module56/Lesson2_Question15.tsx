...
export const Lesson2_Question15: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-114-S-3-Q-15', questionType: 'Main Idea', passageTitle: 'Historical Sociology', passage: passageText, question: `Which one of the following most accurately states the central idea of the passage?`, options: [
    ...
    { 
      ...
      items: [
        { title: "(A)", text: "This is incorrect. The passage doesn't mention other sociologists arguing that structuring *cannot* be applied to history. Abrams is presented as the one *proposing* this application to solve a different problem.", badge: 'Too Narrow', badgeColor: "red" },
        { title: "(B)", text: "This misstates the central conflict. The issue Abrams has with other sociologists is their one-sided view of the society-individual dynamic, not a disagreement about history's influence on contingencies.", badge: 'False Hierarchy', badgeColor: "red" },
        { title: "(C)", text: "This is a distortion. The primary disagreement Abrams identifies is about the relationship between *people and society*, not between *social structures and history*.", badge: 'Too Extreme', badgeColor: "red" },
        ...
        { title: "(E)", text: "The passage's focus is on fixing a problem *within sociology* and then applying that improved sociological method to history. It doesn't claim its primary purpose is to fix the shortcomings of *traditional historical methods*.", badge: 'Wrong Scope', badgeColor: "red" }
    ]
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following most accurately states the central idea of the passage?"
        },
        {
          "type": "options",
          "items": [
        ...
        },
        {
          ...
          "title": "Prediction",
          "variant": "tip",
          "text": "The passage explains Abrams's core idea: that sociologists often have a one-sided view of the society-individual relationship. His solution is 'structuring,' a two-way approach. He then applies this combined approach to the study of history. The main idea must capture this entire process."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "This is incorrect. The passage doesn't mention other sociologists arguing that structuring *cannot* be applied to history. Abrams is presented as the one *proposing* this application to solve a different problem.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "This misstates the central conflict. The issue Abrams has with other sociologists is their one-sided view of the society-individual dynamic, not a disagreement about history's influence on contingencies.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "This is a distortion. The primary disagreement Abrams identifies is about the relationship between *people and society*, not between *social structures and history*.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "This accurately summarizes the passage. It describes how sociologists usually have 'one-sided approaches.' It then explains that Abrams's concept ('structuring') 'unites' these approaches, and that this 'combined approach' is applied 'to the study of history.'",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(E)",
              "text": "The passage's focus is on fixing a problem *within sociology* and then applying that improved sociological method to history. It doesn't claim its primary purpose is to fix the shortcomings of *traditional historical methods*.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
