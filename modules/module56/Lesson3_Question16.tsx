...
export const Lesson3_Question16: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-114-S-3-Q-16', questionType: 'Inference', passageTitle: 'Historical Sociology', passage: passageText, question: `Given the passage’s argument, which one of the following sentences most logically completes the last paragraph?`, options: [
    ...
    { 
      ...
      items: [
        { title: "(A)", text: "This is too narrow. It only mentions the influence of individuals on events, ignoring the other half of Abrams's 'mutual interaction'—the influence of society on individuals.", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(B)", text: "This misrepresents the problem. The passage states that sociologists take a 'one-sided' approach, not that they see 'very little connection' between individuals and history.", badge: 'Out of Scope', badgeColor: "red" },
        { title: "(C)", text: "The passage discusses Abrams's theory, not the professional reputation or academic standing of historical sociology. This is out of scope.", badge: 'Misattribution', badgeColor: "red" },
        { title: "(D)", text: "This is a plausible goal, but it's not the primary purpose of the four-part method. The method's explicit goal is to capture the 'mutual interaction' in history, not just to critique other sociologists.", badge: 'Unsupported Leap', badgeColor: "red" },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "blockquote",
          "text": "**Question:** Given the passage’s argument, which one of the following sentences most logically completes the last paragraph?"
        },
        {
          "type": "options",
          "items": [
        ...
        },
        {
          ...
          "title": "Prediction",
          "variant": "tip",
          "text": "The last paragraph outlines Abrams's four-part method. The purpose of this method is explicitly stated: 'In order to capture the various facets of this mutual interaction...' between the individual and social forces. The logical completion should summarize this goal."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "This is too narrow. It only mentions the influence of individuals on events, ignoring the other half of Abrams's 'mutual interaction'—the influence of society on individuals.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "This misrepresents the problem. The passage states that sociologists take a 'one-sided' approach, not that they see 'very little connection' between individuals and history.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "The passage discusses Abrams's theory, not the professional reputation or academic standing of historical sociology. This is out of scope.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "This is a plausible goal, but it's not the primary purpose of the four-part method. The method's explicit goal is to capture the 'mutual interaction' in history, not just to critique other sociologists.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "This choice perfectly summarizes the purpose of Abrams's method as described in the passage. The entire passage builds to this idea of a 'mutual interaction' between individuals making history ('human agency') and the social forces that shape them ('history'). The four-part structure is designed to analyze and 'portray' these 'complex connections.'",
              "badge": "Correct",
              "badgeColor": "green"
            }
          ]
