...
export const Lesson4_Question17: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-114-S-3-Q-17', questionType: 'Except, Inference', passageTitle: 'Historical Sociology', passage: passageText, question: `The passage states that a contingency could be each of the following EXCEPT:`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Except, Inference', text: 'Read the question stem carefully. Return to the passage for direct evidence before evaluating answer choices.' },
    ...
    { 
      ...
      items: [
        { title: "(A)", text: "This is explicitly stated. The passage defines contingencies as 'social phenomena over which we have varying degrees of control.' So, this is a correct description.", badge: 'Too Extreme', badgeColor: "red" },
        ...
        { title: "(C)", text: "This is explicitly stated. The passage gives 'accidental circumstances' as a direct example of a contingency.", badge: 'Out of Scope', badgeColor: "red" },
        { title: "(D)", text: "This is explicitly stated. The passage says contingencies are phenomena 'over which we have varying degrees of control,' which means they can be controlled to some extent.", badge: 'Partial Match', badgeColor: "red" },
        { title: "(E)", text: "This is explicitly stated. The passage says that contingencies create a structure that 'partially determines the sorts of actions we are able to perform.'", badge: 'Misreading', badgeColor: "red" }
    ]
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "blockquote",
          "text": "**Question:** The passage states that a contingency could be each of the following EXCEPT:"
        },
        {
          "type": "options",
          "items": [
        ...
        },
        {
          ...
          "title": "Prediction",
          "variant": "tip",
          "text": "This is an EXCEPT question that requires a close reading of the second paragraph, where 'contingencies' are defined. We need to find the one description that does not match the text."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "This is explicitly stated. The passage defines contingencies as 'social phenomena over which we have varying degrees of control.' So, this is a correct description.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "The passage describes 'historical structuring' as the broad, continuous process being studied. 'Contingencies' are specific factors or ingredients *within* that larger process, but they are not the process itself. Therefore, a contingency is not a 'form' of historical structuring.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(C)",
              "text": "This is explicitly stated. The passage gives 'accidental circumstances' as a direct example of a contingency.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "This is explicitly stated. The passage says contingencies are phenomena 'over which we have varying degrees of control,' which means they can be controlled to some extent.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "This is explicitly stated. The passage says that contingencies create a structure that 'partially determines the sorts of actions we are able to perform.'",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
