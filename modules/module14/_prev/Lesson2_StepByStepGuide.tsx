...
export const Lesson2_StepByStepGuide: Lesson = {
  id: '14-2',
  title: 'Step-by-Step: Principle-Generalization',
  questionPolicy: 'none',
  content: [
    { type: 'h2', text: 'Step-by-Step: Principle-Generalization' },
    {
      type: 'paragraph',
...

    {
      ...
      variant: 'tip',
      title: 'Timing',
      text: 'You should spend roughly **1 minute and 30 seconds** per Principle-Generalization question. The majority of your time (~40 seconds) should be spent on Steps 1 and 2 — understanding the situation and formulating your pre-phrase. If your pre-phrase is strong, evaluating the answer choices (Step 4) takes only 30–40 seconds. A weak or missing pre-phrase forces you to evaluate each choice from scratch, which easily pushes you past 2 minutes.',
    },
    ...
    { type: 'paragraph', text: 'As you read, identify three components:' },
    {
      ...
      items: [
        {
          title: 'The Players',
          text: 'Who or what is involved? People, organisms, policies, groups? Are there two groups being compared, or one group observed over time? Identify the subjects of the scenario.',
          badge: 'Who/What',
          badgeColor: 'blue',
        },
        {
          title: 'The Key Variable',
          text: 'What is the one factor that changes, differs, or is being manipulated? In an experiment, this is the independent variable. In an anecdote, this is the distinguishing feature between two situations or the cause of a notable outcome.',
          badge: 'What Changed',
          badgeColor: 'blue',
        },
        {
          title: 'The Outcome',
          text: 'What happened as a result? What is the observed effect, consequence, or difference in behavior? This is the dependent variable — the thing that the key variable influenced.',
          badge: 'What Resulted',
          badgeColor: 'indigo',
        },
      ],
...

    {
      ...
      text: 'Some stimuli present three or four interrelated facts without a clear "experiment" structure. When this happens, look for the **contrast** — the element that makes one thing different from another. If there is no contrast, look for the **causal chain** — what leads to what. Every Principle-Generalization stimulus has a core relationship; your job in Step 1 is to find it, even if the stimulus does not make it obvious.',
    },
    ...
    {
      type: 'paragraph',
      text: 'Now that you understand what happened, ask yourself: **What is the one relationship or pattern that makes this situation interesting or noteworthy?** This is the central dynamic — the mechanism that the principle will capture.',
    },

    {
      type: 'paragraph',
      text: 'The key dynamic is not a summary of the stimulus. It is the **underlying logic** — the reason *why* the outcome occurred, expressed in terms of the relationship between the key variable and the outcome. To find it, ask:',
    },
    {
      type: 'list',
      ordered: true,
    ...
    {
      type: 'paragraph',
      text: '**Key Dynamic:** A behavior that appears aggressive or hostile may actually be a rational attempt to solve a problem, and it can be eliminated by providing an alternative solution.',
    },

    {
      type: 'callout',
      variant: 'tip',
      title: 'The "Moral of the Story" Test',
      text: 'Imagine you are telling this story to a friend and they ask, "So what\'s the point?" Your answer to that question is the key dynamic. If you cannot state the point in one or two sentences without using any specific details from the stimulus, you have not yet identified the dynamic. Keep refining until you can.',
    },
    {
      type: 'callout',
      variant: 'default',
      title: 'Principle vs. Explanation Check',
      text: 'Some Principle-Generalization stimuli are explanatory: they tell you *why* a group behaved a certain way or *why* an outcome occurred. Your answer still cannot stay at the one-case explanation level. Turn the explanation into a reusable pattern: "When X kind of setup is present, Y kind of response can result."',
    },
    {
      type: 'table',
      headers: ['If the stimulus explanation sounds like...', 'Raise it to the principle level by thinking...'],
      rows: [
        [
          '"This group ignored the downside because this tool served its interests."',
          '"Groups tend to overlook harms associated with practices that advance their interests."',
        ],
        [
          '"Once this standard was adopted, everyone built around it and switching became costly."',
          '"An early standard can create later lock-in that makes replacement difficult even when a better alternative exists."',
        ],
        [
          '"No individual member has the feature, but the whole arrangement does."',
          '"A system can display a property that is not visible in its parts considered separately."',
        ],
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'This is the most critical step. Take the key dynamic from Step 2 and translate it into fully abstract, general language. Replace every specific detail with a general category, while preserving the logical structure.',
    },
    ...
    {
      type: 'table',
      headers: ['Specific Detail', 'Abstracted Version'],
      rows: [
    ...
    {
      type: 'paragraph',
      text: '**Pre-phrase:** "A behavior that appears hostile or aggressive may actually be a rational attempt to achieve a goal when other means are unavailable, and providing an effective alternative eliminates the behavior."',
    },

    {
      type: 'callout',
      variant: 'default',
      title: 'Common Abstraction Mistakes',
      text: '**Too specific:** "Children bite because they want toys." This is a summary, not a principle. It only applies to this exact scenario.\n\n**Too vague:** "People sometimes do bad things for good reasons." This loses the critical mechanism — the role of unavailable alternatives and the solution of providing them.\n\n**Wrong focus:** "Teaching children to trade is an effective discipline strategy." This captures a practical recommendation but misses the underlying *principle* about why the behavior occurred in the first place.\n\nThe correct level of abstraction preserves the **mechanism** (why → because → therefore) while removing the **specifics** (who, where, what exactly).',
    },
    {
      type: 'table',
      headers: ['Advanced Family', 'What to Abstract', 'Useful Pre-Phrase Template'],
      rows: [
        [
          '**Path Dependency / Lock-In**',
          'An early choice or default becomes self-reinforcing and makes switching harder later.',
          '"Once an option becomes entrenched, moving to a better alternative can remain difficult because the earlier path changes the later landscape." Use `PT-133-S-3-Q-3` as the cleanest real-question model.',
        ],
        [
          '**Emergence / Whole vs Part**',
          'The key property belongs to the system or whole arrangement rather than to any single part.',
          '"A collection or structure can have a feature that cannot be predicted by examining its components one at a time." Use `PT-135-S-4-Q-18` as the cleanest real-question model.',
        ],
      ],
    },
    {
      type: 'breakdown',
      labels: { title: 'Recognition Cue', text: 'How to Use It' },
      items: [
        {
          title: 'Path Dependency / Lock-In',
          text: 'Look for early adoption, defaults, installed bases, prior investments, coordination pressures, or switching-friction language. The principle should capture the self-reinforcing structure, not merely that people prefer what is familiar.',
          badge: 'Recognition',
          badgeColor: 'slate',
        },
        {
          title: 'Emergence / Whole vs Part',
          text: 'Look for a contrast between component-level facts and a whole-level result: no single part has the feature, but the combined arrangement does. The principle should capture that system-level property instead of summarizing the parts.',
          badge: 'Recognition',
          badgeColor: 'slate',
        },
      ],
    ...
    {
      type: 'paragraph',
      text: 'Compare each answer choice to your pre-phrase. The correct answer will be a general proposition that captures the same dynamic you identified, phrased in abstract terms. Use two checks:',
    },

    {
      type: 'breakdown',
      labels: { title: 'Check', text: 'What to Verify' },
      items: [
        {
          title: 'Check 1: The Textbook Test',
          text: 'Is the stimulus a *textbook example* of this principle? Would a professor use this stimulus as a case study to illustrate this principle? If yes, the principle is likely correct. If the stimulus merely "doesn\'t contradict" the principle, it is likely wrong.',
          badge: 'Primary',
          badgeColor: 'indigo',
        },
        {
          title: 'Check 2: The Strength Test',
          text: 'Is the principle\'s language appropriately calibrated to the evidence? A single case supports "can" and "sometimes" but not "always" and "necessarily." If the principle claims more than the stimulus demonstrates, it is too strong.',
          badge: 'Secondary',
          badgeColor: 'blue',
        },
      ],
    ...
    {
      type: 'paragraph',
      text: 'When two choices seem close, apply the **Whole Story Test**: does the principle capture the *entire* central dynamic, or just a piece of it? The correct answer accounts for all the important elements of the story — not just one aspect.',
    },

    {
      type: 'callout',
      variant: 'tip',
      title: 'The Flexibility Pivot',
      text: 'If no answer choice matches your pre-phrase exactly, do not abandon the logic of the stimulus. Instead, look for the choice that best *describes the situation* using different abstract language than you expected. The correct answer often phrases the principle in a way you did not anticipate — but it still captures the same underlying dynamic. Trust your understanding of the stimulus, not your exact wording.',
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "The 4-Step Method for Principle-Generalization Questions"
        },
        {
          "type": "paragraph",
          "text": "This lesson provides a complete, repeatable method for solving any Principle-Generalization question. Each step includes concrete guidance, examples of how the step works in practice, and callouts for when things get tricky. At the end, you will work through a full example applying all four steps, followed by a catalogue of wrong-answer patterns and a timing strategy."
        ...
        {
          "type": "h2",
          "text": "Step 1: Understand the Situation"
        },
        {
          "type": "paragraph",
          "text": "Your first task is to read the stimulus and understand it as a self-contained case study. Unlike Flaw, Weaken, or Strengthen questions, you are usually **not** reading a formal argument. There is often no explicit conclusion, no logical gap to exploit, and no indicator words to guide you. Instead, you are reading a short narrative — the results of an experiment, an observation about behavior, a historical anecdote — and your job is to understand what happened and why."
        ...
        {
          "type": "paragraph",
          "text": "As you read, identify three components:"
        },
        {
          "type": "breakdown",
          "labels": {
        ...
        {
          "type": "paragraph",
          "text": "Applying the three-component framework:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h2",
          "text": "Step 2: Identify the Key Dynamic"
        },
        {
          "type": "paragraph",
          "text": "Now that you understand what happened, ask yourself: **What is the one relationship or pattern that makes this situation interesting or noteworthy?** This is the central dynamic — the mechanism that the principle will capture."
        ...
        {
          "type": "paragraph",
          "text": "From the toddler stimulus:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h2",
          "text": "Step 3: Abstract to General Terms"
        },
        {
          "type": "paragraph",
          "text": "This is the most critical step. Take the key dynamic from Step 2 and translate it into fully abstract, general language. Replace every specific detail with a general category, while preserving the logical structure."
        ...
        {
          "type": "h4",
          "text": "The Abstraction Technique"
        },
        {
          "type": "paragraph",
          "text": "Follow this systematic process:"
        },
        {
          "type": "process",
          "title": "Abstraction Process",
        ...
        },
        {
          ...
          "rows": [
            ...
            [
              "\"Biting\"",
              "\"A behavior that appears aggressive\""
            ],
            [
              "\"Wanting a toy another child was holding\"",
              "\"Attempting to obtain a desired resource\""
            ],
            [
              "\"Verbal negotiation had failed\"",
              "\"Standard means of achieving the goal were unavailable\""
            ],
            [
              "\"Trading toys\"",
              "\"An alternative means of achieving the goal\""
            ],
            [
              "\"Biting stopped\"",
              "\"The apparently aggressive behavior ceased\""
            ]
          ]
        },
        {
        ...
        {
          "type": "paragraph",
          "text": "Consider this illustrative case study:"
        },
        {
          "type": "blockquote",
        ...
        {
          "type": "diff-note",
          "text": "{{+**Try this:** Before reading the step-by-step walkthrough below, attempt Steps 1–3 on your own. Read the pharmaceutical trial scenario above, then: (1) identify the players, the key variable, and the outcome; (2) state the key dynamic in one sentence; (3) write your pre-phrase using no specific details from the stimulus. Then compare your formulation to the walkthrough.+}}",
          "variant": "comment"
        },
        {
          "type": "diff-note",
          "text": "{{~The base lesson uses three <br/> spacer paragraphs here to create visual separation before the analysis. This conveys the right intent (pause before looking at the answer) but is not self-explanatory. The try-it prompt above replaces the spacer with an explicit instruction.~}}",
          "variant": "comment"
        },
        {
          "type": "hr"
        ...
        {
          "type": "h3",
          "text": "Why the Generalization Works"
        },
        {
          "type": "callout",
          "title": "Final Check",
        ...
        {
          "type": "paragraph",
          "text": "Here is how to allocate your ~90 seconds on a Principle-Generalization question:"
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              "Read stimulus",
              "~25 sec",
              "Read carefully. Identify players, key variable, outcome."
            ],
            [
            ...
            [
              "Verify",
              "~10 sec",
              "Confirm your choice captures the whole story. Eliminate any remaining competitors."
            ],
            [
              "**Total**",
              "**~85 sec**",
              "**Leave 5 seconds as buffer for hard questions.**"
            ]
          ]
        },
        {
    ...
    playbook: {
      ...
      content: [
        ...
        { type: 'h3', text: 'The Method' },
        {
          type: 'process',
          steps: [
            '**Understand the Principle.** Read the general rule. Identify every condition, qualifier, and consequence. Restate it as: IF [trigger], THEN [result], PROVIDED [conditions].',
            '**Identify the Trigger.** Determine what specific event or situation must occur for the principle to activate. This is your search criterion for the answer choices.',
            '**Check the Conditions.** For each answer choice, verify that every condition stated in the principle is satisfied -- not just one or two. A partial match is a trap.',
            '**Match the Application.** The correct answer is the specific scenario where (a) the trigger fires, (b) all conditions hold, and (c) the stated result logically follows.',
          ],
        },
        { type: 'h3', text: 'Decision Table' },
        {
          type: 'table',
          headers: ['Application Type', 'How It Works', 'What to Verify', 'Watch Out For'],
          rows: [
            [
              '**Direct Application**',
              'The trigger fires and the result follows exactly as stated',
              'Every condition of the principle is met in the scenario',
              'Answer where one condition is close but not exact',
            ],
            [
              '**Contrapositive**',
              'The result is absent, so the trigger must be absent',
              'The absence of the result truly implies the absence of the trigger',
              'Answer that reverses the conditional without proper contrapositive logic',
            ],
            [
              '**Definitional**',
              'The scenario must match a category defined in the principle',
              'The case satisfies every criterion of the definition',
              'Answer that satisfies most criteria but fails one',
            ],
            [
              '**Advanced (Multiple Conditions)**',
              'Several conditions must all be satisfied simultaneously',
              'Each condition is independently confirmed in the scenario',
        ...
        },
        {
          type: 'callout',
          variant: 'summary',
          text: '**Understand Principle -> Identify Trigger -> Check Conditions -> Match Application.** Read the principle as a rule: IF [trigger], THEN [result]. Find the answer choice where the trigger fires and the result follows.',
        },
      ],
    },
  },
