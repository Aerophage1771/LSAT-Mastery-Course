...
export const Lesson5_Drill_UnintendedConsequences: Lesson = {
  ...
  content: [
...

    {
      ...
      variant: 'default',
      title: 'Key Signal',
      text: 'Look for causal transition language: "as a result of," "the resulting," "this in turn," "but," "however." These markers trace the domino effect from solution to new problem. Also watch for a shift in domain \u2014 the original problem and the new problem are typically in different areas (health \u2192 finance, technology \u2192 employment, agriculture \u2192 environment).',
    },
    ...
    {
      type: 'paragraph',
      text: 'This drill demonstrates the unintended consequences pattern using a modern medicine scenario. Read the stimulus and commit to an answer before scrolling down to the analysis.',
    },
...

    {
      ...
      items: [
        {
          title: 'Link 1: The Solution',
          text: 'Modern medicine has enabled people to enjoy longer, pain-free lives. This is the original achievement \u2014 a successful solution to the problems of disease, suffering, and premature death.',
          badge: 'Success',
          badgeColor: 'green',
        },
        {
          title: 'Link 2: The Intermediate Effect',
          text: '"The resulting increase in life expectancy" \u2014 because people live longer, the proportion of elderly people in the population has grown steadily. This is a direct, predictable consequence of the solution working.',
          badge: 'Consequence',
          badgeColor: 'blue',
        },
        {
          title: 'Link 3: The New Problem',
          text: 'The demographic shift is "creating potentially devastating financial problems for some social welfare programs." A new, different problem has emerged \u2014 in an entirely different domain (public finance vs. healthcare).',
          badge: 'New Problem',
          badgeColor: 'red',
        },
      ],
    ...
    {
      type: 'paragraph',
      text: 'The argument presents a domino effect: **Solution succeeds \u2192 Success produces a side effect \u2192 Side effect creates a new problem.** The key insight is that the new problem exists *because* the solution worked, not because it failed.',
    },
    {
      type: 'paragraph',
      text: 'Notice the domain shift: the original problem was in **healthcare** (disease, early death), but the new problem is in **public finance** (welfare program costs). This cross-domain consequence is characteristic of the unintended consequences pattern \u2014 solving something here breaks something over there.',
    },
    {
      type: 'paragraph',
      text: '**Key Dynamic:** The act of successfully solving one type of problem can directly cause a different type of problem to emerge.',
    },
    ...
    { type: 'h4', text: 'Step 3: Abstract to General Terms' },
    {
      ...
      rows: [
        ...
        [
          '"As a result of... the resulting... this is creating"',
          'Causal chain: Solution \u2192 Success \u2192 New Problem',
        ],
      ],
    },
    {
      type: 'paragraph',
      text: '**Pre-phrase:** "Solving one set of problems can create a different set of problems."',
    },
...

    {
      ...
      items: [
        {
          title: '(A) Technical or scientific innovation cannot be the solution to all problems.',
          text: 'This is too weak and misidentifies the lesson. The stimulus actually shows that innovation **was** the solution to the problem of early death \u2014 it succeeded. The issue is not that innovation fails or has limits, but that its very success can trigger new problems. This answer addresses the wrong question ("Can innovation solve everything?") rather than the right one ("What happens when it does solve something?").',
          badge: 'Wrong Lesson',
          badgeColor: 'red',
        },
        {
    ...
    {
      type: 'table',
      headers: ['Answer', 'What It Claims', 'Matches Causal Chain?', 'Verdict'],
      rows: [
        [
          "(A) Innovation can't solve all problems",
          'Innovation has limits',
          '\u2717 \u2014 Innovation did solve the problem',
          'Wrong Lesson',
        ],
        [
          '(B) Delay innovation until ready',
          'Prescriptive recommendation',
          '\u2717 \u2014 Stimulus is descriptive, not prescriptive',
          'Normative Leap',
        ],
        [
          '(C) Every enhancement \u2192 negatives',
          'Universal + unavoidable',
          '\u2717 \u2014 One example can\'t prove "every" or "unavoidable"',
          'Too Strong',
        ],
        [
          '(D) All institutions affected',
          'Universal scope',
          '\u2717 \u2014 Only "some" programs mentioned',
          'Scope Error',
        ],
        [
          '**(E) Solving problems \u2192 new problems**',
          '**Causal chain: success \u2192 new problem**',
          '**\u2713 \u2014 Captures full chain with moderate language**',
          '**Correct \u2713**',
        ],
      ],
    },
      ...
      items: [
        {
          ...
          text: 'The stimulus describes what **happened**; the wrong answer prescribes what **should** happen. Watch for "should," "ought to," "must" in answers when the stimulus contains no recommendations. A factual account of consequences does not justify a policy prescription.',
          badge: 'Most Common',
          badgeColor: 'blue',
        },
        {
          title: 'The Universal Overreach',
          text: 'The answer claims the pattern applies to "every," "all," or "any" case. The stimulus provides a single example, which supports "can" and "sometimes" but never "always" or "every." Check the force of the quantifiers.',
          badge: 'Common',
          badgeColor: 'blue',
        },
        {
          title: 'The "Solution Failed" Misread',
          text: 'The answer implies that the original solution did not work or was flawed. In an unintended consequences scenario, the solution **succeeded** \u2014 that is precisely why the new problem arose. An answer claiming the solution was inadequate misreads the causal direction.',
          badge: 'Moderate',
          badgeColor: 'slate',
        },
        {
          title: 'The Partial Chain',
          text: 'The answer captures only part of the sequence \u2014 either the solution or the new problem, but not the causal link between them. The correct principle must describe the entire arc: solving Problem A caused Problem B.',
          badge: 'Moderate',
          badgeColor: 'slate',
        },
      ],
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "What Makes Unintended Consequences Distinctive"
        },
        {
          "type": "list",
          "ordered": true,
        ...
        {
          "type": "h3",
          "text": "Drill: Unintended Consequences (PT-124-S-1-Q-5)"
        },
        {
          "type": "paragraph",
          "text": "This drill demonstrates the unintended consequences pattern using a modern medicine scenario. Read the stimulus and commit to an answer before scrolling down to the analysis."
        ...
        {
          "type": "diff-note",
          "text": "{{!The base lesson places the spacer paragraph before the question-card. The visual gap should appear AFTER the question-card. The try-it prompt below replaces the spacer in the correct position.!}}",
          "variant": "comment"
        },
        {
          "type": "question-card",
        ...
        {
          "type": "diff-note",
          "text": "{{+**Try this:** Before reading the analysis below, trace the causal chain: what was the original problem, what was the solution, and what new problem did the solution create? Identify the domain shift. Write your pre-phrase.+}}",
          "variant": "comment"
        },
        {
          "type": "h3",
        ...
        {
          "type": "paragraph",
          "text": "The stimulus presents a clear three-link causal chain. Let's trace each link."
        },
        {
          "type": "breakdown",
          "labels": {
        ...
        },
        {
          ...
          "items": [
            ...
            {
              "title": "(B) Implementing technological innovations should be delayed until the resulting social changes can be managed.",
              "text": "The stimulus is purely **descriptive** — it explains what happened. This answer is **prescriptive** — it recommends what should be done. A factual narrative about consequences cannot support a policy recommendation about timing. Additionally, the stimulus never suggests that the consequences were foreseeable or manageable, which this prescription assumes.",
              "badge": "Normative Leap",
              "badgeColor": "red"
            },
        ...
        {
          "type": "h3",
          "text": "Unintended Consequences: Common Traps"
        },
        {
          "type": "breakdown",
          "labels": {
