...
export const Lesson1_Introduction: Lesson = {
  ...
  questionPolicy: 'none',
  content: [
    { type: 'h2', text: 'MODULE 15: Principle-Generalization' },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Principle-Generalization is the **reverse of Principle-Apply**. In Principle-Apply (Module 14), you receive a general rule and find the specific case that fits it — you move from abstract to concrete. In Principle-Generalization, you receive the specific case and must extract the general rule — you move from **concrete to abstract**. This reversal changes everything about how you approach the question.',
    },
    {
      type: 'paragraph',
      text: 'In Apply questions, precision is king: you decompose the rule into conditions, then check which answer satisfies each one. In Generalization questions, **abstraction** is king: you must strip away the specific details of the stimulus — the proper nouns, the particular context, the domain-specific language — and identify the universal pattern hiding underneath. The challenge is not in matching conditions but in *seeing through* the specifics to the underlying logic.',
    },
    {
      type: 'paragraph',
      text: 'These questions appear roughly **1–2 times per scored Logical Reasoning section** and span the full difficulty range. They are often found in the middle third of a section (questions 8–18). Students who rely on surface-level keyword matching struggle here because the correct answer is always phrased in abstract, general terms that look nothing like the stimulus on the surface — yet perfectly capture its logic at a deeper level.',
    },
    {
      type: 'paragraph',
      text: 'Mastering Principle-Generalization also strengthens your performance on Parallel Reasoning questions, where you must identify the same logical *structure* across two different arguments. The abstraction skill — seeing the universal form behind a specific instance — is the same in both question types. This module trains that skill directly.',
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'Frequency & Difficulty',
      text: 'Expect **1–2 Principle-Generalization questions per scored section**. They cluster in the medium-to-hard range. The difficulty comes not from complex logic but from the abstraction required: the correct answer uses general language that can feel disconnected from the stimulus unless you have practiced the concrete-to-abstract translation. Students who pre-phrase the "moral of the story" before reading the answer choices consistently outperform those who evaluate each choice in isolation.',
    },
    ...
    },
    {
      ...
      rows: [
        [
          '"Which one of the following propositions is best illustrated by the situation above?"',
          '"**propositions**" + "**illustrated by**" — find the general rule the case exemplifies',
        ],
        [
          '"The situation described most closely conforms to which one of the following principles?"',
          '"**conforms to**" + "**principles**" — the situation is an instance of a broader rule',
        ],
        [
          '"Which one of the following principles is best illustrated by the information above?"',
          '"**principles**" + "**illustrated**" — extract the abstract lesson',
        ],
        [
          '"The passage most precisely illustrates which one of the following propositions?"',
          '"**most precisely illustrates**" — precision matters; the rule must fit exactly',
        ],
        [
          '"The situation as described above most closely conforms to which one of the following generalizations?"',
          '"**generalizations**" — the answer is broad and universal, not specific',
        ],
      ],
    },
    {
    ...
    { type: 'h3', text: 'Quick Example — Seeing the Abstraction' },
    {
      type: 'paragraph',
      text: 'To get a feel for the concrete-to-abstract move before diving into the full theory, consider this stimulus:',
    },
    {
      type: 'blockquote',
    ...
    {
      type: 'paragraph',
      text: 'The abstracted principle: **A single trait in an organism can be advantageous in one environmental context and disadvantageous in another, and the prevalence of that trait depends on which context dominates.** Notice how every specific detail — guppies, spots, mates, predators — is replaced with a general category, but the logical *structure* (a trait with dual effects, context-dependent prevalence) is preserved perfectly. That is the core skill this module trains.',
    },
    ...
    {
      type: 'paragraph',
      text: 'This module builds the abstraction skill step by step. Here is the roadmap:',
    },
    {
      type: 'breakdown',
      labels: { title: 'Lesson', text: 'Description' },
      items: [
        {
          title: 'Foundations',
          text: 'The three principle question types compared, the abstraction skill in depth, common generalization categories, how to read the stimulus as a case study, criteria for the correct principle, and a full worked example.',
        },
        {
          title: 'Step-by-Step Guide',
          text: 'A repeatable method for solving Principle-Generalization questions, from identifying the central dynamic to evaluating answer choices.',
        },
        {
          title: 'Drill: Experiment Generalization',
          text: 'Practice with a stimulus describing an experiment whose results illustrate a broader principle.',
        },
        {
          title: 'Drill: Contextual Value',
          text: 'Practice with a stimulus where something\'s value depends entirely on context.',
        },
        {
          title: 'Drill: Unintended Consequences',
          text: 'Practice with a stimulus where a well-intentioned action produces a surprising side effect.',
        },
        {
          title: 'Drill: Motivated Blindness',
          text: 'Practice with a stimulus involving perception bias or selective attention.',
        },
        {
          title: 'Reference Guide',
          text: 'A condensed cheat sheet of every key concept from this module for quick review.',
        },
      ],
    },
...

    {
      ...
      variant: 'summary',
      title: 'Key Takeaway',
      text: 'Principle-Generalization gives you a specific case and asks for the general rule. The core skill is **abstraction** — stripping away the particular details of the stimulus to reveal the universal pattern underneath. The correct answer must be true *because of* the stimulus, not merely consistent with it. Before reading answer choices, always pre-phrase the "moral of the story" in abstract terms.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h2",
          "text": "The Three Principle Question Types"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h3",
          "text": "How Abstraction Works"
        },
        {
          "type": "paragraph",
          "text": "Consider this stimulus:"
        },
        {
          "type": "blockquote",
          "text": "\"Guppies with brightly colored spots attract more mates than dull-colored guppies, but they are also more visible to predators. In environments with few predators, brightly colored guppies thrive; in environments with many predators, dull-colored guppies predominate.\""
        ...
        {
          "type": "paragraph",
          "text": "To abstract this, you replace the specifics with general categories:"
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              "\"Guppies\"",
              "\"Organisms\" or \"members of a species\""
            ],
            [
            ...
            [
              "\"Attracting mates\"",
              "\"An advantage in one context\""
            ],
            [
              "\"Being visible to predators\"",
              "\"A disadvantage in another context\""
            ],
            [
              "\"Environments with few/many predators\"",
        ...
        {
          "type": "h2",
          "text": "Common Generalization Categories"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h2",
          "text": "The Stimulus as a Case Study"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h2",
          "text": "Criteria for the Correct Principle"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h3",
          "text": "1. Strict Support — The Stimulus Must Prove the Principle"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h3",
          "text": "2. Proper Strength — Watch the Force of Language"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "diff-note",
          "text": "{{+**Try this:** Before reading the walkthrough below, read the congestion surcharge scenario above and write your own pre-phrase in abstract terms. Identify the players, the key variable, and the outcome. State the \"moral of the story\" in one sentence using no specific details from the stimulus. Then compare your formulation to the step-by-step analysis.+}}",
          "variant": "comment"
        },
        {
          "type": "diff-note",
          "text": "{{!The Worked Example in this lesson is incomplete: Step 3 (Evaluate the Choices) describes what the correct answer should look like but provides no actual answer choices for the student to evaluate. Consider adding 3–5 sample answer choices or replacing Step 3 with a reference to a full question-card in a drill lesson.!}}",
          "variant": "comment"
        },
        {
          "type": "h3",
        ...
        {
          "type": "h4",
          "text": "Step 1: Identify the Central Dynamic"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h4",
          "text": "Step 2: Abstract to General Terms"
        },
        {
          "type": "paragraph",
          "text": "Replace specifics with general categories:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h4",
          "text": "Step 3: Evaluate the Choices"
        },
        {
          "type": "paragraph",
    ...
    glance: {
      label: 'At a Glance',
      content: [
        { type: 'h3', text: 'Principle-Apply — At a Glance' },
        {
          type: 'paragraph',
          text: '**Goal:** You receive a general principle in the stimulus and must find the specific scenario in the answer choices that satisfies every condition of that principle. **Frequency:** ~2% of LR questions (roughly 1 per scored section), spanning medium-to-hard difficulty.',
        },
        {
          type: 'table',
          headers: ['Stem Pattern', 'Core Skill', 'Common Trap', 'Key Signal'],
          rows: [
            ['"Which situation conforms to the principle above?"', 'Condition matching', 'Partial match (one condition met, another missed)', '"conforms to"'],
            ['"Which is an application of the principle?"', 'Condition matching', 'Reversed direction (concrete to abstract)', '"application of"'],
            ['"The principle most helps to justify which argument?"', 'Condition matching + justification', 'Answer where the principle is irrelevant to the argument\'s gap', '"justify"'],
            ['"Which judgment conforms to the principle?"', 'Condition matching', 'Answer that matches the topic but violates a condition', '"judgment"'],
          ],
        },
        {
          type: 'blockquote',
          text: '"Principle: A government should not restrict any activity unless that activity poses a demonstrable risk to public safety. — The city banned fireworks displays in residential areas after fire department data showed that such displays caused 40% of holiday-season house fires."',
        },
        {
          type: 'paragraph',
          text: 'Trigger: an activity (residential fireworks). Condition: demonstrable risk to public safety (40% of holiday house fires). Result: restriction is justified. The answer must show an activity that demonstrably risks public safety being restricted.',
        },
        { type: 'h4', text: "What's in This Module" },
        {
          type: 'list',
          items: [
            '**Foundations** — How Principle-Apply compares to Strengthen and Generalization; condition decomposition; criteria for the correct match.',
            '**Step-by-Step Guide** — The 4-step method: Understand Principle, Identify Trigger, Check Conditions, Match Application.',
            '**Worked Examples** — Full annotated walkthroughs of representative questions.',
            '**Drills** — Practice across the four application types: Direct, Contrapositive, Definitional, Advanced.',
