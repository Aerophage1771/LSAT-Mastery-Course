...
export const Lesson4_Drill_ContextualValue: Lesson = {
  ...
  content: [
...

    {
      ...
      variant: 'default',
      title: 'Key Signal',
      text: 'Look for contrast words \u2014 "but," "however," "precisely because," "on the other hand" \u2014 that pivot from one context to another. These structural markers signal that the stimulus is setting up a contextual value dynamic.',
    },
    ...
    {
      type: 'paragraph',
      text: 'This drill demonstrates the contextual value pattern using a jazz history scenario. Read the stimulus and commit to an answer before scrolling down to the analysis.',
    },
    ...
    {
      type: 'paragraph',
      text: 'The stimulus describes gifted jazz pianists who possess a specific trait: they have **no striking musical ideas**. The passage then shows this trait operating in two distinct contexts.',
    },

    {
      ...
      items: [
        {
          title: 'The Players',
          text: 'Gifted jazz pianists \u2014 technically skilled musicians who lack originality in musical ideas.',
          badge: 'Who',
          badgeColor: 'blue',
        },
        {
          title: 'The Trait',
          text: '"No striking musical ideas" \u2014 a lack of original creative vision. This single characteristic is the fulcrum of the entire argument.',
          badge: 'The Variable',
          badgeColor: 'indigo',
        },
        {
          title: 'Context 1: Leadership Role',
          text: 'When these pianists led recording sessions, the absence of striking ideas meant they produced **no memorable recordings**. In this context, the trait is a clear weakness.',
          badge: 'Weakness',
          badgeColor: 'red',
        },
        {
          title: 'Context 2: Supporting Role',
          text: '"Precisely because" they lacked strong ideas of their own, they could respond quickly and adaptively to the ideas of imaginative leaders. This made them ideal collaborators, and they contributed "masterful touches to some of the greatest jazz recordings."',
          badge: 'Strength',
          badgeColor: 'green',
        },
      ],
    ...
    {
      type: 'paragraph',
      text: 'The argument is built around a paradox: a single quality (lacking striking ideas) is presented as both a flaw and a virtue. The **context** \u2014 whether the pianist is leading or supporting \u2014 determines which side of the trait manifests.',
    },
    {
      type: 'paragraph',
      text: 'Crucially, the word "precisely because" signals that the strength in Context 2 is a *direct consequence* of the same attribute that was a weakness in Context 1. The trait did not change; the role changed.',
    },
    {
      type: 'paragraph',
      text: '**Key Dynamic:** A characteristic that is a liability in one role can be the very thing that enables excellence in a different role.',
    },
    ...
    {
      type: 'paragraph',
      text: '**Pre-phrase:** "A trait that is a weakness in one context can be a strength \u2014 and contribute to greatness \u2014 in another context."',
    },
    ...
    {
      type: 'table',
      headers: ['Answer', 'What It Focuses On', 'Matches Core Dynamic?', 'Verdict'],
      rows: [
        [
          '(A) Leader recognition',
          "The leader's perceptiveness",
          "\u2717 \u2014 Leader's perspective absent from stimulus",
          'Mismatched Focus',
        ],
        [
          '(B) Requires unimaginative contributors',
          'Necessary condition for great works',
          '\u2717 \u2014 "Any" and "requires" too strong',
          'Too Strong',
        ],
        [
          '(C) Forceful personalities',
          'Personality type \u2192 leadership',
          '\u2717 \u2014 "Ideas" \u2260 "personality"',
          'Imported Concept',
        ],
        [
          '**(D) Weakness \u2192 Strength by context**',
          '**Context-dependent trait value**',
          '**\u2713 \u2014 Captures both sides**',
          '**Correct \u2713**',
        ],
        [
          '(E) Success needs collaborators',
          'Teamwork in general',
          '\u2717 \u2014 Misses the context-reversal insight',
          'Wrong Lesson',
        ],
      ],
    },
    ...
    { type: 'h3', text: 'Contextual Value: Common Traps' },
    {
      ...
      items: [
        {
          title: 'One-Sided Capture',
          text: 'The answer describes only the weakness side or only the strength side of the trait. A contextual value principle must capture **both** sides \u2014 the trait operating in two different contexts with opposite results. If the answer only says "this trait is bad" or "this trait is good," it is incomplete.',
          badge: 'Most Common',
          badgeColor: 'blue',
        },
        {
          title: 'Wrong Player Focus',
          text: 'The answer shifts attention to a different person or entity (e.g., the leader instead of the pianist). Check: does the stimulus analyze the behavior or perspective of the entity the answer focuses on? If not, the answer has the wrong subject.',
          badge: 'Common',
          badgeColor: 'blue',
        },
        {
          title: 'Concept Substitution',
          text: 'The answer replaces the actual trait with a related but different concept (e.g., "personality" instead of "ideas," or "effort" instead of "talent"). The abstraction must generalize the trait, not swap it for a different one.',
          badge: 'Moderate',
          badgeColor: 'slate',
        },
        {
          title: 'Teamwork Generalization',
          text: 'The answer latches onto the collaborative aspect of the scenario and produces a generic principle about teamwork, missing the specific insight about how context determines the value of a trait.',
          badge: 'Moderate',
          badgeColor: 'slate',
        },
      ],
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "What Makes Contextual Value Distinctive"
        },
        {
          "type": "list",
          "ordered": true,
        ...
        {
          "type": "h3",
          "text": "Drill: Contextual Value (PT-119-S-3-Q-8)"
        },
        {
          "type": "paragraph",
          "text": "This drill demonstrates the contextual value pattern using a jazz history scenario. Read the stimulus and commit to an answer before scrolling down to the analysis."
        ...
        {
          "type": "diff-note",
          "text": "{{!The base lesson places the spacer paragraph before the question-card. The visual gap should appear AFTER the question-card to encourage student attempt before reading analysis. The try-it prompt below replaces the spacer in the correct position.!}}",
          "variant": "comment"
        },
        {
          "type": "question-card",
        ...
        {
          "type": "diff-note",
          "text": "{{+**Try this:** Before reading the analysis below, identify the single trait in this stimulus, name the two contexts in which it operates, and state what outcome it produces in each. Write your pre-phrase: what general principle does this case illustrate?+}}",
          "variant": "comment"
        },
        {
          "type": "h3",
        ...
        },
        {
          ...
          "items": [
            {
              "title": "(A) The success of a group enterprise depends on the ability of the leader to recognize the weaknesses of others in the group.",
              "text": "The stimulus focuses on the **paradoxical nature of the pianist's trait**, not on the leader's perceptiveness. We are never told that the leaders recognized these pianists' weaknesses and strategically deployed them. The leader's perspective is entirely absent from the passage. This answer shifts the focus to the wrong player.",
              "badge": "Mismatched Focus",
              "badgeColor": "red"
            },
            {
              "title": "(B) The production of any great work requires contributions from those who are unimaginative but technically skilled.",
              "text": "The word \"requires\" creates a necessary condition: **every** great work needs unimaginative contributors. The stimulus says these pianists contributed to \"some of the greatest\" recordings — it does not claim that great recordings are impossible without such contributors. \"Any\" and \"requires\" are far too strong for what a single historical observation can support.",
              "badge": "Too Strong",
              "badgeColor": "red"
            },
        ...
        {
          "type": "h3",
          "text": "Contextual Value: Common Traps"
        },
        {
          "type": "breakdown",
          "labels": {
