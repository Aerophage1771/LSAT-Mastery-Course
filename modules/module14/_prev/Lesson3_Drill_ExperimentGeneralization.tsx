...
export const Lesson3_Drill_ExperimentGeneralization: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'This drill demonstrates the experiment generalization pattern using a classic psychological experiment. Your job is to isolate the independent variable, determine the causal mechanism, and find the principle that correctly generalizes the result.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: "Let's break the experiment into its structural components using our Isolate framework:",
    },

    {
      ...
      items: [
        {
          title: 'Group 1 (Higher Performance)',
          text: "Tennis players told their performance would assess **the quality of their rackets** — an external object. The focus of judgment was directed away from the players' personal abilities.",
          badge: 'External Focus',
          badgeColor: 'blue',
        },
        {
          title: 'Group 2 (Lower Performance)',
          text: "Tennis players told their **tennis-playing talent would be measured** — a personal attribute. The focus of judgment was directed at the players' own abilities.",
          badge: 'Internal Focus',
          badgeColor: 'blue',
        },
        {
          title: 'Control Variable',
          text: 'Both groups were **equally skilled**. This is explicitly stated and is critical: it rules out innate ability as an explanation for the performance difference. Any difference in outcome must be attributed to the experimental manipulation, not talent.',
          badge: 'Held Constant',
          badgeColor: 'slate',
        },
        {
          title: 'Independent Variable',
          text: '**What players believed was being evaluated** — their rackets (external) vs. their talent (internal). This is the one and only factor that differed between the groups.',
          badge: 'The Key Factor',
          badgeColor: 'indigo',
        },
        {
          title: 'Dependent Variable (Outcome)',
          text: '**Performance level.** Group 1 (racket evaluation) performed "much better" than Group 2 (talent evaluation).',
    ...
    {
      type: 'paragraph',
      text: 'The argument is that shifting the perceived focus of judgment from internal (personal ability) to external (an object) removes a psychological burden — performance anxiety — leading to better performance.',
    },
    ...
    {
      type: 'paragraph',
      text: '**Pre-phrase:** "People perform better on a task when they do not believe their personal abilities are being evaluated."',
    },

    { type: 'h4', text: 'Step 4: Evaluate Each Answer' },
    {
      type: 'paragraph',
      text: 'Now apply the Textbook Test (Is the stimulus a textbook example of this principle?) and the Strength Test (Is the language appropriately calibrated?) to each choice.',
    },
      ...
      items: [
        {
          title:
            '(A) People do less well on a task if they have been told that they will be closely watched while doing it.',
          text: 'This principle is about **being watched**. But both groups were part of an experiment and were therefore being observed — being watched was a *constant*, not a variable. This factor was the same for both groups and therefore cannot explain the *difference* in performance. The principle misidentifies the independent variable: it picks up on a control variable (observation) instead of the actual manipulation (what was being judged).',
          badge: 'Misidentified Variable',
          badgeColor: 'red',
        },
        {
          title:
            '(B) People execute a task more proficiently when they do not believe their abilities are being judged.',
          text: 'This perfectly matches our pre-phrase. The independent variable: "do not believe their abilities are being judged" (the racket group did not feel personally evaluated). The outcome: "execute a task more proficiently" (they performed much better). The strength is appropriate: "more proficiently" matches "much better" without overclaiming. The stimulus is a textbook example of this proposition. **Passes both the Textbook Test and the Strength Test.**',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title: '(C) People perform a task more proficiently when they have confidence in their abilities.',
          text: "The stimulus tells us nothing about the players' *confidence levels*. We know what they were *told* about the purpose of the evaluation, but we do not know how confident they felt. This principle introduces an entirely new psychological concept (confidence) that is not mentioned or implied in the experimental setup. While confidence *might* play a role in the real world, it is not the variable the experiment manipulated or measured.",
          badge: 'Out-of-Scope Concept',
          badgeColor: 'red',
        },
        {
          title:
            '(D) People who assess their talents accurately generally perform near their actual level of proficiency.',
          text: 'The experiment is not about *self-assessment accuracy*. It is about how people perform when being *assessed by others*. No information is given about whether either group assessed their own talents accurately. This principle addresses a completely different psychological phenomenon (metacognitive accuracy) than the one demonstrated in the stimulus (performance anxiety under evaluation).',
          badge: 'Irrelevant Concept',
          badgeColor: 'red',
        },
        {
          title:
    ...
    {
      type: 'table',
      headers: ['Answer', 'Variable Identified', 'Matches Stimulus?', 'Verdict'],
      rows: [
        ['(A) Closely watched', 'Being observed', '✗ — Both groups were observed (constant)', 'Misidentified Variable'],
        [
          '**(B) Abilities not judged**',
          '**Belief about personal evaluation**',
          '**✓ — Exactly the manipulated variable**',
          '**Correct ✓**',
        ],
    ...
    {
      type: 'paragraph',
      text: 'Experiment-based stimuli generate a specific set of traps that recur across many questions. Be alert to these:',
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          title: 'Control Variable Confusion',
          text: 'The answer identifies a factor that was **held constant** across groups (like "being watched") and treats it as the cause of the difference. To spot this: ask whether the factor was the **same** for both groups. If yes, it cannot explain the difference. This is the most common trap in experiment generalization questions.',
          badge: 'Most Common',
          badgeColor: 'blue',
        },
        {
          title: 'Imported Concept',
          text: 'The answer introduces a psychological or causal concept that **was not measured or mentioned** in the experiment (like "confidence" or "effort"). To spot this: check whether the concept appears anywhere in the stimulus. If it does not, the principle is building on an assumption, not on the experimental data.',
          badge: 'Common',
          badgeColor: 'blue',
        },
        {
          title: 'Outcome-Effort Conflation',
          text: 'The answer confuses **what happened** (performance outcome) with **why it happened** (motivation or effort). The experiment measures results, not internal states. Unless the stimulus explicitly discusses effort or motivation, a principle about effort is an inference beyond the data.',
          badge: 'Moderate',
          badgeColor: 'slate',
        },
        {
          title: 'Reversed Causation',
          text: 'The answer states that the **outcome causes** the variable, rather than the variable causing the outcome. Example: "People who perform well believe their abilities are not being judged" reverses the arrow from the stimulus, which shows that belief → performance, not performance → belief.',
          badge: 'Moderate',
          badgeColor: 'slate',
        },
      ],
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Experiment Generalization"
        },
        {
          "type": "paragraph",
          "text": "An **Experiment Generalization** is the most common Principle-Generalization pattern. The stimulus describes the setup and results of a controlled experiment — two groups, one key difference between them, and a measurable outcome — and asks you to identify the general psychological, causal, or behavioral principle that the experiment demonstrates. Your job is to look past the specific experimental details and extract the universal rule that explains *why* the results occurred."
        ...
        {
          "type": "h3",
          "text": "What Makes Experiment Generalization Distinctive"
        },
        {
          "type": "paragraph",
          "text": "In an experiment generalization, the correct principle must:"
        },
        {
          "type": "list",
          "ordered": true,
        ...
        {
          "type": "h3",
          "text": "Key Strategy: Isolate, Then Generalize"
        },
        {
          "type": "paragraph",
          "text": "The strategy for experiment generalizations is a two-phase process:"
        },
        {
          "type": "process",
          "title": "Isolate, Then Generalize",
        ...
        {
          "type": "h3",
          "text": "Drill: Experiment Generalization (PT-116-S-3-Q-3)"
        },
        {
          "type": "paragraph",
          "text": "This drill demonstrates the experiment generalization pattern using a classic psychological experiment. Your job is to isolate the independent variable, determine the causal mechanism, and find the principle that correctly generalizes the result."
        ...
        {
          "type": "diff-note",
          "text": "{{+**Try this:** Attempt this question before reading the analysis below. Identify the independent variable, the control variable, and the outcome. Write your pre-phrase in abstract terms before looking at the explanation.+}}",
          "variant": "comment"
        },
        {
          "type": "paragraph",
          "text": "{{!The spacer paragraph (<br/><br/><br/>) in the base lesson appears before the question-card rather than after it. For student-facing display, the visual gap should appear AFTER the question-card to encourage attempt before scrolling to analysis. The diff-note above replaces the spacer with an explicit try-it prompt.!}}"
        },
        {
          "type": "hr"
        },
        ...
        {
          "type": "h4",
          "text": "Step 1: Isolate the Experimental Components"
        },
        {
          "type": "paragraph",
          "text": "Let's break the experiment into its structural components using our Isolate framework:"
        ...
        {
          "type": "paragraph",
          "text": "**What is the causal mechanism?**"
        },
        {
          "type": "paragraph",
          "text": "The stimulus describes a controlled experiment where the only significant difference between two groups was their *belief* about what was being evaluated. The outcome (performance level) changed based on this belief. This is a classic psychological setup showing how the **perception of personal judgment** affects performance."
        ...
        {
          "type": "paragraph",
          "text": "**What's the key variable?**"
        },
        {
          "type": "paragraph",
          "text": "The crucial difference is the *focus of the judgment*:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "Now generalize the key dynamic by replacing specifics with general categories:"
        },
        {
          "type": "table",
          "headers": [
        ...
        },
        {
          ...
          "items": [
            {
              "title": "(A) People do less well on a task if they have been told that they will be closely watched while doing it.",
              "text": "This principle is about **being watched**. But both groups were part of an experiment and were therefore being observed — being watched was a *constant*, not a variable. This factor was the same for both groups and therefore cannot explain the *difference* in performance. The principle misidentifies the independent variable: it picks up on a control variable (observation) instead of the actual manipulation (what was being judged).",
              "badge": "Misidentified Variable",
              "badgeColor": "red"
            },
            {
              "title": "(B) People execute a task more proficiently when they do not believe their abilities are being judged.",
              "text": "This perfectly matches our pre-phrase. The independent variable: \"do not believe their abilities are being judged\" (the racket group did not feel personally evaluated). The outcome: \"execute a task more proficiently\" (they performed much better). The strength is appropriate: \"more proficiently\" matches \"much better\" without overclaiming. The stimulus is a textbook example of this proposition. **Passes both the Textbook Test and the Strength Test.**",
              "badge": "Correct",
              "badgeColor": "green"
            },
            ...
            {
              "title": "(D) People who assess their talents accurately generally perform near their actual level of proficiency.",
              "text": "The experiment is not about *self-assessment accuracy*. It is about how people perform when being *assessed by others*. No information is given about whether either group assessed their own talents accurately. This principle addresses a completely different psychological phenomenon (metacognitive accuracy) than the one demonstrated in the stimulus (performance anxiety under evaluation).",
              "badge": "Irrelevant Concept",
              "badgeColor": "red"
            },
            {
              "title": "(E) People who think that a superior performance will please those who are testing them generally try harder.",
              "text": "The stimulus measures *performance outcome*, not *effort level*. We cannot infer from the data that the lower-performing group was not trying as hard. It is entirely possible — and in fact more consistent with performance anxiety research — that Group 2 was trying *just as hard* (or harder) but performing worse due to the psychological pressure of being personally evaluated. This principle conflates outcome with effort, which the stimulus does not support.",
              "badge": "Unproven Assumption",
              "badgeColor": "red"
            }
        ...
        {
          "type": "h3",
          "text": "Experiment Generalization: Common Traps"
        },
        {
          "type": "paragraph",
          "text": "Experiment-based stimuli generate a specific set of traps that recur across many questions. Be alert to these:"
