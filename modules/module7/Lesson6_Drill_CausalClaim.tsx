  ...
  content: [
    ...
    { type: 'h3', text: 'Step 1: Find the Conclusion' },
    {
      ...
      items: [
        ...
        {
          title:
            '"In the twelve months following the installation, the rate of respiratory illness among factory workers dropped by 35%."',
        ...
        {
          title:
            '"The factory manager concluded that the new filtration system is responsible for the improvement in worker health."',
