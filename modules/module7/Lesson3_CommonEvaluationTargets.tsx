...
export const Lesson3_CommonEvaluationTargets: Lesson = {
  ...
  content: [
...

    {
      ...
      rows: [
        [
          '**Causal Claims**',
          '~30%',
          'Was there an alternative cause?',
    ...
    {
      type: 'paragraph',
      text: 'The most common evaluation target. The argument asserts that one event or condition **caused** another. The gap is always the same: the author has not ruled out alternative explanations for the observed effect.',
    },
