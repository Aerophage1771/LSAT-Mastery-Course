...
export const Lesson7_Question26: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-111-S-2-Q-26', questionType: 'Third-Party Viewpoint', passageTitle: 'Dworkin', passage: passageText, question: `It can be inferred that legal positivists, as described in the passage, agree with which one of the following statements?`, options: [
    ...
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
        { title: "(A)", text: "This is incorrect. The passage states positivists believe 'law and morality are wholly distinct.' They would not support using personal moral convictions.", badge: 'Misattribution', badgeColor: "red" },
        { title: "(B)", text: "This is too extreme. The passage says positivists view disagreements as legitimate if they are 'over what the underlying convention is.'", badge: 'View Merge', badgeColor: "red" },
        { title: "(C)", text: "This describes Dworkin's theory, not legal positivism. The 'internal logic' of the law is Dworkin's alternative to the positivist view.", badge: 'Too Extreme', badgeColor: "red" },
        ...
        { title: "(E)", text: "This is a misreading. The passage states that for positivists, there is no legal fact when there is 'no consensus' on the law's meaning, not necessarily when jurists have different moral views.", badge: 'Unsupported Inference', badgeColor: "red" }
    ]},
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "blockquote",
          "text": "**Question:** It can be inferred that legal positivists, as described in the passage, agree with which one of the following statements?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This is a Third-Party Viewpoint question. We need to infer the position of 'legal positivists' based only on their description in the passage."
        },
        {
          "type": "callout",
          "title": "Evidence Hunt",
          "variant": "tip",
          "text": "The second paragraph is our primary source. It states that for positivists, the meaning of law 'rests on social convention,' which is resolved by 'registering a consensus.' This means what jurists agree upon *is* the law. The final paragraph adds that the positivist's mistake is assuming meaning 'can only consist in what people think it means... a majority of the interpreter’s peers.'"
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "This is incorrect. The passage states positivists believe 'law and morality are wholly distinct.' They would not support using personal moral convictions.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "This is too extreme. The passage says positivists view disagreements as legitimate if they are 'over what the underlying convention is.'",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "This describes Dworkin's theory, not legal positivism. The 'internal logic' of the law is Dworkin's alternative to the positivist view.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "This aligns with the description of legal positivism. The passage explains that for positivists, the law's meaning comes from 'social convention,' determined by reaching a 'consensus' among legal professionals (jurists). Therefore, the meaning derives from what these interpreters agree it means.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(E)",
              "text": "This is a misreading. The passage states that for positivists, there is no legal fact when there is 'no consensus' on the law's meaning, not necessarily when jurists have different moral views.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
