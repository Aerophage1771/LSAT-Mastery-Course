...
export const Lesson2_Question21: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-111-S-2-Q-21', questionType: 'Main Point', passageTitle: 'Dworkin', passage: passageText, question: `Which one of the following most accurately expresses the main point of the passage?`, options: [
    ...
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
        { title: "(A)", text: "This misidentifies the theories. The passage states Dworkin's own theory is the middle ground; he sees natural law as an unacceptable extreme.", badge: 'Too Narrow', badgeColor: "red" },
        ...
        { title: "(C)", text: "This misrepresents Dworkin's view. He argues the internal logic is the primary guide that *constrains* moral intuition and can be correct *even without* consensus. It doesn't give way to them.", badge: 'False Hierarchy', badgeColor: "red" },
        { title: "(D)", text: "The phrase 'borrowing equally' is too strong and is not supported by the text. His theory is a distinct alternative, not a simple blend of the other two.", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(E)", text: "This incorrectly limits the application of Dworkin's theory to cases 'where a social consensus is not present.' The passage presents it as a general approach. It also misstates his view on authors' intent, as he believes interpretations can be improved upon.", badge: 'Wrong Scope', badgeColor: "red" }
    ]},
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "paragraph",
          "text": "This is a Main Point question. We need to find the answer that best summarizes the author's entire argument about Dworkin's theory."
        },
        {
          "type": "callout",
          "title": "Prediction",
          "variant": "tip",
          "text": "The passage presents Dworkin's theory as a 'middle ground' that avoids the flaws of two other theories. It rejects legal positivism (which relies solely on consensus) and natural law (which relies on unconstrained moral conviction). The core of Dworkin's alternative is that interpretation must be guided by the law's 'internal logic' or underlying principles. The main point must capture this rejection of the two extremes in favor of this third way."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "This misidentifies the theories. The passage states Dworkin's own theory is the middle ground; he sees natural law as an unacceptable extreme.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
            ...
            {
              "title": "(C)",
              "text": "This misrepresents Dworkin's view. He argues the internal logic is the primary guide that *constrains* moral intuition and can be correct *even without* consensus. It doesn't give way to them.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "The phrase 'borrowing equally' is too strong and is not supported by the text. His theory is a distinct alternative, not a simple blend of the other two.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "This incorrectly limits the application of Dworkin's theory to cases 'where a social consensus is not present.' The passage presents it as a general approach. It also misstates his view on authors' intent, as he believes interpretations can be improved upon.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
