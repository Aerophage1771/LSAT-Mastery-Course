...
export const Lesson4_Question23: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-111-S-2-Q-23', questionType: 'Author Attitude', passageTitle: 'Dworkin', passage: passageText, question: `Which one of the following most accurately characterizes the author’s attitude toward Dworkin’s theory?`, options: [
    ...
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
        ...
        { title: "(B)", text: "The passage states Dworkin's theory avoids the error of judicial activism. The author shows no caution about this; it's presented as a strength.", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(C)", text: "The author expresses no doubt or modest expectations. The tone is consistently supportive.", badge: 'Wrong Direction', badgeColor: "red" },
        { title: "(D)", text: "The author supports the theory because it seems correct and useful, not merely because it's original. The author's conviction is stated clearly, not 'quietly.'", badge: 'Misattribution', badgeColor: "red" },
        { title: "(E)", text: "While the author supports the theory, the passage makes no predictions about its future popularity. The focus is on the theory's merits.", badge: 'False Neutrality', badgeColor: "red" }
    ]},
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following most accurately characterizes the author’s attitude toward Dworkin’s theory?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This is an Author Attitude question. We need to find specific language in the passage that reveals the author's opinion of Dworkin's theory."
        },
        {
          "type": "callout",
          "title": "Evidence Hunt",
        ...
        },
        {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "This choice is correct. The author's use of phrases like 'Dworkin correctly sees' and 'as Dworkin does' shows clear agreement and confidence in Dworkin's central arguments.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B)",
              "text": "The passage states Dworkin's theory avoids the error of judicial activism. The author shows no caution about this; it's presented as a strength.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "The author expresses no doubt or modest expectations. The tone is consistently supportive.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "The author supports the theory because it seems correct and useful, not merely because it's original. The author's conviction is stated clearly, not 'quietly.'",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "While the author supports the theory, the passage makes no predictions about its future popularity. The focus is on the theory's merits.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
