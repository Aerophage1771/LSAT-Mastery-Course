...
export const Lesson5_Question24: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-111-S-2-Q-24', questionType: 'Inference', passageTitle: 'Dworkin', passage: passageText, question: `According to the passage, which one of the following is a goal of Dworkin’s theory of legal interpretation?`, options: [
    ...
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
        { title: "(A)", text: "While Dworkin's theory implicitly challenges legal positivism, its main goal is broader than just evaluating past interpretations. It aims to provide a new framework for interpretation in general.", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(B)", text: "This is too strong. The passage says Dworkin believes an interpretation can be correct even without consensus, not that consensus plays no role at all.", badge: 'Out of Scope', badgeColor: "red" },
        { title: "(C)", text: "This is the opposite of Dworkin's position. The passage says his view allows judges to 'consult their own moral intuitions' when guided by the law's internal logic.", badge: 'Misattribution', badgeColor: "red" },
        { title: "(D)", text: "The passage directly contradicts this. The final sentence says Dworkin's theory allows for 'improving upon the interpretations... of the original authors.'", badge: 'Unsupported Leap', badgeColor: "red" },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "blockquote",
          "text": "**Question:** According to the passage, which one of the following is a goal of Dworkin’s theory of legal interpretation?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This is an Inference question asking for a specific goal of Dworkin's theory, according to the passage. We must find direct textual evidence for one of the answer choices."
        },
        {
          "type": "callout",
          "title": "Evidence Hunt",
          "variant": "tip",
          "text": "The third paragraph provides the key. It states that legal positivism is 'incompatible with the actual practice of judges and lawyers...' It then says Dworkin's theory 'seeks to validate this practice.' This is a direct statement of his goal."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "While Dworkin's theory implicitly challenges legal positivism, its main goal is broader than just evaluating past interpretations. It aims to provide a new framework for interpretation in general.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "This is too strong. The passage says Dworkin believes an interpretation can be correct even without consensus, not that consensus plays no role at all.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "This is the opposite of Dworkin's position. The passage says his view allows judges to 'consult their own moral intuitions' when guided by the law's internal logic.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "The passage directly contradicts this. The final sentence says Dworkin's theory allows for 'improving upon the interpretations... of the original authors.'",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "This is a perfect match for the textual evidence. The passage explicitly states that Dworkin's theory 'seeks to validate' the 'actual practice of judges and lawyers.'",
              "badge": "Correct",
              "badgeColor": "green"
            }
          ]
