...
export const Lesson16_Module16_Questions: Lesson = {
  id: "48-16",
  ...
  content: [
    ...
    {
      type: 'accordion',
      title: 'Drill: Structural Complexity (PT-103-S-3-Q-20)',
      content: [
        ...
        '(B) One purpose of writing poetry is to preserve the language in which it is written. [56%] (Correct)',
