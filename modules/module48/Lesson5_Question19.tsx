...
export const Lesson5_Question19: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-141-S-1-P-3-Q-19', questionType: 'Inference', passageTitle: 'Advertising Critique', passage: passageText, question: `Which one of the following is a claim that the author attributes to Marcuse?`, options: [
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-141-S-1-P-3-Q-19"
        },
        {
          "type": "blockquote",
          "text": "Which one of the following is a claim that the author attributes to Marcuse?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks for a specific claim that the author attributes to Marcuse. This requires a careful reading of the first two paragraphs, where the author outlines the Marcusian critique. We are looking for an idea explicitly presented as part of Marcuse's theory.\n\nThe core of Marcuse's argument is that modern corporate society, while objectively unsatisfying, maintains control by making people *feel* satisfied. The passage states that Marcuse believed \"modern people succumb to oppression by believing themselves satisfied,\" and that this process occurs because advertising creates false needs. Therefore, a key claim in Marcuse's theory is that advertising is a mechanism for creating a false sense of satisfaction in an oppressive society."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) In modern society, advertising helps lead people to think that they are satisfied.",
              "text": "This is a direct and accurate paraphrase of the claim made in the first paragraph. The text states that according to Marcuse, people are led to \"[believe] themselves satisfied,\" and that advertising is the primary cause of this process.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B) Modern societies differ from earlier societies in that they fail to satisfy basic physical needs.",
              "text": "Marcuse's theory, as presented, focuses on the manipulation of psychological needs and the creation of \"false\" consumer needs. The passage does not suggest that he believed modern society fails to meet basic *physical* needs.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) It is impossible to draw any meaningful distinction between real and false psychological needs in modern society.",
              "text": "This is a claim made by the *author* in the third paragraph as a critique *of* Marcuse. Marcuse's own theory is entirely dependent on the idea that such a distinction is possible and meaningful. This is a misattribution.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) Advertising in modern society has sometimes become a tool of oppression working to the benefit of totalitarian political systems.",
              "text": "The passage attributes to Marcuse the view that advertising is a tool of oppression that benefits *corporations*. There is no mention of \"totalitarian political systems.\"",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) Advertising exploits basic human needs by deriving from them certain secondary needs which, though they become real needs, subtly work to the detriment of consumers.",
              "text": "This misrepresents a key term. The passage is clear that Marcuse believed the needs created by advertising are \"**false**,\" not that they \"become real needs.\"",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
