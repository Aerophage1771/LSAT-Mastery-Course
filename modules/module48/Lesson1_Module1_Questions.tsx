...
export const Lesson1_Module1_Questions: Lesson = {
  ...
  content: [
    ...
    {
      type: 'accordion',
      title: 'Drill: Ambiguity & Interpretation (PT-107-S-4-Q-15)',
      content: [
    ...
    {
      type: 'accordion',
      title: 'Drill: Fermat\'s Theorem (PT-112-S-4-Q-13)',
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: 'Drill: Educational Computers (PT-129-S-2-Q-13)',
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: 'Drill: Malthus & Biodiversity (PT-131-S-2-Q-18)',
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: 'Drill: Live Musical Performance (PT-131-S-2-Q-7)',
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: 'Drill: Cycling Freedom (PT-125-S-4-Q-15)',
      content: [
        { type: 'h4', text: 'Stimulus' },
    ...
    {
      type: 'accordion',
      title: 'Drill: At Home vs. In One\'s House (PT-108-S-2-Q-22)',
      content: [
        { type: 'h4', text: 'Stimulus' },
