...
export const Lesson4_Question18: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-141-S-1-P-3-Q-18', questionType: 'Paragraph Function', passageTitle: 'Advertising Critique', passage: passageText, question: `The main function of the first paragraph is to`, options: [
    ...
    { type: 'paragraph', text: "The first paragraph accomplishes two main tasks:" },
    { type: 'list', items: [
      "It introduces the central concept that will be debated: the critique of advertising based on the creation of \"false needs.\"",
      "It identifies the primary source and proponent of this critique: the theorist Herbert Marcuse, whose writings are \"central to this type of critique.\""
    ] },
    { type: 'paragraph', text: "The paragraph's purpose is to lay the groundwork for the rest of the passage by describing the viewpoint that will be the primary subject of analysis and, later, refutation." },
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
      { title: "(A) summarize the political and economic context from which Marcusian critiques of advertising arise", text: "The paragraph focuses tightly on summarizing Marcuse's *theory*, not the broader historical or political \"context\" that produced it.", badge: 'Focus on Detail', badgeColor: "red" },
      { title: "(B) outline the mechanisms by which false needs originate in mass market culture", text: "The first paragraph introduces the *concept* of false needs, but the more detailed explanation of the \"mechanisms\" (e.g., the perfume example) is found in the second paragraph. The first paragraph's function is more introductory.", badge: 'Wrong Function', badgeColor: "red" },
      { title: "(C) evaluate the psychological processes by which the manipulative techniques of mass market advertising influence individuals", text: "The key verb here is \"evaluate.\" The first paragraph is purely descriptive; it explains the Marcusian view without passing judgment on it. The author's \"evaluation\" does not begin until the third paragraph.", badge: 'Wrong Paragraph', badgeColor: "red" },
      { title: "(D) describe the prevailing views among contemporary critics of advertising and categorize Marcuse’s theories in relation to those views", text: "The word \"prevailing\" is an overstatement. The passage says this is the view of \"*some* critics\" and that Marcuse is central to \"*this type* of critique,\" which is more specific than a general \"prevailing view.\"", badge: 'Content Dump', badgeColor: "red" },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-141-S-1-P-3-Q-18"
        },
        {
          "type": "blockquote",
          "text": "The main function of the first paragraph is to"
        },
        {
          "type": "options",
          "items": [
        ...
        },
        {
          ...
          "items": [
            {
              "title": "(A) summarize the political and economic context from which Marcusian critiques of advertising arise",
              "text": "The paragraph focuses tightly on summarizing Marcuse's *theory*, not the broader historical or political \"context\" that produced it.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) outline the mechanisms by which false needs originate in mass market culture",
              "text": "The first paragraph introduces the *concept* of false needs, but the more detailed explanation of the \"mechanisms\" (e.g., the perfume example) is found in the second paragraph. The first paragraph's function is more introductory.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) evaluate the psychological processes by which the manipulative techniques of mass market advertising influence individuals",
              "text": "The key verb here is \"evaluate.\" The first paragraph is purely descriptive; it explains the Marcusian view without passing judgment on it. The author's \"evaluation\" does not begin until the third paragraph.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) describe the prevailing views among contemporary critics of advertising and categorize Marcuse’s theories in relation to those views",
              "text": "The word \"prevailing\" is an overstatement. The passage says this is the view of \"*some* critics\" and that Marcuse is central to \"*this type* of critique,\" which is more specific than a general \"prevailing view.\"",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) describe Marcusian views regarding mass market manipulation and indicate their role in certain criticisms of advertising",
              "text": "This choice accurately captures the paragraph's dual function. It \"describes Marcusian views\" and also \"indicates their role in certain criticisms of advertising\" by identifying Marcuse as a central figure in that school of thought.",
              "badge": "Correct",
              "badgeColor": "green"
            }
          ]
