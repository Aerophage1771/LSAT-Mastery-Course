...
export const Lesson5_Module5_Questions: Lesson = {
  id: "48-5",
  title: "Module 5: Flaw",
  content: [
    ...
    {
      type: 'accordion',
      title: 'Drill: Base Rate / Relative Frequency (PT-102-S-3-Q-7)',
      content: [
        { type: 'h4', text: 'Stimulus' },
        { type: 'blockquote', text: 'A commonly accepted myth is that left-handed people are more prone to cause accidents than are right-handed people. But this is, in fact, just a myth, as is indicated by the fact that more household accidents are caused by right-handed people than are caused by left-handed people.' },
        { type: 'h4', text: 'Question' },
    ...
    {
      type: 'accordion',
      title: 'Drill: Hasty Generalization (PT-106-S-3-Q-2)',
      content: [
        { type: 'h4', text: 'Stimulus' },
        { type: 'blockquote', text: 'A number of Grandville\'s wealthiest citizens have been criminals. So, since it is of utmost importance that the Grandville Planning Committee be composed solely of individuals whose personal standards of ethics are beyond reproach, no wealthy person should be appointed to that committee.' },
        { type: 'h4', text: 'Question' },
