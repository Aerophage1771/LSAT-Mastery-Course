  ...
  content: [
    { type: 'h2', text: 'Module 55: Conditional Reasoning' },
    {
      ...
      content: [
        ...
        {
          type: 'blockquote',
          text: 'Astronaut: Any moon, by definition, orbits some planet in a solar system. So, the moons in solar system S4 all orbit the planet Alpha.',
        },
        { type: 'h4', text: 'Question' },
        {
          type: 'paragraph',
          text: "**Question:** The astronaut's conclusion follows logically if which one of the following is assumed?",
        },
        {
          type: 'options',
          items: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: 'blockquote',
          text: "Psychiatrist: Take any visceral emotion you care to consider. There are always situations in which it is healthy to try to express that emotion. So, there are always situations in which it is healthy to try to express one's anger.",
        },
        { type: 'h4', text: 'Question' },
        {
          type: 'paragraph',
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: 'paragraph',
          text: "**Question:** Which one of the following, if assumed, allows the argument's conclusion to be properly drawn?",
        },
        {
          type: 'options',
          items: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: 'blockquote',
          text: 'All material bodies are divisible into parts, and everything divisible is imperfect. It follows that all material bodies are imperfect. It likewise follows that the spirit is not a material body.',
        },
        { type: 'h4', text: 'Question' },
        {
          type: 'paragraph',
          text: '**Question:** The final conclusion above follows logically if which one of the following is assumed?',
        },
        {
          type: 'options',
          items: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: 'blockquote',
          text: 'People who have never been asked to do more than they can easily do are people who never do all they can. Alex is someone who has clearly not done all that he is capable of doing, so obviously no one has ever pushed him to do more than what comes to him easily.',
        },
        { type: 'h4', text: 'Question' },
        {
          type: 'paragraph',
          text: '**Question:** The flawed reasoning in which one of the following is most similar to the flawed reasoning in the argument above?',
        },
        {
          type: 'options',
          items: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: 'paragraph',
          text: '**Question:** Which one of the following arguments is most similar in its pattern of reasoning to the argument above?',
        },
        {
          type: 'options',
          items: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: 'paragraph',
          text: '**Question:** Which one of the following can be properly inferred from the statements above?',
        },
        {
          type: 'options',
          items: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: 'paragraph',
          text: '**Question:** Which one of the following arguments exhibits a flawed pattern of reasoning most similar to the flawed pattern of reasoning exhibited by the argument above?',
        },
        {
          type: 'options',
          items: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: 'paragraph',
          text: '**Question:** Which one of the following must be true on the basis of the information above?',
        },
        {
          type: 'options',
          items: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          type: 'paragraph',
          text: '**Question:** The reasoning is most vulnerable to criticism on the grounds that it fails to consider that',
        },
        {
          type: 'options',
          items: [
