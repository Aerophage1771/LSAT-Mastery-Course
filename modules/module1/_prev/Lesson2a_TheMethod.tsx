...
export const Lesson2a_TheMethod: Lesson = {
  id: '1-2',
  title: 'The Method',
  questionPolicy: 'none',
  content: [
    { type: 'h2', text: 'Step-by-Step: Argument Part' },
    {
      type: 'paragraph',
      text: 'This lesson provides a complete, repeatable method for solving any Argument Part question. Each step includes concrete examples, tips for when the step gets tricky, and a callout with a key insight. At the end, you will work through a full example applying all five steps to a single question.',
    },

    {
      ...
      variant: 'tip',
      title: 'Timing',
      text: 'You should spend roughly **1 minute and 25 seconds** per Argument Part question. The 5-step method may feel slow at first, but with practice it becomes automatic. Timed drilling is the fastest way to internalize the process.',
    },
    ...
    { type: 'h3', text: 'Overview' },
    {
      ...
      steps: [
        ...
        "**Step 2 — Analyze & Hypothesize:** Read the full stimulus, first deciding whether it contains an argument at all, then forming a hypothesis about each statement's role.",
        "**Step 3 — Map the Structure:** Use indicator words, the Why Test, and the Support Test to confirm the argument's flow of support.",
    ...
    { type: 'h3', text: 'The Global LR Operating System' },
    {
      type: 'paragraph',
      text: 'The 5-step method is the Argument Part version of a larger LR system. Use that larger system first, because it tells you whether assumptions matter, how hard to prephrase, and whether this is a question to solve by active hunting or by disciplined elimination.',
    },
    {
      type: 'breakdown',
      labels: { title: 'Global move', text: 'Why it matters' },
      items: [
        {
          title: '1. Read the stem first',
          text: 'The stem tells you the task before the stimulus tempts you into passive reading.',
        },
        {
          title: '2. Classify the stimulus',
          text: 'Is this an argument, a fact set, a paradox, or a formal rule cluster? The right reading posture depends on that classification.',
        },
        {
          title: '3. Decide whether assumptions matter',
          text: 'Arguments invite missing-link analysis. Fact sets usually do not.',
        },
        {
          title: '4. Anticipate answer shape',
          text: 'Ask what the right answer should sound like before looking at the choices: role label, missing bridge, inference, explanation, or abstract pattern.',
        },
        {
          title: '5. Choose hunt mode or elimination mode',
          text: 'Use hunt mode when your prediction is precise. Use elimination mode when the credited answer will likely be only relatively best or when the stimulus is too dense for a clean prephrase.',
        },
      ],
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'How This Fits Argument Part',
      text: 'Argument Part usually rewards a sharp prephrase, but it still benefits from the larger LR system. Step 1 comes from the stem-first rule. Steps 2 and 3 depend on whether the stimulus is really an argument. Step 5 is where you decide whether to hunt for your prephrase or eliminate attractive misdescriptions.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "The 5-Step Method for Argument Part Questions"
        },
        {
          "type": "paragraph",
          "text": "This lesson provides a complete, repeatable method for solving any Argument Part question. Each step includes concrete examples, tips for when the step gets tricky, and a callout with a key insight. At the end, you will work through a full example applying all five steps to a single question."
        ...
        {
          "type": "h2",
          "text": "Step 1: Find the Target Statement"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "diff-note",
          "text": "The 'When This Step Gets Tricky' callouts in Steps 1-5 contain edge-case detail that may overwhelm first-time readers. Consider migrating the trickiest scenarios (paraphrased stems, missing indicator words, buried conclusions, dual-role statements, subtly wrong relationship descriptions) to the Reference Guide (1-12) and replacing each callout here with a one-line forward-reference.",
          "variant": "comment"
        },
        {
          "type": "hr"
        ...
        {
          "type": "h2",
          "text": "Step 2: Analyze the Statements & Spot Potential Roles"
        },
        {
          "type": "paragraph",
        ...
        },
        {
          ...
          "rows": [
            ...
            [
              ...
              "**Likely Conclusion**",
              "*therefore, thus, so, hence, should*"
            ],
            [
            ...
            [
              "A view attributed to others",
              "**Likely Opposing View**",
              "*Some argue, Critics claim, Many believe*"
            ],
            [
              "An acknowledgment of a counterpoint",
              "**Likely Concession**",
        ...
        {
          "type": "diff-note",
          "text": "Steps 2 and 3 both discuss indicator words (signal words in Step 2's table, indicator words in Step 3's Tool 1). Consider consolidating: keep the hypothesis-tagging table in Step 2 but remove the Step 3 'Tool 1: Indicator Words' paragraph, since the Why Test is the real structural confirmation tool. This avoids students re-reading overlapping advice.",
          "variant": "change"
        },
        {
          "type": "hr"
        ...
        {
          "type": "h2",
          "text": "Step 3: Map the Argument's Structure"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h2",
          "text": "Step 4: Pinpoint the Role & Prephrase"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h4",
          "text": "Translating Abstract Language"
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              "\"A claim that the argument as a whole is designed to establish\"",
              "Main Conclusion"
            ],
            [
              "\"A view that other statements in the argument are intended to support\"",
              "Main Conclusion"
            ],
            [
              "\"Evidence offered in support of the argument's main claim\"",
              "Premise"
            ],
            [
              "\"An intermediate conclusion drawn to support the main conclusion\"",
              "Intermediate Conclusion"
            ],
            [
              "\"A position that the argument calls into question\"",
              "Opposing Viewpoint"
            ],
            [
              "\"A point that is granted in order to argue for a different claim\"",
              "Concession"
            ],
            [
              "\"Background information used to set up the argument\"",
              "Context"
            ]
          ]
        },
        ...
        {
          "type": "paragraph",
          "text": "Let's apply all five steps to a single Argument Part question from start to finish."
        },
        {
          "type": "paragraph",
        ...
        },
        {
          ...
          "title": "Try This",
          "variant": "tip",
          "text": "{{+**Try this:** Attempt to identify the role of the sentence about theater attendance declining since 2015 before reading the analysis below. What is your prephrase?+}}"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h3",
          "text": "Applying the 5-Step Method"
        },
        {
          "type": "process",
        ...
        {
          "type": "h3",
          "text": "Why the Role Is a Concession"
        },
        {
          "type": "callout",
          "title": "Final Check",
        ...
        {
          "type": "h3",
          "text": "{{+Your Turn: Apply the Method+}}"
        },
        {
          "type": "paragraph",
          "text": "{{+Now try the full 5-step method on your own. Read the stimulus, identify the target, map the structure, prephrase the role, and choose the best answer before revealing the analysis.+}}"
        },
        {
          "type": "question-card",
          "isIllustrative": true,
          ...
          "difficulty": "medium",
          "stimulus": "{{+Nutritionist: Many people believe that organic produce is more nutritious than conventionally grown produce. While several studies have failed to find significant nutritional differences, **organic farming methods do result in lower pesticide residue levels.** However, the health benefits of reduced pesticide exposure have not been conclusively established for the general population. Therefore, the claim that organic produce is healthier remains unproven.+}}",
          "question": "{{+The statement that organic farming methods result in lower pesticide residue levels plays which one of the following roles in the nutritionist's argument?+}}",
          "options": [
            "{{+**(A)** It is the main conclusion that the argument is designed to establish.+}}",
            "{{+**(B)** It is a premise offered in direct support of the argument's main conclusion.+}}",
            "{{+**(C)** It is a concession that the argument grants before arguing for a different claim.+}}",
            "{{+**(D)** It is an opposing viewpoint that the argument seeks to refute.+}}",
            "{{+**(E)** It is background information that plays no role in the argument's reasoning.+}}"
          ]
        },
        {
          "type": "callout",
          "title": "{{+Analysis+}}",
          "variant": "default",
          "text": "{{+**Answer: (C).** The nutritionist grants that organic produce has lower pesticide residue — that is a real advantage. But the argument immediately pivots: the health benefits of that advantage are unproven, so the broader 'healthier' claim remains unestablished. The target sentence is introduced as a point the author concedes before redirecting the argument. It is not the main conclusion (A), not direct support for the conclusion (B — the conclusion is that the claim is unproven, and lower residue alone does not prove that), not an opposing viewpoint the author refutes (D — the author actually accepts it), and not mere background (E — it plays an active structural role as a concession).+}}"
        },
        {
          "type": "hr"
        },
        {
          "type": "h2",
          "text": "When the Method Gets Hard"
        },
        {
          "type": "paragraph",
      ...
      content: [
        {
          type: 'callout',
          variant: 'tip',
          text: '**Target:** 1:15 per Argument Part question',
        },
        { type: 'h3', text: 'The Method' },
        {
          type: 'process',
          steps: [
            '**Find the target statement.** Locate the sentence the question asks about.',
            '**Analyze surrounding statements.** Identify premises, conclusions, and context around the target.',
            '**Map the argument structure.** Determine how each piece supports or opposes the main point.',
            '**Prephrase the role.** Name the target\'s function (premise, conclusion, counter, context, concession) before reading choices.',
            '**Evaluate choices.** Match your prephrase; eliminate answers that describe a different role.',
          ],
        },
        { type: 'h3', text: 'Decision Table' },
        {
          type: 'table',
          headers: ['If the Target...', 'Then It\'s Probably...', 'Watch Out For...'],
          rows: [
            ['Provides evidence for another claim', 'Premise', 'Confusing with background context'],
            ['Is the main claim everything supports', 'Main Conclusion', 'Intermediate conclusion that looks final'],
            ['Supports the conclusion through another claim', 'Intermediate Conclusion', 'Labeling as premise or main conclusion'],
            ['Presents a view the author disagrees with', 'Opposing Viewpoint', 'Confusing with a concession'],
            ['Acknowledges a point before countering', 'Concession', 'Confusing with a premise the author endorses'],
          ],
        },
        {
          type: 'callout',
