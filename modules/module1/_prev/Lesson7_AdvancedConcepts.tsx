...
export const Lesson7_AdvancedConcepts: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'That is the core **nested opponent-mapping** skill. On harder questions, do not stop at "author" versus "opponent." Instead, map the layer: is the target the opponent\'s conclusion, a premise supporting that conclusion, a concession the author grants, or the author\'s own rebuttal? The right answer often depends on naming both the role **and** whose reasoning it belongs to.',
    },
    {
      type: 'table',
      headers: ['Target sentence', 'Precise map', 'Why this matters'],
      rows: [
        [
          'A claim the author later rejects',
          'Opposing viewpoint or opponent conclusion',
          'Prevents you from mislabeling the sentence as the author\'s own position.',
        ],
        [
          'A reason offered for the opponent\'s claim',
          'Premise within the opponent\'s reasoning',
          'Hard answer choices often describe this as support for a conclusion the author challenges.',
        ],
        [
          'A point the author grants before pivoting',
          'Concession within the author\'s reasoning',
          'Stops you from confusing a concession with the final position.',
        ],
        [
          'The sentence that answers the opponent',
          'Author\'s rebuttal or main conclusion',
          'Clarifies which claim actually survives the pivot.',
        ],
      ],
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'Two-Part Prephrase',
      text: 'For any hard rebuttal stimulus, prephrase the target in two parts: **(1)** what role does it play, and **(2)** whose reasoning is it inside? "A premise in the economist\'s argument" is much safer than just "a premise."',
    },
    ...
    {
      type: 'table',
      headers: ['Strategic Move', 'What the Author Does', 'Example'],
      rows: [
        [
          'Counterexample',
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "diff-note",
          "text": "{{+This lesson covers two distinct skill areas (complex logic and abstract language). Consider splitting into two shorter lessons -- \"Advanced: Complex Logic\" and \"Advanced: Abstract Language\" -- so each can include its own worked example and practice prompts without the combined lesson running long.+}}",
          "variant": "comment"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "diff-note",
          "text": "{{+Illustrative question-card added below. This was the only advanced lesson without one; the art-critic example was described in prose but never rendered as a card students could practice with.+}}",
          "variant": "add"
        },
        {
          "type": "question-card",
          "stimulus": "{{+Art critic: Biographers of a certain artist have claimed that, because the artist was unhappy in marriage, the artist's painting of a couple in a garden must depict the discord the artist felt. This claim is false. The painting clearly is a joyful celebration of nature. The lush landscape, warm colors, and relaxed postures of the figures all convey contentment, not discord.+}}",
          "question": "{{+The statement that the painting clearly is a joyful celebration of nature plays which one of the following roles in the art critic's argument?+}}",
          "options": [
            "{{+(A) It is the art critic's main conclusion.+}}",
            "{{+(B) It is used to support the art critic's main conclusion by providing a counterexample to a general claim. (Correct)+}}",
            "{{+(C) It is a claim that the art critic attributes to the biographers.+}}",
            "{{+(D) It is a concession the art critic makes to the biographers before disagreeing.+}}",
            "{{+(E) It restates the biographers' position in different words.+}}"
          ],
          "isIllustrative": true
        },
        {
        ...
        },
        {
          ...
          "text": "{{+Before reading the analysis, try to answer the question above on your own. Map the argument: Who holds which claim? Where is the pivot? What strategic move does the art critic make with the target statement? Then check your reasoning against the walkthrough.+}}"
        },
        {
          "type": "h3",
          "text": "Analysis"
