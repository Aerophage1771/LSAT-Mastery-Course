...
export const Lesson8_Advanced_Concessions: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Concession Indicators (Introduce the granted point)', "Pivot Words (Return to the author's argument)"],
      rows: [
        ['Although / Though', 'But'],
    ...
    {
      type: 'table',
      headers: ['Feature', 'Concession', 'Opposing Viewpoint'],
      rows: [
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "diff-note",
          "text": "This lesson follows the gold standard structure: concept definition, indicator-word table, comparison table (Concession vs. Opposing Viewpoint), worked PT example with full breakdown, and wrong-answer eliminations. No structural changes needed.",
          "variant": "comment"
        },
        {
          "type": "h2",
        ...
        {
          "type": "diff-note",
          "text": "{{!The Sandwich Pattern callout above describes an 'Although X, Y' structure, but PT-131-S-2-Q-18 uses 'Contrary to Malthus's arguments' as its concession indicator — a non-standard signal that doesn't follow the sandwich template. Consider adding a brief note after the Sandwich Pattern callout acknowledging that real LSAT stimuli often use atypical concession indicators, so students aren't thrown when the pattern doesn't match perfectly.!}}",
          "variant": "comment"
        },
        {
          "type": "question-card",
        ...
        {
          "type": "paragraph",
          "text": "{{+**Try this:** Attempt the question before reading the analysis below. Identify the concession, the pivot word, and the author's main conclusion. Then select your answer and compare it against the walkthrough.+}}"
        },
        {
          "type": "hr"
        },
