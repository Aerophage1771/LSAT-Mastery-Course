...
export const Lesson5_IntermediateConclusion: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Role', 'Receives Support?', 'Gives Support?', 'Position in Chain'],
      rows: [
    ...
    {
      type: 'table',
      headers: ['Words Leading TO the IC (from premise)', 'Words Leading FROM the IC (to main conclusion)'],
      rows: [
        ['since...', 'therefore...'],
        ['because...', 'thus...'],
        ['for...', 'so...'],
...

    {
      type: 'callout',
      variant: 'tip',
      title: 'Why "Assumption" Is Such a Tempting Trap Here',
      text: 'The quoted sentence talks about the gap in Joseph\'s reasoning, so many students overreact and pick the assumption answer. But the target is a **stated** claim, and Joseph explicitly supports it with "since no one else has been able to prove it." Default away from "assumption" when the stem quotes a sentence unless the author simply takes that sentence for granted without support.',
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "diff-note",
          "text": "'The Intermediate Conclusion' appears as both the h2 and part of the h3 ('Concept Focus: The Intermediate Conclusion'). Consider removing the bare h2 or merging the two headings so the title isn't visually duplicated at the top of the lesson.",
          "variant": "change"
        },
        {
          "type": "h2",
        ...
        {
          "type": "diff-note",
          "text": "This lesson is the gold-standard format for Module 1 LR lessons: concept intro with comparison table, real PT question-card, chain-of-reasoning diagram, dedicated 'Why Each Wrong Answer Fails' section, and self-test callouts. Use this structure as the template when improving 1-4, 1-6 through 1-11.",
          "variant": "comment"
        },
        {
          "type": "callout",
