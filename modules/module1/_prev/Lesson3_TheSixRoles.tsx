...
export const Lesson3_TheSixRoles: Lesson = {
  id: '1-3',
  title: 'The Six Roles',
  questionPolicy: 'none',
  content: [
    { type: 'h2', text: 'The Six Argument Roles' },
    {
      type: 'paragraph',
      text: 'Most roles tested on Argument Part questions fall into a few common categories. This lesson maps every role you will encounter and shows you what each one looks like in a real stimulus.',
    },
    ...
    {
      type: 'table',
      headers: ['Role', 'Frequency', 'In Plain English', 'Key Indicator Words'],
      rows: [
        [
          '**Premise / Evidence**',
          '53.5%',
    ...
    {
      type: 'breakdown',
      labels: { title: 'Role Type', text: 'Function & Example' },
      items: [
        {
    ...
    },
    {
      ...
      text: 'On harder rebuttal stimuli, the first sentence is not always the entire opposing view. Sometimes it is only a **premise inside the opponent\'s reasoning**. Before you label the role, ask two questions: **(1)** What is the opponent trying to prove? **(2)** Is this sentence the opponent\'s conclusion, or is it evidence the opponent uses to support some further claim? That extra map prevents the classic mistake of calling every attributed claim "the opposing conclusion."',
    },
    {
      type: 'process',
      title: 'How to Map a Nested Rebuttal',
      steps: [
        '**Find the author\'s target first.** What idea is the author ultimately rejecting or weakening?',
        '**Map the opponent\'s mini-argument.** Separate the opponent\'s premise(s) from the opponent\'s conclusion instead of treating all quoted material as one blob.',
        '**Assign the role relative to the whole stimulus.** A sentence can be an opponent premise, opponent conclusion, concession, or rebuttal target depending on how the author uses it.',
        '**Then translate the answer choice functionally.** The best answer will describe what the sentence does in the dialectic, not merely what topic it mentions.',
      ],
    },
    {
      type: 'blockquote',
      text: '"Some critics argue that remote work weakens collaboration because spontaneous office conversations generate the best ideas. But the strongest teams now build those same idea-sharing habits into structured online check-ins, so the critics\' explanation of what makes collaboration work is incomplete."',
    },
    {
      type: 'paragraph',
      text: 'In that structure, **"spontaneous office conversations generate the best ideas"** is not the opponent\'s final point. It is a **premise inside the opponent\'s reasoning**. The opponent\'s conclusion is that remote work weakens collaboration. The author then attacks the explanatory premise rather than merely repeating the opponent\'s conclusion.',
    },
...

    {
      ...
      variant: 'summary',
      title: 'Key Takeaway',
      text: 'The vast majority of Argument Part questions target **Premise**, **Conclusion** (main or intermediate), **Context**, or **Opposing Viewpoint**. Master the top three roles first — they cover 78% of questions — then build fluency with context, opposing viewpoints, and concessions.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "diff-note",
          "text": "Since 1-1 is being trimmed of its six-roles section, this lesson is now the definitive role reference. Keep all six role treatments complete and authoritative here.",
          "variant": "comment"
        },
        {
          "type": "callout",
          ...
          "variant": "default",
          "text": "{{+Before reading the detailed role descriptions below, try this: read the next stimulus you encounter on a practice test and, for every sentence, ask yourself — \"Does this sentence **give** support, **receive** support, or **neither**?\" That single question sorts most sentences into the right role category. Come back here afterward to check your instincts against the definitions.+}}"
        },
        {
          "type": "h2",
        ...
        {
          "type": "h3",
          "text": "{{+Practice: Identify the Pattern+}}"
        },
        {
          "type": "diff-note",
          "text": "New illustrative exercise added after the three patterns so students can test their recognition skills before moving on.",
          "variant": "add"
        },
        {
          "type": "question-card",
          "isIllustrative": true,
          "stimulus": "{{+Some researchers maintain that increased screen time has no significant effect on adolescent attention spans. Yet longitudinal studies consistently show that teens who spend more than four hours daily on screens score 20% lower on sustained-attention tasks. These findings indicate that heavy screen use does impair the ability to focus for extended periods. Schools should therefore incorporate structured screen-free intervals into the academic day.+}}",
          "question": "{{+Which of the three common patterns — Simple, Chain, or Rebuttal — does this argument follow? Identify every role present.+}}",
          "options": [
            "{{+**Simple:** Premise → Conclusion+}}",
            "{{+**Chain:** Premise → Intermediate Conclusion → Main Conclusion+}}",
            "{{+**Rebuttal:** Opposing View → Pivot → Premise → Conclusion+}}"
          ],
          "difficulty": "medium"
        },
        {
          "type": "accordion",
          "title": "{{+Reveal: Pattern & Role Breakdown+}}",
          "content": "{{+**Pattern: Rebuttal with a Chain inside.**\n\n• **Opposing Viewpoint:** \"Some researchers maintain that increased screen time has no significant effect on adolescent attention spans.\"\n• **Pivot word:** \"Yet\"\n• **Premise:** \"Longitudinal studies consistently show that teens who spend more than four hours daily on screens score 20% lower on sustained-attention tasks.\"\n• **Intermediate Conclusion:** \"These findings indicate that heavy screen use does impair the ability to focus for extended periods.\"\n• **Main Conclusion:** \"Schools should therefore incorporate structured screen-free intervals into the academic day.\"\n\nThis stimulus combines Pattern 3 (Rebuttal) with a mini Pattern 2 (Chain) inside the author's own reasoning. The correct answer is **(C)** — it is a Rebuttal — but noticing the chain within the author's side is exactly the kind of nuance that helps on harder questions.+}}"
        },
        {
          "type": "hr"
        },
    ...
    field: {
      ...
      content: [
        ...
        { type: 'h3', text: 'Role Cards' },
        {
          type: 'breakdown',
          labels: { title: 'Role', text: 'Details' },
          colWidth: 'narrow',
          items: [
            {
              title: 'Premise / Evidence',
              badge: '53.5%',
              badgeColor: 'green',
              text: '**Signal:** because, since, for, given that\n**Function:** Provides direct support for the conclusion\n**Trap:** Confusing with background context',
            },
            {
              title: 'Main Conclusion',
              badge: '13.2%',
              badgeColor: 'green',
              text: '**Signal:** therefore, thus, so, hence, should\n**Function:** The ultimate claim all evidence supports; receives support, gives none\n**Trap:** Intermediate conclusion that looks final',
            },
            {
              title: 'Intermediate Conclusion',
              badge: '11.1%',
              badgeColor: 'blue',
              text: '**Signal:** so [mid-argument], this shows that\n**Function:** A bridge \u2014 receives support AND gives support to the main conclusion\n**Trap:** Labeling as only a premise or only the main conclusion',
            },
            {
              title: 'Context / Framing',
              badge: '9.0%',
              badgeColor: 'blue',
              text: '**Signal:** It is well known, Historically, Generally\n**Function:** Sets the stage with undisputed facts; no argumentative force\n**Trap:** Treating neutral setup as a premise',
            },
            {
              title: 'Opposing Viewpoint',
              badge: '8.3%',
              badgeColor: 'slate',
              text: '**Signal:** Some argue, Critics claim, It is believed\n**Function:** A claim the author intends to challenge or refute\n**Trap:** Confusing with a concession the author makes',
            },
            {
              title: 'Concession',
              badge: '4.9%',
              badgeColor: 'slate',
              text: '**Signal:** Although, While it is true, Granted, Despite\n**Function:** A point the author grants before pivoting to their own conclusion\n**Trap:** Confusing with a premise the author endorses',
            },
          ],
        },
        {
          type: 'callout',
          variant: 'summary',
          text: 'Master the top three roles first \u2014 Premise, Main Conclusion, and Intermediate Conclusion cover 78% of all Argument Part questions.',
        },
      ],
    },
  },
