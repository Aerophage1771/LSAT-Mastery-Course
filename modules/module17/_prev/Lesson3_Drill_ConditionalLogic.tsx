...
export const Lesson3_Drill_ConditionalLogic: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: '**Full chain:** RC \u2192 OC \u2192 STM \u2192 ST. Each link is a necessary condition for the one before it. The contrapositive runs in reverse: ~ST \u2192 ~STM \u2192 ~OC \u2192 ~RC.',
    },
    {
      type: 'callout',
      title: 'Blueprint',
      variant: 'tip',
      text: "When the stimulus establishes a chain of necessary conditions, the most common correct answer is a segment of the contrapositive. Here, if students don't spend time (~ST), then the crisis won't be overcome (~OC). Answer (B) expresses exactly this.",
    },
    { type: 'h4', text: 'Step 3: Evaluate Each Choice' },
    {
      ...
      items: [
        {
          title: '(A) ST \u2192 OC',
          text: 'Reverses the chain. Spending time is necessary for overcoming the crisis, not sufficient. A necessary condition is not a guarantee.',
          badge: 'Reversal',
          badgeColor: 'red',
        },
        {
          title: '(B) ~ST \u2192 ~OC',
          text: '"Will not be overcome unless students spend time" is the contrapositive of OC \u2192 STM \u2192 ST. This is logically valid and follows directly from the chain.',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title: '(C) Comparative importance of math',
          text: 'The stimulus never compares mathematics to other subjects. This introduces an entirely new concept.',
          badge: 'Out of Scope',
          badgeColor: 'red',
        },
        {
          title: '(D) ST \u2192 RC',
          text: '"Only if RC will students ST" makes RC a necessary condition for ST. This reverses the direction: the chain says RC requires ST, not the other way around.',
          badge: 'Reversal',
          badgeColor: 'red',
        },
        {
          title: '(E) ST helps RC',
          text: '"Would help" introduces causal language the stimulus never uses. The chain establishes necessary conditions, not causal assistance.',
          badge: 'Distortion',
          badgeColor: 'red',
        },
      ],
    },
    {
      ...
      title: 'Key Takeaway',
      variant: 'summary',
      text: 'When you see multiple conditionals in an MBT stimulus, your first move should be to diagram and chain them. The correct answer will almost always be a valid segment of that chain or its contrapositive. Mistaken reversals and negations are the primary traps.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Drill: Conditional Logic in Must Be True"
        },
        {
          "type": "paragraph",
          "text": "Conditional reasoning is the backbone of MBT questions. The test makers build chains of If-Then statements and ask you to derive what must follow. Your task is to translate each premise into a conditional diagram, link the chain through shared terms, and identify the valid inference — which is often the **contrapositive** of the completed chain."
        ...
        {
          "type": "h3",
          "text": "The Concept: Chaining If-Then Statements"
        },
        {
          "type": "paragraph",
          "text": "When a stimulus provides A→B and B→C, the transitive chain A→C is guaranteed. Equally valid is the contrapositive ~C→~A. Correct answers on the LSAT frequently test whether you can build these chains accurately and recognize contrapositives expressed in natural language. The difficulty increases when the stimulus hides conditionals behind words like \"unless,\" \"only if,\" \"no...that does not,\" or double negatives."
        ...
        {
          "type": "diff-note",
          "text": "ADDITION: 'Try it first' prompt. This is missing from the website version — the full analysis follows the question-card immediately. Adding this pause is the highest-priority improvement for all drill lessons.",
          "variant": "comment"
        },
        {
          "type": "callout",
          ...
          "variant": "tip",
          "text": "{{+**Attempt this question on your own before reading the analysis below.** Diagram each conditional in the stimulus, build the chain, and identify which answer choice follows from the chain or its contrapositive. Commit to an answer, then check your reasoning below.+}}"
        },
        {
          "type": "h3",
          "text": "Full Analysis"
        ...
        {
          "type": "h4",
          "text": "Step 1: Diagram Each Premise"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h4",
          "text": "Step 3: Evaluate Each Choice"
        },
        {
          "type": "breakdown",
          "labels": {
