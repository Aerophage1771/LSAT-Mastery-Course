...
export const Lesson2_Contrapositive: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'For every conditional statement, there exists exactly one other statement that is **100% logically equivalent** to it. This is the contrapositive. If the original is true, the contrapositive is guaranteed to be true\u2014no additional assumptions, no probability, no hedging.',
    },
    {
      type: 'list',
      items: [
...

    {
      type: 'callout',
      variant: 'tip',
      title: 'The Only Valid Move',
      text: 'Of the four possible manipulations of A \u2192 B, only the contrapositive is valid. The Mistaken Reversal and Mistaken Negation are covered in Lesson 3. For now, drill the contrapositive until it becomes automatic.',
    },
    ...
    {
      type: 'paragraph',
      text: 'You do not need to think about whether a contrapositive "makes sense" in the real world. Forming the contrapositive is a purely mechanical, two-step process that works every single time:',
    },
    {
      type: 'process',
      title: 'Forming the Contrapositive',
      steps: [
    ...
    {
      type: 'table',
      headers: ['Original Statement', 'Step 1: Reverse', 'Step 2: Negate', 'Contrapositive'],
      rows: [
        ...
        [
          ...
          'Fail \u2192 NOT Study',
          'NOT Fail \u2192 Study',
          'NOT Fail \u2192 Study (double negative cancels)',
        ],
        [
          'Lawyer \u2192 NOT Scientist',
          'NOT Scientist \u2192 Lawyer',
    ...
    {
      type: 'callout',
      title: 'Double-Negative Rule',
      text: 'When you negate a term that is already negative, the two negatives cancel and the term becomes positive. "NOT NOT A" is simply "A." This is the most common source of errors when students first practice contrapositives\u2014always simplify double negatives.',
    },
    ...
    {
      type: 'paragraph',
      text: 'The LSAT relies heavily on the contrapositive to hide correct answers in Sufficient Assumption, Necessary Assumption, and Inference questions. The typical pattern: the argument needs a bridge stated as **X \u2192 Y**, but the correct answer is phrased as its contrapositive **NOT Y \u2192 NOT X** (or vice versa). If you only look for the bridge in its original form, you will miss the correct answer.',
    },
    ...
    {
      type: 'paragraph',
      text: '**Goal:** Find the sufficient assumption\u2014the one statement that, if added, makes the conclusion follow with certainty.',
    },
    {
      type: 'process',
...

    {
      ...
      items: [
        {
          title: '(B)',
          text: 'Translates to **Enforceable \u2192 Effective**. This is the Mistaken Reversal of our bridge (Effective \u2192 Enforceable). We need to know what happens when a law is NOT enforceable, but this rule only tells us about enforceable laws. A conditional tells us nothing about what happens when the sufficient condition is absent.',
          badge: 'Mistaken Reversal',
          badgeColor: 'red',
        },
        {
          title: '(C)',
          text: 'Restates Premise 1 (gambling laws are unenforceable). A sufficient assumption must provide new information that bridges existing premises to the conclusion. Repeating a premise adds nothing.',
          badge: 'Restatement',
          badgeColor: 'red',
        },
        {
          title: '(D)',
          text: 'Introduces "citizen agreement" as a condition for effectiveness. The stimulus mentions citizens only as background context, not as a logical variable in the conditional chain. This condition is irrelevant to the structural gap.',
          badge: 'Out of Scope',
          badgeColor: 'red',
        },
        {
          title: '(E)',
          text: "Links enforceability to citizen agreement. The argument's gap is strictly between unenforceability and ineffectiveness. This creates an unrelated conditional that doesn't bridge the existing premises.",
          badge: 'Out of Scope',
          badgeColor: 'red',
        },
      ],
    ...
    {
      type: 'paragraph',
      text: 'The contrapositive becomes exceptionally powerful when applied to chains of conditional logic. Many LSAT arguments build multi-step chains, and the test writers often require you to contrapose the entire chain to reach the conclusion.',
    },
    {
      type: 'paragraph',
      text: 'The principle is identical to single-statement contraposition: **reverse the entire sequence and negate every term.**',
    },
    {
      type: 'table',
      headers: ['Chain Type', 'Original', 'Contrapositive'],
      rows: [
    ...
    {
      type: 'paragraph',
      text: 'Notice how the end of the original chain becomes the start of the contrapositive chain. If you know the final necessary condition is false, logical force cascades backward through every link, proving the initial sufficient condition is also false.',
    },
...

    {
      ...
      items: [
        {
          title: '(A)',
          text: 'Translates to **Divisible \u2192 Material Body**. This is a Mistaken Reversal of Premise 1 (Material Body \u2192 Divisible). It provides no information about the spirit and does not trigger the contrapositive chain.',
          badge: 'Mistaken Reversal',
          badgeColor: 'red',
        },
        {
          title: '(B)',
          text: "Translates to **Imperfect \u2192 Divisible**. This reverses the relationship from Premise 2. Even if true, it doesn't help us determine whether the spirit is a material body, because we need to trigger the negative side of the chain.",
          badge: 'Mistaken Reversal',
          badgeColor: 'red',
        },
        {
          title: '(C)',
          text: 'If the spirit is divisible, then by Premise 2 the spirit is imperfect. But proving the spirit is imperfect does NOT prove it is not a material body\u2014many things besides material bodies could be imperfect. We are stuck inside the "Imperfect" category.',
          badge: 'Wrong Direction',
          badgeColor: 'red',
        },
        {
          title: '(E)',
          text: "This offers a disjunction: Spirit is NOT Divisible OR Spirit is Imperfect. The first branch works (NOT Divisible triggers NOT Material Body via Premise 1's contrapositive). But the second branch fails\u2014being imperfect proves nothing about being a material body. A sufficient assumption must work 100% of the time; this one only works 50%.",
          badge: 'Not Sufficient',
          badgeColor: 'red',
        },
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'When a conditional involves multiple conditions joined by AND or OR, forming the contrapositive requires an additional step: you must **switch the connector** when you negate.',
    },
    {
      type: 'paragraph',
      text: "This principle is known as De Morgan's Laws, and it appears regularly on the LSAT whenever rules combine multiple requirements or alternatives.",
    },

    {
      type: 'table',
      headers: ['Original Connector', 'After Negation', 'Why'],
      rows: [
    ...
    {
      type: 'paragraph',
      text: '**Original:** "If you study hard AND eat well, you will succeed."\n(Study AND Eat \u2192 Succeed)',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: '**Translation:** "If you did not succeed, then you either did not study hard, or you did not eat well, or both." You don\'t need to fail at both to break the AND chain; failing at just one part is enough.',
    },

    { type: 'h4', text: 'Example 2: Negating OR' },
    {
      type: 'paragraph',
      text: '**Original:** "If it rains OR snows, the game is cancelled."\n(Rain OR Snow \u2192 Cancelled)',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: '**Translation:** "If the game was not cancelled, then it is not raining AND it is not snowing." Both triggers must be absent for the result to be absent.',
    },

    {
      ...
      variant: 'tip',
      title: 'Memory Device',
      text: 'Think of AND as a chain with two links\u2014breaking one link breaks the whole chain (so failure of either part suffices). Think of OR as two separate ropes holding a weight\u2014you need to cut both ropes (so failure of both parts is required) to drop the weight.',
    },
    ...
    {
      type: 'paragraph',
      text: 'The LSAT rarely states conditionals as clean "If A, then B" sentences. Instead, conditionals are embedded in natural language with specific phrases. Recognizing these phrases is essential for accurate diagramming.',
    },
    {
      type: 'table',
      headers: ['LSAT Language', 'Diagram', 'Contrapositive'],
      rows: [
    ...
    {
      type: 'table',
      headers: ['Logic Concept', 'Formula / Notation', 'Example'],
      rows: [
        ...
        [
          ...
          'If not (Rich AND Famous), then not Rich OR not Famous',
        ],
        ["**De Morgan's (OR)**", 'NOT (A OR B) = NOT A AND NOT B', 'If not (Rain OR Snow), then not Rain AND not Snow'],
        [
          '**Chain Contrapositive**',
          'A \u2192 B \u2192 C becomes NOT C \u2192 NOT B \u2192 NOT A',
          'Full reversal of multi-link chains',
        ],
      ],
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Lesson 2: Using the Contrapositive to Unlock New Inferences"
        },
        {
          "type": "paragraph",
          "text": "**Objective:** To learn how to form and use the contrapositive, which is the only logically valid inference you can draw from a single conditional statement. This lesson covers the mechanical process, its application to LSAT assumption and inference questions, chaining contrapositives, and the critical interaction between AND/OR connectors (De Morgan's Laws)."
        ...
        {
          "type": "h3",
          "text": "2.1 What the Contrapositive Is (and Why It Matters)"
        },
        {
          "type": "paragraph",
          "text": "For every conditional statement, there exists exactly one other statement that is **100% logically equivalent** to it. This is the contrapositive. If the original is true, the contrapositive is guaranteed to be true—no additional assumptions, no probability, no hedging."
        ...
        },
        {
          ...
          "rows": [
            [
              ...
              "A → B",
              "Given (True)",
              "Always stated in stimulus"
            ],
            [
              "Contrapositive",
              "NOT B → NOT A",
              "VALID (100%)",
              "Very High — hidden in correct answers"
            ],
            [
              "Mistaken Reversal",
              "B → A",
              "INVALID",
              "Very High — common trap answer"
            ],
            [
              "Mistaken Negation",
              "NOT A → NOT B",
              "INVALID",
              "High — common trap answer"
            ]
          ]
        },
        {
        ...
        {
          "type": "h3",
          "text": "2.2 The Mechanical Process: Reverse and Negate"
        },
        {
          "type": "paragraph",
          "text": "You do not need to think about whether a contrapositive \"makes sense\" in the real world. Forming the contrapositive is a purely mechanical, two-step process that works every single time:"
        ...
        {
          "type": "h3",
          "text": "2.3 LSAT Application: The Disguised Assumption"
        },
        {
          "type": "paragraph",
          "text": "The LSAT relies heavily on the contrapositive to hide correct answers in Sufficient Assumption, Necessary Assumption, and Inference questions. The typical pattern: the argument needs a bridge stated as **X → Y**, but the correct answer is phrased as its contrapositive **NOT Y → NOT X** (or vice versa). If you only look for the bridge in its original form, you will miss the correct answer."
        ...
        {
          "type": "h3",
          "text": "2.4 Contraposition and Logical Chains"
        },
        {
          "type": "paragraph",
          "text": "The contrapositive becomes exceptionally powerful when applied to chains of conditional logic. Many LSAT arguments build multi-step chains, and the test writers often require you to contrapose the entire chain to reach the conclusion."
        ...
        {
          "type": "h3",
          "text": "2.5 Advanced Contrapositives: De Morgan's Laws (AND/OR Flipping)"
        },
        {
          "type": "paragraph",
          "text": "When a conditional involves multiple conditions joined by AND or OR, forming the contrapositive requires an additional step: you must **switch the connector** when you negate."
        ...
        },
        {
          ...
          "rows": [
            [
              "A **AND** B",
              "NOT A **OR** NOT B",
              "Failing at just one part breaks the joint requirement"
            ],
            [
              "A **OR** B",
              "NOT A **AND** NOT B",
              "Both alternatives must be absent to guarantee the result is absent"
            ]
          ]
        },
        {
          "type": "h4",
          "text": "Example 1: Negating AND"
        },
        {
          "type": "paragraph",
          "text": "**Original:** \"If you study hard AND eat well, you will succeed.\"\n(Study AND Eat → Succeed)"
        ...
        {
          "type": "h3",
          "text": "2.6 Common Contrapositive Triggers in LSAT Language"
        },
        {
          "type": "paragraph",
          "text": "The LSAT rarely states conditionals as clean \"If A, then B\" sentences. Instead, conditionals are embedded in natural language with specific phrases. Recognizing these phrases is essential for accurate diagramming."
        ...
        },
        {
          ...
          "rows": [
            ...
            [
              ...
              "If not (Rain OR Snow), then not Rain AND not Snow"
            ],
            [
              "**Chain Contrapositive**",
              "A → B → C becomes NOT C → NOT B → NOT A",
