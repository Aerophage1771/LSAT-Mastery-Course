...
export const Lesson_Intro: Lesson = {
  ...
  questionPolicy: 'none',
  content: [
    { type: 'h2', text: 'MODULE 22: Conditional Reasoning' },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Conditional reasoning is the backbone of LSAT logic. It is not a niche topic confined to a handful of questions — it is the invisible framework running beneath nearly every problem on the test. When a Sufficient Assumption question asks you to complete a chain of logic, you are doing conditional reasoning. When a Necessary Assumption question asks you to find the unstated requirement, you are doing conditional reasoning. When a Flaw question describes someone who "confused sufficient and necessary conditions," you are evaluating conditional reasoning. When a Parallel Reasoning question asks you to match argument structure, you are comparing conditional patterns.',
    },
    {
      type: 'paragraph',
      text: 'Unlike most skills on the LSAT, conditional logic is not intuitive. In everyday conversation, we routinely infer things that formal logic does not permit. We hear "If you study hard, you will pass" and assume the reverse — that if you don\'t study, you won\'t pass. That assumption is a logical fallacy, and the LSAT exploits it ruthlessly. The test rewards students who can suppress their conversational instincts and reason with mechanical precision.',
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'Frequency & Impact',
      text: 'Conditional reasoning skills are tested directly or indirectly on **roughly 40\u201360% of all Logical Reasoning questions**. They also appear in Logic Games rule interpretation and Reading Comprehension inference questions. Mastering this single module will improve your performance across all three scored sections of the LSAT.',
    },
    ...
    {
      type: 'paragraph',
      text: 'This module takes you from the foundations of conditional logic to its most advanced applications. Each lesson builds on the previous one, so mastery is cumulative.',
    },
    {
      type: 'process',
      title: 'Module Roadmap',
      steps: [
        '**Lesson 1 — Foundations:** The material conditional (A \u2192 B), sufficient vs. necessary conditions, indicator words, and diagramming techniques. You will learn to translate any LSAT conditional statement into arrow notation. This lesson also introduces validity vs. truth, the set-to-condition bridge, and the first disguised-conditionals translation patterns so the logic remains stable even when the wording changes.',
        ...
        '**Lesson 5 — Complex Structures:** Chaining multiple conditionals, handling "unless/except/without," simplifying dense rules, and working with rules, exceptions, nested conditionals, and compound conditional statements.',
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "MODULE 21: Conditional Reasoning"
        },
        {
          "type": "paragraph",
          "text": "**Module Goal**\n\n**Master the formal logic that underlies the LSAT: translate conditional statements into diagrams, derive valid inferences, and avoid the reasoning errors the test is designed to exploit.** Conditional reasoning is not one question type — it is the structural engine that powers nearly every question type on the exam."
        ...
        {
          "type": "h3",
          "text": "What Is Conditional Reasoning?"
        },
        {
          "type": "paragraph",
          "text": "At its core, conditional reasoning is about **If-Then relationships**. A conditional statement establishes a rule: if one condition is met, then another condition must also be met. The \"if\" part is called the **sufficient condition** — it is enough to trigger the result. The \"then\" part is called the **necessary condition** — it is required whenever the trigger is present."
        ...
        {
          "type": "diff-note",
          "text": "The question-type table, arrow notation, trigger words, and 'All vs. Only' callout below duplicate content from IntroDeep. Consider keeping the Intro focused on motivation and the roadmap, letting IntroDeep own the detailed tables.",
          "variant": "comment"
        },
        {
          "type": "h3",
          "text": "{{~Question Types That Rely on Conditional Logic~}}"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h3",
          "text": "Common Conditional Triggers"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "diff-note",
          "text": "Double <hr> here is a formatting glitch. Remove one.",
          "variant": "comment"
        },
        {
          "type": "hr"
    ...
    glance: {
      label: 'At a Glance',
      content: [
        { type: 'h2', text: 'Conditional Reasoning — At a Glance' },
        {
          type: 'paragraph',
          text: 'Master the If-Then logic that powers **roughly 40-60% of all Logical Reasoning questions** and recurs across Logic Games and Reading Comprehension.',
        },
        {
          type: 'table',
          headers: ['Element', 'What to Look For', 'Core Skill', 'Common Trap'],
          rows: [
            ['Sufficient Condition', '"If," "when," "every," "all," "each"', 'Place on the left side of the arrow', 'Treating it as necessary (Mistaken Reversal)'],
            ['Necessary Condition', '"Only if," "requires," "must," "unless"', 'Place on the right side of the arrow', 'Treating it as sufficient (Mistaken Negation)'],
            ['Contrapositive', 'Reverse and negate both sides', 'Derive ~B \u2192 ~A from A \u2192 B', 'Forgetting to negate, or negating without reversing'],
            ['Quantifiers', '"Some," "most," "all," "none"', 'Match quantifier level to valid inferences', 'Shifting from "most" to "all" without justification'],
          ],
        },
        {
          type: 'paragraph',
          text: '**Quick Example:** "If it rains, the ground is wet." Rain is sufficient (trigger). Wet ground is necessary (requirement). Contrapositive: ~Wet \u2192 ~Rain. Invalid: Wet \u2192 Rain (Mistaken Reversal) or ~Rain \u2192 ~Wet (Mistaken Negation).',
        },
        {
          type: 'list',
          items: [
            '**Lesson 1 — Foundations:** Translate conditionals into arrow diagrams; learn trigger words for sufficient and necessary sides.',
            '**Lesson 2 — Contrapositive:** Derive the only valid inference from any conditional by reversing and negating.',
            '**Lesson 3 — Fallacies:** Spot Mistaken Reversal and Mistaken Negation on sight.',
            '**Lesson 4 — Quantifiers:** Handle "some," "most," and combination rules that control which inferences hold.',
            '**Lessons 5-6 — Complex Structures & Mastery:** Chain conditionals, decode "unless/except/without," and handle nested and compound rules under time pressure.',
          ],
        },
        {
          type: 'callout',
          ...
          text: 'The arrow is a one-way street: move forward (trigger \u2192 requirement) or use the contrapositive (~requirement \u2192 ~trigger) — never reverse without negating.',
        },
      ],
    },
  },
