...
export const Lesson9_Advanced_ChallengingAssumption: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Feature', 'Stated Premise', 'Implicit (Unstated) Premise'],
      rows: [
    ...
    {
      type: 'breakdown',
      labels: { title: 'Component', text: 'Analysis' },
      items: [
        {
    ...
    { type: 'h3', text: 'Step 3: Evaluate the Answer Choices' },
    {
      ...
      items: [
        {
          title:
            "(A) contradict the conclusion... without offering any reason to reject any of Rifka's implicit premises",
