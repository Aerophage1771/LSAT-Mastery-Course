...
export const Lesson1_Introduction: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: '**Question Goal:** Identify the specific rhetorical or logical strategy the author uses to reach the conclusion. Are they drawing an analogy, ruling out alternatives, providing a counterexample, or appealing to a principle? Your task is to describe *how* the argument is constructed, not *what* it concludes.',
    },
    ...
    {
      type: 'paragraph',
      text: "You can identify a Method of Reasoning question because the stem asks about the argument's strategy, technique, or method — not about a specific sentence's role (Argument Part) or the conclusion's content (Main Conclusion). Look for these patterns:",
    },
    {
      type: 'table',
      ...
      rows: [
        ...
        [
          ...
          'Asks for the **strategy**',
        ],
        [
          '"The environmentalist uses which one of the following argumentative techniques?"',
          'Asks for the **technique** (often in dialogue format)',
        ],
      ],
    },
