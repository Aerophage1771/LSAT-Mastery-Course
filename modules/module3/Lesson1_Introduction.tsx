...
export const Lesson1_Introduction: Lesson = {
  ...
  content: [
    ...
    { type: 'paragraph', text: '**Question Goal:** What specific rhetorical or logical strategy does the author use to justify their stance? How does the author’s evidence function to support the main point? Is the argument drawing an analogy, ruling out alternative explanations, or appealing to a general principle?' },
    ...
    { type: 'h3', text: 'Core Concepts: Strategy vs. Content' },
