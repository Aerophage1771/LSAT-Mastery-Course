...
export const Lesson6_RefutationByCounterexample: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Feature', 'Counterexample', 'Refutation by Analogy', 'Alternative Explanation'],
      rows: [
        [
          '**What it attacks**',
    ...
    {
      type: 'table',
      headers: ['Option', 'Trap Type', 'Why It Fails'],
      rows: [
        [
          '(B)',
          '**Wrong Action**',
    ...
    {
      type: 'breakdown',
      labels: { title: 'Claim Type', text: 'Effect of One Counterexample' },
      items: [
        {
