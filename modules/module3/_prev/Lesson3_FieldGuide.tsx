...
export const Lesson3_FieldGuide: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Method', 'Freq.', 'Core Description', 'Answer Choice Language'],
      rows: [
        [
          '**Analogy**',
          '~23%',
...

    {
      type: 'callout',
      variant: 'tip',
      title: 'Fast Family Check',
      text: 'Before reading Method answers, sort the stimulus into a family first: **analogy**, **elimination**, **counterexample**, **causal explanation**, **assumption attack**, **principle application**, **concession / qualification**, **negative consequences**, **data-based support**, or **scope restriction**. You do not need the perfect LSAT label up front, but you do need the right family.',
    },
    ...
    {
      type: 'breakdown',
      labels: { title: 'Sub-Type', text: 'Description' },
      items: [
        {
...

    {
      ...
      variant: 'summary',
      title: 'Key Takeaways',
      text: '• The four highest-frequency strategies — **Analogy** (~23%), **Consequences** (~17%), **Causal Reasoning** (~14%), and **Challenging Assumptions** (~11%) — together account for roughly **65%** of all Method of Reasoning questions.\n• Each method has distinctive **indicator language** in both the stimulus and the answer choices. Learn to spot these signals.\n• Refer to the **Master Summary Table** at the top for a quick-reference overview of all categories.',
    },

    {
      ...
      text: 'The next lesson covers the remaining strategies — **Applying Principles**, **Process of Elimination**, and **Refutation by Counterexample** — plus the **Quick Pattern Matching** decision process and a complete **Indicator Language** quick-reference table.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "diff-note",
          "text": "{{!note!}} At ~85 blocks this is the longest lesson in the module. The Master Summary Table below duplicates Lesson 3-1's Method Categories table. If 3-1 is trimmed to a 3-row preview, this becomes the canonical catalog and the overlap is resolved.",
          "variant": "comment"
        },
        {
          "type": "h2",
        ...
        {
          "type": "diff-note",
          "text": "{{~change~}} The 'Other' row (~12%) is vague. Expand with one-sentence descriptions: Reductio = 'assumes opponent is right and derives absurdity'; Definition dispute = 'shows a key term is ambiguous'; Conditional logic = 'traces if-then chains to a conclusion'. Students need enough to recognize these when they appear.",
          "variant": "comment"
        },
        {
          "type": "hr"
        ...
        {
          "type": "diff-note",
          "text": "{{+add+}} Insert a mini-exercise or lightweight question-card after the Quick Pattern Matching section below. The student has read 7 deep-dive method sections without any practice. Even a 'Name the method in this 3-sentence argument' callout would improve retention.",
          "variant": "comment"
        },
        {
          "type": "h2",
    ...
    field: {
      ...
      content: [
          ...
          items: [
            {
              ...
              text: '**Signal:** "just as," "similarly," "it would be like," "by your reasoning"\n\n**How It Works:** Compares two situations \u2014 because they are similar in relevant ways, what is true of one is argued to be true of the other. Variations include supportive analogy, refutation by analogy (applies opponent\'s logic to an absurd case), and attacking an analogy (showing a crucial difference).\n\n**Trap:** Confusing a counterexample (same category) with an analogy (different category).',
              badge: '~23%',
              badgeColor: 'green',
            },
            {
              title: 'Highlighting Consequences',
              text: '**Signal:** "would result in," "would lead to," "suppose X were true"\n\n**How It Works:** Argues for or against a position by predicting outcomes. The negative-consequences variant shows a plan will backfire. The reductio variant assumes a claim is true and derives a contradiction.\n\n**Trap:** Mixing up negative consequences (plan leads to bad outcome) with proof by contradiction (claim leads to impossibility).',
              badge: '~17%',
              badgeColor: 'green',
            },
            {
              title: 'Causal Reasoning',
              text: '**Signal:** "is caused by," "an alternative explanation is," "could instead be caused by"\n\n**How It Works:** Proposes a cause, challenges someone else\'s proposed cause, or offers a different cause for the same event. The alternative-explanation variant agrees the phenomenon occurred but names a different driver.\n\n**Trap:** Accepting a correlation as a causal claim when the argument only establishes co-occurrence.',
              badge: '~14%',
              badgeColor: 'blue',
            },
            {
              title: 'Challenging an Assumption',
              text: '**Signal:** "assumes without justification," "presupposes," "takes for granted"\n\n**How It Works:** Identifies a necessary but unstated premise and provides evidence that this assumption is false. The speaker does not attack stated evidence \u2014 they break the logical link between premises and conclusion.\n\n**Trap:** Confusing attacking an assumption with attacking the stated evidence.',
              badge: '~11%',
              badgeColor: 'blue',
            },
          ],
        },
        {
          type: 'callout',
          variant: 'summary',
          text: 'These four highest-frequency strategies \u2014 **Analogy**, **Consequences**, **Causal Reasoning**, and **Challenging Assumptions** \u2014 together account for roughly **65%** of all Method of Reasoning questions. The remaining strategies (Principles, Elimination, Counterexample) are covered in the Extended Guide.',
        },
      ],
    },
  },
