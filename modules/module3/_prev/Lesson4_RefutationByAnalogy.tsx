...
export const Lesson4_RefutationByAnalogy: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Feature', 'Refutation by Analogy', 'Counterexample'],
      rows: [
...

    {
      ...
      items: [
        ...
        {
          title:
            "(D) Show that the developer's line of reasoning would lead to an unacceptable conclusion if applied to a different situation",
    ...
    {
      type: 'table',
      headers: ['Option', 'Trap Type', 'What Went Wrong'],
      rows: [
        [
          '(A)',
          '**Wrong Action**',
