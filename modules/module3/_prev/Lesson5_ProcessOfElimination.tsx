...
export const Lesson5_ProcessOfElimination: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Signal Type', 'Example Language', 'What It Does'],
      rows: [
        [
    ...
    {
      type: 'table',
      headers: ['Feature', 'Process of Elimination', 'Counterexample', 'Alternative Explanation'],
      rows: [
        [
          '**Goal**',
    ...
    {
      type: 'breakdown',
      labels: { title: 'Example Type', text: 'Illustration' },
      items: [
        {
