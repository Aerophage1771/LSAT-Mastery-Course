...
export const Lesson7_HighlightingNegativeConsequences: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Category', 'Indicator Words & Phrases'],
      rows: [
        [
          'Causal Chain',
    ...
    {
      type: 'table',
      headers: ['Feature', 'Negative Consequences', 'Counterexample'],
      rows: [
    ...
    {
      type: 'breakdown',
      labels: { title: 'Speaker', text: 'Argument Structure' },
      items: [
        {
    ...
    { type: 'h3', text: 'Step 3: Evaluate the Answer Choices' },
    {
      ...
      items: [
        {
          title:
            '(A) listing a set of considerations to show that a prescribed treatment... in fact harms that patient',
        ...
        {
          title:
            '(B) describing the application of the technology... as one step that initiates a process that leads to an undesirable end',
