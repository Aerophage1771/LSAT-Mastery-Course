...
export const Lesson5_Drill_DefinitionalChecklist: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'A **Definitional Checklist** question is a Principle-Apply pattern where the principle defines a category by specifying what qualifies and — critically — what does not. The correct answer is the one scenario that meets every inclusion criterion while clearly avoiding every exclusion criterion. Your job is not to reason about conditional logic or contrapositives; it is to categorize each answer choice against a precise, multi-part definition.',
    },

    {
      type: 'paragraph',
      text: 'These questions feel different from standard conditional Principle-Apply because the principle reads more like a dictionary entry than a rule. It says: "X is defined as [positive features] and is distinct from [excluded features]." The difficulty comes from the LSAT\'s ability to construct answer choices that satisfy *most* of the definition but violate one element — usually the exclusion clause.',
    },
    {
      type: 'paragraph',
      text: 'Even on definitional questions, the shared vocabulary still works. The **trigger** is category membership, the answer choice supplies the **case facts**, the **bridge** is whether those facts satisfy the inclusion criteria while avoiding the exclusion criteria, and the **verdict** is whether the case counts as an instance of the defined category.',
    },

    { type: 'h3', text: 'The Definitional Checklist Method' },
    {
      type: 'paragraph',
      text: 'When the principle defines a category, build a two-part checklist before reading the answers:',
    },
    {
      type: 'process',
      title: 'Building a Definitional Checklist',
      steps: [
        ...
        '**Step 3 — Categorize Each Answer:** For every answer choice, ask two questions: (a) Does it satisfy every positive criterion? (b) Does it fall into any excluded category? Only the answer whose case facts bridge to the category verdict passes both filters.',
      ],
    },

    {
      type: 'callout',
      variant: 'tip',
      title: 'The Exclusion Test Is Usually Decisive',
      text: 'On most definitional checklist questions, multiple answers will superficially resemble the positive definition. The fastest path to the correct answer is often through the exclusion criteria: eliminate any choice whose motivation falls into an excluded category. Typically only one answer survives.',
    },
    ...
    {
      type: 'paragraph',
      text: 'This drill uses a principle that defines "the most advanced kind of moral motivation" by stating what it IS (abstract principles) and what it is NOT (self-interest, societal norms). Your task is to build the checklist and sort five scenarios into the correct categories.',
    },
    {
      type: 'paragraph',
...

    {
      ...
      question:
        '**The Question:** The actions of which one of the following individuals exhibit the most advanced kind of moral motivation, as described by the ethicist?',
      options: [
    ...
    {
      type: 'paragraph',
      text: "The ethicist's statement is a definition with explicit inclusion and exclusion criteria. Let's extract them:",
    },

    {
      type: 'breakdown',
      labels: { title: 'Checklist Item', text: 'What to Look For' },
      items: [
        {
          title: 'Positive Criterion: Based solely on abstract principles',
          text: 'The person\'s motivation must be a general, abstract ethical belief — a principle that applies universally, not just to the specific situation. Key word: "solely" means no mixed motives. The abstract principle must be the *only* driver of the action.',
          badge: 'Must Be Present',
          badgeColor: 'blue',
        },
        {
          title: 'Exclusion 1: NOT calculated self-interest',
          text: 'The motivation cannot be personal gain, personal protection, career advancement, financial benefit, or avoidance of personal harm. Any scenario where the person acts to benefit or protect themselves fails this criterion.',
          badge: 'Must Be Absent',
          badgeColor: 'red',
        },
        {
          title: 'Exclusion 2: NOT desire to adhere to societal norms',
          text: 'The motivation cannot be peer pressure, fear of social judgment, desire to fit in, conformity, or following what others expect. Any scenario where the person acts because of what others think or want fails this criterion.',
          badge: 'Must Be Absent',
          badgeColor: 'red',
        },
      ],
    ...
    {
      type: 'paragraph',
      text: '**The complete filter:** Advanced Motivation = [Abstract Principle as sole driver] + [NOT self-interest] + [NOT societal norms]. An answer must pass ALL three checks.',
    },

    { type: 'h4', text: 'Step 2: Categorize Each Answer' },
    {
      type: 'paragraph',
      text: 'Now apply the three-part checklist to each scenario. For each person, identify their stated motivation and classify it.',
    },
    ...
    {
      type: 'paragraph',
      text: 'All three elements confirmed. Answer (D) is the only scenario that satisfies the positive criterion while avoiding both exclusion categories.',
    },
    ...
    {
      type: 'table',
      headers: ['Answer', 'Abstract Principle?', 'Self-Interest?', 'Societal Norms?', 'Category'],
      rows: [
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "diff-note",
          "text": "The framing that definitional questions require 'categorization, not conditional logic' is pedagogically useful but slightly oversimplified. The categorization process IS conditional: IF abstract principle (not self-interest and not societal norms) THEN advanced motivation. A brief note acknowledging this connection would strengthen the lesson.",
          "variant": "comment"
        },
        {
          "type": "h3",
          "text": "The Definitional Checklist Method"
        },
        {
          "type": "paragraph",
          "text": "When the principle defines a category, build a two-part checklist before reading the answers:"
        ...
        {
          "type": "h3",
          "text": "Drill: Definitional Checklist (PT-123-S-2-Q-7)"
        },
        {
          "type": "paragraph",
          "text": "This drill uses a principle that defines \"the most advanced kind of moral motivation\" by stating what it IS (abstract principles) and what it is NOT (self-interest, societal norms). Your task is to build the checklist and sort five scenarios into the correct categories."
        ...
        },
        {
          ...
          "question": "**The Question:** The actions of which one of the following individuals exhibit the most advanced kind of moral motivation, as described by the ethicist?",
          "options": [
            "(A) Bobby contributed money to a local charity during a charity drive at work because he worried that not doing so would make him look stingy.",
            "(B) Wes contributed money to a local charity during a charity drive at work because he believed that doing so would improve his employer's opinion of him.",
            "(C) Donna's employers engaged in an illegal but profitable practice that caused serious damage to the environment. Donna did not report this practice to the authorities, out of fear that her employers would retaliate against her.",
        ...
        {
          "type": "h4",
          "text": "Step 1: Build the Definitional Checklist"
        },
        {
          "type": "paragraph",
          "text": "The ethicist's statement is a definition with explicit inclusion and exclusion criteria. Let's extract them:"
        ...
        {
          "type": "h4",
          "text": "Step 2: Categorize Each Answer"
        },
        {
          "type": "paragraph",
          "text": "Now apply the three-part checklist to each scenario. For each person, identify their stated motivation and classify it."
        },
        {
          ...
          "items": [
            ...
            {
              "title": "(D) Jadine: reported illegal practice out of a belief that protecting the environment is always more important than monetary profit.",
              "text": "**Stated motivation:** A universal ethical belief (\"protecting the environment is *always* more important than monetary profit\").\n**Category:** This is an abstract principle — a general moral rule that applies universally (signaled by \"always\"), not just to Jadine's specific situation.\n\n**Positive Criterion (abstract principle)?** ✓ — \"Protecting the environment is always more important than monetary profit\" is a general, abstract ethical principle.\n**Exclusion 1 (self-interest)?** ✓ — Jadine gains nothing personally; she risks employer retaliation by reporting.\n**Exclusion 2 (societal norms)?** ✓ — No mention of peer pressure or social expectations driving her decision.\n\n**Verdict: Passes all three checks.** This is the definitional match.",
              "badge": "Correct",
              "badgeColor": "green"
            },
        ...
        {
          "type": "paragraph",
          "text": "Re-read the ethicist's definition and confirm that answer (D) is the only match:"
        },
        {
          "type": "list",
          "items": [
