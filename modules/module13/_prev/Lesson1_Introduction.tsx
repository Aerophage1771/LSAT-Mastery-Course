...
export const Lesson1_Introduction: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: "**Question Goal**\n\nYou are given a general rule or principle in the stimulus. Your job is to find the one answer choice whose **case facts** satisfy the rule's **trigger** and therefore reach the rule's **verdict**.",
    },
    ...
    {
      type: 'paragraph',
      text: "These questions appear roughly **1–2 times per scored Logical Reasoning section** and span the full difficulty range. They are often underestimated because the principle is given to you — you don't have to find it yourself. But the challenge lies in the precision required: the correct answer must satisfy *every* part of the principle's trigger, and wrong answers are designed to match *almost* perfectly while violating a single, easy-to-miss requirement.",
    },
    {
      type: 'paragraph',
      text: "Mastering Principle-Apply also strengthens your performance on related question types. The ability to decompose a rule into trigger and verdict is the same skill you need for Sufficient Assumption questions (where you construct the rule), Parallel Reasoning (where you match the rule's logical form), and Conditional Reasoning throughout the Logic Games section. This module trains your precision, and precision pays compound interest across the entire exam.",
    },
    {
      type: 'callout',
      variant: 'tip',
    ...
    {
      type: 'paragraph',
      text: '**Quick Example:** Suppose the stimulus states: "A business owner who knowingly sells a defective product to a customer is liable for any injuries that result from the defect." The correct answer must present a scenario where (1) a business owner (2) knowingly sells (3) a defective product (4) to a customer, and the verdict is liability for resulting injuries. If even one of those four trigger elements is missing — say the seller is an employee, not the owner — the answer is wrong.',
    },

    { type: 'hr' },

    { type: 'h3', text: 'What You\'ll Learn' },
    {
      type: 'paragraph',
      text: 'This module builds your Principle-Apply skills through a structured sequence:',
    },
    {
      type: 'list',
      ordered: true,
      items: [
        '**Foundations** — What makes Apply different from Strengthen, shared vocabulary (trigger, verdict, case facts, bridge, contrapositive), the matching process, and common principle structures.',
        '**Step-by-Step Guide** — The systematic approach for solving any Principle-Apply question under timed conditions.',
        '**Drills** — Direct application, contrapositive application, definitional checklist, and advanced application practice.',
        '**Reference Guide** — Quick-access summary of the method, vocabulary, and common traps.',
      ],
    },
...

    {
      ...
      variant: 'summary',
      title: 'Key Takeaway',
      text: "Principle-Apply gives you the rule and asks you to find the case. Your single most important habit is to **treat the principle as a checklist**: decompose it into trigger elements and a verdict, then verify that the correct answer's case facts satisfy *every* trigger element before reaching the stated verdict. If even one element is missing, the answer is wrong — no matter how close it looks.",
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h2",
          "text": "What Makes Apply Different"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h2",
          "text": "The Matching Process"
        },
        {
          "type": "diff-note",
          "text": "The Matching Process section below (Steps 1–2 with the defective-product breakdown) duplicates the core teaching of Lesson 2 (Step-by-Step Guide). Consider trimming this section to a brief conceptual summary and moving the full decomposition process to Lesson 2, where it can anchor the 4-Step Method. The Common Principle Structures table further below is a better endpoint for this introduction.",
          "variant": "comment"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h3",
          "text": "Step 1: Break the Principle into Conditions and Consequences"
        },
        {
          "type": "paragraph",
          "text": "Every principle on the LSAT can be decomposed into two components:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h3",
          "text": "Step 2: Check Each Answer Against the Checklist"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h2",
          "text": "Common Principle Structures"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "diff-note",
          "text": "The Worked Example below describes what an analysis would look like but presents no actual answer choices. This is an explanation masquerading as practice. Consider replacing with a real PT question-card and actual options so the student can attempt it before reading the walkthrough. Add a 'Try this first' prompt immediately before the analysis.",
          "variant": "comment"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "paragraph",
          "text": "Consider this illustrative principle and application set:"
        },
        {
          "type": "blockquote",
        ...
        {
          "type": "paragraph",
          "text": "{{+**Try this:** Before reading the walkthrough, consider: what two conditions must a scenario satisfy to correctly apply this principle? What conclusion should a correct answer reach?+}}"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h4",
          "text": "Step 1: Decompose the Principle"
        },
        {
          "type": "paragraph",
          "text": "The editorial states: a regulation is **justified** only if two conditions are met:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h4",
          "text": "Step 2: Evaluate Each Answer"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "diff-note",
          "text": "This Step 2 walkthrough describes hypothetical answer choices without actually presenting them. Students would benefit from seeing real labeled options — even simplified ones — so they can practice the elimination process rather than just reading about it.",
          "variant": "comment"
        },
        {
          "type": "hr"
    ...
    glance: {
      ...
      content: [
        ...
        {
          type: 'paragraph',
          text: '**Goal:** The principle is given in the stimulus. Find the answer choice whose case facts satisfy every trigger element and reach the stated verdict. **Frequency:** ~3% of LR questions (1--2 per scored section), spanning the full difficulty range.',
        },
        {
          type: 'table',
          headers: ['Stem Pattern', 'Core Skill', 'Common Trap'],
          rows: [
            ['"Which is an application of the principle above?"', 'Checklist matching', 'Missing one subtle trigger element'],
            ['"Which most closely conforms to the principle?"', 'Checklist matching', 'Sufficient-necessary reversal'],
            ['"Which judgment best illustrates the principle?"', 'Checklist matching', 'Wrong verdict with correct trigger'],
            ['"Which is consistent with the principle stated above?"', 'Checklist matching', 'Scope mismatch — different domain'],
          ],
        },
        {
          type: 'paragraph',
          text: '**Quick Example:** Principle: "A business owner who knowingly sells a defective product is liable for resulting injuries." The correct answer must present (1) a business owner, (2) who knowingly sells, (3) a defective product, (4) to a customer, reaching the verdict of liability. If even one element is missing — say the seller is an employee, not the owner — the answer is wrong.',
        },
        { type: 'h4', text: "What's in This Module" },
        {
          type: 'list',
          items: [
            'Foundations: Apply vs Strengthen direction, shared vocabulary (trigger, verdict, case facts, bridge, contrapositive)',
            'Step-by-Step: four-step method — Diagram Principle, Build Trigger Checklist, Check Case Facts, Verify Bridge',
            'Drills: Direct Application, Contrapositive Application, Definitional Checklist, Advanced Application',
            'Reference Guide: compact cheat sheet with all application types and trap patterns',
          ],
        },
      ],
    },
