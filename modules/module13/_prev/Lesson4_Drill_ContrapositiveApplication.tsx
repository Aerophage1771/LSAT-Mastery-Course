...
export const Lesson4_Drill_ContrapositiveApplication: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: "A **Contrapositive Application** is a Principle-Apply pattern where the correct answer does not mirror the principle's forward logic. Instead, it applies the principle's logically equivalent contrapositive: if the consequence did not occur (or should not occur), then at least one condition must not have been met. This is the second most common Principle-Apply pattern after direct application, and it is the primary source of difficulty on these questions because it requires you to negate both sides of the rule and reverse the direction.",
    },

    {
      type: 'paragraph',
      text: 'Many students can apply a principle forward — IF conditions, THEN consequence — but freeze when the correct answer works backward. The LSAT exploits this by constructing stimuli with "only when" or "only if" language, which naturally sets up a necessary-condition relationship that is most cleanly applied via the contrapositive.',
    },
    {
      type: 'paragraph',
      text: 'Use the same shared vocabulary here as everywhere else in the Principle family: identify the **trigger** and **verdict**, then decide whether the answer choice\'s **case facts** bridge to that verdict directly or through the **contrapositive**. On this pattern, the bridge usually runs through the reverse trigger.',
    },

    { type: 'h3', text: 'How the Contrapositive Works in Principle-Apply' },
    {
      type: 'paragraph',
      text: 'Every conditional statement has a logically equivalent contrapositive. If the principle says:',
    },
    {
      type: 'list',
      ordered: false,
    ...
    {
      type: 'paragraph',
      text: 'When a principle uses necessary-condition language — "only when," "only if," "requires," "must" — the structure is:',
    },
    {
      type: 'list',
      ordered: false,
    ...
    {
      type: 'paragraph',
      text: 'This drill demonstrates the contrapositive pattern using a principle with "only when" language. Your task is to identify the necessary condition, form the contrapositive, and find the answer that correctly applies it.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'The principle uses the phrase "only when," which is the LSAT\'s signature necessary-condition indicator. Let\'s translate:',
    },
    {
      type: 'paragraph',
      text: '**Natural language:** "A nation can experience economic growth only when consumer confidence is balanced with a small amount of consumer skepticism."',
    },
    {
      type: 'paragraph',
      text: '**Logical form:** Economic Growth (EG) → The Balance must exist (confidence balanced with small amount of skepticism)',
    },
    {
      type: 'paragraph',
      text: '"Only when" tells us The Balance is *necessary* for Economic Growth. It does NOT tell us The Balance is *sufficient*. Having The Balance does not guarantee growth — it merely permits it.',
    },

    { type: 'h4', text: 'Step 2: Form the Contrapositive' },
    {
      type: 'paragraph',
      text: 'Since this is a necessary-condition principle, the most reliable way to apply it is through its contrapositive:',
    },
    {
      type: 'breakdown',
      labels: { title: 'Direction', text: 'Logical Statement' },
      items: [
        {
          title: 'Original',
          text: 'Economic Growth → The Balance exists\n\nIf a nation has economic growth, then consumer confidence is balanced with a small amount of skepticism.',
          badge: 'Forward',
          badgeColor: 'blue',
        },
        {
          title: 'Contrapositive',
          text: '¬The Balance → ¬Economic Growth\n\nIf the balance does NOT exist (e.g., consumers are exclusively confident or exclusively skeptical), then the nation CANNOT experience economic growth.',
          badge: 'Reverse',
          badgeColor: 'indigo',
        },
      ],
    ...
    {
      type: 'paragraph',
      text: 'The correct answer should describe a scenario where The Balance is absent and correctly conclude that economic growth cannot occur.',
    },
    ...
    {
      type: 'paragraph',
      text: 'Re-read the principle and confirm that answer (D) correctly applies the contrapositive:',
    },
    {
      type: 'list',
      ordered: true,
    ...
    {
      type: 'table',
      headers: ['Answer', 'Balance Present?', 'Correct Direction?', 'Valid Conclusion?', 'Verdict'],
      rows: [
        [
          '(A) Balance → Growth',
          '✓ (present)',
        ...
        [
          '(B) Not skepticism → Growth',
          '? — vague',
          "✗ — unrelated to the principle's logic",
          '✗ — guarantees growth',
          'Over-broad',
        ],
        [
          '(C) Exclusive → Growth',
          '✗ (absent)',
          '✗ — should deny growth, not affirm it',
          '✗ — contradicts contrapositive',
          'Contradiction',
        ],
        [
          '**(D) Exclusive confidence → No growth**',
          '**✗ (absent)**',
    ...
    {
      type: 'paragraph',
      text: 'The pattern is striking: **four of five wrong answers claim economic growth WILL occur** in situations where the principle either says nothing about growth or actively prohibits it. The LSAT baits you with the appealing but invalid inference that meeting (or approximating) a necessary condition guarantees the outcome.',
    },
    ...
    { type: 'h3', text: 'Key Lessons from This Drill' },
    {
      ...
      variant: 'summary',
      title: 'Key Takeaways',
      text: '**1. "Only when" introduces a necessary condition, not a sufficient one.** The phrase "X only when Y" means Y is required for X, but Y alone does not guarantee X. The most reliable application is the contrapositive: if Y is absent, X cannot occur.\n\n**2. The contrapositive creates a second valid trigger.** When a principle tells you what is *required*, the cleanest application is often to test the reverse trigger: if the requirement is absent, the verdict fails. That is the bridge in this drill.\n\n**3. The Sufficient-Necessary Reversal is the #1 trap.** Choices (A) and (E) both commit this error: they assume that having the necessary condition guarantees the outcome. This is the most common wrong-answer pattern on conditional Principle-Apply questions.\n\n**4. Distortion of the condition is a secondary trap.** Choice (E) doesn\'t just reverse the logic — it also alters the condition itself by flipping the confidence-skepticism ratio. Always verify that the case facts match the trigger exactly, not just approximately.\n\n**5. When you see necessary-condition language, write the contrapositive immediately.** Don\'t wait until you\'ve read the answers. Form the contrapositive as part of your principle decomposition in Step 1. This gives you two valid trigger paths to match against, doubling your chances of recognizing the correct answer quickly.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Contrapositive Application"
        },
        {
          "type": "paragraph",
          "text": "A **Contrapositive Application** is a Principle-Apply pattern where the correct answer does not mirror the principle's forward logic. Instead, it applies the principle's logically equivalent contrapositive: if the consequence did not occur (or should not occur), then at least one condition must not have been met. This is the second most common Principle-Apply pattern after direct application, and it is the primary source of difficulty on these questions because it requires you to negate both sides of the rule and reverse the direction."
        ...
        {
          "type": "h3",
          "text": "How the Contrapositive Works in Principle-Apply"
        },
        {
          "type": "paragraph",
          "text": "Every conditional statement has a logically equivalent contrapositive. If the principle says:"
        ...
        {
          "type": "h3",
          "text": "Drill: Contrapositive Application (PT-106-S-1-Q-10)"
        },
        {
          "type": "paragraph",
          "text": "This drill demonstrates the contrapositive pattern using a principle with \"only when\" language. Your task is to identify the necessary condition, form the contrapositive, and find the answer that correctly applies it."
        ...
        {
          "type": "h4",
          "text": "Step 2: Form the Contrapositive"
        },
        {
          "type": "paragraph",
          "text": "Since this is a necessary-condition principle, the most reliable way to apply it is through its contrapositive:"
        ...
        {
          "type": "paragraph",
          "text": "All elements confirmed. Answer (D) is a clean contrapositive application."
        },
        {
          "type": "hr"
        },
