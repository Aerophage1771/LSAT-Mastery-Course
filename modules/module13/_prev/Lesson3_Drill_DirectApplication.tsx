...
export const Lesson3_Drill_DirectApplication: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: "A **Direct Application** is the most fundamental Principle-Apply pattern. In a direct application, the correct answer mirrors the principle's structure exactly: every condition in the principle is satisfied by the facts in the scenario, and the scenario reaches the same consequence the principle dictates. There is no contrapositive reasoning, no negation, no exception — just a clean, one-to-one structural match between the abstract rule and the concrete case.",
    },

    {
      type: 'paragraph',
      text: 'Direct applications are the most common Principle-Apply pattern and are often the easiest to solve — *if* you are systematic. The difficulty comes not from the logic (which is straightforward) but from the precision required: the LSAT constructs wrong answers that match the principle on every dimension except one. That one missed condition is usually the most subtle element of the rule: a qualifier about intent, a requirement about degree, or a specification about the purpose of an action.',
    },
    {
      type: 'paragraph',
      text: 'In the shared Principle-family vocabulary, the principle gives you the **trigger** and the **verdict**; each answer gives you **case facts**. Your task is to see whether the case facts bridge cleanly into the trigger so that the verdict follows with no extra assumptions.',
    },
...

    {
      type: 'callout',
      variant: 'default',
      title: 'Direct vs. Contrapositive Application',
      text: 'A direct application applies the principle forward: conditions are met → consequence follows. A contrapositive application applies the principle in reverse: consequence did NOT follow → at least one condition was NOT met. Both are logically valid, but direct applications are more common on the LSAT because they test straightforward matching rather than logical negation. This drill focuses exclusively on direct application.',
    },
    ...
    {
      type: 'paragraph',
      text: 'This drill demonstrates the direct application pattern using a principle with multiple conditions. Your job is to decompose the principle, build a checklist, and find the one answer that satisfies every item on that checklist.',
    },
    {
      type: 'paragraph',
...

    {
      ...
      difficulty: 'medium',
      stimulus:
        'Politician: Governments should tax any harmful substance that is available to the general public at a level that the tax would discourage continued use of the substance.',
    ...
    {
      type: 'paragraph',
      text: "The politician's statement is a single conditional rule. Let's translate it into a clear trigger -> verdict structure:",
    },
    {
      type: 'paragraph',
      text: '**Natural language:** "Governments should tax any harmful substance that is available to the general public at a level that the tax would discourage continued use of the substance."',
    },
    {
      type: 'paragraph',
      text: '**Conditional form:** IF [Substance is Harmful] AND [Substance is Available to the General Public] → THEN [Government Should Tax It at a Level That Discourages Use]',
    },
    {
      type: 'paragraph',
      text: 'This is a standard multi-condition rule with a specific consequence. The consequence is not just "tax it" — it specifies the *purpose* of the tax (to discourage use) and the *level* of the tax (sufficient to achieve that purpose). These details are critical.',
    },

    { type: 'h4', text: 'Step 2: List the Conditions' },
    { type: 'paragraph', text: "Let's extract each trigger and the verdict into an explicit checklist:" },
    {
      type: 'breakdown',
      labels: { title: 'Checklist Item', text: 'What to Look For in Each Answer' },
      items: [
        {
          title: 'Condition 1: The substance is harmful',
          text: 'The scenario must describe a substance that causes harm — to health, to the environment, to safety, etc. The harm must be established, not merely speculated.',
          badge: 'Required',
          badgeColor: 'blue',
        },
        {
          title: 'Condition 2: The substance is available to the general public',
          text: 'The substance must be publicly accessible — sold over the counter, commercially available, etc. A substance restricted to professionals or specific industries may not satisfy this condition.',
          badge: 'Required',
          badgeColor: 'blue',
        },
        {
          title: 'Consequence: The tax should discourage continued use',
          text: 'The tax must be levied for the specific purpose of reducing consumption. The goal is behavioral change — making people use less of the substance. A tax imposed for revenue, for research funding, or for any other purpose does not match.',
          badge: 'Required',
          badgeColor: 'indigo',
        },
      ],
    ...
    {
      type: 'table',
      headers: ['Answer', 'Harmful?', 'Public?', 'Tax to Discourage Use?', 'Verdict'],
      rows: [
    ...
    {
      type: 'paragraph',
      text: "Notice the pattern: **every wrong answer satisfies Conditions 1 and 2** (harmful and publicly available). The differentiator is always the consequence — the purpose and direction of the tax. This is typical of well-constructed Principle-Apply questions. The LSAT doesn't make it easy by having wrong answers fail on obvious conditions. Instead, every answer looks plausible on the surface, and the distinction is in the precise details of the consequence.",
    },
    ...
    { type: 'h3', text: 'Key Lessons from This Drill' },
    {
      ...
      variant: 'summary',
      title: 'Key Takeaways',
      text: '**1. Direct application means a one-to-one structural match.** The correct answer mirrors the principle exactly: same trigger satisfied, same verdict reached, same logical direction. No inference, no negation, no exception — just a clean match.\n\n**2. The verdict includes its purpose.** In this question, the principle doesn\'t just say "tax it" — it says "tax it to discourage use." The purpose is part of the verdict, and answers that satisfy the action (taxing) but not the purpose (discouraging use) are wrong. Always decompose the verdict fully.\n\n**3. The bridge lives in the case facts.** In this question, every wrong answer involved a harmful, publicly available substance. The differentiator was whether the case facts bridged to the correct verdict — specifically, the *goal* or *direction* of the tax. Don\'t stop checking once the trigger mostly matches.\n\n**4. "Discouraging use" can be expressed indirectly.** The correct answer (C) doesn\'t use the word "discourage." Instead, it says "give people an incentive to purchase" alternatives. Recognizing that incentivizing alternatives *is* discouraging use requires understanding the functional bridge — not just matching keywords.\n\n**5. Build the checklist before looking at answers.** If you had your three-item checklist (harmful + public + tax-to-discourage) firmly in mind before reading the answer choices, the correct answer would be immediately identifiable and every wrong answer would fail on a clear, specific criterion. The checklist approach transforms a subjective judgment into a mechanical process.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "diff-note",
          "text": "The opening two paragraphs both end with the same observation about subtle wrong answers ('violates a single easy-to-miss requirement' / 'the LSAT doesn't make it easy by having wrong answers fail on obvious conditions'). Consider merging into one paragraph to reduce redundancy.",
          "variant": "comment"
        },
        {
          "type": "h3",
          "text": "What Makes an Application \"Direct\""
        },
        {
          "type": "paragraph",
          "text": "In a direct application, the answer choice:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h3",
          "text": "Drill: Direct Application (PT-104-S-4-Q-1)"
        },
        {
          "type": "paragraph",
          "text": "This drill demonstrates the direct application pattern using a principle with multiple conditions. Your job is to decompose the principle, build a checklist, and find the one answer that satisfies every item on that checklist."
        ...
        {
          "type": "paragraph",
          "text": "The politician's statement is a single conditional rule. Let's translate it into a clear logical structure:"
        },
        {
          "type": "paragraph",
          "text": "**Natural language:** \"Governments should tax any harmful substance that is available to the general public at a level that the tax would discourage continued use of the substance.\""
        ...
        {
          "type": "paragraph",
          "text": "Let's extract each condition and the consequence into an explicit checklist:"
        },
        {
          "type": "breakdown",
          "labels": {
            "title": "Checklist Item",
            "text": "What to Look For in Each Answer"
          },
          "items": [
            {
              "title": "Condition 1: The substance is harmful",
        ...
        {
          "type": "paragraph",
          "text": "Now let's apply the checklist to each answer choice systematically."
        },
        {
          "type": "breakdown",
          "labels": {
        ...
        {
          "type": "paragraph",
          "text": "Re-read the principle and confirm that answer (C) satisfies every requirement:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "All three elements are satisfied. The answer is confirmed."
        },
        {
          "type": "hr"
        },
