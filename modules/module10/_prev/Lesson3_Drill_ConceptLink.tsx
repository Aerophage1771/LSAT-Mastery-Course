  ...
  content: [
    ...
    },
    {
      ...
      items: [
        {
          title:
            '"All known living things are made of the same basic kinds of matter, are carbon based, and are equipped with genetic codes."',
          text: 'This is the evidence. It lists three specific traits shared by all known living things (including humans):\n1. Same basic matter\n2. Carbon-based\n3. Genetic codes\n\nThese are **compositional** facts — they describe what living things are *made of* and how they are *structured*.',
        },
        {
          title: '"So human life has the same origin as all other known life."',
          text: 'This is the conclusion. The word "So" signals the logical leap. The conclusion introduces a brand-new concept: **"same origin."** This term was never mentioned in the premise. The author jumps from shared *composition* (what things are made of) to shared *origin* (where things came from).',
        },
      ],
    },
    ...
    },
    {
      ...
      text: 'The fastest way to find the gap in a Concept Link question is to ask: **"Which word in the conclusion is new?"** Here, "origin" is new. Every term in the premises (matter, carbon, genetic codes) relates to *composition*. The conclusion is about *origin*. The bridge must connect composition to origin.',
    },

    { type: 'h4', text: 'Step 3: Prephrase the Bridge' },
    {
      type: 'paragraph',
      text: 'To make the conclusion airtight, we need a rule that guarantees the jump from shared composition to shared origin. The prephrase:',
    },
    {
      type: 'paragraph',
      text: '***"To make the conclusion guaranteed, I need a rule that says: If two things share the same basic matter (or carbon base, or genetic codes), then they have the same origin."***',
    },
    ...
    {
      type: 'paragraph',
      text: 'We are looking for the answer that connects one of the compositional traits from the premises to the "same origin" concept in the conclusion.',
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          title: '(A) Without the existence of other life forms, human life would never have come into existence.',
          text: "This establishes a *dependency* — humans needed other life to exist. But dependency is not the same as shared origin. Two things can depend on each other without coming from the same source. A parasite depends on its host, but they don't share an origin. **Wrong concept — dependency ≠ origin.**",
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(B) There are not any living beings that have genetic codes but are not carbon based.',
          text: 'This connects two of the *premise* terms together (genetic codes and carbon base). It says these traits always co-occur. But both of these concepts are already in the premise — this answer reinforces the evidence without crossing the bridge to the *new* concept of "origin." **Stays within the premises — doesn\'t reach the conclusion.**',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(C) There can never be any living thing that does not have a genetic code.',
          text: "This just reinforces the universality of genetic codes. We already know all *known* living things have them. Making this universal doesn't help prove anything about where they came from. **Strengthens a premise without bridging the gap.**",
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(D) Many yet-to-be-discovered types of living things will also be carbon based.',
          text: 'The argument is strictly about *"all known living things."* Future discoveries are outside the scope of the argument. Furthermore, even if undiscovered life is also carbon-based, this still doesn\'t connect composition to origin. **Out of scope and wrong concept.**',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(E) Any two living things made of the same basic kinds of matter have the same origin.',
          text: 'This is the perfect bridge. It takes a compositional trait from the premise ("same basic kinds of matter") and links it directly to the rogue concept in the conclusion ("same origin").\n\n**Logic Check:**\n• Do humans and other known life share the same basic matter? **Yes** (from Premise).\n• Does this rule say same matter → same origin? **Yes** (from Answer E).\n• Therefore, do humans and other known life have the same origin? **Yes.** The conclusion is now 100% guaranteed. ✓\n\nNotice that the correct answer only needs to connect *one* of the three premise traits (matter, carbon, genetic codes) to the conclusion. It doesn\'t need to use all three — one bridge is sufficient.',
          badge: 'Correct',
          badgeColor: 'green',
        },
      ],
    ...
    {
      type: 'table',
      headers: ['Answer', 'What It Connects', 'Does It Reach "Origin"?'],
      rows: [
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "How to Spot a Concept Link Gap"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h3",
          "text": "Drill: The Concept Link (PT-120-S-1-Q-12)"
        },
        {
          "type": "h4",
          "text": "The Problem"
        ...
        {
          "type": "paragraph",
          "text": "{{+**Try this:** Before reading the analysis below, apply the Concept Link checklist. Find the rogue term in the conclusion, identify the bridge you need, and predict the correct answer.+}}"
        },
        {
          "type": "hr"
        },
        ...
        },
        {
          ...
          "items": [
            {
              "title": "\"All known living things are made of the same basic kinds of matter, are carbon based, and are equipped with genetic codes.\"",
              "text": "This is the evidence. It lists three specific traits shared by all known living things (including humans):\n1. Same basic matter\n2. Carbon-based\n3. Genetic codes\n\nThese are **compositional** facts — they describe what living things are *made of* and how they are *structured*."
            },
            {
              "title": "\"So human life has the same origin as all other known life.\"",
        ...
        {
          "type": "paragraph",
          "text": "In other words, we need a definitional bridge: **Same Composition → Same Origin.**"
        },
        {
          "type": "h4",
