...
export const Lesson5_Drill_BinaryAssumption: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Premise Structure', 'Conclusion', 'Gap (Third Option?)'],
      rows: [
        ['Defines "wrong" + shows item is not wrong', 'Item must be "right"', 'Could it be morally neutral?'],
        [
          'Defines "failure" + shows item is not a failure',
          'Item is a "success"',
          'Could it be neither success nor failure?',
        ],
    ...
    },
    {
      type: 'callout',
      variant: 'default',
      title: 'The Hidden Third Category',
    ...
    {
      type: 'paragraph',
      text: "This argument is dense with definitions. Let's deconstruct each statement into formal logic to see the structure clearly.",
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          title:
            '"An action is morally right if it would be reasonably expected to increase the aggregate well-being of the people affected by it."',
          text: 'This defines one path to being "morally right" — but it is a **one-way** definition.\n\n**Logic:** Increases Well-Being → Morally Right (IWB → MR)\n\n*Critical nuance:* "If" establishes a sufficient condition. Increasing well-being is *sufficient* for being right, but it may not be *necessary*. There could be other ways to be morally right that don\'t involve increasing well-being. The arrow only goes one direction.',
        },
        {
          title:
            '"An action is morally wrong if and only if it would be reasonably expected to reduce the aggregate well-being of the people affected by it."',
          text: 'This is a **two-way** definition of "morally wrong" — the phrase "if and only if" creates a biconditional.\n\n**Logic:** Morally Wrong ↔ Reduces Well-Being\n\nThis gives us two usable rules:\n• MW → RWB (If wrong, then reduces well-being)\n• RWB → MW (If reduces well-being, then wrong)\n\nAnd by contrapositive:\n• ~RWB → ~MW (If does NOT reduce well-being, then NOT wrong)',
        },
        {
          title:
            '"Thus, actions that would be reasonably expected to leave unchanged the aggregate well-being of the people affected by them are also right."',
          text: 'This is the conclusion. It introduces a third category of action: those with **unchanged well-being** (neutral actions). The philosopher concludes that these neutral actions are also "morally right."\n\n**Logic:** Unchanged Well-Being → Morally Right (UWB → MR)',
        },
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'The argument gets us to "not wrong" but then jumps to "right." The hidden assumption is that these are the only two categories — that there is no third option like "morally neutral" or "morally indeterminate." If a third category exists, an action could be "not wrong" without being "right," and the conclusion would fail.',
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'Diagramming Reveals the Gap',
      text: 'Notice how diagramming the conditionals made the gap crystal clear. We can trace the chain from UWB → ~RWB → ~MW, but there is no arrow from ~MW → MR. The correct answer must supply this missing arrow to complete the chain all the way to MR.',
    },

    { type: 'h4', text: 'Step 3: Prephrase the Bridge' },
    {
      type: 'paragraph',
      text: 'To guarantee the conclusion, we need a rule that eliminates the possibility of a "morally neutral" middle ground. We need:',
    },
    {
      type: 'paragraph',
      text: '***"To make the conclusion guaranteed, I need: If an action is not morally wrong, then it is morally right. (~MW → MR)"***',
    },
    {
      type: 'paragraph',
      text: 'This creates a strict binary: every action is either right or wrong, with no third option. Once we have this rule, the chain becomes: UWB → ~RWB → ~MW → MR. The conclusion follows with certainty.',
    },

    { type: 'h4', text: 'Step 4: Evaluate the Choices' },
    {
      type: 'paragraph',
      text: 'We are looking for the answer that establishes the strict "Right vs. Wrong" binary — the rule that ~MW → MR.',
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          title:
            '(A) Only wrong actions would be reasonably expected to reduce the aggregate well-being of the people affected by them.',
          text: '"Only wrong actions reduce well-being" translates to: RWB → MW (If reduces well-being, then wrong). But we already have this — it is one half of the biconditional from Premise 2. This answer **restates a premise** rather than bridging the gap. It tells us nothing about the relationship between "not wrong" and "right." **Redundant — adds nothing new.**',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(B) No action is both right and wrong.',
        ...
        {
          title: '(C) Any action that is not morally wrong is morally right.',
          text: 'This is the exact binary assumption we predicted: **~MW → MR.** It declares that there is no middle ground — if an action is not wrong, it must be right. No third category is possible.\n\n**Logic Check (complete chain):**\n1. A neutral action does not reduce well-being. (Definition)\n2. Does not reduce well-being → Not morally wrong. (Contrapositive of Premise 2)\n3. Not morally wrong → Morally right. (Answer C)\n4. **Therefore: neutral action → Morally right. ✓**\n\nThe conclusion is now 100% guaranteed.',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
    ...
    {
      type: 'table',
      headers: ['', 'Without Answer (C)', 'With Answer (C)'],
      rows: [
    ...
    {
      type: 'paragraph',
      text: 'Without Answer (C), neutral actions land in a logical limbo — proven to be "not wrong" but not proven to be "right." Answer (C) eliminates this limbo by collapsing the moral universe into a strict binary.',
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Drill: The Binary Assumption (PT-123-S-2-Q-23)"
        },
        {
          "type": "h4",
          "text": "The Problem"
        ...
        {
          "type": "paragraph",
          "text": "{{+**Try this:** This stimulus contains a biconditional (\"if and only if\"). Diagram all three definitions using arrows, then trace what we can prove about a neutral action. Find the point where the chain breaks before reading the analysis.+}}"
        },
        {
          "type": "h3",
          "text": "Full Analysis"
        ...
        },
        {
          ...
          "items": [
            {
              "title": "\"An action is morally right if it would be reasonably expected to increase the aggregate well-being of the people affected by it.\"",
              "text": "This defines one path to being \"morally right\" — but it is a **one-way** definition.\n\n**Logic:** Increases Well-Being → Morally Right (IWB → MR)\n\n*Critical nuance:* \"If\" establishes a sufficient condition. Increasing well-being is *sufficient* for being right, but it may not be *necessary*. There could be other ways to be morally right that don't involve increasing well-being. The arrow only goes one direction."
            },
            {
              "title": "\"An action is morally wrong if and only if it would be reasonably expected to reduce the aggregate well-being of the people affected by it.\"",
              "text": "This is a **two-way** definition of \"morally wrong\" — the phrase \"if and only if\" creates a biconditional.\n\n**Logic:** Morally Wrong ↔ Reduces Well-Being\n\nThis gives us two usable rules:\n• MW → RWB (If wrong, then reduces well-being)\n• RWB → MW (If reduces well-being, then wrong)\n\nAnd by contrapositive:\n• ~RWB → ~MW (If does NOT reduce well-being, then NOT wrong)"
            },
            {
              "title": "\"Thus, actions that would be reasonably expected to leave unchanged the aggregate well-being of the people affected by them are also right.\"",
              "text": "This is the conclusion. It introduces a third category of action: those with **unchanged well-being** (neutral actions). The philosopher concludes that these neutral actions are also \"morally right.\"\n\n**Logic:** Unchanged Well-Being → Morally Right (UWB → MR)"
            }
          ]
        },
        ...
        {
          "type": "paragraph",
          "text": "**Let's trace the logic for a \"neutral\" action (one with unchanged well-being):**"
        },
        {
          "type": "process",
          "title": "Logical Chain",
        ...
        },
        {
          ...
          "items": [
            {
              "title": "(A) Only wrong actions would be reasonably expected to reduce the aggregate well-being of the people affected by them.",
              "text": "\"Only wrong actions reduce well-being\" translates to: RWB → MW (If reduces well-being, then wrong). But we already have this — it is one half of the biconditional from Premise 2. This answer **restates a premise** rather than bridging the gap. It tells us nothing about the relationship between \"not wrong\" and \"right.\" **Redundant — adds nothing new.**",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            ...
            {
              "title": "(D) There are actions that would be reasonably expected to leave unchanged the aggregate well-being of the people affected by them.",
              "text": "This confirms that the category of \"neutral actions\" discussed in the conclusion actually *exists* — that there are real-world examples of such actions. But proving that a category exists tells us nothing about the *moral status* of actions in that category. We need to know whether neutral actions are right, not whether they exist. **Existence ≠ classification.**",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
        ...
        {
          "type": "h3",
          "text": "The Binary Structure Visualized"
        },
        {
          "type": "paragraph",
          "text": "Here is the logical landscape before and after the sufficient assumption:"
        },
        {
          "type": "table",
          "headers": ["", "Without Answer (C)", "With Answer (C)"],
