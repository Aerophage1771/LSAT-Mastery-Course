...
export const Lesson4_Drill_ExclusivityRule: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Premise Structure', 'Conclusion Structure', 'Gap'],
      rows: [
        [
          'Rules X and Y are the stated triggers',
          '"There is no reason at all"',
          'Could triggers Z, W, etc. exist outside the stated list?',
        ],
        [
          'Conditions A, B, and C are defined',
          '"It is impossible for this to occur"',
          'Could condition D (unstated) also cause it?',
        ],
        [
          'The policy lists three requirements',
          '"The policy does not apply"',
          'Could other policies or requirements also apply?',
        ],
      ],
    },
    {
      ...
      text: 'The core issue is always a **scope mismatch**: the premises are narrow (a specific list from a specific source), but the conclusion is broad (an absolute claim about all possibilities). The exclusivity rule closes this scope mismatch by declaring that the narrow list *is* the complete list. This transforms the narrow premise into a universal claim, making the absolute conclusion valid.',
    },
    ...
    {
      type: 'paragraph',
      text: "Let's trace the argument's logic piece by piece, paying close attention to the scope of each claim.",
    },
    {
      type: 'breakdown',
    ...
    {
      type: 'paragraph',
      text: '**What is the scope mismatch?**\nThe argument moves from a narrow premise to a broad conclusion:',
    },
    {
      type: 'table',
      headers: ['Premise Scope', 'Conclusion Scope'],
      rows: [
        [
          "Cecile does not need to disclose **according to the association's two rules**",
          'There is **no reason at all** for Cecile to disclose',
        ],
      ],
    },
    {
      type: 'paragraph',
      text: "The gap is the possibility that other reasons exist outside of the association's specific requirements. What if federal securities law requires disclosure for officers with stock holdings? What if a court order mandates it? What if professional ethics standards require it? The argument assumes the association's rules are the *only* rules that matter — but it never states this.",
    },

    { type: 'h4', text: 'Step 3: Prephrase the Bridge' },
    {
      type: 'paragraph',
      text: "To make the conclusion airtight, we must eliminate every possible reason for disclosure outside the association's rules. We need:",
    },
    {
      type: 'paragraph',
      text: '***"To make the conclusion guaranteed, I need a rule that says: The association\'s requirements are the ONLY reasons that could apply to Cecile."***',
    },
    {
      type: 'paragraph',
      text: 'This exclusivity statement would transform the narrow "association doesn\'t require it" into the broad "there is no reason at all."',
    },

    { type: 'h4', text: 'Step 4: Evaluate the Choices' },
    {
      type: 'paragraph',
      text: "We are looking for the answer that makes the association's list exhaustive — the only possible reasons for disclosure.",
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          title:
            '(A) Cecile will not be appointed to a position in the association that authorizes her to disburse funds.',
          text: 'The conclusion is about whether there is a reason to disclose **"at this time."** What might happen in the future is irrelevant to her current duties. Even without this assumption, we already know she currently doesn\'t disburse funds. This answer addresses a future scenario that the conclusion doesn\'t concern itself with. **Wrong timeframe.**',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: "(B) Cecile's office and her position on the timber business's board create no conflicts of interest.",
          text: "A conflict of interest might be a *good moral reason* for disclosure, but the argument is about whether a reason *exists that would require it*. More importantly, this answer still leaves open the possibility that other non-conflict-based reasons exist (e.g., legal requirements). It only eliminates one potential alternative reason while the conclusion claims there are *no* reasons. **Too narrow — doesn't achieve exclusivity.**",
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          ...
          text: "This is the **Exclusivity Rule**. It declares that the association's two-trigger list is the complete, exhaustive set of reasons that could ever require Cecile to disclose. No federal law, no state regulation, no ethics code, no other source — just the association's rules.\n\n**Logic Check:**\n• The association has two triggers (Premise 1).\n• Cecile activates neither trigger (Premise 2).\n• These are the only reasons that could apply (Answer C).\n• Therefore, there is **no reason** for Cecile to disclose. ✓\n\nThe conclusion follows with 100% certainty.",
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title: '(D) The timber business on whose board Cecile sits is owned by a petrochemical company.',
          text: 'This would actually **undermine** the conclusion. If the timber company is owned by a petrochemical company, there is an argument that Cecile effectively sits on the board of a petrochemical-affiliated entity, which could activate Trigger 2. This answer makes disclosure *more likely*, not less. **Wrong direction — this is a weakener.**',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(E) Cecile owns no investments in the petrochemical industry.',
          text: "The association's trigger is about sitting on the *board* of a petrochemical company, not about owning *investments* in the industry. Cecile already doesn't sit on a petrochemical board (she's on a timber board), so this information about her investment portfolio doesn't address either trigger. **Addresses the wrong rule condition.**",
          badge: 'Incorrect',
          badgeColor: 'red',
        },
      ],
    ...
    {
      type: 'process',
      title: 'How the Exclusivity Rule Closes the Gap',
      steps: [
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "How to Spot an Exclusivity Gap"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h3",
          "text": "Drill: The Exclusivity Rule (PT-122-S-2-Q-25)"
        },
        {
          "type": "h4",
          "text": "The Problem"
        ...
        {
          "type": "paragraph",
          "text": "{{+**Try this:** Before reading the analysis, identify the scope mismatch. What does the premise cover? What does the conclusion claim? What single statement would close the gap?+}}"
        },
        {
          "type": "h3",
          "text": "Full Analysis"
        ...
        },
        {
          ...
          "items": [
            {
              "title": "\"Cecile's association requires public disclosure of an officer's investments in two cases only: when an officer is authorized to disburse association funds, and when an officer sits on the board of a petrochemical company.\"",
              "text": "This is a rule from a specific source — the association. The phrase \"in two cases only\" is critical: it tells us the **complete list of triggers according to the association**. There are exactly two:\n\n**Trigger 1:** Officer is authorized to disburse funds → Must disclose.\n**Trigger 2:** Officer sits on petrochemical board → Must disclose.\n\nImportantly, this rule only covers what the *association* requires. It says nothing about federal law, state regulations, company bylaws, or other potential sources of disclosure obligations."
            },
            {
              "title": "\"Cecile, an officer who is not authorized to disburse funds, sits on the board of just one company, a small timber business.\"",
              "text": "This applies the association's rules to Cecile specifically:\n\n• **Trigger 1 check:** Does she disburse funds? **No** — she is \"not authorized.\"\n• **Trigger 2 check:** Does she sit on a petrochemical board? **No** — she sits on a *timber* board.\n\nSo according to the association's rules, neither trigger is activated. The association does not require Cecile to disclose."
            },
            {
              "title": "\"Therefore, there is no reason for Cecile to publicly disclose her investments at this time.\"",
        ...
        },
        {
          ...
          "items": [
            {
              "title": "(A) Cecile will not be appointed to a position in the association that authorizes her to disburse funds.",
              "text": "The conclusion is about whether there is a reason to disclose **\"at this time.\"** What might happen in the future is irrelevant to her current duties. Even without this assumption, we already know she currently doesn't disburse funds. This answer addresses a future scenario that the conclusion doesn't concern itself with. **Wrong timeframe.**",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            ...
            {
              "title": "(C) The association's requirements provide the only reasons there might be for Cecile to disclose her investments.",
              "text": "This is the **Exclusivity Rule**. It declares that the association's two-trigger list is the complete, exhaustive set of reasons that could ever require Cecile to disclose. No federal law, no state regulation, no ethics code, no other source — just the association's rules.\n\n**Logic Check:**\n• The association has two triggers (Premise 1).\n• Cecile activates neither trigger (Premise 2).\n• These are the only reasons that could apply (Answer C).\n• Therefore, there is **no reason** for Cecile to disclose. ✓\n\nThe conclusion follows with 100% certainty.",
              "badge": "Correct",
              "badgeColor": "green"
            },
        ...
        {
          "type": "h3",
          "text": "The Exclusivity Pattern in Action"
        },
        {
          "type": "paragraph",
          "text": "Here is the logical structure laid bare:"
        },
        {
          "type": "process",
          "title": "How the Exclusivity Rule Closes the Gap",
