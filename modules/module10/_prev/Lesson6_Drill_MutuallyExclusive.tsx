...
export const Lesson6_Drill_MutuallyExclusive: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Premise Structure', 'Conclusion', 'Gap (Overlap Possible?)'],
      rows: [
        [
          'Item belongs to "great dramatic novels"',
          '"Science fiction" label is inappropriate',
          'Could a novel be both a great dramatic novel and science fiction?',
        ],
        [
          'Item qualifies as "educational"',
          'Item is not "entertainment"',
          'Could something be both educational and entertaining?',
        ],
        [
          'Action is "legally permitted"',
          'Action is not "morally wrong"',
          'Could something be both legal and morally wrong?',
        ],
      ],
    },
    {
    ...
    {
      type: 'paragraph',
      text: "This argument is rich with rhetorical language. Let's strip it down to its logical bones, identifying each piece of the reasoning.",
    },
    {
      type: 'breakdown',
      labels: { title: 'Statement', text: 'Analysis' },
      items: [
        {
          title:
            '"H. G. Wells\'s great dramatic novel The Time Machine is classified as science fiction simply because it takes place in the future."',
          text: 'This gives us the setup. Two important facts:\n1. The book is a **"great dramatic novel"** — the author accepts this classification.\n2. Others have classified it as **"science fiction"** — this is the classification the author plans to attack.\n\nThe phrase "simply because it takes place in the future" is dismissive — the author thinks this is an insufficient reason for the science fiction label.',
        },
        {
          title: '"But this classification is inappropriate..."',
          text: 'This is the **main conclusion**. The word "But" signals opposition. The author asserts that calling *The Time Machine* "science fiction" is **wrong** — the classification doesn\'t fit.',
        },
        {
          title:
            '"...because Wells\'s book possesses something that great dramatic novels have and science fiction generally lacks —"',
          text: 'This begins the evidence. The author is drawing a contrast between two categories:\n• Great dramatic novels → **have** this quality.\n• Science fiction → **generally lacks** this quality.\n\nThe word **"generally"** is a critical weakness. It means science fiction *usually* lacks this quality but *not always*. There could be exceptions.',
        },
        {
          title:
            '"— compelling characters that enable the reader to become absorbed in their plight and not just in the author\'s representation of the future of technology."',
          text: "The specific quality is **compelling characters**. The author's evidence is:\n• *The Time Machine* has compelling characters.\n• Great dramatic novels have compelling characters.\n• Science fiction generally lacks compelling characters.\n\nTherefore (the author concludes), since *The Time Machine* has the quality of great dramatic novels and lacks the typical quality of science fiction... it isn't science fiction.",
        },
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'The second vulnerability is the **key gap** that can be closed by a single premise. Even if some science fiction has compelling characters, the argument works if we simply declare that the two categories cannot overlap.',
    },

    { type: 'h4', text: 'Step 3: Prephrase the Bridge' },
    {
      type: 'paragraph',
      text: 'To make the conclusion airtight, we need a rule that makes the two categories mutually exclusive. We need:',
    },
    {
      type: 'paragraph',
      text: '***"To make the conclusion guaranteed, I need: A great dramatic novel cannot also be science fiction (or equivalently: nothing can be both a great dramatic novel and science fiction)."***',
    },
    {
      type: 'paragraph',
      text: 'With this rule in place, the moment we establish that *The Time Machine* is a "great dramatic novel," it automatically cannot be "science fiction." The conclusion follows immediately.',
    },

    { type: 'h4', text: 'Step 4: Evaluate the Choices' },
    {
      type: 'paragraph',
      text: 'We are looking for the answer that declares the two genre categories cannot overlap — that membership in one excludes membership in the other.',
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          ...
          text: 'This links the presence of characters to the "great dramatic novel" label — but it does not separate great dramatic novels from science fiction. Under this rule, a science fiction novel with compelling characters would *also* qualify as a great dramatic novel. But it could still be *both*. The overlap between the two categories remains open. **Connects characters to dramatic novels but doesn\'t exclude science fiction.**',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(B) Novels can always be clearly classified into distinct genres.',
          text: 'This is far too broad and vague. Even if novels *can* be classified into distinct genres, it doesn\'t tell us *which* genres are distinct from which. It provides no specific rule about the relationship between "great dramatic novels" and "science fiction." **Too general — provides no specific bridge.**',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(C) A work of science fiction cannot achieve greatness unless it contains compelling characters.',
          text: 'This tells us what a science fiction book needs to be "great" — but the conclusion is about whether *The Time Machine* should be classified as science fiction at all. Whether science fiction books need good characters to be great is a separate question from whether a great dramatic novel can be science fiction. **Addresses quality within a genre, not genre classification.**',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: "(D) The most important determinant of a novel's quality is the strength of its characters.",
          text: 'The argument is about **classification** (which genre does the book belong to?), not about **quality** (how good is the book?). A rule about what determines quality is irrelevant to a question about genre boundaries. **Wrong concept entirely — quality ≠ classification.**',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(E) A dramatic novel cannot both be great and belong to the genre of science fiction.',
          text: 'This is the mutual exclusivity rule we predicted. It declares that the two categories cannot overlap: if a dramatic novel is great, it cannot be science fiction.\n\n**Logic Check:**\n1. *The Time Machine* is a great dramatic novel. (Stated in premises)\n2. A dramatic novel cannot both be great and belong to science fiction. (Answer E)\n3. Therefore, *The Time Machine* cannot belong to science fiction — the classification is inappropriate. ✓\n\nNotice that this answer is precisely targeted. It doesn\'t say *no* novel can be both dramatic and science fiction — it says a dramatic novel that is also *great* cannot be. This matches the specific claim in the premise that the book is a *"great* dramatic novel."',
          badge: 'Correct',
          badgeColor: 'green',
        },
      ],
    ...
    {
      type: 'paragraph',
      text: "A common concern with this argument is the word \"generally\" — if science fiction only *generally* lacks compelling characters, doesn't that leave room for exceptions? The answer is: **yes, but it doesn't matter once we have Answer (E).** Here's why:",
    },
    {
      type: 'paragraph',
      text: 'Answer (E) does not rely on the "generally lacks compelling characters" evidence at all. It works through a completely different logical path:',
    },
    {
      type: 'process',
      title: 'How Answer (E) Bypasses the "Generally" Problem',
      steps: [
    ...
    {
      type: 'paragraph',
      text: 'The "compelling characters" evidence and the "generally lacks" qualifier are both irrelevant once Answer (E) is in place. The conclusion follows from the book\'s status as a great dramatic novel alone, without needing any argument about character quality.',
    },
    ...
    {
      type: 'paragraph',
      text: "Compare the structure of this lesson's pattern (Mutually Exclusive) with the previous lesson's pattern (Binary Assumption):",
    },
    {
      type: 'table',
      headers: ['Feature', 'Binary Assumption (Lesson 5)', 'Mutually Exclusive (Lesson 6)'],
      rows: [
        ['Direction of the leap', 'From "not A" to "must be B"', 'From "is A" to "cannot be B"'],
        [
          'What the argument assumes',
          'A and B are **exhaustive** (no third option)',
          'A and B are **exclusive** (no overlap)',
        ],
        [
          'What the correct answer provides',
          '"If not A, then B" (closes the gap)',
          '"If A, then not B" (prevents overlap)',
        ],
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Mutually Exclusive Categories"
        },
        {
          "type": "paragraph",
          "text": "The Mutually Exclusive Categories pattern appears when an argument proves that something belongs to Category A and then concludes it cannot belong to Category B. The logical leap is the assumption that being in one category automatically excludes membership in the other — that the two categories cannot overlap. This is only valid if the categories are genuinely mutually exclusive."
        ...
        {
          "type": "h3",
          "text": "How to Spot a Mutual Exclusivity Gap"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h3",
          "text": "Drill: Mutually Exclusive Categories (PT-128-S-2-Q-15)"
        },
        {
          "type": "h4",
          "text": "The Problem"
        ...
        {
          "type": "paragraph",
          "text": "{{+**Try this:** Identify what Category A the book is placed in and what Category B the argument claims it cannot belong to. Ask: what rule would make those two categories mutually exclusive?+}}"
        },
        {
          "type": "h3",
          "text": "Full Analysis"
        ...
        },
        {
          ...
          "items": [
            {
              "title": "\"H. G. Wells's great dramatic novel The Time Machine is classified as science fiction simply because it takes place in the future.\"",
              "text": "This gives us the setup. Two important facts:\n1. The book is a **\"great dramatic novel\"** — the author accepts this classification.\n2. Others have classified it as **\"science fiction\"** — this is the classification the author plans to attack.\n\nThe phrase \"simply because it takes place in the future\" is dismissive — the author thinks this is an insufficient reason for the science fiction label."
            },
            {
              "title": "\"But this classification is inappropriate...\"",
            ...
            {
              "title": "\"...because Wells's book possesses something that great dramatic novels have and science fiction generally lacks —\"",
              "text": "This begins the evidence. The author is drawing a contrast between two categories:\n• Great dramatic novels → **have** this quality.\n• Science fiction → **generally lacks** this quality.\n\nThe word **\"generally\"** is a critical weakness. It means science fiction *usually* lacks this quality but *not always*. There could be exceptions."
            },
            {
              "title": "\"— compelling characters that enable the reader to become absorbed in their plight and not just in the author's representation of the future of technology.\"",
              "text": "The specific quality is **compelling characters**. The author's evidence is:\n• *The Time Machine* has compelling characters.\n• Great dramatic novels have compelling characters.\n• Science fiction generally lacks compelling characters.\n\nTherefore (the author concludes), since *The Time Machine* has the quality of great dramatic novels and lacks the typical quality of science fiction... it isn't science fiction."
            }
          ]
        },
        ...
        {
          "type": "h3",
          "text": "Why the \"Generally\" Qualifier Doesn't Matter"
        },
        {
          "type": "paragraph",
          "text": "A common concern with this argument is the word \"generally\" — if science fiction only *generally* lacks compelling characters, doesn't that leave room for exceptions? The answer is: **yes, but it doesn't matter once we have Answer (E).** Here's why:"
        ...
        {
          "type": "h3",
          "text": "Binary vs. Mutually Exclusive: Side-by-Side Comparison"
        },
        {
          "type": "paragraph",
          "text": "Compare the structure of this lesson's pattern (Mutually Exclusive) with the previous lesson's pattern (Binary Assumption):"
