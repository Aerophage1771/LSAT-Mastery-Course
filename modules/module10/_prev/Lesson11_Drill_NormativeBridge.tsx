...
export const Lesson11_Drill_NormativeBridge: Lesson = {
  ...
  content: [
...

    {
      type: 'callout',
      variant: 'tip',
      title: 'Fact → Judgment = Normative Bridge',
      text: 'Whenever you see an argument that says "X is impossible, therefore X is a bad goal" or "Y cannot be done perfectly, therefore Y should not be attempted," you are looking at a Normative Bridge gap. The missing assumption is always the rule that links impossibility to inappropriateness.',
    },

    {
      type: 'table',
      headers: ['Component', 'Example'],
      rows: [
    ...
    {
      type: 'paragraph',
      text: 'Separate the descriptive claims from the normative conclusion to expose the logical leap.',
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          title:
            'Some theorists argue that literary critics should strive to be value-neutral in their literary criticism.',
          text: 'The position under attack. Certain theorists hold a *normative* view: critics *should* be value-neutral.',
        },
        {
          title:
          ...
          text: "The theorists' reasoning. This explains *why* they hold their view — it gives their justification.",
        },
        {
          title: 'But literary criticism cannot be completely value-neutral.',
          text: '**Key evidence (descriptive fact).** The author states that the goal is *impossible* to fully achieve.',
        },
        {
          title: 'Thus, some theorists are mistaken about what is an appropriate goal for literary criticism.',
          text: '**Conclusion (normative judgment).** The author uses the impossibility to declare the goal *inappropriate* — a value judgment about what critics should aim for.',
        },
      ],
    },
      ...
      items: [
        {
          title:
            "(A) Any critic who is able to help readers make their own judgments about literary works' merits should strive to produce value-neutral criticism.",
          text: 'This *supports* the theorists — it says critics should be value-neutral. The author is trying to *refute* the theorists, so an answer that agrees with them goes in the wrong direction entirely.',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
        ...
        },
        {
          title:
            '(C) Critics are more likely to provide criticisms of the works they like than to provide criticisms of the works they dislike.',
          text: 'This gives more detail about *why* critics cannot be neutral, but it does not bridge the gap between "cannot be neutral" and "should not try to be neutral." It adds facts without providing the normative rule.',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title:
            "(D) The less readers understand the meaning of a literary work, the less capable they will be of evaluating that work's merits.",
          text: "This actually supports the theorists' rationale (critics should help readers understand, which helps readers evaluate). It gives a reason in favor of the goal, not against it.",
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title:
            "(E) Critics who try to avoid rendering value judgments about the works they consider tend to influence readers' judgments less than other critics do.",
          text: 'This compares different types of critics but does not address whether the goal of value-neutrality is *appropriate* or *mistaken*. It is an interesting observation that does not fix the logical gap.',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
      ],
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "The Normative Bridge Pattern"
        },
        {
          "type": "paragraph",
          "text": "The Normative Bridge pattern occurs when an argument moves from **descriptive facts** (what *is* the case) to a **normative conclusion** (what *should* be the case). The premises establish that something is impossible, impractical, or limited. The conclusion then makes a value judgment — declaring that a goal is wrong, a practice is inappropriate, or a standard should be abandoned."
        ...
        {
          "type": "paragraph",
          "text": "{{+**Try this:** The key leap is from a factual claim (value-neutrality is impossible) to a normative verdict (the theorists are mistaken). What rule would make this leap logically guaranteed? Prephrase: \"If X is impossible, then...\"{{+}}"
        },
        {
          "type": "h3",
        ...
        },
        {
          ...
          "items": [
            {
              "title": "Some theorists argue that literary critics should strive to be value-neutral in their literary criticism.",
              "text": "The position under attack. Certain theorists hold a *normative* view: critics *should* be value-neutral."
            },
            {
              "title": "These theorists maintain that by exposing the meaning of literary works without evaluating them, critics will enable readers to make their own judgments about the works' merits.",
              "text": "The theorists' reasoning. This explains *why* they hold their view — it gives their justification."
            },
            {
              "title": "But literary criticism cannot be completely value-neutral.",
        ...
        {
          "type": "paragraph",
          "text": "We need a rule that explicitly connects impossibility to inappropriateness:"
        },
        {
          "type": "list",
          "items": [
        ...
        },
        {
          ...
          "items": [
            {
              "title": "(A) Any critic who is able to help readers make their own judgments about literary works' merits should strive to produce value-neutral criticism.",
              "text": "This *supports* the theorists — it says critics should be value-neutral. The author is trying to *refute* the theorists, so an answer that agrees with them goes in the wrong direction entirely.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) If it is impossible to produce completely value-neutral literary criticism, then critics should not even try to be value-neutral.",
              "text": "This is the exact Normative Bridge: **Impossible → Should not try.**\n\n**Logic Check:** The author established that complete value-neutrality is impossible. This rule says that if it is impossible, critics should not even try. Therefore, the theorists (who say critics *should* try) are mistaken about what is an appropriate goal. The conclusion follows with certainty.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(C) Critics are more likely to provide criticisms of the works they like than to provide criticisms of the works they dislike.",
              "text": "This gives more detail about *why* critics cannot be neutral, but it does not bridge the gap between \"cannot be neutral\" and \"should not try to be neutral.\" It adds facts without providing the normative rule.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) The less readers understand the meaning of a literary work, the less capable they will be of evaluating that work's merits.",
              "text": "This actually supports the theorists' rationale (critics should help readers understand, which helps readers evaluate). It gives a reason in favor of the goal, not against it.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) Critics who try to avoid rendering value judgments about the works they consider tend to influence readers' judgments less than other critics do.",
              "text": "This compares different types of critics but does not address whether the goal of value-neutrality is *appropriate* or *mistaken*. It is an interesting observation that does not fix the logical gap.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
