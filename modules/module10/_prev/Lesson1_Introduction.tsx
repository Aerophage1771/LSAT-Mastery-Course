...
export const Lesson1_Introduction: Lesson = {
  ...
  questionPolicy: 'none',
  content: [
    { type: 'h2', text: 'MODULE 11: Sufficient Assumption' },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Sufficient Assumption (SA) is one of the **most challenging but most learnable** question types on the LSAT. It appears roughly once per scored Logical Reasoning section — sometimes twice — and it consistently ranks among the hardest questions students encounter. The difficulty is not random; SA questions demand a precise, almost mathematical form of reasoning that rewards careful analysis over intuition.',
    },
    {
      type: 'paragraph',
      text: 'The payoff for mastering SA questions extends far beyond the questions themselves. The skills you build here — identifying logical gaps, diagramming conditional relationships, and testing whether an answer *guarantees* a conclusion — directly transfer to Necessary Assumption, Parallel Reasoning, and even some Flaw questions. SA is one of the best investments you can make in your Logical Reasoning score.',
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'Frequency & Difficulty',
      text: 'Expect **1\u20132 Sufficient Assumption questions per scored section**. They tend to appear in the second half of the section (questions 15\u201325), where difficulty is highest. Because most test-takers struggle with these, getting them right provides a significant scoring advantage over the competition.',
    },
    ...
    },
    {
      ...
      rows: [
        [
          ...
          '"**follows logically**" \u2014 demands certainty',
        ],
        [
          '"Which one of the following, if assumed, enables the conclusion to be properly drawn?"',
          '"**properly drawn**" \u2014 the conclusion must be valid',
        ],
        [
          '"The conclusion is properly inferred if which one of the following is assumed?"',
          '"**properly inferred**" \u2014 logical deduction, not probability',
        ],
        [
          '"Which one of the following principles, if valid, most helps to justify the reasoning above?"',
          '"**justify the reasoning**" \u2014 close the logical gap',
        ],
        [
          '"Which one of the following, if assumed, allows the conclusion above to be properly inferred?"',
          '"**allows ... properly inferred**" \u2014 makes the logic work',
        ],
      ],
    },
    {
    ...
    {
      type: 'paragraph',
      text: 'The argument reverses a conditional: it knows Completes Program \u2192 Eligible, but concludes Eligible \u2192 Completed Program. The sufficient assumption that closes the gap is the reverse link: *Only people who completed the program are eligible.* Once that bridge is in place, the conclusion is guaranteed.',
    },
    ...
    {
      type: 'paragraph',
      text: 'This module walks you through Sufficient Assumption in a structured sequence:',
    },
    {
      type: 'list',
      items: [
        '**Foundations** \u2014 SA vs. Necessary Assumption, the logical gap, and the eight recurring SA patterns.',
        '**Step-by-Step Guide** \u2014 A repeatable process for attacking any SA question.',
        '**Drills** \u2014 Pattern-specific practice on Concept Links, Exclusivity Rules, Binary Assumptions, Mutually Exclusive Categories, General Principles, Conditional Chains, Either/Or Bridges, and Normative Bridges.',
        '**Reference Guide** \u2014 A compact cheat sheet for review.',
      ],
    },

    {
      ...
      variant: 'summary',
      title: 'Key Takeaway',
      text: 'The defining test of a Sufficient Assumption answer is absolute: **Premises + Correct Answer = Conclusion is 100% guaranteed.** If you can imagine any scenario where the premises and the answer are true but the conclusion is still false, the answer is not sufficient. SA answers tend to be strong, broad statements \u2014 don\'t shy away from answers that seem "too strong."',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "MODULE 10: Sufficient Assumption"
        },
        {
          "type": "paragraph",
          "text": "**Question Goal**\n\n**Identify an unstated premise that, if added to the argument, would make the conclusion 100% logically certain.** In other words, which statement perfectly fixes the current gap between the evidence and the conclusion? Unlike a Strengthen answer (which only needs to make the conclusion *more likely*), a Sufficient Assumption answer must make the conclusion *guaranteed* — airtight, bulletproof, logically valid."
        ...
        {
          "type": "h2",
          "text": "Sufficient Assumption vs. Necessary Assumption"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "paragraph",
          "text": "The gap typically takes one of these forms:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "diff-note",
          "text": "HIGH PRIORITY: This worked example should be converted to a question-card with five answer choices so students can attempt it before reading the analysis. The current format presents analysis immediately without any pause for independent practice.",
          "variant": "change"
        },
        {
          "type": "paragraph",
          "text": "{{+**Try this:** Before reading the walkthrough below, identify: (1) the conclusion, (2) the logical gap, and (3) what rule would make the conclusion 100% guaranteed.+}}"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h4",
          "text": "Step 4: Confirm the Missing Rule"
        },
        {
          "type": "paragraph",
