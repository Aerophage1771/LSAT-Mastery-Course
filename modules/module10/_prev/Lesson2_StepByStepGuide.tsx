...
export const Lesson2_StepByStepGuide: Lesson = {
  id: '10-2',
  title: 'Step-by-Step: Sufficient Assumption',
  questionPolicy: 'none',
  content: [
    { type: 'h2', text: 'Step-by-Step: Sufficient Assumption' },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'Your first move is always to identify the building blocks of the argument. Read the stimulus carefully and isolate two parts:',
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Pay especially close attention to the **specific terms** used in the premises versus the conclusion. SA questions often hinge on one or two words that appear in the conclusion but not in the premises (or vice versa). These mismatched terms are the key to spotting the gap.',
    },
    ...
    {
      type: 'paragraph',
      text: 'Once the parts are identified, translate the argument into a clearer logical form. For SA questions, this step is more important than for any other question type because the correct answer must be *logically precise*.',
    },

    { type: 'h3', text: 'The Conditional Diagramming Technique' },
    {
      type: 'paragraph',
      text: 'Many SA questions involve conditional logic — statements using "if," "only if," "all," "every," "no," "unless," "requires," or "must." When you spot these keywords, diagram the relationships using arrows:',
    },
    {
      type: 'table',
      headers: ['Statement', 'Diagram', 'Translation'],
      rows: [
    ...
    {
      type: 'paragraph',
      text: 'Once you have diagrammed the premises and the conclusion, look for a **break in the chain**. If the premises give you A → B and C → D, but the conclusion requires A → D, then the missing link is B → C. The correct answer will supply this link.',
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'When to Diagram',
      text: 'Diagram whenever the argument contains two or more conditional statements. If the argument is non-conditional (e.g., it relies on a conceptual gap or a general principle), diagramming may not be necessary — use conceptual analysis instead. About **60–70%** of SA questions benefit from diagramming; the rest are better handled by identifying the conceptual gap directly.',
    },

    { type: 'h3', text: 'Identifying the Gap' },
    {
      type: 'paragraph',
      text: 'With the reasoning clearly laid out (diagrammed or paraphrased), pinpoint the disconnect. Ask yourself:',
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Before looking at the answer choices, articulate what the correct answer must do. SA questions are highly prephrasable — the gap is structural, not ambiguous. Complete this sentence:',
    },
    { type: 'paragraph', text: '***"To make the conclusion guaranteed, I need a rule that says..."***' },
    {
      type: 'paragraph',
      text: 'Your prephrase should be a clear, specific statement. Unlike Strengthen questions (where the prephrase can be directional), an SA prephrase should be close to an exact logical statement.',
    },
    ...
    { type: 'h4', text: 'High-Difficulty Heuristics' },
    {
      type: 'table',
      headers: ['Heuristic', 'What It Means In Practice'],
      rows: [
        [
          '**Trigger the rule already on the page**',
          'If the stimulus already gives the governing rule, do not hunt for a bigger principle. Look for the one missing fact that makes the case satisfy that rule.',
        ],
        [
          '**In causal SA, guarantee the stated causal link**',
          'A causal answer must do more than make the conclusion sound reasonable. It usually certifies the needed cause, activates the stated condition, or completes the causal chain the stimulus already sketches.',
        ],
        [
          '**When the conclusion drops an "if," activate the condition**',
          'If a premise says "if the study data are correct, then..." but the conclusion states the result unconditionally, the correct answer may simply assert that the condition is met.',
        ],
        [
          '**Prefer the narrowest complete bridge over a sweeping rewrite**',
          'SA answers are often strong, but the best one usually adds exactly the missing link rather than rewriting the whole argument in broader language.',
        ],
      ],
    },

    {
      type: 'callout',
      variant: 'default',
      title: 'Prephrase Precision Matters',
      text: 'On SA questions, your prephrase should be **as specific as possible**. On Strengthen questions, a directional prephrase ("something that rules out alternative causes") is fine. On SA questions, aim for a concrete logical statement ("B → C"). The more precise your prephrase, the faster you will identify the correct answer — and the less likely you are to fall for a trap that addresses the right topic but gets the logical direction wrong.',
    },
    ...
    {
      type: 'paragraph',
      text: 'Scan the five choices looking for one that matches your prephrase. For each candidate, mentally insert it as a new premise and run the **Sufficient Assumption Equation**:',
    },
    { type: 'paragraph', text: '**Premises + This Answer = Is the conclusion 100% guaranteed?**' },
    {
      type: 'paragraph',
      text: 'If yes, you have found the correct answer. If no — if you can imagine any scenario where the premises and the answer are true but the conclusion is still false — eliminate the choice and move on.',
    },

    { type: 'h3', text: 'Common Wrong Answer Patterns' },
    {
      type: 'paragraph',
      text: 'Wrong answers on SA questions fail in predictable ways. Recognizing these traps lets you eliminate quickly and with confidence.',
    },
    {
      type: 'table',
      ...
      rows: [
        [
          '**Mistaken Reversal**',
          'Uses the correct terms but connects them in the wrong logical direction. You need A → B, but the answer gives B → A.',
          'Diagram both the answer and the needed bridge. If the arrows point the wrong way, eliminate. This is the **#1 most common trap** on SA questions.',
        ],
        [
          '**Mistaken Negation**',
          'Negates both sides of the needed conditional. You need A → B, but the answer gives ~A → ~B.',
          'Check the polarity of each term. If the answer negates the terms you need, it is logically invalid.',
        ],
        [
          '**The Restatement**',
          'Simply paraphrases a premise or restates something already derivable from the premises. Adds nothing new.',
          'Ask: "Does this tell me something I didn\'t already know from the stimulus?" If not, it cannot bridge the gap.',
        ],
        [
          '**Necessary but Not Sufficient**',
          'Provides a statement that is probably required for the conclusion but is too weak to guarantee it. Uses hedging words like "some," "can," or "sometimes."',
          'Check the strength: does the answer close the gap *completely*, or does it just narrow it? If it merely helps, it belongs on a Strengthen question, not an SA question.',
        ],
        [
          '**Out of Scope**',
          'Introduces a concept that is irrelevant to the core logical structure of the argument.',
          'Check: does this answer connect the *specific* terms in the premises to the *specific* terms in the conclusion? If it addresses a different topic entirely, eliminate.',
        ],
      ],
    },
    ...
    {
      type: 'paragraph',
      text: "Let's apply all four steps to a complete Sufficient Assumption question from start to finish.",
    },
    { type: 'paragraph', text: 'Consider this illustrative argument:' },
    {
      type: 'blockquote',
      text: '"A restaurant critic should not review any restaurant in which the critic has a financial interest. Girard, a prominent food writer, owns stock in the company that operates Café Lumière. Therefore, Girard should not review Café Lumière."',
    },
    {
      type: 'paragraph',
      text: 'This example is helpful because it forces you to separate two possible gaps: whether Girard counts as a critic, and whether stock ownership counts as a financial interest in the restaurant.',
    },
    ...
    { type: 'h3', text: 'Why One Gap Matters Most' },
    {
      type: 'callout',
      variant: 'default',
      title: 'Final Check',
      text: 'A sufficient assumption can close any gap that is genuinely blocking the conclusion, but it has to close one completely. In this setup, the most direct repair is to make Girard fall inside the class governed by the rule. Once he counts as a critic, the remaining premise about stock ownership naturally triggers the financial-interest language. Facts about his past reviews, his disclosure practices, or the ethics of biased reviews still do not force the conclusion.',
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "The 4-Step Method for Sufficient Assumption Questions"
        },
        {
          "type": "paragraph",
          "text": "This lesson provides a complete, repeatable method for solving any Sufficient Assumption question. The goal is the same every time: understand the author's argument, find the logical gap, and find the one answer choice that, when added as a new premise, makes the conclusion 100% certain. Each step below includes concrete guidance, tips for tricky situations, and key insights."
        ...
        {
          "type": "h2",
          "text": "Step 2: Diagram and Identify the Gap"
        },
        {
          "type": "paragraph",
          "text": "Once the parts are identified, translate the argument into a clearer logical form. For SA questions, this step is more important than for any other question type because the correct answer must be *logically precise*."
        ...
        {
          "type": "h3",
          "text": "The Conditional Diagramming Technique"
        },
        {
          "type": "paragraph",
          "text": "Many SA questions involve conditional logic — statements using \"if,\" \"only if,\" \"all,\" \"every,\" \"no,\" \"unless,\" \"requires,\" or \"must.\" When you spot these keywords, diagram the relationships using arrows:"
        ...
        {
          "type": "paragraph",
          "text": "***\"To make the conclusion guaranteed, I need a rule that says...\"***"
        },
        {
          "type": "paragraph",
          "text": "Your prephrase should be a clear, specific statement. Unlike Strengthen questions (where the prephrase can be directional), an SA prephrase should be close to an exact logical statement."
        ...
        {
          "type": "paragraph",
          "text": "**Premises + This Answer = Is the conclusion 100% guaranteed?**"
        },
        {
          "type": "paragraph",
          "text": "If yes, you have found the correct answer. If no — if you can imagine any scenario where the premises and the answer are true but the conclusion is still false — eliminate the choice and move on."
        ...
        {
          "type": "diff-note",
          "text": "HIGH PRIORITY: This worked example should become a full question-card with five answer choices so students can attempt it before reading the analysis. The current format walks through all four steps without any interactive component — the student has nothing to try. The Step 4 walkthrough currently ends without showing or resolving any answer choices, which is a pedagogical dead end.",
          "variant": "change"
        },
        {
          "type": "paragraph",
          "text": "{{+**Try this:** Before reading the walkthrough below, apply all four steps yourself. What is the conclusion? Where is the gap? What would the correct answer need to say?+}}"
        },
        {
          "type": "paragraph",
          "text": "This example is helpful because it forces you to separate two possible gaps: whether Girard counts as a critic, and whether stock ownership counts as a financial interest in the restaurant."
        ...
        {
          "type": "diff-note",
          "text": "The analysis ends here without resolving Step 4 — no answer choices are shown and no correct answer is identified. This leaves students without a model for what the correct answer looks like. Either add five answer choices and complete the analysis, or add a sentence summarizing what the correct answer would state.",
          "variant": "comment"
        },
        {
          "type": "hr"
        },
        {
          ...
          "title": "Key Takeaways",
          "variant": "summary",
          "text": "The 4-Step Method gives you a reliable, repeatable process: **Break Down → Diagram/Find the Gap → Prephrase → Evaluate.**\n\nDiagram conditional relationships whenever they appear. Most SA questions involve at least one conditional statement, and the correct answer almost always supplies a missing piece of the conditional chain.\n\n{{~Prphrase~}}{{+Prephrase+}} with precision. On SA questions, aim for a specific logical statement rather than a general direction.\n\nWatch for the **Mistaken Reversal** — the most common and most dangerous trap on SA questions. If you need A → B, expect to see B → A among the answer choices.\n\nAlways run the **Sufficient Assumption Equation**: Premises + Answer = Conclusion guaranteed? If you can construct any counterexample, the answer is not sufficient."
        }
      ]
    }
  },
