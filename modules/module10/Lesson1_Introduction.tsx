...
export const Lesson1_Introduction: Lesson = {
  ...
  content: [
    ...
    {
      type: 'callout',
      text: '**Identify an unstated premise** that, if added to the argument, would make the conclusion 100% logically certain.',
      variant: 'goal',
    },
    { type: 'paragraph', text: 'This module covers Sufficient Assumption.' },
    { type: 'hr' },
