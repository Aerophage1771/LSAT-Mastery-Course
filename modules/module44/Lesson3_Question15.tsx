...
export const Lesson3_Question15: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-1-P-3-Q-15', questionType: 'Inference (EXCEPT)', passageTitle: 'Cultural Identity', passage: passageText, question: `The passage provides information to answer all of the following questions EXCEPT:`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Inference (EXCEPT)', text: 'Read the question stem carefully. Return to the passage for direct evidence before evaluating answer choices.' },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-1-P-3-Q-15"
        },
        {
          "type": "blockquote",
          "text": "**Question:** The passage provides information to answer all of the following questions EXCEPT:"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This is an \"EXCEPT\" question, which asks to identify which of the listed questions the passage does *not* provide enough information to answer. The correct approach is to treat each answer choice as a question and search the passage for a direct or strongly implied answer. The one that cannot be answered is the correct choice."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) What kinds of influences affect the national identities people construct from their past?",
              "text": "The first paragraph explicitly answers this. It states that \"human biases and purposes\" and \"the anxieties and agendas of the present\" are the key influences. The passage can answer this question.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) Why did nineteenth-century European commentators ignore some discussion of Greek culture by ancient Greek writers?",
              "text": "The first paragraph explains that these commentators were revising Greek identity \"to support an image of European cultural dominance.\" Acknowledging the culture's hybrid past would have undermined this goal. Therefore, they ignored the acknowledgments to maintain their fabricated narrative. The passage can answer this question.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) In what ways did African cultural influence affect the culture of ancient Greece?",
              "text": "The passage states *that* ancient Greece had roots in \"Egyptian and various other African and Eastern cultures.\" It asserts the existence of this influence. However, it provides no specific details about the nature of this influence—for example, whether it was in art, religion, philosophy, or governance. The passage does not give the information needed to answer \"in what ways.\"",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(D) Why was Queen Victoria of England declared empress of India in 1876?",
              "text": "The second paragraph explains this was done so that \"ruling elites of Europe felt the clear need to project their power backward in time, giving it a legitimacy that only longevity could impart.\" The ceremony was intended to make her rule seem like an \"age-old custom.\" The passage can answer this question.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) What is one reason why revolutionary poets speak and write as they do?",
              "text": "The third paragraph states that revolutionary poets create idealized images of the past for the purpose of \"giving their adherents something to revive and admire.\" This is a clear reason for their actions. The passage can answer this question.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
