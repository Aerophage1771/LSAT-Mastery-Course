...
export const Lesson6_Question18: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-1-P-3-Q-18', questionType: 'Third-Party Viewpoint', passageTitle: 'Cultural Identity', passage: passageText, question: `The “purveyors of nationalist dogma” mentioned in the second-to-last sentence of the passage would be most likely to agree with which one of the following?`, options: [
    ...
    { 
      ...
      items: [
        { title: "(A) Colonized nations should not attempt to regain their historical cultures.", text: "This is unlikely. The passage uses Algerian nationalists, who were trying to create an idealized version of their precolonial past, as an example of this kind of identity construction. A nationalist would likely support, not oppose, such an attempt.", badge: 'Misattribution', badgeColor: "red" },
        { title: "(B) Imperial cultures should incorporate the traditions of their colonies.", text: "This contradicts the nationalist ideal of purity. Incorporating foreign traditions would dilute the supposed uniqueness and superiority of the national culture.", badge: 'View Merge', badgeColor: "red" },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-1-P-3-Q-18"
        },
        {
          "type": "blockquote",
          "text": "**Question:** The “purveyors of nationalist dogma” mentioned in the second-to-last sentence of the passage would be most likely to agree with which one of the following?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks what the \"purveyors of nationalist dogma\" would most likely agree with. To answer, we must first define this group based on the information in the final paragraph."
        },
        {
          "type": "paragraph",
          "text": "The passage states that \"we have never been as aware as we are now of the fact that historical and cultural experiences... cross national boundaries, despite the claims to the contrary made by purveyors of nationalist dogma.\" This sentence structure defines the group by what they oppose. The author's view is that cultures are interconnected and hybrid. Therefore, the \"purveyors of nationalist dogma\" must believe the opposite: that cultures are (or should be) pure, self-contained, monolithic, and confined within national boundaries. Their \"dogma\" is the belief in a unique and pure national identity."
        },
        {
          "type": "paragraph",
          "text": "We are looking for an answer choice that reflects this belief in cultural purity and separation from outside influences."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) Colonized nations should not attempt to regain their historical cultures.",
              "text": "This is unlikely. The passage uses Algerian nationalists, who were trying to create an idealized version of their precolonial past, as an example of this kind of identity construction. A nationalist would likely support, not oppose, such an attempt.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) Imperial cultures should incorporate the traditions of their colonies.",
              "text": "This contradicts the nationalist ideal of purity. Incorporating foreign traditions would dilute the supposed uniqueness and superiority of the national culture.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) The cultural traditions of a nation should remain untainted by outside influences.",
              "text": "This statement perfectly captures the essence of nationalist dogma as described by the author. The desire for a culture that is \"untainted by outside influences\" is the core belief that stands in direct opposition to the author's final point about the interconnectedness and hybridity of all cultures.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(D) A country’s cultural identity partakes of many social and cultural domains.",
              "text": "This is a direct statement of the *author's* view, which the passage explicitly states is contrary to the claims of nationalist dogma. Nationalists would disagree with this.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) National histories are created to further aspirations to sovereignty and dominance.",
              "text": "This is the author's *analysis* of the nationalists' motivation. A purveyor of nationalist dogma would likely not describe their own work in this way. They would probably claim to be uncovering the \"true\" history of their nation, not creating a tool for political ends. This choice describes their function from an outside, critical perspective, not their own belief.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
