...
export const Lesson5_Question17: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-1-P-3-Q-17', questionType: 'Phrase Meaning', passageTitle: 'Cultural Identity', passage: passageText, question: `The author’s use of the word “traditional” (last sentence of the second paragraph) is intended to indicate that the jamborees`, options: [
    ...
    { 
      ...
      items: [
        { title: "(A) had been revived after centuries of neglect", text: "This suggests the traditions were authentically old, which is the opposite of the author's point.", badge: 'Dictionary Trap', badgeColor: "red" },
        { title: "(B) were legitimized by their historic use in the native culture", text: "The passage does not state that these jamborees were drawn from native culture; the context suggests they were creations of the European imperial power.", badge: 'Partial Meaning', badgeColor: "red" },
        { title: "(C) exemplified the dominance of the imperial culture", text: "While true, this misses the specific function of the quotation marks. The quotes are not just about dominance but about the *inauthenticity* of the tradition being used to express that dominance.", badge: 'Wrong Connotation', badgeColor: "red" },
        ...
        { title: "(E) combined historic elements of imperial and native cultures", text: "The passage provides no evidence to support the idea that these ceremonies were a combination of cultures. The focus is on the imperial power's act of invention.", badge: 'Wrong Context', badgeColor: "red" }
    ]
    },
    { type: 'callout', variant: 'summary', title: 'Key Takeaway', text: 'Never pick the common dictionary definition when the author uses the word in a specialized or ironic way.' },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-1-P-3-Q-17"
        },
        {
          "type": "blockquote",
          "text": "**Question:** The author’s use of the word “traditional” (last sentence of the second paragraph) is intended to indicate that the jamborees"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks for the intended meaning behind the author's use of the word \"traditional\" in quotation marks in the second paragraph. Quotation marks used in this way often signal irony, skepticism, or that the word is being used in a special, non-literal sense."
        },
        {
          "type": "paragraph",
          "text": "The context is the celebration of Queen Victoria as empress of India in \"numerous 'traditional' jamborees.\" The entire paragraph is about the **\"manufacture and reinterpretation of rituals, ceremonies, and traditions\"** by European elites to give their power \"a legitimacy that only longevity could impart.\" The point is that these rituals were *not* genuinely traditional or ancient; they were newly created to *appear* traditional."
        },
        {
          "type": "paragraph",
          "text": "The quotation marks serve to highlight this artificiality. The author is communicating to the reader that these events were called traditional, but in fact, they were a fabrication designed to create a false sense of historical legitimacy for a very recent act of colonial power."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) had been revived after centuries of neglect",
              "text": "This suggests the traditions were authentically old, which is the opposite of the author's point.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) were legitimized by their historic use in the native culture",
              "text": "The passage does not state that these jamborees were drawn from native culture; the context suggests they were creations of the European imperial power.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) exemplified the dominance of the imperial culture",
              "text": "While true, this misses the specific function of the quotation marks. The quotes are not just about dominance but about the *inauthenticity* of the tradition being used to express that dominance.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) conferred spurious historical legitimacy upon colonial authority",
              "text": "This choice is a perfect fit. \"Spurious\" means fake or not genuine. The quotation marks around \"traditional\" are intended to show that the tradition was fake and that its purpose was to confer a false (\"spurious\") sense of historical legitimacy on the colonial government.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(E) combined historic elements of imperial and native cultures",
              "text": "The passage provides no evidence to support the idea that these ceremonies were a combination of cultures. The focus is on the imperial power's act of invention.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
