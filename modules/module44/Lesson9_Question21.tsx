...
export const Lesson9_Question21: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-1-P-3-Q-21', questionType: 'Passage Purpose', passageTitle: 'Cultural Identity', passage: passageText, question: `The primary purpose of the passage is to`, options: [
    ...
    { 
      ...
      items: [
        ...
        { title: "(E) reveal the imperialist motivations of some nineteenth-century scholarship", text: "This is far too narrow. It describes the content of the first paragraph's example but fails to capture the purpose of the passage as a whole, which uses that example as one piece of evidence for a much broader claim about identity construction in general.", badge: 'Misreading', badgeColor: "red" }
    ]
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-1-P-3-Q-21"
        },
        {
          "type": "blockquote",
        ...
        {
          "type": "paragraph",
          "text": "This question asks for the \"primary purpose.\" It requires a holistic understanding of the author's main goal in writing the text. We must identify the central claim that the entire passage is structured to support."
        },
        {
          "type": "paragraph",
          "text": "The passage begins by stating a clear thesis in the first paragraph: \"the anxieties and agendas of the present exert an extraordinary influence on the national identities we construct from the cultural past.\" The rest of the passage is dedicated to proving this thesis through a series of diverse examples: the revision of Greek history, the manufacturing of British imperial traditions, and the creation of an idealized past by Algerian revolutionaries. The final paragraph reflects on the implications of this phenomenon."
        },
        {
          "type": "paragraph",
          "text": "The entire text functions as a well-supported argument for a single, central idea. The primary purpose is therefore to present and defend this central claim."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) argue for the creation of a global culture made up of elements from many national cultures",
              "text": "The author's tone is analytical, not prescriptive. They describe the interconnectedness of cultures but do not advocate for the creation of a new \"global culture.\"",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) explain how the desire for cultural uniformity supports imperialist attitudes",
              "text": "This is too narrow. It only covers one aspect of the evidence (the imperial examples) and ignores the broader application of the thesis to non-imperial contexts, like the Algerian one.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) stress the importance of objectivity in studying the actual sources of cultural identity",
              "text": "While the passage demonstrates a lack of objectivity in how cultures are defined, its main goal is not to lecture the reader on scholarly methods. Its purpose is more analytical: to explain the *mechanism* and *motivation* behind this biased construction of identity. The call for objectivity is an implication, not the primary purpose.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) advance the claim that present concerns motivate the shaping of cultural identities",
              "text": "This is a precise and accurate summary of the author's central thesis. The passage's primary goal is to \"advance the claim\" (i.e., argue for the idea) that \"present concerns\" (biases, agendas, anxieties) are the driving force (\"motivate\") behind the \"shaping of cultural identities.\" This statement encompasses all the evidence and the main argument of the passage.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(E) reveal the imperialist motivations of some nineteenth-century scholarship",
              "text": "This is far too narrow. It describes the content of the first paragraph's example but fails to capture the purpose of the passage as a whole, which uses that example as one piece of evidence for a much broader claim about identity construction in general.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
