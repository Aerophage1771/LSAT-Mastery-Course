...
export const Lesson8_Question20: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-1-P-3-Q-20', questionType: 'Passage Principle', passageTitle: 'Cultural Identity', passage: passageText, question: `In the context of the passage, the examples in the second and third paragraphs best exemplify which one of the following generalizations?`, options: [
    ...
    { 
      ...
      items: [
        ...
        { title: "(B) National identity generally requires cultural uniformity.", text: "This is not the primary point of these specific examples. The focus is on creating a sense of historical legitimacy or an inspiring past, not necessarily on enforcing uniformity. Furthermore, this contradicts the author's final conclusion.", badge: 'Too Specific', badgeColor: "red" },
        { title: "(C) Most colonial cultures are by nature artificial and contrived.", text: "This is too narrow. The author explicitly states that \"Similar constructions have also been made by native cultures,\" using Algeria as the key example. The generalization must apply to both the colonial and the native case.", badge: 'Too Broad', badgeColor: "red" },
        { title: "(D) Historical and cultural experiences may cross national boundaries.", text: "This is the main idea of the final paragraph, but it is not the specific point being illustrated by the examples in paragraphs two and three. Those examples are about how groups construct their *own* internal narratives, not about cross-cultural exchange.", badge: 'Wrong Domain', badgeColor: "red" },
        { title: "(E) Revolutionary cultures are often more authentic than imperial cultures.", text: "The author explicitly refutes this by calling the constructions \"similar.\" The passage's logic is that both imperial and revolutionary groups use the same artificial strategy. It does not present one as more authentic than the other.", badge: 'Partial Match', badgeColor: "red" }
    ]
    },
    { type: 'callout', variant: 'summary', title: 'Key Takeaway', text: 'Principle answers must be abstract enough to generalize but specific enough to justify the passage\\u0027s argument.' },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-1-P-3-Q-20"
        },
        {
          "type": "blockquote",
          "text": "**Question:** In the context of the passage, the examples in the second and third paragraphs best exemplify which one of the following generalizations?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks for a generalization that is exemplified by the examples in *both* the second and third paragraphs. We must find a single abstract principle that connects the case of the British in India and the case of the Algerian revolutionaries."
        },
        {
          "type": "paragraph",
          "text": "Let's review the core of each example:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "The common thread is the act of invention or construction. In both cases, something that is presented as an authentic, old tradition or history is, in fact, a modern creation designed for a specific purpose."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) Apparent traditions may be products of artifice.",
              "text": "This generalization fits both examples perfectly. \"Apparent traditions\" are things that look traditional. \"Products of artifice\" means they are skillfully invented or artificial. The British jamborees are an \"apparent tradition\" that is a \"product of artifice.\" The idealized Algerian past is also an \"apparent tradition\" that is a \"product of artifice.\" This statement successfully connects both examples.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B) National identity generally requires cultural uniformity.",
              "text": "This is not the primary point of these specific examples. The focus is on creating a sense of historical legitimacy or an inspiring past, not necessarily on enforcing uniformity. Furthermore, this contradicts the author's final conclusion.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) Most colonial cultures are by nature artificial and contrived.",
              "text": "This is too narrow. The author explicitly states that \"Similar constructions have also been made by native cultures,\" using Algeria as the key example. The generalization must apply to both the colonial and the native case.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) Historical and cultural experiences may cross national boundaries.",
              "text": "This is the main idea of the final paragraph, but it is not the specific point being illustrated by the examples in paragraphs two and three. Those examples are about how groups construct their *own* internal narratives, not about cross-cultural exchange.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) Revolutionary cultures are often more authentic than imperial cultures.",
              "text": "The author explicitly refutes this by calling the constructions \"similar.\" The passage's logic is that both imperial and revolutionary groups use the same artificial strategy. It does not present one as more authentic than the other.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
