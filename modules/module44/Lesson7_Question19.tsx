...
export const Lesson7_Question19: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-1-P-3-Q-19', questionType: 'Application', passageTitle: 'Cultural Identity', passage: passageText, question: `Which one of the following would most likely be an example of one of the “rituals, ceremonies, and traditions” mentioned in the second sentence of the second paragraph?`, options: [
    ...
    { type: 'list', items: [
      "**Action:** A colonial power either invents (\"manufactures\") or modifies (\"reinterprets\") a ritual.",
      "**Purpose:** The goal is to reinforce the colonizer's authority and create a false sense of historical legitimacy, making its rule seem natural or ancient."
    ]},
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-1-P-3-Q-19"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following would most likely be an example of one of the “rituals, ceremonies, and traditions” mentioned in the second sentence of the second paragraph?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This is an application question that asks for a hypothetical example of the phenomenon described in the second paragraph: the \"manufacture and reinterpretation of rituals, ceremonies, and traditions\" by a colonial power to reinforce its authority."
        },
        {
          "type": "paragraph",
          "text": "We need to create a clear template from the paragraph. The key elements are:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "We must find the answer choice that matches both the action and the purpose."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) an annual ceremony held by an institution of the colonizing culture to honor the literary and theatrical achievements of members of the native culture",
              "text": "The purpose here is to \"honor\" the native culture, which does not directly align with the goal of creating false legitimacy for the colonizer's rule.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) a religious service of the colonizing culture that has been adapted to include elements of the native culture in order to gain converts",
              "text": "The action (adaptation) fits, but the purpose is religious (\"to gain converts\"), not political in the sense of legitimizing the colonial *government's* authority as described in the paragraph.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) a traditional play that is part of a colonized nation’s original culture, but is highly popular among the leaders of the imperial culture",
              "text": "This involves no \"manufacture or reinterpretation.\" The imperial leaders are merely passive observers of an unchanged native tradition.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) a ritual dance, traditionally used to commemorate the union of two native deities, that is modified to depict the friendship between the colonial and native cultures",
              "text": "This fits the template perfectly.\n*   **Action:** An existing native tradition (a \"ritual dance\") is \"modified\" (reinterpreted).\n*   **Purpose:** The new meaning—depicting \"friendship\" between the colonizer and the colonized—serves to legitimize the colonial presence, making it seem like a natural and positive part of the native culture's sacred history. This is a classic example of reinforcing authority through reinterpretation.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(E) a traditional village oratory competition in which members of the native culture endeavor to outdo one another in allegorical criticisms of the colonizing culture",
              "text": "This is the opposite of the phenomenon. Here, the native culture is using its own tradition to *resist* colonial authority, not the other way around.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
