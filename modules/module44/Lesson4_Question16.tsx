...
export const Lesson4_Question16: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-1-P-3-Q-16', questionType: 'Author Attitude', passageTitle: 'Cultural Identity', passage: passageText, question: `The author’s attitude toward the studies mentioned in the second sentence of the passage is most likely`, options: [
    ...
    { 
      ...
      items: [
        ...
        { title: "(B) reservation over their preoccupation with colonialism", text: "The author shows no \"reservation\" or doubt. Furthermore, the author is the one who chooses to use colonialism as a primary example, indicating no issue with such a preoccupation.", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(C) skepticism toward the relevance of the examples they cite", text: "The author is the one presenting the examples as relevant proof for the studies' claims. The author is confident in the relevance of the examples, not skeptical.", badge: 'Wrong Direction', badgeColor: "red" },
        { title: "(D) concern that they fail to explain ancient Greek culture", text: "The author uses the Greek example to illustrate the studies' point, not to critique the studies for failing to provide a full explanation. The author shows no such concern.", badge: 'Misattribution', badgeColor: "red" },
        { title: "(E) unqualified disagreement with their insistence that cultures are monolithic", text: "This is incorrect for two reasons. First, the author agrees with the studies. Second, neither the author nor the studies insist that cultures *are* monolithic; they argue that cultures are falsely *portrayed* as monolithic for political purposes.", badge: 'False Neutrality', badgeColor: "red" }
    ]
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-1-P-3-Q-16"
        },
        {
          "type": "blockquote",
          "text": "**Question:** The author’s attitude toward the studies mentioned in the second sentence of the passage is most likely"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks for the author's attitude toward the \"recent studies\" mentioned in the second sentence. We must determine whether the author agrees with, disagrees with, or is neutral toward the conclusions of these studies."
        },
        {
          "type": "paragraph",
          "text": "The second sentence presents the core idea from these studies: \"the anxieties and agendas of the present exert an extraordinary influence on the national identities we construct from the cultural past.\" To determine the author's attitude, we must look at how the author uses this idea. The author immediately follows this sentence with phrases like \"For example...\" (introducing the revision of Greek history), \"Another example is...\" (introducing manufactured British traditions), and \"Similar constructions have also been made...\" (introducing the Algerian case)."
        },
        {
          "type": "paragraph",
          "text": "The entire structure of the passage is a presentation of evidence that supports and validates the conclusion of these \"recent studies.\" The author is not critiquing or questioning the studies; they are using the rest of the passage to demonstrate that the studies are correct. This indicates a strong sense of agreement."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) overall agreement with their conclusion about influences on cultural identity",
              "text": "This choice accurately reflects the author's supportive stance. The passage is structured to provide evidence for the studies' conclusion, showing the author is in \"overall agreement.\"",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B) reservation over their preoccupation with colonialism",
              "text": "The author shows no \"reservation\" or doubt. Furthermore, the author is the one who chooses to use colonialism as a primary example, indicating no issue with such a preoccupation.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) skepticism toward the relevance of the examples they cite",
              "text": "The author is the one presenting the examples as relevant proof for the studies' claims. The author is confident in the relevance of the examples, not skeptical.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) concern that they fail to explain ancient Greek culture",
              "text": "The author uses the Greek example to illustrate the studies' point, not to critique the studies for failing to provide a full explanation. The author shows no such concern.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) unqualified disagreement with their insistence that cultures are monolithic",
              "text": "This is incorrect for two reasons. First, the author agrees with the studies. Second, neither the author nor the studies insist that cultures *are* monolithic; they argue that cultures are falsely *portrayed* as monolithic for political purposes.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
