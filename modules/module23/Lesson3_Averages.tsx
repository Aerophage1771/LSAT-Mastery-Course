  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "diff-note",
          "text": "This lesson is dramatically underweight (~10 blocks) compared to other lessons in this module. Weighted Averages and Mean vs. Median each get only a single paragraph. Expand with LSAT-contextualized examples, a signal-word table for average-related arguments, and a 'How This Flaw Appears Across Question Types' section paralleling Lesson 2.",
          "variant": "comment"
        },
        {
          "type": "h3",
          "text": "Lesson 3: The Averages Fallacy"
        },
        {
          "type": "paragraph",
          "text": "**Lesson Objective:** Understand how averages mislead—through Simpson's Paradox, weighted-average errors, and mean-vs-median confusion—and learn to dismantle LSAT arguments that exploit these traps."
        ...
        },
        {
          ...
          "headers": [
            "",
            "Drug (Recovered / Total)",
            "Placebo (Recovered / Total)"
          ],
          "rows": [
            [
              "Mild cases",
        ...
        {
          "type": "diff-note",
          "text": "Missing: an 'How This Flaw Appears Across Question Types' section (present in Lesson 2 but absent here). Add a breakdown mapping average-related flaws to Flaw, Weaken, Strengthen, and Paradox question types.",
          "variant": "comment"
        },
        {
          "type": "h4",
        ...
        {
          "type": "diff-note",
          "text": "This lesson needs roughly 20-25 more blocks to match the depth standard set by Lessons 2 and 5. Add: (1) LSAT-contextualized examples for Weighted Averages and Mean vs. Median, (2) a signal-word diagnostic table, (3) a question-card or constructed exercise.",
          "variant": "comment"
        }
      ],
    },
