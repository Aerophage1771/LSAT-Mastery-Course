...
export const Lesson5_GamblersFallacy: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'The Gambler\'s Fallacy is the mistaken belief that random processes have a built-in memory—that probability "self-corrects" in the short term to match long-run averages. In reality, each independent event is unaffected by what came before it.',
    },

    {
      type: 'blockquote',
      text: '"The roulette wheel landed on red six times in a row, so black is due next." This sentence captures the essence of the Gambler\'s Fallacy: treating probability as a debt that nature must repay.',
    },
...

    {
      ...
      text: 'LSAT arguments exploiting this fallacy often use emotionally loaded language—"overdue," "bound to happen," "long streak," "due for a correction." These phrases signal that the argument treats randomness as having a schedule. Flag them immediately.',
    },
    ...
    {
      type: 'paragraph',
      text: "The Hot Hand Fallacy is the mirror image of the Gambler's Fallacy. Instead of expecting a streak to reverse, this error expects a streak to continue—purely because it has been going on.",
    },
    ...
    {
      type: 'paragraph',
      text: 'The critical distinction underlying both fallacies is whether events are **independent** or **dependent**. Getting this right is essential for evaluating probability arguments on the LSAT.',
    },
    ...
    {
      type: 'paragraph',
      text: "The LSAT doesn't test your ability to calculate probabilities. Instead, it tests whether you can spot when an argument misuses probability concepts. Here are the most common patterns:",
    },

    {
      type: 'process',
      title: 'Common LSAT Probability Error Patterns',
      steps: [
    ...
    {
      type: 'accordion',
      title: 'Full Analysis of Practice Question',
      content: [
        {
          type: 'paragraph',
          text: '**Why (B) is correct:** The official\'s argument hinges on the word "overdue"—the classic signal of the Gambler\'s Fallacy. The argument assumes that because 53 years have passed (slightly more than the 50-year average), a major earthquake is "virtually certain" soon. This treats independent geological events as if probability accumulates over time, like a debt that must be repaid.',
        },
        {
          type: 'paragraph',
          text: '**Why (E) is tempting but wrong:** Answer (E) describes a related but different flaw. The official does use past averages to predict the future, but the *specific* error is the "overdue" reasoning—the belief that elapsed time increases the probability of the next event. Answer (E) is too broad; it doesn\'t capture the particular mechanism of the fallacy.',
        },
        {
          type: 'paragraph',
          text: "**Why (A) is wrong:** The argument's flaw isn't about the seismologist's credibility. Even if the 50-year average is perfectly accurate, the \"overdue\" reasoning is still fallacious.",
        },
        {
          type: 'paragraph',
          text: '**Why (C) is wrong:** Cost-benefit analysis is a separate issue. The flaw is in the probability reasoning, not the economic reasoning.',
        },
        {
          type: 'paragraph',
          text: '**Why (D) is wrong:** The occurrence of smaller earthquakes is irrelevant to the logical flaw in the argument about major earthquakes being "overdue."',
        },
        {
          type: 'paragraph',
          text: '**Key Takeaway:** When you see an argument claiming something is "overdue" or "due" based on past frequency, the flaw is almost always the Gambler\'s Fallacy. The correct answer will identify the assumption that elapsed time increases probability for independent events.',
        },
      ],
    },
...

    {
      ...
      text: 'The Gambler\'s Fallacy and the Hot Hand Fallacy are two sides of the same coin—both incorrectly assume that independent events influence each other. When an LSAT argument predicts something is "due," "overdue," or "bound to continue," ask one question: **"Are these events truly independent?"** If so, past outcomes tell you nothing about what comes next. The past does not negotiate with the future.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h3",
          "text": "Lesson 5: Flawed Predictions"
        },
        {
          "type": "paragraph",
          "text": "**Lesson Objective:** To identify arguments that incorrectly use past outcomes to predict future random events. You will learn to distinguish independent events from dependent events, recognize the Gambler's Fallacy and its mirror image (the Hot Hand Fallacy), and understand how probability errors surface on the LSAT."
        ...
        {
          "type": "h4",
          "text": "The Key Concept: Independence of Events"
        },
        {
          "type": "paragraph",
          "text": "The critical distinction underlying both fallacies is whether events are **independent** or **dependent**. Getting this right is essential for evaluating probability arguments on the LSAT."
        ...
        {
          "type": "h4",
          "text": "How Probability Errors Appear on the LSAT"
        },
        {
          "type": "paragraph",
          "text": "The LSAT doesn't test your ability to calculate probabilities. Instead, it tests whether you can spot when an argument misuses probability concepts. Here are the most common patterns:"
        ...
        {
          "type": "h4",
          "text": "Practice: Identifying the Fallacy"
        },
        {
          "type": "paragraph",
          "text": "Consider this illustrative example that combines several concepts from this lesson:"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "paragraph",
          "text": "{{!The stimulus and answer choices for this practice question (earthquake/official scenario) are missing from the website content. The accordion contains only the analysis referencing answers (A)-(E). Restore or add a constructed question with visible stimulus and answer choices.!}}"
        },
        {
          "type": "accordion",
          "title": "Full Analysis of Practice Question",
