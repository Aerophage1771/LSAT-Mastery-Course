...
export const Lesson6_Conclusion: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: "The most challenging LSAT Math questions don't rely on a single fallacy—they layer multiple quantitative errors into a single argument. Recognizing these compound flaws requires fluency with every flaw type from this module.",
    },

    {
      type: 'paragraph',
      text: '**Why the LSAT combines flaws:** A single-flaw argument is relatively easy to spot once you know the pattern. By stacking two or three errors, the test makers create arguments where identifying one flaw can blind you to another—and the "most attractive wrong answer" often describes the secondary flaw rather than the primary one.',
    },
...

    {
      type: 'callout',
      variant: 'tip',
      title: 'Multi-Flaw Strategy',
      text: 'When you spot one flaw, don\'t stop. Ask: "Is there a second error here?" On the LSAT, the correct answer targets the *primary* flaw—the one the conclusion depends on most. Secondary flaws often appear as tempting wrong answers.',
    },
    ...
    {
      type: 'paragraph',
      text: "Before you can analyze a quantitative flaw, you need to recognize that the argument *is* quantitative. LSAT Math arguments don't always use explicit numbers—they often rely on comparative or statistical language that implies numerical reasoning.",
    },

    { type: 'h4', text: 'Signal Words and Patterns' },
    {
      type: 'paragraph',
      text: 'Train yourself to flag these terms the moment you read them. Each one signals a specific type of quantitative reasoning—and a specific category of potential error.',
    },

    {
      ...
      rows: [
        [
          'percent, proportion, fraction, share, ratio',
          'Relative comparison to a total',
          'Is the total provided? Could it have changed?',
        ],
        [
          'more, fewer, greater, less, increase, decrease',
          'Absolute number comparison',
          'Is this about the rate or the raw count?',
        ],
        [
          'average, mean, median, typical, normal',
          'Central tendency claim',
          'Outliers? Weighted groups? Mean vs. median?',
        ],
        [
          'most, majority, many, few, rarely',
          'Frequency or proportion claim',
          'Of what population? Is the sample representative?',
        ],
        [
          'rate, likelihood, probability, risk, chance',
          'Frequency relative to opportunities',
          'Rate vs. absolute number confusion?',
        ],
        [
          'due, overdue, bound to, streak, trend',
          'Prediction based on past frequency',
          "Gambler's Fallacy? Independent events?",
        ],
        [
          'total, overall, combined, aggregate, net',
          'Whole-group claim',
          'Part vs. whole? Net effect? Overlapping sets?',
        ],
        [
          'doubled, tripled, X times as many',
          'Multiplicative comparison',
          'From what base? Doubling from 1 to 2 vs. 1M to 2M?',
        ],
        [
          'survey, study, sample, respondents',
          'Evidence from a subset',
          'Is the sample representative? Self-selection bias?',
        ],
        [
          'cost, revenue, profit, savings, spending',
          'Financial calculation',
          'Net effect? Are both sides of the ledger shown?',
        ],
      ],
    },
    ...
    {
      type: 'paragraph',
      text: '**Pro Tip:** When you see two or more signal words from different rows in the same argument, the argument is almost certainly combining flaws. Slow down and analyze each quantitative claim independently before evaluating the conclusion.',
    },
...

    {
      ...
      content: [
        ...
        {
          type: 'paragraph',
          text: "**Why (A) is tempting:** It identifies a real flaw (mean vs. median), but this is a secondary concern. The argument's central error is its causal attribution, not its choice of statistical measure.",
        },
        {
          type: 'paragraph',
          text: "**Why (C) is wrong:** The argument doesn't generalize from a sample of hospitals—it discusses all hospitals in the city.",
        },
        {
          type: 'paragraph',
          text: '**Why (D) is wrong:** While the recommendation to "other cities" is questionable, the primary flaw is in the causal reasoning within the original city\'s data, not in the generalization step.',
        },
        {
          type: 'paragraph',
          text: "**Why (E) is wrong:** This answer choice introduces an irrelevant counterfactual. The argument's flaw is that it ignores a present alternative cause, not a hypothetical scenario without the policy.",
        },
        {
          type: 'paragraph',
          text: '**Key Takeaway:** When an argument has multiple flaws, the LSAT asks you to identify the *most* significant one. Here, the causal reasoning error (ignoring the urgent care clinics as an alternative explanation) is more fundamental than the statistical concerns. The correct answer targets the flaw the conclusion depends on most heavily.',
        },
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'Below is a comprehensive summary of every quantitative flaw type covered in this module, with the recognition cues you need to spot them instantly on test day.',
    },
    ...
    {
      type: 'paragraph',
      text: 'Use this four-step diagnostic routine on every LSAT argument that contains numerical or statistical language. It should become second nature through practice.',
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h3",
          "text": "Module Conclusion: Mastering LSAT Math"
        },
        {
          "type": "paragraph",
          "text": "You have learned that LSAT Math is not a math test—it is a logic test in disguise. Numbers, percentages, and statistics are the camouflage; the underlying flaws are always logical. This final lesson consolidates everything you've learned, introduces advanced multi-flaw scenarios, and equips you with a rapid-fire diagnostic routine for test day."
        ...
        {
          "type": "h4",
          "text": "Combining Quantitative Flaws"
        },
        {
          "type": "paragraph",
          "text": "The most challenging LSAT Math questions don't rely on a single fallacy—they layer multiple quantitative errors into a single argument. Recognizing these compound flaws requires fluency with every flaw type from this module."
        ...
        {
          "type": "h4",
          "text": "Spotting Quantitative Arguments"
        },
        {
          "type": "paragraph",
          "text": "Before you can analyze a quantitative flaw, you need to recognize that the argument *is* quantitative. LSAT Math arguments don't always use explicit numbers—they often rely on comparative or statistical language that implies numerical reasoning."
        ...
        {
          "type": "h4",
          "text": "Signal Words and Patterns"
        },
        {
          "type": "paragraph",
          "text": "Train yourself to flag these terms the moment you read them. Each one signals a specific type of quantitative reasoning—and a specific category of potential error."
        ...
        {
          "type": "h4",
          "text": "Advanced Practice: The Multi-Flaw Argument"
        },
        {
          "type": "paragraph",
          "text": "Consider this illustrative example that layers multiple quantitative errors—exactly the kind of complex argument you might encounter on the most difficult LSAT questions:"
        ...
        {
          "type": "paragraph",
          "text": "{{!The stimulus and answer choices for this advanced practice question (ER triage policy scenario) are missing. The accordion references answers (A)-(E) but no question is visible. Restore or add a constructed question.!}}"
        },
        {
          "type": "accordion",
          "title": "Full Analysis of Advanced Practice Question",
          "content": [
            ...
            {
              "type": "paragraph",
              "text": "**Bonus Analysis — Multiple Flaws Present:**"
            },
            {
              "type": "list",
              "items": [
        ...
        {
          "type": "diff-note",
          "text": "The flaw reference below (10 items), the signal-words table, and the checklist all heavily overlap with the Reference Guide (Lesson 7). Consider removing these sections from the Conclusion and pointing to the Reference Guide instead, keeping the Conclusion focused on multi-flaw strategy.",
          "variant": "comment"
        },
        {
          "type": "h4",
          "text": "Complete LSAT Math Flaw Reference"
        },
        {
          "type": "paragraph",
          "text": "Below is a comprehensive summary of every quantitative flaw type covered in this module, with the recognition cues you need to spot them instantly on test day."
        },
        {
          ...
          "labels": {
            "title": "Flaw Type",
            "text": "Recognition Cues & Response"
          },
          "colWidth": "equal",
          "items": [
            {
        ...
        {
          "type": "h4",
          "text": "Your Quantitative Reasoning Checklist"
        },
        {
          "type": "paragraph",
          "text": "Use this four-step diagnostic routine on every LSAT argument that contains numerical or statistical language. It should become second nature through practice."
