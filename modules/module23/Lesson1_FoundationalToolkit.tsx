...
export const Lesson1_FoundationalToolkit: Lesson = {
  ...
  questionPolicy: 'none',
  content: [
    { type: 'h2', text: 'MODULE 23: LSAT Math' },
    {
      type: 'paragraph',
      text: 'This module provides a comprehensive framework for mastering quantitative arguments within the LSAT Logical Reasoning section. While these questions feature numerical concepts like percentages, averages, and rates, they are fundamentally tests of logic, not mathematics. The LSAT never asks you to compute; it asks you to reason about numbers.',
    },
    {
      type: 'paragraph',
      text: 'Our approach is twofold:',
    },
    {
      type: 'list',
      items: [
        '**Build the Foundation:** Define the ten core quantitative concepts you must know.',
        '**Identify the Traps:** Analyze the most common logical fallacies the LSAT constructs using these concepts.',
      ],
    },
    ...
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'Cross-Question Reach',
      text: '**Flaw:** "Which of the following is a flaw in the argument?" \u2192 The argument confuses a percentage change with an absolute change.\n**Weaken:** "Which most weakens the argument?" \u2192 An answer that provides the missing denominator.\n**Strengthen:** "Which most strengthens the argument?" \u2192 An answer showing the base rates are comparable.\n**Paradox:** "Which resolves the apparent discrepancy?" \u2192 An answer explaining why a rate rose while absolute numbers fell.',
    },
    {
      type: 'paragraph',
      text: 'Mastering LSAT Math is not about learning one trick for one question type. It is about developing a reflex\u2014an automatic alarm that fires whenever an argument conflates raw numbers with proportions, ignores base rates, or leaps from group averages to individual conclusions.',
    },
    ...
    {
      type: 'paragraph',
      text: '**Lesson Objective:** Introduce the ten fundamental quantitative terms that form the bedrock of LSAT Math questions. Your goal is not just to memorize these definitions, but to understand them with enough precision to spot when the LSAT misuses or conflates them.',
    },
    ...
    {
      type: 'paragraph',
      text: "The LSAT's most reliable trick is swapping between these three ways of expressing quantity. The table below clarifies how each works and where the traps lie.",
    },
    {
      type: 'table',
      headers: ['Measure', 'What It Tells You', 'What It Hides', 'Classic LSAT Swap'],
      rows: [
        [
          'Raw Number (e.g., 500 accidents)',
          'The actual count of events',
          'The size of the population at risk',
          'Uses a large count to imply a high rate',
        ],
        [
          'Percentage (e.g., 20% of students)',
          'The proportion relative to a base',
          'The size of the base itself',
          'Uses a high percentage of a tiny group to imply a large count',
        ],
        [
          'Rate (e.g., 5 per 1,000 drivers)',
          'Frequency normalized to a standard denominator',
          'Whether the denominator changed over time',
          'Shows a falling rate to imply fewer total events, ignoring population growth',
        ],
      ],
    },
    {
      ...
      text: "Whenever an argument's premise uses one type of measure and the conclusion uses a different type, you are almost certainly looking at a flaw. **Premise in percentages \u2192 Conclusion in raw numbers = red flag.** Premise in raw numbers \u2192 Conclusion about rates = red flag.",
    },
    ...
    {
      type: 'paragraph',
      text: 'This module covers six major flaw families. Each lesson targets one. Use this table as a roadmap and a quick-reference throughout your study.',
    },
    {
      type: 'table',
      headers: ['Flaw Family', 'Core Error', 'Lesson', 'Example Trigger'],
      rows: [
        [
          'Numbers vs. Percentages',
          'Confusing absolute count with proportion or rate',
          'Lesson 2',
          '"More accidents occur on highways" \u2192 highways are more dangerous',
        ],
        [
          'Part vs. Whole',
          'Generalizing from a subgroup to the entire group (or vice versa)',
          'Lesson 2',
          '"75% of sales in one city" \u2192 must be top seller nationwide',
        ],
        [
          "Averages & Simpson's Paradox",
          'Treating averages as representative; ignoring subgroup weights',
          'Lesson 3',
          '"Average salary rose" \u2192 every employee earns more',
        ],
        [
          'Base Rate Neglect',
          'Drawing conclusions without accounting for underlying prevalence',
          'Lesson 4',
          '"Test is 95% accurate" \u2192 a positive result means you\'re 95% likely to have the condition',
        ],
        [
          "Gambler's Fallacy",
          'Assuming past independent events influence future probabilities',
          'Lesson 5',
          '"Coin landed heads 5 times" \u2192 tails is overdue',
        ],
        [
          'Correlation \u2192 Causation (with numbers)',
          'Treating a statistical correlation as proof of a causal link',
          'Lesson 4',
          '"Cities with more hospitals have more crime" \u2192 hospitals cause crime',
        ],
      ],
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "diff-note",
          "text": "The module header says MODULE 22 in the website version but MODULE 23 in the mastery course main content. Reconcile the numbering.",
          "variant": "comment"
        },
        {
          "type": "h2",
          "text": "{{~MODULE 22~}}: LSAT Math"
        },
        {
          "type": "paragraph",
          "text": "This module provides a comprehensive framework for mastering quantitative arguments within the LSAT Logical Reasoning section. While these questions feature numerical concepts like percentages, averages, and rates, they are fundamentally tests of logic, not mathematics. The LSAT never asks you to compute; it asks you to reason about numbers."
        ...
        {
          "type": "h3",
          "text": "Lesson 1: The Foundational Toolkit"
        },
        {
          "type": "paragraph",
          "text": "**Lesson Objective:** Introduce the ten fundamental quantitative terms that form the bedrock of LSAT Math questions. Your goal is not just to memorize these definitions, but to understand them with enough precision to spot when the LSAT misuses or conflates them."
        ...
        {
          "type": "paragraph",
          "text": "About ten concepts make up 90% of what you'll encounter. Let's master them."
        },
        {
          "type": "breakdown",
          "labels": {
            "title": "Concept",
            "text": "Definition & LSAT Trap"
          },
          "items": [
            {
              "title": "1. Absolute Number",
        ...
        {
          "type": "h3",
          "text": "Raw Numbers vs. Percentages vs. Rates"
        },
        {
          "type": "paragraph",
          "text": "The LSAT's most reliable trick is swapping between these three ways of expressing quantity. The table below clarifies how each works and where the traps lie."
        ...
        {
          "type": "h3",
          "text": "Master Table of LSAT Math Flaw Types"
        },
        {
          "type": "paragraph",
          "text": "This module covers six major flaw families. Each lesson targets one. Use this table as a roadmap and a quick-reference throughout your study."
        ...
        {
          "type": "diff-note",
          "text": "No practice element in this lesson. Add a mini-exercise after the Raw Numbers vs. Percentages vs. Rates table: present a short argument and ask the student to identify the type-of-measure mismatch between premise and conclusion.",
          "variant": "comment"
        },
        {
          "type": "callout",
        ...
        {
          "type": "diff-note",
          "text": "The flaw roadmap table lists only six families but omits several sub-types taught later (Double Counting, Percentage of a Percentage, Net Effect). Either expand the table or add a note that individual lessons cover additional sub-types.",
          "variant": "comment"
        }
      ],
    },
