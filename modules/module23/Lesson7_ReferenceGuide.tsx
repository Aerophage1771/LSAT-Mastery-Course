...
export const Lesson7_ReferenceGuide: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'This guide consolidates every key concept, flaw type, and strategy from the LSAT Math module into a single, searchable reference. Use it for rapid review before test day and as a lookup tool during practice.',
    },
    ...
    {
      type: 'paragraph',
      text: 'The table below catalogs every major quantitative flaw the LSAT tests. For each flaw you will find its name, a plain-language description, the kind of LSAT language that signals it, and a quick diagnostic for spotting it in real time.',
    },

    {
      type: 'table',
      headers: ['Flaw Type', 'Description', 'Typical LSAT Language', 'How to Spot It'],
      rows: [
        [
    ...
    {
      type: 'paragraph',
      text: 'When you encounter any of the following words in a stimulus, you are likely dealing with a quantitative argument. Recognizing them instantly saves precious seconds.',
    },

    {
      type: 'table',
      headers: ['Category', 'Signal Words'],
      rows: [
        [
          'Proportional / Relative',
          'percent, percentage, proportion, ratio, rate, share, fraction, per capita, relative to',
        ],
        ...
        [
          ...
          'likely, unlikely, probable, chance, odds, risk, frequency, incidence, prevalence',
        ],
    ...
    {
      type: 'paragraph',
      text: 'Quantitative reasoning errors appear across multiple Logical Reasoning question types. The table below shows how the same underlying flaw manifests differently depending on the question stem.',
    },

    {
      type: 'table',
      headers: ['Question Type', 'What the Question Asks', 'How Math Flaws Appear'],
      rows: [
        [
          'Flaw',
    ...
    {
      type: 'paragraph',
      text: 'Below are the traps that appear most frequently in LSAT Math questions. Internalizing these patterns will help you eliminate wrong answers faster and avoid second-guessing correct ones.',
    },

    {
      type: 'breakdown',
      labels: { title: 'Trap', text: 'How It Works & How to Beat It' },
      items: [
        {
    ...
    {
      type: 'paragraph',
      text: 'Run through this checklist whenever you encounter a quantitative stimulus in Logical Reasoning.',
    },

    {
      type: 'process',
      title: 'Quantitative Reasoning Checklist',
      steps: [
...

    {
      type: 'callout',
      variant: 'tip',
      title: 'Quick Recall Mnemonic',
      text: "Remember **B-A-R-G-D-P-R-P** for the eight flaw types: **B**ase rate neglect, **A**verages / Simpson's Paradox, **R**elative vs. absolute change, **G**ambler's fallacy, **D**ouble counting, **P**art vs. whole, numbers vs. **R**ates (percentages), **P**ercentage of a percentage.",
    },

    {
      ...
      text: 'This guide covers all eight LSAT Math flaw types, signal words for rapid identification, question-type interactions, seven common traps, and a seven-step test day checklist. Return to it whenever you need a quick refresher before practice or on test day.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "LSAT Math — Comprehensive Reference Guide"
        },
        {
          "type": "paragraph",
          "text": "This guide consolidates every key concept, flaw type, and strategy from the LSAT Math module into a single, searchable reference. Use it for rapid review before test day and as a lookup tool during practice."
        ...
        },
        {
          ...
          "rows": [
            ...
            [
              "Aggregate / Absolute",
              "number, total, count, amount, sum, quantity, volume"
            ],
            [
              "Central Tendency",
              "average, mean, median, typical, normal, per, on average"
            ],
            [
              "Comparison",
              "more, fewer, less, greater, higher, lower, exceed, surpass, majority, minority"
            ],
            [
              "Change Over Time",
              "increase, decrease, rise, fall, grow, shrink, doubled, tripled, halved, decline"
            ],
            [
              "Probability / Likelihood",
              "likely, unlikely, probable, chance, odds, risk, frequency, incidence, prevalence"
            ...
            [
              "Scope / Population",
              "all, none, every, most, some, many, few, sample, population, group, category"
            ]
          ]
        },
        {
        ...
        {
          "type": "h3",
          "text": "How LSAT Math Flaws Interact with Question Types"
        },
        {
          "type": "paragraph",
          "text": "Quantitative reasoning errors appear across multiple Logical Reasoning question types. The table below shows how the same underlying flaw manifests differently depending on the question stem."
        ...
        },
        {
          ...
          "labels": {
            "title": "Trap",
            "text": "How It Works & How to Beat It"
          },
          "items": [
            {
              "title": "1. The Impressive Number",
        ...
        {
          "type": "diff-note",
          "text": "Missing: the 10-concept foundational vocabulary from Lesson 1 (Absolute Number, Rate, Total, Percentage, Average, Median, Weighted Average, Rate of Change, Market Share, Threshold). The reference guide catalogues flaws but not the foundational terms those flaws exploit. Add a condensed vocabulary table.",
          "variant": "comment"
        },
        {
          "type": "diff-note",
          "text": "Consider adding a Quick-Check exercise at the end — e.g., a 2-sentence argument and a prompt to name the flaw — so students can verify they can apply the reference.",
          "variant": "comment"
        },
        {
          "type": "callout",
    ...
    cheat: {
      label: 'Cheat Sheet',
      content: [
        { type: 'h2', text: 'LSAT Math — Cheat Sheet' },
        {
          type: 'callout',
          variant: 'summary',
          title: 'Key Principle',
          text: '**Every LSAT math flaw exploits the same gap: the argument shifts between two units of measurement (count vs. rate, part vs. whole, relative vs. absolute) without proving the shift is valid.**',
        },
        {
          type: 'table',
          headers: ['Pattern', 'What It Means', 'How to Handle'],
          rows: [
            ['Raw number cited as evidence, rate-based conclusion', 'Numbers vs. Percentages flaw', 'Ask: "Out of how many?" Convert the count to a rate before judging'],
            ['Subgroup data, whole-group conclusion (or vice versa)', 'Part vs. Whole / Composition-Division error', 'Check whether the evidence scope matches the conclusion scope'],
            ['"Average" used as proxy for "typical"', 'Outlier-driven mean or Simpson\'s Paradox', 'Ask whether outliers or subgroup sizes could reverse the trend'],
            ['High test accuracy cited for a rare condition', 'Base Rate Neglect', 'Consider: false positives may dominate when prevalence is low'],
            ['Past streak used to predict future outcome', 'Gambler\'s Fallacy', 'Ask: are the events independent? If yes, past results are irrelevant'],
            ['"Doubled" or "tripled" without base numbers', 'Relative vs. Absolute Change illusion', 'Convert to absolute figures; "tripled" from 1 to 3 is trivial'],
            ['Two overlapping categories added together', 'Double Counting', 'Ask whether a member could belong to both groups; if so, the total is inflated'],
          ],
        },
        {
          type: 'table',
          ...
          rows: [
            ['The Impressive Number', 'A large raw count sounds alarming in isolation', 'Always ask for the denominator; 10,000 out of 100 million is trivial'],
            ['The Shifting Baseline', 'Two percentages look comparable at face value', 'Verify the underlying totals stayed constant between the compared periods'],
            ['The Reversed Conditional', 'P(positive | disease) looks like P(disease | positive)', 'Identify the direction: the question flips who is in the denominator'],
            ['The Composition Error', 'What is true of each part feels like it should be true of the whole', 'Check scope: does the evidence describe parts but the conclusion describe the whole?'],
            ['The Relative-Change Illusion', '"50% increase" sounds dramatic regardless of base', 'Convert between relative and absolute; compute actual numbers if possible'],
          ],
        },
        {
          type: 'list',
          items: [
            '**Signal words for proportional language:** percent, ratio, rate, share, per capita, relative to',
            '**Signal words for aggregate language:** number, total, count, amount, sum, quantity',
            '**Signal words for averages:** average, mean, median, typical, on the whole',
            '**Signal words for change:** increase, decrease, doubled, tripled, halved, grew',
            '**Flaw-type mnemonic (B-A-R-G-D-P-R-P):** Base rate, Averages, Relative vs. absolute, Gambler\'s, Double counting, Part vs. whole, numbers vs. Rates, Percentage of a percentage',
          ],
        },
        {
          type: 'callout',
          variant: 'summary',
          title: 'The One Thing',
          text: 'When a quantitative stimulus shifts units between the evidence and the conclusion — count to rate, part to whole, relative to absolute — that shift is almost always the flaw. Name the shift, and the correct answer writes itself.',
        },
      ],
    },
  },
