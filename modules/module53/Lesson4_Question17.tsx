...
export const Lesson4_Question17: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-110-S-4-Q-17', questionType: 'Passage Purpose', passageTitle: 'Critical Legal Studies', passage: passageText, question: `The author’s primary purpose in the passage is to`, options: [
    ...
    { 
      ...
      items: [
        { title: "(A)", text: "The passage does not evaluate several different legal doctrines. Instead, it focuses on one philosopher's critique of a single legal theory.", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(B)", text: "The passage describes the substance of a disagreement, but it does not explain the historical background or the specific events that led to the controversy.", badge: 'Out of Scope', badgeColor: "red" },
        { title: "(C)", text: "The author is not advocating for their own position but is describing someone else's (Meyerson's) critique. Meyerson's arguments are a challenge to CLS, not necessarily a whole new interpretation of legal tradition.", badge: 'Partial Match', badgeColor: "red" },
        ...
        { title: "(E)", text: "While Meyerson refutes claims, the author's primary role is to describe her arguments, not to do the refuting. Also, the passage centers on Meyerson's challenge to one movement (CLS), not on claims from 'various scholars'.", badge: 'Misreading', badgeColor: "red" }
    ]
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question 17 Breakdown"
        },
        {
          "type": "blockquote",
          "text": "**Question:** The author’s primary purpose in the passage is to"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This is a Passage Purpose question. It asks for the author's main goal in writing the passage. The author's role here is primarily that of a reporter or explainer. They are not advancing their own argument, but are systematically presenting the arguments of one person (Meyerson) as they relate to another group (CLS). The entire passage is structured to detail Meyerson's critique."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "The passage does not evaluate several different legal doctrines. Instead, it focuses on one philosopher's critique of a single legal theory.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "The passage describes the substance of a disagreement, but it does not explain the historical background or the specific events that led to the controversy.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "The author is not advocating for their own position but is describing someone else's (Meyerson's) critique. Meyerson's arguments are a challenge to CLS, not necessarily a whole new interpretation of legal tradition.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "This choice accurately captures the main goal of the passage. The author's purpose is to present Meyerson's specific arguments, which act as a 'challenge' to the 'school of thought' known as Critical Legal Studies (CLS).",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(E)",
              "text": "While Meyerson refutes claims, the author's primary role is to describe her arguments, not to do the refuting. Also, the passage centers on Meyerson's challenge to one movement (CLS), not on claims from 'various scholars'.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
