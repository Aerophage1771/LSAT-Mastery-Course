...
export const Lesson3_Question16: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-110-S-4-Q-16', questionType: 'Phrase Function', passageTitle: 'Critical Legal Studies', passage: passageText, question: `The primary purpose of the reference to a game in the last paragraph is to`, options: [
    ...
    { type: 'paragraph', text: "This question asks for the function of the 'game' reference in the final paragraph. Meyerson introduces the hypothetical game to illustrate her point that one can apply a set of rules to determine an outcome without necessarily endorsing the moral value of those rules. This is a classic use of an analogy—a comparison between two different things to clarify or explain a principle." },
    { 
      type: 'breakdown',
      labels: { title: 'Option', text: 'Analysis' },
      items: [
        { title: "(A)", text: "The game is a hypothetical scenario created to make a point, not a real-world example of how a legal principle was used in the past. Therefore, it is not a previous application.", badge: 'Content Dump', badgeColor: "red" },
        { title: "(B)", text: "This choice is correct because Meyerson uses the game as a direct comparison to the legal system to make her point. An analogy is a comparison between two things to explain or clarify an idea. Here, the game illustrates her argument that applying rules (legal formalism) does not require believing in their moral rightness (objectivism).", badge: "Correct", badgeColor: "green" },
        { title: "(C)", text: "Meyerson's goal is not to suggest that the law is unimportant like a game. She uses the comparison only to isolate and explain a specific point about the nature of rules.", badge: 'Wrong Function', badgeColor: "red" },
        { title: "(D)", text: "The reference to the game is meant to highlight a similarity with the law, not to contrast them. Meyerson is arguing that the law is *like* the game in that rules can be separated from moral endorsement.", badge: 'Wrong Scope', badgeColor: "red" },
        { title: "(E)", text: "While the game itself involves a wrongful act (stealing), Meyerson uses it to defend legal formalism, not to dismiss it. The game's clear separation of rules from morality helps strengthen her argument.", badge: 'Partial Role', badgeColor: "red" }
    ]
    },
    { type: 'callout', variant: 'summary', title: 'Key Takeaway', text: 'Function questions ask WHY the author included something — not WHAT it says.' },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question 16 Breakdown"
        },
        {
          "type": "blockquote",
          "text": "**Question:** The primary purpose of the reference to a game in the last paragraph is to"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks for the function of the 'game' reference in the final paragraph. Meyerson introduces the hypothetical game to illustrate her point that one can apply a set of rules to determine an outcome without necessarily endorsing the moral value of those rules. This is a classic use of an analogy—a comparison between two different things to clarify or explain a principle."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "The game is a hypothetical scenario created to make a point, not a real-world example of how a legal principle was used in the past. Therefore, it is not a previous application.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "This choice is correct because Meyerson uses the game as a direct comparison to the legal system to make her point. An analogy is a comparison between two things to explain or clarify an idea. Here, the game illustrates her argument that applying rules (legal formalism) does not require believing in their moral rightness (objectivism).",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(C)",
              "text": "Meyerson's goal is not to suggest that the law is unimportant like a game. She uses the comparison only to isolate and explain a specific point about the nature of rules.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "The reference to the game is meant to highlight a similarity with the law, not to contrast them. Meyerson is arguing that the law is *like* the game in that rules can be separated from moral endorsement.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "While the game itself involves a wrongful act (stealing), Meyerson uses it to defend legal formalism, not to dismiss it. The game's clear separation of rules from morality helps strengthen her argument.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
