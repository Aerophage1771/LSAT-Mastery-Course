...
export const Lesson7_Question20: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-110-S-4-Q-20', questionType: 'Structure', passageTitle: 'Critical Legal Studies', passage: passageText, question: `Which one of the following most accurately describes the organization of the final paragraph in the passage?`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Structure', text: 'Write a one-line summary of each paragraph\\u0027s job. Chain them sequentially. The correct answer describes this exact flow.' },
    ...
    { 
      ...
      items: [
        ...
        { title: "(B)", text: "This choice is incorrect because the paragraph presents arguments from two opposing sides (Meyerson versus CLS), not from two opponents who share the same viewpoint.", badge: 'Wrong Sequence', badgeColor: "red" },
        { title: "(C)", text: "While the paragraph does outline arguments for and against a position, it does not offer a new position to reconcile them. Instead, Meyerson's argument is presented as a direct refutation of the CLS position.", badge: 'Missing Step', badgeColor: "red" },
        { title: "(D)", text: "The paragraph presents a debate about the logical relationship between two ideas (legal formalism and objectivism), not a debate about the practical consequences of holding a certain belief.", badge: 'Added Step', badgeColor: "red" },
        { title: "(E)", text: "The paragraph does not imagine two different solutions to summarize a controversy. It examines a single point of disagreement in detail by presenting an argument and a series of responses to it.", badge: 'Partial Blueprint', badgeColor: "red" }
    ]
    },
    { type: 'callout', variant: 'summary', title: 'Key Takeaway', text: 'Structure answers must match the passage\\u0027s flow exactly. One wrong step disqualifies the answer.' },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following most accurately describes the organization of the final paragraph in the passage?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This is a Structure question focused on the final paragraph. We must map its logical flow. The paragraph begins by identifying a 'CLS charge' (a criticism of legal formalism). Meyerson then responds to this charge. A potential CLS counter-response ('A CLS scholar might object...') is introduced, followed by Meyerson's final reply. This entire sequence is an investigation into the plausibility of the initial CLS criticism."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "This answer is correct because the paragraph's structure follows this exact pattern. It first identifies the 'CLS charge' (the criticism) and then investigates its plausibility by presenting Meyerson's counterargument, a potential objection from a CLS scholar, and Meyerson's final reply.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B)",
              "text": "This choice is incorrect because the paragraph presents arguments from two opposing sides (Meyerson versus CLS), not from two opponents who share the same viewpoint.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "While the paragraph does outline arguments for and against a position, it does not offer a new position to reconcile them. Instead, Meyerson's argument is presented as a direct refutation of the CLS position.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "The paragraph presents a debate about the logical relationship between two ideas (legal formalism and objectivism), not a debate about the practical consequences of holding a certain belief.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "The paragraph does not imagine two different solutions to summarize a controversy. It examines a single point of disagreement in detail by presenting an argument and a series of responses to it.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
