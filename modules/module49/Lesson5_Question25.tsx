...
export const Lesson5_Question25: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-141-S-1-P-4-Q-25', questionType: 'Analogy', passageTitle: 'Property Justice', passage: passageText, question: `Based on what can be inferred from their titles, the relationship between which one of the following pairs of documents is most analogous to the relationship between passage A and passage B?`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Analogy', text: 'Abstract the passage relationship to a topic-neutral rule. Test each answer\\u0027s underlying logic against that rule — ignore surface similarities.' },
    ...
    { type: 'breakdown', labels: { title: "Option", text: "Analysis" }, items: [
      { title: "(A) “Card Counting for Everyone: A Can’t-Lose System for Beating the Dealer” / “The Evils of Gambling”", text: "The relationship here is one of opposition or conflicting values (a how-to guide vs. a moral condemnation). This is not the required relationship.", badge: 'Topic Match Trap', badgeColor: "red" },
      { title: "(B) “Mayor McConnell Is Unfit to Serve” / “Why Mayor McConnell Should be Reelected”", text: "This is a direct pro/con debate on a specific topic. This is a relationship of point/counterpoint, not theory/application.", badge: 'Wrong Structure', badgeColor: "red" },
      { title: "(C) “Pruning Fruit Trees: A Guide for the Novice” / “Easy Recipes for Beginning Cooks”", text: "These are two separate, parallel guides for beginners on different subjects. One is not an application of the other.", badge: 'Partial Match', badgeColor: "red" },
      { title: "(D) “Notable Failures of the STORM Weather Forecasting Model” / “Meteorologists’ Best Tool Yet: The STORM Forecasting Model”", text: "This is another point/counterpoint relationship, arguing for and against the value of a specific tool.", badge: 'Wrong Scope', badgeColor: "red" },
    ...
    { type: 'callout', variant: 'summary', title: 'Key Takeaway', text: 'Answers sharing the same TOPIC but different logical structure are the most dangerous traps.' },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-141-S-1-P-4-Q-25"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Based on what can be inferred from their titles, the relationship between which one of the following pairs of documents is most analogous to the relationship between passage A and passage B?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This is an analogy question. The task is to identify a pair of document titles whose relationship is \"most analogous\" to the relationship between Passage A and Passage B. To solve this, we must first precisely define the relationship between the original passages."
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "The core relationship is **[General Theory/Fundamental Principles of Repair] → [Specific Application/Analysis of a concrete problem needing repair]**."
        },
        {
          "type": "paragraph",
          "text": "Now we evaluate the answer choices to find a pair that mirrors this abstract-to-concrete, theory-to-application relationship."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) “Card Counting for Everyone: A Can’t-Lose System for Beating the Dealer” / “The Evils of Gambling”",
              "text": "The relationship here is one of opposition or conflicting values (a how-to guide vs. a moral condemnation). This is not the required relationship.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) “Mayor McConnell Is Unfit to Serve” / “Why Mayor McConnell Should be Reelected”",
              "text": "This is a direct pro/con debate on a specific topic. This is a relationship of point/counterpoint, not theory/application.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) “Pruning Fruit Trees: A Guide for the Novice” / “Easy Recipes for Beginning Cooks”",
              "text": "These are two separate, parallel guides for beginners on different subjects. One is not an application of the other.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) “Notable Failures of the STORM Weather Forecasting Model” / “Meteorologists’ Best Tool Yet: The STORM Forecasting Model”",
              "text": "This is another point/counterpoint relationship, arguing for and against the value of a specific tool.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) “Fundamentals of Building Construction and Repair” / “Engineering Report: The Repairs Needed by the Thales Building”",
              "text": "This pair fits the analogy perfectly.\n*   The first title, \"Fundamentals of Building Construction and Repair,\" represents a **general theory**, including principles for **fixing problems (\"Repair\")**. This is analogous to Passage A.\n*   The second title, \"Engineering Report: The Repairs Needed by the Thales Building,\" represents a **specific application** of those principles to a **concrete problem (\"The Thales Building\")** that needs **fixing (\"Repairs Needed\")**. This is analogous to Passage B.",
              "badge": "Correct",
              "badgeColor": "green"
            }
          ]
