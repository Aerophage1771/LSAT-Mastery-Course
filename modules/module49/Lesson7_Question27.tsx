...
export const Lesson7_Question27: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-141-S-1-P-4-Q-27', questionType: 'Approach', passageTitle: 'Property Justice', passage: passageText, question: `Which one of the following most accurately describes the difference in approach taken by passage A as compared to passage B?`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Approach', text: 'Identify the author\\u0027s argumentative strategy: comparing, critiquing, proposing, defending, or analyzing.' },
    ...
    { type: 'breakdown', labels: { title: "Option", text: "Analysis" }, items: [
      ...
      { title: "(B) Passage A argues for the superiority of one view over competing views, while passage B considers only a single view.", text: "Passage A does not mention or argue against any \"competing views.\" It simply presents one theory.", badge: 'Content Dump', badgeColor: "red" },
      { title: "(C) Passage A invokes commonly held principles to support a policy recommendation, while passage B relies on the views of established authorities to support its claims.", text: "Passage A is a philosophical theory, not a \"policy recommendation.\" Passage B builds its case on a logical argument, not on an appeal to \"established authorities.\"", badge: 'Wrong Method', badgeColor: "red" },
      { title: "(D) Passage A briefly states a view and then provides an argument for it, while passage B provides a detailed statement of a view but no argument.", text: "This mischaracterizes both. Passage A explains a view but provides little in the way of an argument *for* it against other views. Passage B provides a very clear and structured \"argument.\"", badge: 'Partial Description', badgeColor: "red" },
      { title: "(E) Passage A provides an argument in support of a view, while passage B attempts to undermine a view.", text: "Passage B does the opposite of undermining a view; it builds a strong argument *in support of* the view that Native American land claims are just.", badge: 'Wrong Scope', badgeColor: "red" }
    ]},
    { type: 'callout', variant: 'summary', title: 'Key Takeaway', text: 'Approach questions ask HOW the author argues — not WHAT they argue.' },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-141-S-1-P-4-Q-27"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following most accurately describes the difference in approach taken by passage A as compared to passage B?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks for the most accurate description of the \"difference in approach\" between the two passages. This requires an analysis of the tone, style, and rhetorical stance of each author."
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "We need an answer choice that captures both the generality of A and the specific, yet slightly detached, argumentative style of B."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) Passage A espouses a general view without providing details, while passage B sketches an argument that it does not necessarily endorse.",
              "text": "This choice accurately captures the nuances of both passages. Passage A does present a \"general view\" (the theory) without specific application \"details.\" Passage B \"sketches an argument,\" and the phrasing \"one natural way of reasoning\" suggests the author \"does not necessarily endorse\" it as their own final position, but rather presents it as a logical line of thought. This is a very strong fit.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B) Passage A argues for the superiority of one view over competing views, while passage B considers only a single view.",
              "text": "Passage A does not mention or argue against any \"competing views.\" It simply presents one theory.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) Passage A invokes commonly held principles to support a policy recommendation, while passage B relies on the views of established authorities to support its claims.",
              "text": "Passage A is a philosophical theory, not a \"policy recommendation.\" Passage B builds its case on a logical argument, not on an appeal to \"established authorities.\"",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) Passage A briefly states a view and then provides an argument for it, while passage B provides a detailed statement of a view but no argument.",
              "text": "This mischaracterizes both. Passage A explains a view but provides little in the way of an argument *for* it against other views. Passage B provides a very clear and structured \"argument.\"",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) Passage A provides an argument in support of a view, while passage B attempts to undermine a view.",
              "text": "Passage B does the opposite of undermining a view; it builds a strong argument *in support of* the view that Native American land claims are just.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
