...
export const Lesson1_PassageAnalysis: Lesson = {
  ...
  content: [
    { type: 'passage-card', title: 'Property Justice', passage: passageText, paragraphCount: 3, wordCount: 476 },    { type: 'h3', text: "Passage Analysis" },
    ...
    { type: 'list', items: [
      "**The Principle of Justice in Acquisition:** This principle defines how an individual can legitimately come to own something that was previously unowned. It is the rule for original ownership.",
      "**The Principle of Justice in Transfer:** This principle defines the conditions under which property can be justly transferred from one owner to another (e.g., through sale, gift, or inheritance)."
    ]},
    ...
    { type: 'list', items: [
      "**The Principle of Rectification:** This principle is designed to correct for past injustices. It involves a two-step process: first, determining through historical analysis what the distribution of property *should* have been if the injustice had not occurred; and second, taking action to bring the current, actual ownership into alignment with that ideal, rectified state."
    ]},
    ...
    { type: 'list', items: [
      "Native Americans were the original occupants and thus the rightful owners of the land.",
      "This land was \"illicitly taken from them\" during and after the European invasion.",
      "Consequently, the current owners lack a legitimate right to the land.",
      "The ideal moral remedy is to restore the land to its rightful owners wherever this is feasible, acknowledging that compromises may be necessary due to practical difficulties."
    ]},
    ...
    { type: 'callout', title: "Comparative Workflow Anchor", variant: "summary", text: "This is a classic **theory -> application** comparative set. The clean reading workflow is: summarize Passage A's framework, read Passage B while testing it against that framework, then state the relationship before doing the questions. Passage A provides the abstract principles; Passage B applies them to a concrete land-claims dispute." },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h4",
          "text": "Passage A: The Philosophical Framework"
        },
        {
          "type": "paragraph",
          "text": "This passage outlines a three-part philosophical theory of justice regarding property ownership. It is abstract, logical, and structured like a formal proof."
        },
        {
          "type": "paragraph",
          "text": "First, the author establishes two fundamental principles that would govern a perfectly just world:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "The author then introduces a critical complication: the real world is not perfectly just. Injustices like theft and fraud break the chain of legitimate ownership. This necessitates a third principle to address these historical wrongs:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h4",
          "text": "Passage B: A Real-World Application"
        },
        {
          "type": "paragraph",
          "text": "This passage moves from abstract theory to a concrete historical case: the land claims of Native Americans in the United States."
        },
        {
          "type": "paragraph",
          "text": "It begins by citing a specific law, the Indian Nonintercourse Act of 1790, which was designed to prevent fraudulent land transfers from Native Americans, thereby acknowledging the potential for injustice."
        },
        {
          "type": "paragraph",
          "text": "The author then presents what is described as a \"natural\" and \"obvious\" line of reasoning regarding these claims:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h4",
          "text": "The Head-to-Head: Theory Meets Practice"
        },
        {
          "type": "paragraph",
          "text": "The relationship between the two passages is that of a general theory and a specific application. Passage A provides the abstract philosophical framework, while Passage B presents a real-world scenario that serves as a perfect case study for that framework."
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "In essence, Passage A provides the blueprint for fixing historical injustices related to property, and Passage B identifies a specific, large-scale historical injustice that demands such rectification."
        },
        {
          "type": "callout",
          "title": "Summary",
          "variant": "summary",
          "text": "• **Passage A (The Theory):** Outlines a three-part philosophical theory for just property ownership: (1) just acquisition, (2) just transfer, and (3) a principle of **rectification** to correct for historical injustices.\n• **Passage B (The Case Study):** Presents the historical case of Native American land claims, arguing that since their land was acquired justly and then transferred unjustly, the proper remedy is restoration.\n• **The Connection:** Passage B serves as a concrete example of the abstract problem that Passage A's \"Principle of Rectification\" is designed to solve."
        }
      ],
    },
  },
