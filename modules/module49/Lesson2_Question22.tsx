...
export const Lesson2_Question22: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-141-S-1-P-4-Q-22', questionType: 'Passage Purpose', passageTitle: 'Property Justice', passage: passageText, question: `Which one of the following most accurately describes the main purpose for which passage A was written and the main purpose for which passage B was written?`, options: [
    ...
    { type: 'breakdown', labels: { title: "Option", text: "Analysis" }, items: [
      { title: "(A) Passage A: to propose a solution to a moral problem / Passage B: to criticize a proposed solution to a moral problem", text: "This mischaracterizes both passages. Passage A offers a framework, not a solution to a specific problem. Passage B argues *for* a solution (restoration), it does not criticize one.", badge: 'Too Extreme', badgeColor: "red" },
      ...
      { title: "(C) Passage A: to spell out the details of two fundamental principles / Passage B: to examine a case that exemplifies a moral ideal", text: "The first part is factually incorrect. Passage A discusses *three* principles (acquisition, transfer, and rectification).", badge: 'Out of Scope', badgeColor: "red" },
      { title: "(D) Passage A: to argue for a particular moral ideal / Passage B: to question the assumptions of a moral theory", text: "This misstates the tone and function of both. Passage A is more descriptive than argumentative. Passage B applies the assumptions of such a moral theory; it does not question them.", badge: 'Partial Match', badgeColor: "red" },
      { title: "(E) Passage A: to advocate the use of certain moral principles / Passage B: to provide a counterexample to some widely held moral principles", text: "The word \"advocate\" is arguably too strong for Passage A's neutral tone. More importantly, Passage B provides a classic *example* of the principles in action, not a counterexample.", badge: 'Misreading', badgeColor: "red" }
    ]},
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-141-S-1-P-4-Q-22"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following most accurately describes the main purpose for which passage A was written and the main purpose for which passage B was written?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks for the \"main purpose\" of each passage. This requires understanding the overall goal of each text."
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "We are looking for an answer choice that captures this distinction between a general, theoretical outline and a specific, applied analysis."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) Passage A: to propose a solution to a moral problem / Passage B: to criticize a proposed solution to a moral problem",
              "text": "This mischaracterizes both passages. Passage A offers a framework, not a solution to a specific problem. Passage B argues *for* a solution (restoration), it does not criticize one.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) Passage A: to sketch a general outline of a branch of moral theory / Passage B: to give a particular moral analysis of a real case",
              "text": "This aligns perfectly with our analysis. Passage A \"sketches a general outline\" of a theory of justice. Passage B gives a \"particular moral analysis\" of the \"real case\" of Native American land claims.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(C) Passage A: to spell out the details of two fundamental principles / Passage B: to examine a case that exemplifies a moral ideal",
              "text": "The first part is factually incorrect. Passage A discusses *three* principles (acquisition, transfer, and rectification).",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) Passage A: to argue for a particular moral ideal / Passage B: to question the assumptions of a moral theory",
              "text": "This misstates the tone and function of both. Passage A is more descriptive than argumentative. Passage B applies the assumptions of such a moral theory; it does not question them.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) Passage A: to advocate the use of certain moral principles / Passage B: to provide a counterexample to some widely held moral principles",
              "text": "The word \"advocate\" is arguably too strong for Passage A's neutral tone. More importantly, Passage B provides a classic *example* of the principles in action, not a counterexample.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
