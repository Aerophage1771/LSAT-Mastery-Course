  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "paragraph",
          "text": "By analyzing this question type, we can identify three common patterns. Recognizing these will help you anticipate the structure of the correct answer."
        },
        {
          "type": "breakdown",
          "labels": {
