...
export const Lesson6_Advanced_DeconstructingHighDifficulty: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'On the hardest Parallel Flaw questions, the standard two-step process (Name the Flaw → Find the Match) often needs reinforcement. The **Structural Elimination Method** adds systematic checkpoints that help you navigate compound flaws and multiple viable candidates.',
    },

    {
      type: 'process',
      title: 'The Structural Elimination Method',
      steps: [
    ...
    {
      type: 'paragraph',
      text: 'When multiple answer choices look similar, use these structural dimensions to distinguish them:',
    },
    {
      type: 'table',
      headers: ['Dimension', 'What to Check', 'Common Trap'],
      rows: [
        [
          '**Conditional Direction**',
          'Does the answer reverse the conditional in the same direction as the stimulus? (MR vs. MN)',
          'An answer commits a Mistaken Negation when the stimulus commits a Mistaken Reversal — close but not identical',
        ],
        [
          '**Quantifier Match**',
          'Does the answer use the same quantifier scope? (All vs. Some vs. Most)',
          'An answer uses "some" where the stimulus uses "all," changing the logical structure entirely',
        ],
        [
          '**Epistemic Layer**',
          'Does the answer include a mental-state verb (knows, believes, intends) matching the stimulus?',
          'An answer drops the "knows" component, committing only the surface flaw but not the epistemic one',
        ],
        [
          '**Causal vs. Correlational**',
          'Does the answer assert causation in the same way as the stimulus?',
          'An answer treats a correlation as evidence when the stimulus treats it as proof — the strength of claim differs',
        ],
        [
          '**Number of Entities**',
          'Does the answer involve the same number of groups, rules, or agents?',
          'An answer adds an extra group or condition not present in the stimulus, changing the structural geometry',
        ],
        [
          '**Conclusion Scope**',
          "Does the answer's conclusion match the scope (universal/particular) of the stimulus's conclusion?",
          'An answer concludes about "all" members when the stimulus concludes about a specific individual',
        ],
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'The LSAT deploys specific trap designs on hard Parallel Flaw questions. Recognizing them saves time and prevents second-guessing:',
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          title: 'The Half-Match',
          text: 'The answer replicates one of two compound flaws perfectly but drops the other. This is the dominant trap when the stimulus has a Double Flaw. It exploits test-takers who stop checking after finding the first flaw match.',
          badge: 'Very Common',
          badgeColor: 'red',
        },
        {
          title: 'The Topic Twin',
          text: 'The answer discusses the same subject matter or uses similar vocabulary as the stimulus but commits a different structural error. It exploits the natural bias toward topical similarity over logical similarity.',
          badge: 'Very Common',
          badgeColor: 'red',
        },
        {
          title: 'The Adjacent Flaw',
          text: 'The answer commits a flaw in the same *family* as the stimulus (e.g., both are conditional errors) but the specific mechanism differs (Mistaken Reversal vs. Mistaken Negation). This is the hardest trap to avoid without precise flaw identification.',
          badge: 'Common',
          badgeColor: 'red',
        },
        {
          title: 'The Valid Decoy',
          text: 'The answer is actually logically valid but uses complex language that makes it *look* flawed. On hard questions, valid decoys are designed to survive a quick read. You must verify the logic carefully before eliminating.',
          badge: 'Common',
          badgeColor: 'red',
        },
        {
          title: 'The Overcomplicated Choice',
          text: 'The answer introduces additional logical layers not present in the stimulus (extra premises, additional conditions). Even if it commits the right flaw, the extra complexity means its overall structure does not parallel the stimulus.',
          badge: 'Occasional',
          badgeColor: 'red',
        },
      ],
    ...
    { type: 'h3', text: 'Answer Choice Breakdown' },
    {
      ...
      items: [
        ...
        {
          title:
            '(B) Every certified inspector has passed the advanced safety course. Since Tomás has passed, Tomás is a certified inspector.',
        ...
        {
          title:
            '(C) Every tenured professor has published at least three peer-reviewed articles. Dr. Patel has published three articles. Since Dr. Patel knows she has published three articles, Dr. Patel knows she has tenure.',
        ...
        {
          title:
            '(D) All students who complete the internship receive a letter of recommendation. Kenji knows he will receive a letter. Therefore, Kenji knows he has completed the internship.',
        ...
        {
          title:
            '(E) If a building meets the new safety code → occupancy permit. Permit obtained. Therefore, building meets the code.',
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Advanced: Deconstructing High-Difficulty Parallel Flaws"
        },
        {
          "type": "h3",
          "text": "Why Some Parallel Flaw Questions Are Brutally Hard"
        },
        {
          "type": "paragraph",
          "text": "You have now practiced matching individual flaws: Mistaken Negation, Composition, Missing Comparison, and more. On a medium-difficulty Parallel Flaw question, the stimulus commits one recognizable error, and the correct answer replicates it cleanly. But the hardest questions — the ones that appear in the final third of a section and carry the highest difficulty ratings — operate differently. They are engineered to defeat the standard two-step process by making every step harder."
        ...
        {
          "type": "h4",
          "text": "Factor 2: Abstract Structure"
        },
        {
          "type": "paragraph",
          "text": "The LSAT hides the flaw inside dense, abstract, or unfamiliar subject matter. When the stimulus discusses epistemology, statistical methodology, or philosophy of science, your brain spends cognitive resources on comprehension rather than analysis. Meanwhile, the correct answer may involve an everyday topic — buying supplies for a club, planning a road trip — that *feels* too simple to be right."
        ...
        {
          "type": "h4",
          "text": "Factor 3: Multiple Viable Candidates"
        },
        {
          "type": "paragraph",
          "text": "In easier questions, only one or two answer choices are even plausibly similar to the stimulus. In the hardest questions, **three or four** answer choices commit logical errors that resemble the stimulus flaw. The differences between them are subtle: one might use \"some\" where the stimulus uses \"all,\" or one might reverse the direction of a causal claim. You must perform precise structural matching to distinguish the perfect match from the near-misses."
        ...
        {
          "type": "h3",
          "text": "The Structural Elimination Method"
        },
        {
          "type": "paragraph",
          "text": "On the hardest Parallel Flaw questions, the standard two-step process (Name the Flaw → Find the Match) often needs reinforcement. The **Structural Elimination Method** adds systematic checkpoints that help you navigate compound flaws and multiple viable candidates."
        ...
        {
          "type": "h3",
          "text": "Advanced Flaw Matching Techniques"
        },
        {
          "type": "paragraph",
          "text": "When multiple answer choices look similar, use these structural dimensions to distinguish them:"
        ...
        {
          "type": "h3",
          "text": "Step 1: Diagnose All Flaws"
        },
        {
          "type": "paragraph",
          "text": "Let's map the stimulus:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h3",
          "text": "Step 2: Build the Blueprint"
        },
        {
          "type": "callout",
          "title": "Blueprint (Compound Flaw)",
