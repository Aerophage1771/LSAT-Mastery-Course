...
export const Lesson8_Drill_NetEffectFlaw: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'Imagine a cup of incredibly delicious, nutrient-rich coffee that also happens to have one drop of poison in it. If the coffee is so powerful that its benefits far outweigh the harm of the poison, the person who drinks it might end up *healthier overall*. The Net Effect Flaw would be to look at that person and conclude: "Well, they drank the coffee *and* the poison, and they got healthier, so the poison must be harmless."',
    },
    {
      type: 'paragraph',
      text: 'This is wrong because the positive net effect does not absolve the poison. It is entirely possible — even likely — that the person would be *even healthier* if they drank the coffee without the poison. The net benefit exists *despite* the harmful component, not *because* every component is beneficial.',
    },

    {
      ...
      text: '**The Net Effect Flaw:** An argument observes that a combination of factors (A + B) produces a positive overall result, and then concludes that a specific, potentially harmful component (B) is itself not harmful.\n\nThe error: the positive outcome could be entirely driven by factor A, which is so beneficial that it masks the damage caused by B.',
    },
    ...
    {
      type: 'paragraph',
      text: 'The Net Effect Flaw most commonly appears in arguments about health, economics, and policy — contexts where multiple factors interact to produce an aggregate outcome. The flaw exploits two types of reasoning:',
    },
    {
      type: 'table',
      headers: ['Reasoning Type', 'How the Flaw Works', 'Example'],
      rows: [
        [
          '**Percentage / Rate Arguments**',
          'An overall rate improvement is used to conclude that a risky component is harmless',
          '"People who eat fruits and vegetables (including those with pesticide residues) have lower cancer rates. Therefore, pesticide residues pose no health risk." — The cancer reduction could come entirely from the fruits and vegetables, *despite* the pesticides.',
        ],
        [
          '**Quantity / Magnitude Arguments**',
          'A large positive total is used to dismiss a small negative component',
          '"The new factory brought in $10 million in revenue and also produced pollution. Since the town is economically better off, the pollution must not be harmful." — The economic benefit does not mean the pollution is harmless; the town could be even better off without it.',
        ],
        [
          '**Comparative Arguments**',
          'A favorable comparison between packages is used to absolve a risky component',
          '"Communities near power plants have lower disease rates than the national average. Therefore, power plants pose no health risk." — The economic benefits of the power plant (better hospitals, higher incomes) could be driving the health improvement, masking radiation risk.',
        ],
      ],
    },
    ...
    },
    {
      ...
      text: 'When you see this pattern, ask yourself: **"Is it possible that the good component is so powerful that it is masking the harm of the bad component?"** If the answer is yes, you have found the Net Effect Flaw.',
    },
    ...
    { type: 'h3', text: 'Answer Choice Breakdown' },
    {
      ...
      items: [
        {
          title:
            '(A) Communities with modern power plants have lower illness rates — whether nuclear or not — so nuclear plants pose no health risk.',
        ...
        {
          title:
            '(B) No health risk from high-fat diet if combined with exercise. So exercise is more useful than dietary restriction.',
        ...
        {
          title:
            '(C) Trained motorcyclists have fewer accidents than car drivers who only pass a driving test. So motorcycles are not inherently riskier.',
        ...
        {
          title:
            '(D) Wooden cutting boards have fewer microbes than plastic boards after washing. So wooden boards pose no greater microbial risk.',
        ...
        {
          title:
            '(E) Vitamin supplements offer no greater benefit than fruits and vegetables. So there is no risk in skipping supplements if you eat enough produce.',
    ...
    {
      type: 'paragraph',
      text: 'Choice (C) is the strongest distractor because it *also* involves a flawed health/risk conclusion, and it *also* involves a confounding factor. But the structural mechanism is different:',
    },
    {
      type: 'table',
      headers: ['Element', 'Stimulus (Net Effect)', 'Choice A (Net Effect)', 'Choice C (Confounded Comparison)'],
      rows: [
        [
          '**Data type**',
          'One-package data (produce with pesticides)',
          'One-package data (community with nuclear plant)',
          'Two-group comparison (trained motorcyclists vs. tested drivers)',
        ],
        [
          '**What is being absolved?**',
          'A component *within* the package (pesticides)',
          'A component *within* the package (nuclear risk)',
          'An entire category (motorcycles as a vehicle type)',
        ],
        [
          '**Source of the error**',
          'Net benefit masks component harm',
          'Net benefit masks component harm',
          'Confounding variable (training) distorts comparison',
        ],
        [
          '**Missing information**',
          'Outcome without the harmful component',
          'Outcome without the harmful component',
          'Outcome with equal training for both groups',
        ],
      ],
    },
    {
      type: 'paragraph',
      text: 'The key distinction: in the stimulus and in (A), the *same population* is exposed to a package, and the argument absolves one ingredient. In (C), *different populations* are compared under different conditions, and the argument draws a conclusion about vehicle safety. Different flaw, different structure.',
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Drill: The Net Effect Flaw"
        },
        {
          "type": "h3",
          "text": "Concept Focus: The Net Effect Flaw"
        },
        {
          "type": "paragraph",
          "text": "One of the most sophisticated causal errors on the LSAT is what we might call the **Net Effect Flaw**, or the **\"Good with the Bad\" Fallacy**. This flaw occurs when an argument observes an overall positive outcome from a complex situation and incorrectly concludes that **every single component** of that situation must be either positive or neutral."
        ...
        {
          "type": "h3",
          "text": "How Percentage and Quantity Arguments Create Net Effect Errors"
        },
        {
          "type": "paragraph",
          "text": "The Net Effect Flaw most commonly appears in arguments about health, economics, and policy — contexts where multiple factors interact to produce an aggregate outcome. The flaw exploits two types of reasoning:"
        ...
        {
          "type": "h3",
          "text": "Spotting the Net Effect Flaw"
        },
        {
          "type": "paragraph",
          "text": "When reading a stimulus, look for this three-part structure:"
        },
        {
          "type": "process",
          "title": "The Net Effect Pattern",
        ...
        {
          "type": "h3",
          "text": "Step 1: Diagnose the Flaw"
        },
        {
          "type": "paragraph",
          "text": "Let's break down the argument's core components:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h3",
          "text": "Trap Analysis: Why (C) Is Tempting"
        },
        {
          "type": "paragraph",
          "text": "Choice (C) is the strongest distractor because it *also* involves a flawed health/risk conclusion, and it *also* involves a confounding factor. But the structural mechanism is different:"
        },
        {
          ...
          "headers": [
            ...
            "Stimulus (Net Effect)",
            "Choice A (Net Effect)",
            "Choice C (Confounded Comparison)"
          ],
          "rows": [
            [
              "**Data type**",
