...
export const Lesson7_Drill_DoubleFlaw: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'Double Flaw arguments typically layer a **surface-level logical error** with a **deeper conceptual error**. The surface flaw is the one most test-takers will catch. The deeper flaw is the one that separates high scorers from everyone else.',
    },
    {
      type: 'table',
      headers: ['Layer', 'Description', 'Example'],
      rows: [
        [
          '**Surface Flaw**',
          "A standard conditional, causal, or quantifier error visible in the argument's formal structure",
          'Mistaken Reversal: treating a necessary condition as sufficient',
        ],
        [
          '**Deep Flaw**',
          'A conceptual error involving category shifts, epistemic assumptions, or hidden equivocation',
          'Epistemic Leap: concluding what a person *knows* from what is objectively *true*',
        ],
      ],
    },
    {
      type: 'paragraph',
      text: "The **Epistemic Flaw** is one of the most sophisticated deep flaws the LSAT uses. It exploits the gap between objective reality and a person's subjective knowledge. In the real world, a rule might be true (e.g., 'If you have a winning ticket, you can claim the prize'). But in the world of the mind, a person might have the ticket without *knowing* it is a winner. They might not even know the prize exists.",
    },
    ...
    {
      type: 'paragraph',
      text: '"Bank deposits are credited... **only when** they are made before 3 P.M." The phrase "only when" (like "only if") introduces a **necessary condition**. This means: if a deposit was credited today, it *must have been* made before 3 PM.',
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'The Rule',
      text: "Credited on Transaction Date → Made Before 3 PM\n\nBeing made before 3 PM is *necessary* for same-day credit, but it is not *sufficient*. Other conditions might also be required (e.g., the bank's computers must be functioning, it cannot be a holiday).",
    },
    {
      type: 'paragraph',
      text: 'The argument then tells us the deposit was made "before 3 PM" and concludes that it was "credited on the transaction date." This is a classic **Mistaken Reversal**. It confuses a requirement for a guarantee. Just because a necessary condition is met does not mean the outcome is assured.',
    },
    ...
    {
      type: 'paragraph',
      text: '"Alicia **knows** that the bank deposit was made before 3 P.M. So, Alicia **knows** that the bank deposit was credited..."',
    },
    {
      type: 'paragraph',
      text: 'Even if the conditional logic were valid, there is a second flaw here. The argument assumes that because Alicia knows a fact (the deposit was early), she must also know the logical conclusion of that fact. But for Alicia to "know" the outcome, she would have to know **two things**:',
    },
    {
      type: 'list',
      ordered: true,
    ...
    {
      type: 'paragraph',
      text: 'The argument only gives us #1. It illicitly assumes #2. We cannot conclude what someone *knows* without establishing that they know both the premise *and* the rule that governs it. This is the **Epistemic Leap**.',
    },
    ...
    { type: 'h3', text: 'Answer Choice Breakdown' },
    {
      ...
      items: [
        {
          title:
            '(A) Journalists are the only ones permitted to ask questions. Marjorie is a journalist. Therefore she will be permitted.',
        ...
        {
          title:
            '(C) George will be promoted only if Helen resigns. George knows Helen will resign. Therefore George knows he will be promoted.',
        ...
        {
          title:
            '(D) John believes 4 is prime and divisible by 2. Hence John believes there is a prime number divisible by 2.',
        ...
        {
          title:
            '(E) Pat wants to become a social worker. Social workers are poorly paid. Pat apparently wants to be poorly paid.',
    ...
    {
      type: 'paragraph',
      text: 'Use this checklist whenever a question asks you to find an answer that exhibits multiple flaws. Verify each dimension independently:',
    },
    {
      type: 'table',
      headers: ['Checkpoint', 'Stimulus', 'Correct Answer (C)', 'Near-Miss (B)'],
      rows: [
        ['**Has a conditional rule?**', '✓ Credited → Before 3 PM', '✓ Promoted → Helen Resigns', '✓ Works → Thursday'],
        [
          '**Reverses the conditional?**',
          '✓ Observes Before 3 PM, concludes Credited',
          '✓ Observes Helen Resigns, concludes Promoted',
          '✓ Observes Thursday, concludes Works',
        ],
        [
          '**Uses mental-state language?**',
          '✓ "Alicia knows"',
          '✓ "George knows"',
          '✗ "We know" (about the rule, not agent knowledge)',
        ],
        [
          '**Agent knows a premise, not the rule?**',
          '✓ Alicia knows the time, not the bank rule',
          '✓ George knows Helen will resign, not the promotion rule',
          '✗ No agent-knowledge claim about a premise',
        ],
        [
          '**Concludes agent knows the outcome?**',
          '✓ Concludes Alicia knows about the credit',
          '✓ Concludes George knows about the promotion',
          '✗ Concludes an objective fact (Patrice is working)',
        ],
      ],
    },
    {
      type: 'paragraph',
      text: 'Choice (B) is the most dangerous trap in this question. It perfectly replicates the Mistaken Reversal, and the phrase "We know" gives it a superficial epistemic flavor. But the epistemic structure does not match: the conclusion is an objective claim about what Patrice is doing, not a claim about what anyone *knows*. This distinction is the entire game on Double Flaw questions.',
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Drill: The Double Flaw"
        },
        {
          "type": "h3",
          "text": "Concept Focus: The Double Flaw Pattern"
        },
        {
          "type": "paragraph",
          "text": "The most difficult Parallel Flaw questions on the LSAT rarely test a single, simple error. Instead, they engineer a special kind of complexity by layering one flaw on top of another. An argument might be broken in **two distinct ways simultaneously**, and your job is to find an answer choice that is similarly broken in *both* ways."
        ...
        {
          "type": "h3",
          "text": "How Double Flaws Are Constructed"
        },
        {
          "type": "paragraph",
          "text": "Double Flaw arguments typically layer a **surface-level logical error** with a **deeper conceptual error**. The surface flaw is the one most test-takers will catch. The deeper flaw is the one that separates high scorers from everyone else."
        ...
        {
          "type": "h3",
          "text": "How to Identify Compound Flaws"
        },
        {
          "type": "paragraph",
          "text": "Use these diagnostic signals to detect when a stimulus contains more than one flaw:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h3",
          "text": "How to Match Compound Flaws in Answer Choices"
        },
        {
          "type": "paragraph",
          "text": "Once you have identified both flaws, use this systematic matching process:"
        },
        {
          "type": "process",
          "title": "Compound Flaw Matching",
        ...
        {
          "type": "h3",
          "text": "Step 1: Diagnose the Surface Flaw"
        },
        {
          "type": "paragraph",
          "text": "First, let's analyze the conditional rule, ignoring the \"knowing\" for a moment."
        },
        {
          "type": "paragraph",
          "text": "\"Bank deposits are credited... **only when** they are made before 3 P.M.\" The phrase \"only when\" (like \"only if\") introduces a **necessary condition**. This means: if a deposit was credited today, it *must have been* made before 3 PM."
        ...
        {
          "type": "h3",
          "text": "Step 2: Diagnose the Deep Flaw"
        },
        {
          "type": "paragraph",
          "text": "Now, let's add the \"knowledge\" component back in."
        },
        {
          "type": "paragraph",
          "text": "\"Alicia **knows** that the bank deposit was made before 3 P.M. So, Alicia **knows** that the bank deposit was credited...\""
        ...
        {
          "type": "h3",
          "text": "Step 3: Build the Blueprint"
        },
        {
          "type": "callout",
          "title": "Blueprint (Compound Flaw)",
        ...
        {
          "type": "h3",
          "text": "Step 4: First Pass — Eliminate by Surface Flaw"
        },
        {
          "type": "paragraph",
          "text": "We first check which answer choices commit a **Mistaken Reversal** (or at least some conditional logic error):"
        ...
        {
          "type": "h3",
          "text": "Step 5: Second Pass — Filter by Deep Flaw"
        },
        {
          "type": "paragraph",
          "text": "Among the surviving choices (B and C), we check for the **Epistemic Leap**:"
        },
        {
          "type": "hr"
        },
        ...
        {
          "type": "h3",
          "text": "\"Both Flaws Must Match\" Verification Checklist"
        },
        {
          "type": "paragraph",
          "text": "Use this checklist whenever a question asks you to find an answer that exhibits multiple flaws. Verify each dimension independently:"
        },
        {
          ...
          "rows": [
            [
              ...
              "✓ Credited → Before 3 PM",
              "✓ Promoted → Helen Resigns",
              "✓ Works → Thursday"
            ],
            [
              "**Reverses the conditional?**",
