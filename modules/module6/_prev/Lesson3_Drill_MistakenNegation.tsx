...
export const Lesson3_Drill_MistakenNegation: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'The **Mistaken Negation** — also known as **Denying the Antecedent** — is one of the two most common conditional logic errors on the LSAT (the other being the Mistaken Reversal). It occurs when an author takes a conditional rule and assumes that if the *trigger* (sufficient condition) is absent, the *result* (necessary condition) must also be absent.',
    },
    {
      type: 'paragraph',
      text: 'In everyday language, the error sounds like this: "The rule says *if* you study hard, you will pass. You did not study hard, so you will not pass." The problem? There could be many other ways to pass — natural talent, prior knowledge, an easy exam. The rule only tells us what happens when the trigger fires; it says nothing about what happens when the trigger is absent.',
    },
    ...
    {
      type: 'paragraph',
      text: "Let's break down the Mistaken Negation in formal terms so you can recognize it instantly in any context:",
    },
    {
      type: 'breakdown',
      labels: { title: 'Component', text: 'Explanation' },
      items: [
        {
          title: 'The Rule (Premise)',
          text: '**If A, then B.** (A $\\rightarrow$ B)\nThis states that A is a *sufficient* condition for B. Whenever A occurs, B must follow. But it does NOT state that A is the *only* way to get B.',
          badge: 'Given',
          badgeColor: 'blue',
        },
        {
          title: 'The Observation (Premise)',
          text: '**A is not true.** (~A)\nThe author observes that the sufficient condition has not been met.',
          badge: 'Given',
          badgeColor: 'blue',
        },
        {
          title: 'The Flawed Conclusion',
          text: '**Therefore, B is not true.** (~B)\nThe author concludes that because the trigger did not fire, the result cannot occur. This is the error.',
          badge: 'Flaw',
          badgeColor: 'red',
        },
      ],
    ...
    {
      type: 'paragraph',
      text: 'To master conditional flaws in Parallel Flaw questions, you need to instantly distinguish valid inferences from invalid ones. This reference table covers all four possible moves:',
    },
    {
      type: 'table',
      headers: ['Inference', 'Pattern', 'Validity', 'Name'],
      rows: [
        [
    ...
    {
      type: 'paragraph',
      text: 'In Parallel Flaw questions, the LSAT exploits the similarity between Mistaken Negation and Mistaken Reversal to create trap answer choices. Both are conditional logic errors, but they work in opposite directions:',
    },
    {
      type: 'table',
      headers: ['Feature', 'Mistaken Negation', 'Mistaken Reversal'],
      rows: [
        ...
        [
          '**Everyday example**',
          '"No rain, so no wet grass" (ignoring sprinklers)',
          '"Wet grass, so it rained" (ignoring sprinklers)',
        ],
      ],
    },
    {
      type: 'paragraph',
      text: 'When the stimulus commits a Mistaken Negation, the trap answer will often commit a Mistaken Reversal (or vice versa). Since both involve conditional rules, students who identify the flaw loosely as "a conditional error" will fall for the trap. Precision matters: you must identify *which* conditional error.',
    },
    ...
    {
      type: 'paragraph',
      text: 'The argument takes a conditional rule (If Punishment → Obligation), observes that the antecedent is not met (no punishment), and concludes that the consequent cannot be true (no obligation).',
    },
    { type: 'paragraph', text: 'This is a textbook **Mistaken Negation**: If A → B. ~A. Therefore ~B.' },
    {
      type: 'paragraph',
      text: 'The rule only tells us that punishment is *one* reason the city might have an obligation. The city might have an obligation for other reasons entirely — public health, environmental standards, voter demand. The argument wrongly treats punishment as the *only* possible reason for the obligation.',
    },
    ...
    { type: 'h3', text: 'Answer Choice Breakdown' },
    {
      ...
      items: [
        ...
        {
          title:
            '(C) Regulations successful only if students adhere. Students will adhere. Therefore regulations will be successful.',
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Drill: The Mistaken Negation Flaw"
        },
        {
          "type": "h3",
          "text": "Concept Focus: The Mistaken Negation"
        },
        {
          "type": "paragraph",
          "text": "The **Mistaken Negation** — also known as **Denying the Antecedent** — is one of the two most common conditional logic errors on the LSAT (the other being the Mistaken Reversal). It occurs when an author takes a conditional rule and assumes that if the *trigger* (sufficient condition) is absent, the *result* (necessary condition) must also be absent."
        ...
        {
          "type": "h3",
          "text": "How Conditional Errors Create Parallel Structures"
        },
        {
          "type": "paragraph",
          "text": "In Parallel Flaw questions, the LSAT exploits the similarity between Mistaken Negation and Mistaken Reversal to create trap answer choices. Both are conditional logic errors, but they work in opposite directions:"
        },
        {
          ...
          "rows": [
            ...
            [
              ...
              "The *consequent* is affirmed"
            ],
            [
              "**What is concluded?**",
              "The *consequent* is negated",
              "The *antecedent* is affirmed"
            ],
            [
              "**Core assumption**",
              "A is the *only* way to get B",
              "B can *only* come from A"
            ],
            [
              "**Everyday example**",
              "\"No rain, so no wet grass\" (ignoring sprinklers)",
        ...
        {
          "type": "paragraph",
          "text": "This is a textbook **Mistaken Negation**: If A → B. ~A. Therefore ~B."
        },
        {
          "type": "paragraph",
          "text": "The rule only tells us that punishment is *one* reason the city might have an obligation. The city might have an obligation for other reasons entirely — public health, environmental standards, voter demand. The argument wrongly treats punishment as the *only* possible reason for the obligation."
        ...
        {
          "type": "paragraph",
          "text": "This question illustrates two classic Parallel Flaw traps:"
        },
        {
          "type": "list",
          "items": [
