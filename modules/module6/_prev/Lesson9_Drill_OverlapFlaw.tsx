...
export const Lesson9_Drill_OverlapFlaw: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'Many LSAT flaws are about simple "if-then" mistakes. But some of the most difficult flaws require you to think visually, like a mathematician. These questions test your understanding of **quantifiers** — words like "all," "some," and "most" — and how groups and subgroups relate to one another.',
    },
    {
      type: 'paragraph',
      text: 'The specific error in this drill is the **Overlap Flaw**. This flaw occurs when an argument concludes that two groups *must* share members, when in fact they only *might*. The argument takes a property that belongs to "some" members of a larger group and forces that property onto a specific subgroup — without proving that the subgroup is among the members who have the property.',
    },
    ...
    {
      type: 'paragraph',
      text: 'The Overlap Flaw is best understood visually. Consider a large circle representing all **Tenured Faculty** at a university. Within this circle, we can place smaller circles representing various departments — Linguistics, History, Philosophy, etc. We know two facts:',
    },
    {
      type: 'list',
      ordered: true,
    ...
    {
      type: 'paragraph',
      text: 'The question is: must the Linguistics circle overlap with the "Not Full Professor" region? The answer is **no**. It is entirely possible that all the "Not Full Professors" are in the History or Philosophy circles, and every single member of the Linguistics department happens to be a Full Professor. The Linguistics circle could sit comfortably in the part of the Tenured circle where *everyone* is a Full Professor.',
    },
    {
      type: 'paragraph',
      text: 'This is the Overlap Flaw: concluding that a subgroup *must* share a property with the larger group, when the subgroup could occupy a completely different region of that group.',
    },

    {
      type: 'callout',
      variant: 'default',
      title: 'The Core Error',
      text: '**The Overlap Flaw:** Some members of Group A have Property X. All members of Group B are in Group A. Therefore, some members of Group B must have Property X.\n\nThe error: Group B might be entirely contained within the part of Group A that does *not* have Property X. The property does not automatically transfer from the whole to the subgroup.',
    },
    ...
    {
      type: 'paragraph',
      text: 'The Overlap Flaw has a distinctive fingerprint. When reading a stimulus, watch for these signals:',
    },
    {
      type: 'breakdown',
      labels: { title: 'Signal', text: 'What It Means' },
      items: [
        {
          title: 'Quantifier Language',
          text: 'The argument uses words like "some," "not all," "most," "a few," or "at least one" to describe a property of a larger group. These partial quantifiers are the starting point for overlap errors.',
          badge: 'Key Signal',
          badgeColor: 'blue',
        },
        {
          title: 'Subset Relationship',
          text: 'The argument establishes that one group is entirely contained within another ("all X are Y," "every member of X has Y"). This creates the subgroup that the flaw will target.',
          badge: 'Key Signal',
          badgeColor: 'blue',
        },
        {
          title: 'Forced Transfer',
          text: 'The conclusion claims that the subgroup *must* have the property that only "some" of the larger group has. This is the logical leap — transferring a partial property to a specific subset.',
          badge: 'The Flaw',
          badgeColor: 'red',
        },
        {
          title: 'Plausible But Unproven',
          text: 'The conclusion *sounds* reasonable — it is certainly *possible* that some linguistics professors are not full professors. But the LSAT requires logical certainty, not mere plausibility. Possible is not the same as guaranteed.',
          badge: "Why It's Tricky",
          badgeColor: 'slate',
        },
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'When the stimulus commits an Overlap Flaw, matching it requires checking three structural components in each answer choice:',
    },
    {
      type: 'process',
    ...
    { type: 'h3', text: 'Answer Choice Breakdown' },
    {
      ...
      items: [
        {
          title:
            '(A) All modern office towers are climate-controlled. Not all office buildings are climate-controlled. Therefore, not all office buildings are modern office towers.',
        ...
        {
          title:
            '(B) All municipal hospital buildings are massive. Not all are forbidding. Therefore, massive buildings need not be forbidding.',
        ...
        {
          title:
            '(C) Some buildings by famous architects are not well proportioned. All government buildings are designed by famous architects. Therefore, some government buildings are not well proportioned.',
        ...
        {
          title:
            '(D) Not all public buildings are well designed. Some poorly designed public buildings were intended for private use. Therefore, the poorly designed public buildings were all originally designed for private use.',
        ...
        {
          title:
            '(E) Some cathedrals are not built of stone. Every cathedral is impressive. Therefore, buildings can be impressive even though they are not built of stone.',
    ...
    {
      type: 'paragraph',
      text: 'One of the most striking features of this question is that **three of the five answer choices are logically valid** (A, B, and E). In a Parallel Flaw question, valid arguments are automatic eliminations — they cannot parallel a flawed argument because they commit no error at all.',
    },
    {
      type: 'paragraph',
      text: 'This gives you a powerful shortcut: before analyzing *which* flaw each answer commits, check whether the answer is valid. If it is, cross it out immediately. On this question, the validity filter eliminates three choices and leaves you with only (C) and (D) to compare — a much more manageable task.',
    },
    {
      type: 'table',
      headers: ['Choice', 'Valid?', 'Flaw Type (If Invalid)', 'Matches Stimulus?'],
      rows: [
    ...
    {
      type: 'paragraph',
      text: 'The Overlap Flaw belongs to a broader family of **set-theoretic errors** — mistakes about how groups, subgroups, and properties interact. These errors appear throughout the LSAT, not just in Parallel Flaw questions. Understanding a few core set-theory principles will help you across multiple question types:',
    },
    {
      type: 'breakdown',
      labels: { title: 'Principle', text: 'Explanation' },
      items: [
        {
          title: 'Properties of the whole do not automatically transfer to parts',
          text: 'Just because "some A are X" does not mean that any specific subgroup of A must also be X. The subgroup might be entirely within the non-X region of A. This is the Overlap Flaw.',
          badge: 'This Drill',
          badgeColor: 'green',
        },
        {
          title: 'Properties of parts do not automatically transfer to the whole',
          text: 'Just because each member of a group has a property does not mean the group *as a whole* has that property. Each brick weighs 2 pounds, but a wall of 1,000 bricks does not weigh 2 pounds. This is the Composition Flaw (covered in Lesson 4).',
          badge: 'Related Flaw',
          badgeColor: 'blue',
        },
        {
          title: 'Shared membership does not guarantee shared properties',
          text: 'Two subgroups of the same larger group (e.g., Linguistics and History are both subgroups of Tenured Faculty) do not necessarily share any properties beyond their common membership. They could occupy completely different regions of the parent group.',
          badge: 'Extension',
          badgeColor: 'indigo',
        },
        {
          title: '"Some" is compatible with "all" and with "none of the specific ones you care about"',
          text: 'When the LSAT says "some A are X," this is compatible with 1%, 50%, or 99% of A being X. More importantly, the specific subset B that you are interested in might be entirely within the X region or entirely outside it. "Some" provides no guarantees about specific subsets.',
          badge: 'Fundamental',
          badgeColor: 'slate',
        },
      ],
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Drill: The Overlap Flaw"
        },
        {
          "type": "h3",
          "text": "Concept Focus: The Overlap Flaw"
        },
        {
          "type": "paragraph",
          "text": "Many LSAT flaws are about simple \"if-then\" mistakes. But some of the most difficult flaws require you to think visually, like a mathematician. These questions test your understanding of **quantifiers** — words like \"all,\" \"some,\" and \"most\" — and how groups and subgroups relate to one another."
        ...
        {
          "type": "h3",
          "text": "Venn Diagram Logic: Why Groups Can Overlap Without Having To"
        },
        {
          "type": "paragraph",
          "text": "The Overlap Flaw is best understood visually. Consider a large circle representing all **Tenured Faculty** at a university. Within this circle, we can place smaller circles representing various departments — Linguistics, History, Philosophy, etc. We know two facts:"
        ...
        {
          "type": "h3",
          "text": "How to Spot the Overlap Flaw"
        },
        {
          "type": "paragraph",
          "text": "The Overlap Flaw has a distinctive fingerprint. When reading a stimulus, watch for these signals:"
        ...
        {
          "type": "h3",
          "text": "How to Match the Overlap Flaw in Answer Choices"
        },
        {
          "type": "paragraph",
          "text": "When the stimulus commits an Overlap Flaw, matching it requires checking three structural components in each answer choice:"
        ...
        {
          "type": "h2",
          "text": "Full Step-by-Step Analysis"
        },
        {
          "type": "h3",
          "text": "Step 1: Diagnose the Flaw (Visualize the Groups)"
        },
        {
          "type": "paragraph",
          "text": "Let's map the argument's premises and conclusion using group relationships:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h3",
          "text": "The Validity Filter: A Powerful Shortcut"
        },
        {
          "type": "paragraph",
          "text": "One of the most striking features of this question is that **three of the five answer choices are logically valid** (A, B, and E). In a Parallel Flaw question, valid arguments are automatic eliminations — they cannot parallel a flawed argument because they commit no error at all."
        ...
        },
        {
          ...
          "rows": [
            ...
            [
              "(C)",
              "✗ Invalid",
              "Overlap Flaw (forced transfer from whole to subgroup)",
              "**Yes — perfect match**"
            ],
            [
              "(D)",
              "✗ Invalid",
              "Unjustified Universal (\"some\" → \"all\")",
              "No — different quantifier error"
            ],
            [
              "(E)",
              "✓ Valid",
        ...
        {
          "type": "h3",
          "text": "Set Theory and the LSAT: Why This Matters"
        },
        {
          "type": "paragraph",
          "text": "The Overlap Flaw belongs to a broader family of **set-theoretic errors** — mistakes about how groups, subgroups, and properties interact. These errors appear throughout the LSAT, not just in Parallel Flaw questions. Understanding a few core set-theory principles will help you across multiple question types:"
