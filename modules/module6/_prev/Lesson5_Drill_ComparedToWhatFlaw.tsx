...
export const Lesson5_Drill_ComparedToWhatFlaw: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'Statistics on the LSAT are dangerous. They look like hard facts while hiding massive logical holes. One of the most common statistical traps is the **False Comparison** — drawing a comparative conclusion from data about only one group.',
    },
    {
      type: 'paragraph',
      text: 'The core of this flaw is simple: the argument tells you something about Group A and then concludes that Group A is *better*, *worse*, or *different* from Group B — without ever providing data about Group B. The question you must always ask is: **"Compared to what?"**',
    },
    {
      type: 'paragraph',
      text: 'Consider this example: "90% of people who exercise regularly live past 70. Therefore, exercise increases your lifespan." Sounds convincing — until you ask: what percentage of people who *don\'t* exercise live past 70? If the answer is 95%, then exercise actually *decreases* lifespan. Without the comparison data, the 90% figure is meaningless for drawing causal or comparative conclusions.',
    },
    ...
    {
      type: 'paragraph',
      text: 'The Missing Comparison flaw appears in several recognizable patterns. Each involves drawing a conclusion that requires comparing two groups while only providing evidence about one:',
    },
    {
      type: 'table',
      headers: ['Subtype', "What's Missing", 'Example'],
      rows: [
        [
          '**Missing Baseline**',
          'Data about the comparison group is entirely absent',
          '"80% of vegetarians are healthy. Therefore, vegetarianism improves health." (What % of non-vegetarians are healthy?)',
        ],
        [
          '**Self-Selected Comparison**',
          'The groups differ in ways beyond the variable being tested',
          '"People who take vitamin C report fewer colds. Vitamin C prevents colds." (People who take vitamins may also exercise, eat well, and sleep more.)',
        ],
        [
          '**Incomplete Data**',
          'Only one metric is reported when multiple are needed',
          '"City A has more robberies than City B. City A is more dangerous." (City A may be 10× larger — the *rate* per capita might be lower.)',
        ],
        [
          '**Temporal Gap**',
          'Comparison across time periods without controlling for other changes',
          '"Crime dropped after the new policy. The policy reduced crime." (Crime was already declining before the policy.)',
        ],
      ],
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'The One-Group Red Flag',
      text: 'Whenever an LSAT argument presents data about **only one group** and then draws a conclusion about whether that group is better, worse, or different from another group, you are almost certainly looking at a Compared-to-What flaw. The absence of baseline data is the gap.',
    },
    ...
    {
      type: 'paragraph',
      text: 'In Parallel Flaw questions, the Compared-to-What flaw follows a predictable three-part structure:',
    },
    {
      type: 'process',
      title: 'The Pattern',
    ...
    {
      type: 'paragraph',
      text: 'When matching this flaw in answer choices, look for all three elements: single-group data, a comparative/causal conclusion, and (often) a recommendation. Be especially wary of answer choices that **include** the comparison data — they fix the flaw rather than replicating it.',
    },
    ...
    {
      type: 'paragraph',
      text: 'The LSAT uses specific trap designs when the stimulus contains a Missing Comparison flaw:',
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          ...
          text: 'An answer choice that discusses the same type of reasoning but **includes** the comparison data (e.g., "Group A has a higher rate than Group B"). By providing the baseline, this choice avoids the flaw entirely. It is logically *stronger* than the stimulus, not parallel to it.',
          badge: 'Very Common',
          badgeColor: 'red',
        },
        {
          title: 'The Causal Argument',
          text: 'An answer choice that presents a correlation between two variables and concludes causation — but uses *two-group* comparative data rather than single-group data. The flaw is causal confusion, not a missing comparison. Different flaw type.',
          badge: 'Common',
          badgeColor: 'red',
        },
        {
          title: 'The Policy Mismatch',
          text: 'An answer choice that makes a policy recommendation based on different logical grounds (e.g., an appeal to authority or a moral argument rather than a statistical claim). The recommendation may sound similar, but the underlying reasoning differs.',
          badge: 'Occasional',
          badgeColor: 'red',
        },
      ],
    ...
    { type: 'h3', text: 'Answer Choice Breakdown' },
    {
      ...
      items: [
        ...
        {
          title:
            '(E) Most people who exercise regularly handle stress → exercise decreases stress risk → exercise recommended',
    ...
    {
      type: 'paragraph',
      text: 'In Parallel Flaw questions, you are **hunting for broken reasoning**, not valid reasoning. Choices that "fix" the flaw by adding the missing data are traps — they are incorrect *because* they are too good. The correct answer must be broken in the same way as the stimulus.',
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Drill: The \"Compared to What?\" Flaw"
        },
        {
          "type": "h3",
          "text": "Concept Focus: The Missing Comparison"
        },
        {
          "type": "paragraph",
          "text": "Statistics on the LSAT are dangerous. They look like hard facts while hiding massive logical holes. One of the most common statistical traps is the **False Comparison** — drawing a comparative conclusion from data about only one group."
        ...
        {
          "type": "h3",
          "text": "Types of Compared-to-What Errors"
        },
        {
          "type": "paragraph",
          "text": "The Missing Comparison flaw appears in several recognizable patterns. Each involves drawing a conclusion that requires comparing two groups while only providing evidence about one:"
        ...
        {
          "type": "h3",
          "text": "How This Flaw Appears in Parallel Structures"
        },
        {
          "type": "paragraph",
          "text": "In Parallel Flaw questions, the Compared-to-What flaw follows a predictable three-part structure:"
        ...
        {
          "type": "h3",
          "text": "Common Traps in Compared-to-What Questions"
        },
        {
          "type": "paragraph",
          "text": "The LSAT uses specific trap designs when the stimulus contains a Missing Comparison flaw:"
        ...
        {
          "type": "paragraph",
          "text": "Let's map the stimulus argument:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "The critical question: **Compared to what?**"
        },
        {
          "type": "paragraph",
          "text": "What if 90% of meat-eaters also reach age 50 without serious heart disease? If that were true, then being a vegetarian would actually *decrease* your chances of avoiding heart disease (75% vs. 90%). The argument only provides data about vegetarians. It never tells us the rate for non-vegetarians. Without this baseline comparison, the claim that \"avoiding meat *increases* one's chances\" is completely unsupported."
        ...
        {
          "type": "h3",
          "text": "Trap Analysis: The \"Fixed\" Answers"
        },
        {
          "type": "paragraph",
          "text": "The most instructive feature of this question is the design of choices **(B)** and **(D)**. Both discuss similar topics (health behaviors and outcomes) and reach similar conclusions (recommendations to change behavior). They *sound* like the stimulus. But they are incorrect precisely **because** they are logically sound:"
        },
        {
          ...
          "rows": [
            ...
            [
              ...
              "Yes",
              "No — this is how epidemiology works",
              "Yes — same flaw as stimulus"
            ]
          ]
        },
        {
