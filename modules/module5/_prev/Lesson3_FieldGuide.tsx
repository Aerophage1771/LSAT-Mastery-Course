...
export const Lesson3_FieldGuide: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Category', 'Flaw Type', 'Core Error', 'Freq.'],
      rows: [
        [
          '**Causal**',
...

    {
      ...
      text: 'This lesson covers Categories 1-2 (Causal and Conditional Logic flaws). The **Extended Guide** (next lesson) covers Categories 3-5 — Statistical/Sampling flaws, Scope Shift flaws, and Other Common Flaws — plus the LSAT Language Translation Table and the Quick Identification Flowchart.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        { type: 'diff-note', text: '{{!note!}} At ~120 blocks, this is the longest lesson in the module and possibly the entire course. Consider splitting into two lessons: "Field Guide Part 1: Causal & Conditional Flaws" and "Field Guide Part 2: Statistical, Scope Shift, & Other Flaws." Two 60-block lessons are far more digestible than one 120-block lecture.', variant: 'comment' },
        {
          "type": "h2",
        ...
        { type: 'diff-note', text: '{{+add+}} Insert a 2-question "Quick Check" exercise here before moving to Category 2. Give two 1-sentence arguments and ask the student to identify the causal sub-type (correlation-to-causation, reverse causation, or third factor). This breaks up the lecture and reinforces the causal section before the student moves on. Repeat this pattern after each category.', variant: 'comment' },
        {
          "type": "hr"
        },
        {
        ...
        { type: 'diff-note', text: '{{-remove-}} The LSAT Language Translation Table at the bottom of this lesson (mapping common flaw names to LSAT phrasing) duplicates the LSAT Language Decoder in Lesson 5-12. Remove it from here and add a forward reference: "See the Reference Guide (Lesson 12) for a complete LSAT language decoder mapping every flaw type to its answer-choice phrasing."', variant: 'comment' },
        {
          "type": "h3",
        ...
        { type: 'diff-note', text: '{{~change~}} Category 5 ("Other Common Flaws") groups 7 diverse flaw types under a single heading. Consider whether Straw Man and Equivocation deserve more depth -- they appear on harder questions and students consistently struggle with them. At minimum, add a "How This Differs From Ad Hominem" note under Straw Man, since students often confuse the two.', variant: 'comment' },
        {
          "type": "h3",
          ...
          items: [
            {
              ...
              badgeColor: 'green',
              text: '**Signal:** Causal language in conclusion (causes, leads to, results in) with correlational evidence in premises.\n**Example:** "Cities with more police have higher crime. Therefore, police encourage crime."\n**Trap:** Answer describes reverse causation or third-factor when the flaw is basic correlation \u2192 causation.',
            },
            {
              title: 'Reverse Causation',
              badge: 'Medium Frequency',
              badgeColor: 'blue',
              text: '**Signal:** Two correlated phenomena where the causal arrow could plausibly point in either direction.\n**Example:** "Positive attitudes correlate with career success. Therefore, positivity causes success." (Success may cause positivity.)\n**Trap:** Answer describes correlation \u2192 causation generically instead of the specific directional error.',
            },
            {
              title: 'Third Factor / Common Cause',
              badge: 'Medium Frequency',
              badgeColor: 'blue',
              text: '**Signal:** Two phenomena that could both be effects of an unstated third variable.\n**Example:** "Tutored students have lower grades. Therefore, tutoring harms performance." (Struggling academically causes both.)\n**Trap:** Answer names correlation \u2192 causation without specifying the overlooked common cause.',
            },
            {
              title: 'Mistaken Reversal (Affirming the Consequent)',
              badge: 'High Frequency',
              badgeColor: 'green',
              text: '**Signal:** An "if A then B" rule, followed by observing B and concluding A.\n**Example:** "All dogs are mammals. Fido is a mammal. Therefore, Fido is a dog."\n**Trap:** Answer describes a mistaken negation instead of a mistaken reversal.',
            },
            {
              title: 'Mistaken Negation (Denying the Antecedent)',
              badge: 'Medium Frequency',
              badgeColor: 'blue',
              text: '**Signal:** An "if A then B" rule, followed by observing ~A and concluding ~B.\n**Example:** "If it rains, the ground is wet. It is not raining. Therefore, the ground is not wet."\n**Trap:** Answer describes a mistaken reversal instead of a mistaken negation.',
            },
            {
              title: 'Necessary vs. Sufficient Confusion',
              badge: 'High Frequency',
              badgeColor: 'green',
              text: '**Signal:** Language about requirements or prerequisites treated as guarantees.\n**Example:** "To get an A you must submit homework. I submitted homework, so I will get an A."\n**Trap:** Answer uses reversal/negation language when the error is specifically treating necessary as sufficient.',
            },
          ],
        },
        {
          type: 'callout',
          variant: 'summary',
          text: '**Causal and Conditional flaws account for ~35% of all Flaw questions.** When you see causal language in the conclusion, check for correlation \u2192 causation first. When you see if/then language, diagram the conditional before reading answers.',
        },
      ],
    },
  },
