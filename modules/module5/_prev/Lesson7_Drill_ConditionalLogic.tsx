...
export const Lesson7_Drill_ConditionalLogic: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'Conditional logic flaws are among the most **precisely testable** errors on the LSAT. Unlike causal or sampling flaws — which can be subtle and context-dependent — conditional flaws are *structural*. The reasoning is invalid regardless of the topic. If you can diagram the argument accurately, you can identify the flaw every time.',
    },
    {
      type: 'paragraph',
      text: "This lesson covers two fundamental conditional errors: **Affirming the Consequent** (Mistaken Reversal) and **Denying the Antecedent** (Mistaken Negation). Together, they account for roughly 10% of all Flaw questions, and they underpin harder flaws you'll encounter in later lessons.",
    },
    ...
    {
      type: 'paragraph',
      text: 'Every conditional statement has two parts: the **antecedent** (the "if" part) and the **consequent** (the "then" part). The antecedent is the *sufficient* condition — it guarantees the consequent. The consequent is the *necessary* condition — it must be true whenever the antecedent is true.',
    },
    {
      type: 'code',
    ...
    {
      type: 'paragraph',
      text: 'From the statement "If A, then B," there are exactly **two valid inferences** and **two invalid inferences**. Mastering this distinction is the key to every conditional logic flaw question.',
    },

    { type: 'h3', text: 'Valid vs. Invalid Conditional Inferences' },
    {
      type: 'table',
      headers: ['Inference', 'Form', 'Example', 'Valid?'],
      rows: [
        [
          '**Modus Ponens** (Direct)',
          'A is true. ∴ B is true.',
    ...
    {
      type: 'paragraph',
      text: 'This is the more common of the two errors. The argument observes that the consequent (B) is true and leaps to the conclusion that the antecedent (A) must be true — essentially reversing the conditional arrow.',
    },
    {
      type: 'code',
    ...
    {
      type: 'paragraph',
      text: '**Concrete Example:** "If a student earns an A on the final, they pass the course. Maria passed the course. Therefore, Maria must have earned an A on the final."',
    },
    {
      type: 'paragraph',
      text: '**Why it fails:** Earning an A is one *sufficient* way to pass, but Maria could have passed by earning a B, or through extra credit, or by averaging her grades across multiple exams. The argument mistakes one sufficient path for the only path.',
    },

    { type: 'h3', text: 'Error 2: Denying the Antecedent (Mistaken Negation)' },
    {
      type: 'paragraph',
      text: 'This error negates the antecedent (A is false) and concludes the consequent must also be false. It assumes the antecedent was the *only* way to achieve the consequent.',
    },
    {
      type: 'code',
    ...
    {
      type: 'paragraph',
      text: '**Concrete Example:** "If it rains, the soccer game will be canceled. It is not raining. Therefore, the soccer game will not be canceled."',
    },
    {
      type: 'paragraph',
      text: "**Why it fails:** Rain is one *sufficient* cause for cancellation, but the game could also be canceled due to lightning, a flooded field, or a scheduling conflict. The absence of rain doesn't guarantee the game proceeds.",
    },

    {
      type: 'callout',
      variant: 'default',
      title: 'How the LSAT Describes These Flaws',
      text: 'The LSAT uses characteristic language for each error:\n\n**Mistaken Reversal:** "treats a condition that is *sufficient* for a result as a condition that is *necessary* for that result" or "confuses a sufficient condition with a necessary condition."\n\n**Mistaken Negation:** "assumes that because a sufficient condition is *absent*, the result must also be absent" or "treats the absence of one cause as proof that the effect will not occur."',
    },
    ...
    {
      type: 'paragraph',
      text: 'On the actual LSAT, conditional logic is rarely stated in clean "If A, then B" form. Instead, it is buried in everyday language. You must recognize the conditional structure beneath the surface.',
    },
    {
      type: 'table',
      headers: ['Natural Language', 'Conditional Translation', 'Notes'],
      rows: [
        ...
        [
          '"Passing the bar is required for practicing law"',
      ...
      items: [
        {
          ...
          text: 'This describes an equivocation flaw — using a term in two different senses. But "unusable" is used consistently throughout the argument. The issue is the logical structure, not the definition of any term.',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          ...
          text: 'This is a precise match. The "event that can cause a certain result" is unplugging the mouse (a sufficient condition). The argument treats this event as "necessary" — meaning it must have happened for the result to occur. This perfectly describes a Mistaken Reversal.',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title: '(C) It introduces information unrelated to its conclusion...',
          text: "All the information in the argument is directly related to the conclusion. The rule about unplugging mice and the fact that Fred's software is unusable are both relevant. The flaw is in how the information is *used*, not that it is irrelevant.",
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(D) It attempts to support its conclusion by citing a generalization that is too broad.',
          text: 'The generalization ("Unplugging a peripheral renders software unusable") is a reasonable technical fact, not an overly broad one. The flaw is in how this rule is *applied* — specifically, in reversing the conditional — not in the rule itself being too broad.',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(E) It overlooks the possibility that some programs do not require a peripheral component...',
          text: "This is out of scope. The argument specifically discusses a program that *does* require a mouse. Whether other programs exist that don't require a mouse is irrelevant to the logical error in this argument.",
          badge: 'Incorrect',
          badgeColor: 'red',
        },
      ],
...

    {
      ...
      items: [
        {
          title: '(A) takes for granted that the committee members have the same criteria...',
          text: 'The argument says they must "unanimously" agree, which actually addresses this concern. The flaw is structural, not about the committee\'s internal agreement.',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          ...
          text: "This is tempting because it describes a *consequence* of the flaw — but it doesn't name the flaw itself. The core error is confusing the direction of a conditional, not ignoring capacity limits.",
          badge: 'Tempting but Incorrect',
          badgeColor: 'red',
        },
        {
          title:
            '(C) treats the fact that a condition is sufficient to ensure a result as proof that the condition is necessary for that result',
          text: 'The "condition sufficient to ensure a result" is committee selection → merit. The argument treats having merit as if it will necessarily lead to inclusion — i.e., treats the sufficient condition as necessary. Perfect match.',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title:
            "(D) presumes... that the committee's selections are not biased toward works in certain artistic styles",
          text: "Bias is a concern about the committee's judgment, but the argument's flaw is logical, not evaluative. Even an unbiased committee wouldn't guarantee every meritorious work gets selected.",
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          ...
          text: 'This describes a temporal scope shift, but the argument\'s error is about conditional direction, not time frame. The word "eventually" in the conclusion doesn\'t create a temporal confusion — the flaw exists regardless of timing.',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
      ],
    ...
    {
      type: 'process',
      title: 'Identifying the Specific Error',
      steps: [
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Drill: The Conditional Logic Flaw"
        },
        {
          "type": "h3",
        ...
        {
          "type": "h3",
          "text": "How Conditional Statements Work"
        },
        {
          "type": "paragraph",
          "text": "Every conditional statement has two parts: the **antecedent** (the \"if\" part) and the **consequent** (the \"then\" part). The antecedent is the *sufficient* condition — it guarantees the consequent. The consequent is the *necessary* condition — it must be true whenever the antecedent is true."
        ...
        {
          "type": "h3",
          "text": "Error 1: Affirming the Consequent (Mistaken Reversal)"
        },
        {
          "type": "paragraph",
          "text": "This is the more common of the two errors. The argument observes that the consequent (B) is true and leaps to the conclusion that the antecedent (A) must be true — essentially reversing the conditional arrow."
        ...
        {
          "type": "h3",
          "text": "Error 2: Denying the Antecedent (Mistaken Negation)"
        },
        {
          "type": "paragraph",
          "text": "This error negates the antecedent (A is false) and concludes the consequent must also be false. It assumes the antecedent was the *only* way to achieve the consequent."
        ...
        {
          "type": "h3",
          "text": "Recognizing Conditional Flaws in Disguise"
        },
        {
          "type": "paragraph",
          "text": "On the actual LSAT, conditional logic is rarely stated in clean \"If A, then B\" form. Instead, it is buried in everyday language. You must recognize the conditional structure beneath the surface."
        },
        {
          ...
          "rows": [
            ...
            [
              ...
              "Enter → Ticket",
              "\"Must\" signals a necessary condition"
            ],
            [
              "\"Only members can vote\"",
              "Vote → Member",
              "\"Only\" introduces the necessary condition"
            ],
            [
            ...
            [
              "\"A college degree guarantees an interview\"",
              "Degree → Interview",
              "\"Guarantees\" = sufficient condition"
            ]
          ]
        },
        {
        ...
        },
        {
          ...
          "items": [
            ...
            {
              "title": "(B) It treats an event that can cause a certain result as though that event is necessary to bring about that result.",
              "text": "This is a precise match. The \"event that can cause a certain result\" is unplugging the mouse (a sufficient condition). The argument treats this event as \"necessary\" — meaning it must have happened for the result to occur. This perfectly describes a Mistaken Reversal.",
              "badge": "Correct",
              "badgeColor": "green"
            },
        ...
        },
        {
          ...
          "items": [
            ...
            {
              "title": "(B) ignores the possibility that there are more works of genuine artistic merit than the museum can hold",
              "text": "This is tempting because it describes a *consequence* of the flaw — but it doesn't name the flaw itself. The core error is confusing the direction of a conditional, not ignoring capacity limits.",
              "badge": "Tempting but Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) treats the fact that a condition is sufficient to ensure a result as proof that the condition is necessary for that result",
              "text": "The \"condition sufficient to ensure a result\" is committee selection → merit. The argument treats having merit as if it will necessarily lead to inclusion — i.e., treats the sufficient condition as necessary. Perfect match.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(D) presumes... that the committee's selections are not biased toward works in certain artistic styles",
              "text": "Bias is a concern about the committee's judgment, but the argument's flaw is logical, not evaluative. Even an unbiased committee wouldn't guarantee every meritorious work gets selected.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) confuses a claim about works currently in the collection with a claim about all works that will ever be in the collection",
              "text": "This describes a temporal scope shift, but the argument's error is about conditional direction, not time frame. The word \"eventually\" in the conclusion doesn't create a temporal confusion — the flaw exists regardless of timing.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
        ...
        {
          "type": "h3",
          "text": "Conditional Flaw Identification Flowchart"
        },
        {
          "type": "paragraph",
          "text": "Use this quick decision process when you suspect a conditional logic flaw:"
        },
        {
          "type": "process",
          "title": "Identifying the Specific Error",
