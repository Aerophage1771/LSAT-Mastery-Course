...
export const Lesson11_Advanced_QuantitativeConditional: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'The **Quantitative-Conditional Flaw** is one of the most devious error types on the LSAT. It occurs when an argument uses conditional logic words — specifically **"if"** versus **"only if"** — to describe groups of people in a survey or poll, then draws a conclusion that hinges on mistranslating these words. The trap is that "if" and "only if" look interchangeable in everyday language but describe **completely different sets of people** in formal logic.',
    },
    {
      type: 'paragraph',
      text: 'This flaw type sits at the intersection of conditional logic and statistical reasoning, making it particularly challenging. To solve it, you must simultaneously track (1) the formal logic translation of the survey question and (2) the quantitative implications for the size of each group.',
    },
    ...
    {
      type: 'paragraph',
      text: 'Before tackling the flaw, you must understand the precise logical difference between "if" and "only if" — because the entire argument turns on this distinction:',
    },

    {
      type: 'table',
      headers: ['Statement', 'Formal Translation', 'What It Means', 'Group Described'],
      rows: [
        [
          '"Officials should resign **if** indicted"',
          'Indicted → Should Resign',
          'Indictment is **sufficient** for resignation — being indicted alone is enough reason to resign',
          'People who think indictment is a sufficient trigger',
        ],
        [
          '"Officials should resign **only if** convicted"',
          'Should Resign → Convicted',
          "Conviction is **necessary** for resignation — you should only resign if you've been convicted (not before)",
          'People who think conviction is required before resignation',
        ],
      ],
    },
    ...
    {
      type: 'breakdown',
      labels: { title: 'Belief Group', text: 'What They Think' },
      items: [
        {
          title: '"If indicted" group',
          text: 'These people set a **low bar** for resignation. Even a mere indictment (no conviction needed) is enough reason to resign. They would also support resignation upon conviction, since conviction is a stronger trigger than indictment.',
          badge: 'Low Bar',
          badgeColor: 'green',
        },
        {
          title: '"Only if convicted" group',
          text: 'These people set a **high bar** for resignation. They believe officials should NOT resign over a mere indictment — conviction is the minimum threshold. But this does NOT tell us they think conviction is *sufficient* — they might believe resignation requires conviction PLUS other factors.',
          badge: 'High Bar',
          badgeColor: 'red',
        },
      ],
    ...
    {
      type: 'paragraph',
      text: "When survey data uses conditional language, the logical structure determines which group is actually being measured. Misreading this structure can lead to conclusions that are not just wrong, but **logically backwards**. Here's why:",
    },

    {
      type: 'process',
      title: 'The Logical Chain',
      steps: [
...

    {
      ...
      items: [
        {
          title: '(A) draws a conclusion about the population in general based only on a sample of that population',
          text: "This describes a sampling flaw — generalizing from a survey to the whole population. While surveys always involve sampling, the error here is in the *interpretation* of the survey's logical terms, not in the act of sampling itself. Even a perfect census with 100% response rate would still produce the same logical error.",
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(B) confuses a sufficient condition with a required condition',
          text: 'The phrase "only if they are convicted" establishes conviction as a **required** (necessary) condition. The conclusion treats this group as if they are the people who believe "if they are convicted" (a **sufficient** condition). This misinterpretation — swapping the meaning of necessary and sufficient — is the reason the quantitative comparison fails.',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title: '(C) is based on an ambiguity of one of its terms',
          text: 'This describes an equivocation flaw — a word used in two senses. The terms "indicted" and "convicted" are clear legal terms with no ambiguity. The error is not in the definitions of words but in the logical structure of the conditional statements.',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          ...
          text: "This answer describes *what* the argument does (makes a comparison across beliefs), but doesn't explain *why* it's flawed. Many valid arguments compare responses to different questions. The flaw is the specific misinterpretation of the conditional logic, not the act of comparing.",
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(E) contains premises that cannot all be true',
          text: "There is no contradiction. It is perfectly consistent for 50% to hold one belief and 35% to hold another — these percentages don't need to sum to 100%, as people may hold both beliefs, neither, or other views entirely.",
          badge: 'Incorrect',
          badgeColor: 'red',
        },
      ],
    ...
    {
      type: 'paragraph',
      text: 'One powerful way to understand this flaw is to visualize the relative sizes of the groups involved. Consider three groups of respondents:',
    },
    {
      type: 'table',
      headers: ['Group', 'Belief', 'Size (from survey)', 'Relationship to \"If Convicted\" Group'],
      rows: [
        [
          '"If indicted" group',
          'Indictment alone is sufficient to resign',
          '50%',
          'Subset of "if convicted" (lower bar includes higher bar)',
        ],
        ['"Only if convicted" group', 'Conviction is the minimum standard required', '35%', 'Subset of "if convicted"'],
        [
          '"If convicted" group',
          'Conviction is sufficient to resign',
          'NOT measured — but likely very large',
          'Includes BOTH groups above, plus others',
        ],
      ],
    },
    {
      type: 'paragraph',
      text: 'The "if convicted" group is the broadest: it includes anyone who thinks conviction is a sufficient trigger for resignation. Since indictment is a *lesser* charge than conviction, anyone who supports resignation for indictment would *certainly* support it for conviction. The "if convicted" group therefore includes at minimum the 50% + 35% = 85%, and possibly more. The argument\'s conclusion that more people support resignation for indictment (50%) than for conviction is almost certainly *backwards*.',
    },
    ...
    {
      type: 'paragraph',
      text: 'Answer (C) identifies the precise error: treating the proportion for whom reviews are *necessary* (25%, the "only if" group) as the proportion for whom reviews are *sufficient* (the "if" group, which is much larger).',
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Advanced Drill: The Quantitative-Conditional Translation"
        },
        {
          "type": "h3",
          "text": "Concept Focus: Where Quantity Meets Conditional Logic"
        },
        {
          "type": "paragraph",
          "text": "The **Quantitative-Conditional Flaw** is one of the most devious error types on the LSAT. It occurs when an argument uses conditional logic words — specifically **\"if\"** versus **\"only if\"** — to describe groups of people in a survey or poll, then draws a conclusion that hinges on mistranslating these words. The trap is that \"if\" and \"only if\" look interchangeable in everyday language but describe **completely different sets of people** in formal logic."
        ...
        {
          "type": "h2",
          "text": "The Critical Distinction: \"If\" vs. \"Only If\""
        },
        {
          "type": "paragraph",
          "text": "Before tackling the flaw, you must understand the precise logical difference between \"if\" and \"only if\" — because the entire argument turns on this distinction:"
        ...
        {
          "type": "paragraph",
          "text": "These are dramatically different beliefs:"
        },
        {
          "type": "breakdown",
          "labels": {
        ...
        {
          "type": "h2",
          "text": "How Percentage Arguments Can Be Structurally Flawed"
        },
        {
          "type": "paragraph",
          "text": "When survey data uses conditional language, the logical structure determines which group is actually being measured. Misreading this structure can lead to conclusions that are not just wrong, but **logically backwards**. Here's why:"
        ...
        },
        {
          ...
          "items": [
            ...
            {
              "title": "(D) draws a conclusion about a specific belief based on responses to queries about two different specific beliefs",
              "text": "This answer describes *what* the argument does (makes a comparison across beliefs), but doesn't explain *why* it's flawed. Many valid arguments compare responses to different questions. The flaw is the specific misinterpretation of the conditional logic, not the act of comparing.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
        ...
        {
          "type": "h2",
          "text": "Visualizing the Group Sizes"
        },
        {
          "type": "paragraph",
          "text": "One powerful way to understand this flaw is to visualize the relative sizes of the groups involved. Consider three groups of respondents:"
        },
        {
          ...
          "headers": [
            ...
            "Belief",
            "Size (from survey)",
            "Relationship to \"If Convicted\" Group"
          ],
          "rows": [
            [
              "\"If indicted\" group",
            ...
            [
              "\"Only if convicted\" group",
              "Conviction is the minimum standard required",
              "35%",
              "Subset of \"if convicted\""
            ],
            [
              "\"If convicted\" group",
              "Conviction is sufficient to resign",
        ...
        {
          "type": "paragraph",
          "text": "This question follows the same pattern as the worked example:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h2",
          "text": "Spotting the Quantitative-Conditional Flaw"
        },
        {
          "type": "paragraph",
          "text": "Use this checklist when you encounter a survey or poll in a Flaw question:"
        },
        {
          "type": "process",
          "title": "Detection Checklist",
