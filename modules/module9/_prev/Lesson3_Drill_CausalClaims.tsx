...
export const Lesson3_Drill_CausalClaims: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'Causal reasoning is one of the most frequently tested argument structures on the LSAT. In a causal argument, the author observes that two things are associated — they occur together, one follows the other, or they correlate statistically — and concludes that one **caused** the other. This leap from correlation to causation is inherently vulnerable because there are always alternative explanations for any observed association.',
    },
    {
      type: 'paragraph',
      text: "To strengthen a causal argument, you must provide information that makes the author's proposed cause-effect relationship more plausible. You do this by narrowing the field of possible explanations until the author's preferred cause is the most likely one standing.",
    },
    ...
    {
      type: 'paragraph',
      text: 'There are three primary strategies for strengthening a causal argument. Each attacks the gap from a different angle, but all share the same goal: making the proposed cause-effect link more credible.',
    },

    {
      ...
      rows: [
        [
          ...
          "Eliminate other plausible explanations for the observed effect. If no other factor can explain the result, the author's explanation becomes more likely by default.",
          '"No other variable changed during the study period" eliminates confounding factors.',
        ],
        [
          '**Show the Mechanism**',
          'Provide a plausible explanation for *how* the cause produces the effect. A clear causal pathway makes the link more believable.',
          '"The chemical in substance X binds to pain receptors" explains how X reduces pain.',
        ],
        [
          '**Show Dose-Response / Timeline**',
          'Demonstrate that increasing the cause increases the effect (dose-response), or that the effect appears only after the cause is introduced and disappears when it is removed (timeline). These patterns are hallmarks of genuine causation.',
          '"Workers exposed for longer periods developed more severe symptoms" shows dose-response.',
        ],
      ],
    },
    { type: 'h4', text: 'The Ideal Experiment Checklist' },
    {
      type: 'paragraph',
      text: 'When causal evidence comes from a study, imagine the strongest possible version of that study. The closer the evidence gets to this ideal, the more a Strengthen answer can justify a causal conclusion.',
    },
    {
      type: 'breakdown',
      labels: { title: 'Ideal Feature', text: 'Why It Helps' },
      items: [
        {
          title: 'Baseline',
          text: 'Shows what the subjects were like before the alleged cause entered the picture.',
          badge: 'Core',
          badgeColor: 'blue',
        },
        {
          title: 'Control / comparison group',
          text: 'Lets you compare "cause present" against "cause absent" instead of staring at one snapshot in isolation.',
          badge: 'Core',
          badgeColor: 'blue',
        },
        {
          title: 'Random assignment',
          text: 'Makes it less likely that one group already differed in the very trait the conclusion is trying to explain.',
          badge: 'Core',
          badgeColor: 'blue',
        },
        {
          title: 'Placebo / blinding protection',
          text: 'Prevents expectations or biased measurement from generating a fake effect.',
          badge: 'Core',
          badgeColor: 'blue',
        },
      ],
    },
    { type: 'h4', text: 'Competing Hypotheses' },
    {
      type: 'paragraph',
      text: 'A correlation does not force a single explanation. Good Strengthen answers often help by shrinking the list of rival stories. Ask which of these is still alive:',
    },
    {
      type: 'list',
      items: [
        '**Reverse causation:** Did the effect actually produce the alleged cause?',
        '**Third factor:** Is there a hidden variable producing both?',
        '**Bad comparison:** Did the groups differ before the alleged cause appeared?',
        '**Wrong mechanism:** Even if the pattern is real, is the author explaining it the right way?',
        '**Weak prediction:** If the explanation were true, should we observe another telltale sign that is currently missing?',
      ],
    },

    {
      type: 'callout',
      variant: 'tip',
      title: 'The "No Cause → No Effect" Test',
      text: 'One of the most powerful strengthening patterns on the LSAT is showing that when the alleged cause is absent, the effect does not occur. If removing the cause also removes the effect, the causal link becomes much harder to deny. Look for answer choices that establish this "control group" dynamic.',
    },
    ...
    {
      type: 'paragraph',
      text: "Let's engage with the text sentence by sentence to see how the author builds their causal case.",
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          title:
            '"In a transportation company, a certain syndrome often attributed to stress by medical experts afflicts a significantly higher percentage of workers in Department F than in any other department."',
          text: 'You are introduced to a correlation. There is a specific location, Department F, and a specific health problem, a stress-related syndrome. The key data point is that the *rate* of the syndrome is higher in Department F than anywhere else in the company.',
        },
        {
          title:
            '"We can conclude, therefore, that the work done in Department F subjects workers to higher stress levels than does the work in the other departments in the company."',
          text: 'This is the conclusion. The author is making a **causal claim**: because the syndrome is linked to stress and it happens more in Department F, the *work in Department F* must be the source of that stress. The word "therefore" signals this is the conclusion.',
        },
      ],
    },
    ...
    {
      type: 'paragraph',
      text: "You are looking for the answer that makes the author's causal explanation more likely by ruling out a competing explanation.",
    },
    {
      type: 'breakdown',
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Strengthening Causal Arguments"
        },
        {
          "type": "paragraph",
          "text": "Causal reasoning is one of the most frequently tested argument structures on the LSAT. In a causal argument, the author observes that two things are associated — they occur together, one follows the other, or they correlate statistically — and concludes that one **caused** the other. This leap from correlation to causation is inherently vulnerable because there are always alternative explanations for any observed association."
        ...
        {
          "type": "h3",
          "text": "How to Strengthen Causal Claims"
        },
        {
          "type": "paragraph",
          "text": "There are three primary strategies for strengthening a causal argument. Each attacks the gap from a different angle, but all share the same goal: making the proposed cause-effect link more credible."
        ...
        {
          "type": "h3",
          "text": "Drill: Strengthening Causal Claims (PT-128-S-3-Q-1)"
        },
        {
          "type": "h4",
          "text": "The Problem"
        ...
        {
          "type": "paragraph",
          "text": "Which one of the following, if true, most helps to support the argument?"
        },
        {
          "type": "question-card",
          "id": "PT-128-S-3-Q-1",
        ...
        },
        {
          ...
          "items": [
            {
              "title": "\"In a transportation company, a certain syndrome often attributed to stress by medical experts afflicts a significantly higher percentage of workers in Department F than in any other department.\"",
              "text": "You are introduced to a correlation. There is a specific location, Department F, and a specific health problem, a stress-related syndrome. The key data point is that the *rate* of the syndrome is higher in Department F than anywhere else in the company."
            },
            {
              "title": "\"We can conclude, therefore, that the work done in Department F subjects workers to higher stress levels than does the work in the other departments in the company.\"",
              "text": "This is the conclusion. The author is making a **causal claim**: because the syndrome is linked to stress and it happens more in Department F, the *work in Department F* must be the source of that stress. The word \"therefore\" signals this is the conclusion."
            }
          ]
        },
        ...
        },
        {
          ...
          "items": [
            ...
            {
              "title": "(B) Some experts believe that the syndrome can be caused by various factors, only one of which is high stress.",
              "text": "**[The Weakener]**\nThis choice actually *hurts* the argument. If the syndrome can be caused by various factors other than stress — such as bad lighting, toxic chemicals, or poor ventilation — then the author's specific claim that stress from the *work* in Department F is the cause becomes less likely. This opens the door to alternative explanations rather than closing it. **Wrong direction.**",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) Many workers who transfer into Department F from elsewhere in the company soon begin to develop the syndrome.",
              "text": "**[The Correct Choice — Timeline / No Cause → Effect]**\nThis is devastating because it provides a before-and-after comparison. These workers were presumably healthy while working in other departments (no cause → no effect). After transferring to Department F, they developed the syndrome (cause introduced → effect appears). This rules out the self-selection alternative: these workers didn't choose Department F *because* they were already stressed or sick — they only became affected *after* they started working there. This is the \"No Cause → No Effect\" pattern, one of the strongest forms of causal support.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            ...
            {
              "title": "(E) Job-related stress has been the most frequently cited cause for dissatisfaction among workers at the company.",
              "text": "**[The Scope Mismatch]**\nDissatisfaction is not the same thing as the specific medical syndrome mentioned in the stimulus. Furthermore, if stress-related dissatisfaction is high across the *whole company*, it does not explain why the syndrome is concentrated specifically in Department F. This choice fails to distinguish Department F from other departments. **Wrong concept and wrong scope.**",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
