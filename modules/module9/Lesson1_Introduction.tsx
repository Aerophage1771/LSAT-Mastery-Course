...
export const Lesson1_Introduction: Lesson = {
  ...
  content: [
    ...
    {
      type: 'callout',
      text: '**Identify a new piece of information that, if true, makes the conclusion more likely to follow from the premises.** You are looking for a "helpful premise" that reinforces the author\'s logical leap.',
      variant: 'goal',
    },
    { type: 'hr' },
