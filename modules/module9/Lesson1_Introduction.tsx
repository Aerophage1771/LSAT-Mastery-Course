...
export const Lesson1_Introduction: Lesson = {
  ...
  content: [
    ...
    {
      type: 'callout',
      text: '**Identify a new piece of information** that, if true, makes the conclusion more likely to follow from the premises.',
      variant: 'goal',
    },
    { type: 'paragraph', text: 'This module covers Strengthen.' },
    { type: 'hr' },
