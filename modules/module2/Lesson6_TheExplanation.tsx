...
export const Lesson6_TheExplanation: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Feature', 'Simple Argument', 'Explanatory Argument'],
      rows: [
    ...
    {
      type: 'table',
      headers: ['Indicator Phrase', 'What It Signals', 'Example'],
      rows: [
        [
    ...
    { type: 'h3', text: 'Answer Choice Analysis' },
    {
      ...
      items: [
        ...
        {
          title:
            '(D) If unusually rich growth of vegetation caused the ice ages, it undoubtedly did so by depleting CO₂...',
