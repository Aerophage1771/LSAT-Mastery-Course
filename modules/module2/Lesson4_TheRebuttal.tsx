...
export const Lesson4_TheRebuttal: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Pivot Word', 'Strength', 'Example'],
      rows: [
    ...
    { type: 'h4', text: 'Step 1: Identify the Rebuttal Structure' },
    {
      ...
      items: [
        ...
        {
          title:
            '"In view of the context provided by the rest of the poem, the line was clearly meant to refer to... a creationist theory."',
    ...
    {
      type: 'table',
      headers: ['Trap Type', 'What It Does', 'Example from the Tennyson Question'],
      rows: [
        [
          '**The Premise Trap**',
