...
export const Lesson8_Advanced_IntermediateConclusion: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Scenario', 'Final Indicator Marks...', 'How to Detect It'],
      rows: [
        [
    ...
    {
      type: 'table',
      headers: ['Test', 'Main Conclusion', 'Intermediate Conclusion'],
      rows: [
    ...
    { type: 'h3', text: 'Answer Choice Analysis' },
    {
      ...
      items: [
        ...
        {
          title:
            '(B) The reason that many hormones can each independently raise blood glucose levels is probably a metabolic quirk of the brain.',
