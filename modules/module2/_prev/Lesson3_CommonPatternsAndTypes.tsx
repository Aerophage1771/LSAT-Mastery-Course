...
export const Lesson3_CommonPatternsAndTypes: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Type', 'Frequency', 'Core Function', 'Key Indicator Words'],
      rows: [
        [
          '**1. The Rebuttal**',
          '~45%',
    ...
    {
      type: 'table',
      headers: ['Pivot Words (Before Conclusion)', 'Rejection Words (In Conclusion)'],
      rows: [
        ['But', 'mistaken'],
    ...
    {
      type: 'table',
      headers: ['Recommendation Words', 'Judgment Words'],
      rows: [
...

    {
      ...
      variant: 'summary',
      title: 'Key Takeaways',
      text: '• **Four conclusion types** cover virtually all Main Conclusion questions: Rebuttal (~45%), Prescription (~25%), Explanation (~20%), and Prediction/Fact (~10%).\n• **The Rebuttal** follows the "They Say / But / I Say" pattern -- the conclusion almost always follows the pivot word.\n• **The Prescription** uses "should," "must," "ought to," or value judgments to recommend an action or make a judgment.\n• The upcoming lessons cover each type in depth with worked examples and drills.',
    },

    {
      ...
      text: 'This lesson covers Types 1-2 (The Rebuttal and The Prescription). The **Extended Guide** (next lesson) covers Types 3-4 -- The Explanation and The Prediction/Factual Claim -- plus the Quick Pattern Matching process, Pivot Word Reference, and the Sandwich Conclusion Pattern.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "diff-note",
          "text": "The full four-type breakdown below substantially overlaps the preview in Lesson 2-1. Since Lesson 2-1 is being trimmed, this lesson becomes the canonical taxonomy. No cut needed here -- just confirm 2-1's preview is abbreviated.",
          "variant": "comment"
        },
        {
          "type": "h2",
        ...
        {
          "type": "paragraph",
          "text": "This is the most common argument structure on the LSAT (~45%). {{!The Reference Guide (2-11) lists Rebuttal at ~35%. Reconcile to one authoritative figure across all lessons.!}} The author's primary goal is to **tear down an existing claim**. The stimulus introduces a position held by others, and the main conclusion is the author's direct rejection of that position."
        },
        {
          "type": "h4",
          "text": "How to Spot It"
        ...
        {
          "type": "paragraph",
          "text": "This is the most straightforward type (~10%). {{!The Reference Guide lists this at ~15%. Reconcile.!}} The author uses a set of premises to prove a simple descriptive **fact** or make a **prediction** about a future event. It is a claim about what *is* or *will be* true."
        },
        {
          "type": "h4",
          "text": "How to Spot It"
        ...
        {
          "type": "diff-note",
          "text": "Add a mini-exercise here: present a 3-sentence argument with a sandwiched conclusion and ask the student to identify the main conclusion before revealing the answer. This is the last chance for practice before the deep-dive lessons.",
          "variant": "add"
        },
        {
          "type": "hr"
    ...
    field: {
      label: 'Field Guide',
      content: [
        { type: 'h3', text: 'Main Conclusion Patterns \u2014 Field Guide' },
        ...
        { type: 'h3', text: 'Pattern Cards' },
        {
          ...
          items: [
            {
              title: 'The Rebuttal',
              text: '**Signal:** "They Say / But / I Say" \u2014 the argument opens with someone else\'s position, pivots with *But* or *However*, then the author rejects it.\n\n**Structure:** Opposing View \u2192 Pivot \u2192 Author\'s Rejection (Conclusion) \u2192 Evidence\n\n**Common Trap:** Picking the opposing view that appears *before* the pivot word. The conclusion is always *after* the pivot.',
              badge: '~45%',
              badgeColor: 'green',
            },
            {
              title: 'The Prescription',
              text: '**Signal:** Prescriptive language \u2014 *should, must, ought to, it is advisable, unfair, unwise, pointless.*\n\n**Structure:** Problem / Context \u2192 Recommendation or Value Judgment (Conclusion) \u2192 Rationale\n\n**Common Trap:** Confusing the problem description (premise) with the recommendation (conclusion). The problem is the *reason*; the recommendation is the *point*.',
              badge: '~25%',
              badgeColor: 'green',
            },
          ],
        },
        {
          type: 'callout',
          variant: 'summary',
          text: '\u2022 **Rebuttal (~45%)** \u2014 Conclusion follows the pivot word; reject the opposing view trap.\n\u2022 **Prescription (~25%)** \u2014 "Should" / "must" language marks the conclusion; don\'t confuse the problem with the recommendation.',
        },
      ],
    },
  },
