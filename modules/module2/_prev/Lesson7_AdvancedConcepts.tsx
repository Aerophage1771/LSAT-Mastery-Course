...
export const Lesson7_AdvancedConcepts: Lesson = {
  ...
  content: [
    ...
    {
      type: 'breakdown',
      labels: { title: 'Difficulty Factor', text: 'What Makes It Hard' },
      items: [
        {
    ...
    {
      type: 'table',
      headers: ['Hard Answer Pattern', 'What It Really Is', 'How to Spot It'],
      rows: [
        [
    ...
    { type: 'h4', text: 'Best-Supported Paraphrase vs. Perfect Match' },
    {
      type: 'paragraph',
      text: 'On advanced Main Conclusion questions, the credited answer is often the **best-supported paraphrase**, not a beautiful mirror of your prephrase. This is especially common when the conclusion contains referential language ("this view"), a comparison ("more likely"), or context-dependent voice tracking.',
    },
    {
      type: 'table',
      headers: ['If the answer does this...', 'Treat it as...', 'Unless it also...'],
      rows: [
        [
          'Names a previously vague referential',
          'Potentially correct translation',
          'points to the wrong claim, speaker, or object',
        ],
        [
          'Makes an implied comparison explicit',
          'Potentially correct translation',
          'changes the baseline, direction, or certainty',
        ],
        [
          'States the author\'s point more directly than the stimulus did',
          'Potentially correct paraphrase',
          'adds a stronger commitment than the author made',
        ],
        [
          'Looks less familiar than a quoted premise',
          'Still a live contender',
          'fails the Why Test or shifts the scope',
        ],
      ],
    },
    ...
    {
      type: 'table',
      headers: ['Component', 'What to Check', 'Red Flag'],
      rows: [
        [
          'Subject',
