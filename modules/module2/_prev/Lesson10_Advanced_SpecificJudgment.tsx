...
export const Lesson10_Advanced_SpecificJudgment: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'Understanding this distinction is the key to avoiding the Conditional Paraphrase Trap:',
    },
    {
      type: 'table',
      headers: ['Feature', 'Specific Judgment', 'General Rule'],
      rows: [
        ['Scope', 'About *this* particular case', 'About *all* cases meeting certain conditions'],
        [
          'Language',
          'Uses proper nouns, definite articles (\"the,\" \"this\")',
          'Uses conditionals (\"If... then...\"), universals (\"any,\" \"all\")',
        ],
        ...
        [
          'Example',
          '"The similarity between Novels X and Y is coincidental"',
          '"If two authors have similar lives, similar novels are coincidental"',
        ],
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'These language markers help you quickly distinguish whether the author is making a specific or general claim:',
    },
    {
      type: 'table',
      headers: ['Specific Language (Conclusion is likely specific)', 'General Language (Conclusion might be general)'],
      rows: [
    ...
    {
      type: 'paragraph',
      text: "This trap is so common and effective that it deserves its own name. Here's how it works:",
    },
    {
      type: 'process',
      title: 'How the Trap Is Built',
      steps: [
    ...
    { type: 'h3', text: 'Answer Choice Analysis' },
    {
      ...
      items: [
        {
          title: '(A) Novel X and Novel Y are both semiautobiographical... similar themes...',
          text: "This is the **initial premise** that sets up the puzzle. It's background information, not the author's point.",
          badge: 'Trap: The Premise',
          badgeColor: 'red',
        },
        {
          title: '(B) The fact that... might lead one to suspect plagiarism...',
          text: 'This is the **opposing viewpoint** — the suspicion the author argues *against*. The word \"However\" signals that the author rejects this view.',
          badge: 'Trap: Opposing Viewpoint',
          badgeColor: 'red',
        },
        {
          title: '(C) The author of Novel X and the author of Novel Y are from very similar backgrounds...',
          text: 'This is the **premise** used to support the conclusion, directly introduced by \"since.\" It\'s the evidence, not the point.',
          badge: 'Trap: The Premise',
          badgeColor: 'red',
        },
        {
          title: '(D) It is less likely that... plagiarism than that... merely coincidental.',
          text: 'This is a valid paraphrase of the main conclusion. \"More likely A than B\" is logically equivalent to \"Less likely B than A.\" It preserves the **specific judgment** about these two novels at the correct certainty level.',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title: '(E) If the authors of Novel X and Novel Y are from very similar backgrounds...',
          text: 'This is the **Conditional Paraphrase Trap**. It takes the author\'s specific line of reasoning and converts it into a general \"If... then...\" rule. The author made a ruling about *this one case*, not a universal claim about all similar situations. Note how it uses \"If\" — turning facts the author accepted as true into a hypothetical condition.',
          badge: 'Trap: Conditional Paraphrase',
          badgeColor: 'red',
        },
      ],
    },
    ...
    {
      type: 'paragraph',
      text: "Both (D) and (E) capture the gist of the author's reasoning. Here's why (D) is correct and (E) is not:",
    },
    {
      type: 'table',
      headers: ['Feature', '(D) — Correct', '(E) — Incorrect'],
      rows: [
        [
          'Scope',
          'Specific: about Novels X and Y',
          'General: \"If authors have similar backgrounds...\" (universal rule)',
        ],
        [
          'Status of facts',
          'Treats the similar backgrounds as *established*',
          'Treats the similar backgrounds as *hypothetical* (\"If...\")',
        ],
        [
          'What it claims',
          'Coincidence is more likely than plagiarism *in this case*',
          'Similar backgrounds generally make plagiarism suspicions unwarranted',
        ],
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Specific Judgment vs. General Rule"
        },
        {
          "type": "paragraph",
          "text": "This lesson tackles one of the most sophisticated traps on Main Conclusion questions. On difficult questions, the author makes a specific judgment about a particular case — a ruling on *this situation* based on *these facts*. A highly tempting wrong answer takes that specific reasoning and generalizes it into a broad \"If... then...\" rule. The trap works because the general rule *accurately describes the logic* the author used, but it overstates the scope of the author's claim. Your task is to be precise: is the author making a ruling about one case, or trying to establish a universal law?"
        ...
        {
          "type": "h3",
          "text": "Specific vs. General: The Core Distinction"
        },
        {
          "type": "paragraph",
          "text": "Understanding this distinction is the key to avoiding the Conditional Paraphrase Trap:"
        },
        {
          ...
          "rows": [
            [
              ...
              "About *all* cases meeting certain conditions"
            ],
            [
              "Language",
              "Uses proper nouns, definite articles (\"the,\" \"this\")",
            ...
            [
              "Claim",
              "\"In this situation, X is true\"",
              "\"Whenever Y happens, X follows\""
            ],
            [
              "Provability",
              "Proved by the specific facts presented",
              "Would require evidence across many cases"
            ],
            [
              "Example",
              "\"The similarity between Novels X and Y is coincidental\"",
        ...
        },
        {
          "type": "table",
          "headers": [
            "Specific Language (Conclusion is likely specific)",
            "General Language (Conclusion might be general)"
          ],
          "rows": [
            [
              "\"Novel X,\" \"this policy,\" \"the mayor's plan\"",
              "\"any novel,\" \"all policies,\" \"whenever\""
            ],
            [
              "\"in this case,\" \"here,\" \"for these novels\"",
              "\"in general,\" \"as a rule,\" \"in all cases\""
            ],
            [
              "\"is more likely,\" \"was probably\"",
              "\"will always,\" \"must necessarily\""
            ],
            [
            ...
            [
              "\"it is coincidental\" (about one case)",
              "\"coincidences are common when...\" (general law)"
            ]
          ]
        },
        {
        ...
        {
          "type": "h3",
          "text": "The Conditional Paraphrase Trap"
        },
        {
          "type": "paragraph",
          "text": "This trap is so common and effective that it deserves its own name. Here's how it works:"
        ...
        {
          "type": "paragraph",
          "text": "This argument follows a classic rebuttal structure with a specific judgment:"
        },
        {
          "type": "process",
          "title": "The Argument Flow",
        ...
        {
          "type": "h3",
          "text": "Why (D) Over (E): A Closer Look"
        },
        {
          "type": "paragraph",
          "text": "Both (D) and (E) capture the gist of the author's reasoning. Here's why (D) is correct and (E) is not:"
        },
        {
          ...
          "rows": [
            ...
            [
              "Author's intent",
              "A judgment about these two novels",
              "A principle that could apply to any pair of novels"
            ]
          ]
        },
        {
