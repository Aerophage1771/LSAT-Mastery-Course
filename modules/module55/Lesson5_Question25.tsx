...
export const Lesson5_Question25: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-113-S-1-Q-25', questionType: 'Structure', passageTitle: 'Psychology of Risk', passage: passageText, question: `The passage can be most accurately described as`, options: [
    ...
    { 
      ...
      items: [
        { title: "(A)", text: "This is too narrow. While the passage does analyze motives in collective decision-making, its main point is the broader act of connecting a psychological principle to international relations.", badge: 'Wrong Sequence', badgeColor: "red" },
        { title: "(B)", text: "This is close but inaccurate. The Falklands War is used as an *example* to illustrate the theory, not as a formal 'test case' to prove it. A test case implies a more rigorous, scientific validation.", badge: 'Missing Step', badgeColor: "red" },
        { title: "(C)", text: "This gets the relationship backward. The passage shows political scholars using findings from psychology, not the other way around.", badge: 'Added Step', badgeColor: "red" },
        ...
        { title: "(E)", text: "The passage focuses on applying one primary psychological theory to international crises. It does not present two separate or competing ways of understanding them.", badge: 'Partial Blueprint', badgeColor: "red" }
    ]
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "blockquote",
          "text": "**Question:** The passage can be most accurately described as"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This is a Structure/Organization question. We need to find the description that best captures the overall structure and purpose of the passage."
        },
        {
          "type": "callout",
          "title": "Prediction",
          "variant": "tip",
          "text": "The passage has a clear two-part structure. It first explains a concept from one field ('new psychological considerations regarding risk') and then shows how that concept can be used to understand a different field ('application to another field of inquiry,' which is international conflict)."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "This is too narrow. While the passage does analyze motives in collective decision-making, its main point is the broader act of connecting a psychological principle to international relations.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "This is close but inaccurate. The Falklands War is used as an *example* to illustrate the theory, not as a formal 'test case' to prove it. A test case implies a more rigorous, scientific validation.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "This gets the relationship backward. The passage shows political scholars using findings from psychology, not the other way around.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "This accurately describes the two-part structure of the passage. It first examines new psychological ideas about risk and loss aversion and then applies these ideas to another area of study, international conflict.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(E)",
              "text": "The passage focuses on applying one primary psychological theory to international crises. It does not present two separate or competing ways of understanding them.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
