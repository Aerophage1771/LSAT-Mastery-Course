...
export const Lesson3_Question23: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-113-S-1-Q-23', questionType: 'Function', passageTitle: 'Psychology of Risk', passage: passageText, question: `The question in the second sentence of the second paragraph functions primarily as`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Function', text: 'Read the question stem carefully. Return to the passage for direct evidence before evaluating answer choices.' },
    ...
    { 
      ...
      items: [
        { title: "(A)", text: "The passage suggests the opposite. It states that subjects 'commonly judge' the gamble in a specific way, implying the results are consistent, not that they 'vary widely.'", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(B)", text: "The answer to the question actually supports and clarifies the previously accepted view; it does not conflict with it. The example shows why people are risk-averse when seeking gains.", badge: 'Out of Scope', badgeColor: "red" },
        ...
        { title: "(D)", text: "The entire passage is about how the differences between objective and subjective valuations are real and important. This question highlights one of those real discrepancies.", badge: 'Partial Match', badgeColor: "red" },
        { title: "(E)", text: "The question is part of the discussion of the previous theory, not a transition away from it. The actual transition to the new research findings occurs later in the paragraph with the word 'Nevertheless.'", badge: 'Misreading', badgeColor: "red" }
    ]
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question 23 Breakdown"
        },
        {
          "type": "blockquote",
          "text": "**Question:** The question in the second sentence of the second paragraph functions primarily as"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This is a Function question. It asks for the purpose of the question about the $100 gamble in the second paragraph. We must analyze its role in the context of that paragraph's argument."
        },
        {
          "type": "callout",
          "title": "Prediction",
          "variant": "tip",
          "text": "The second paragraph starts by describing the 'previously accepted view' that people are risk-averse when seeking gains. The question about the gamble serves as a specific, concrete example to illustrate and explain this very concept."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "The passage suggests the opposite. It states that subjects 'commonly judge' the gamble in a specific way, implying the results are consistent, not that they 'vary widely.'",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "The answer to the question actually supports and clarifies the previously accepted view; it does not conflict with it. The example shows why people are risk-averse when seeking gains.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "This is correct. The question about the gamble and the subsequent explanation serve as an 'illustration' to show how the 'previously accepted view' works in practice for situations involving potential gains.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(D)",
              "text": "The entire passage is about how the differences between objective and subjective valuations are real and important. This question highlights one of those real discrepancies.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "The question is part of the discussion of the previous theory, not a transition away from it. The actual transition to the new research findings occurs later in the paragraph with the word 'Nevertheless.'",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
