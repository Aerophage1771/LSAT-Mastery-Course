...
export const Lesson4_Quantifiers: Lesson = {
  ...
  content: [
    ...
    {
      type: 'accordion',
      title: 'PT-124-S-2-Q-25',
      content: [
        { type: 'blockquote', text: '**Stimulus:** Most serious students are happy students, and most serious students go to graduate school. Furthermore, all students who go to graduate school are overworked.\n\n**Question:** Which one of the following can be properly inferred from the statements above?' },
        { 
          type: 'options', 
          items: [
            "(A) Most overworked students are happy students.",
            "(B) Some happy students are overworked. (Correct)",
    ...
    { type: 'h4', text: '4.4 Invalid Quantifier Chains: The Undistributed Middle' },
    ...
    {
        type: 'accordion',
        title: 'PT-122-S-4-Q-24',
        content: [
            { type: 'blockquote', text: '**Stimulus:** Most of the employees of the Compujack Corporation are computer programmers. Since most computer programmers receive excellent salaries from their employers, at least one Compujack employee must receive an excellent salary from Compujack.\n\n**Question:** Which one of the following arguments exhibits a flawed pattern of reasoning most similar to the flawed pattern of reasoning exhibited by the argument above?' },
            { 
            type: 'options', 
            items: [
                "(A) Most gardeners are people with a great deal of patience. Since most of Molly’s classmates are gardeners, at least one of Molly’s classmates must be a person with a great deal of patience. (Correct)",
    ...
    { type: 'h4', text: '4.5 Quick Reference Guide: Valid vs. Invalid' },
    { 
      type: 'table',
