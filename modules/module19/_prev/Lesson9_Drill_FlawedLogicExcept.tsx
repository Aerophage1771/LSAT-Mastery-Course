...
export const Lesson9_Drill_FlawedLogicExcept: Lesson = {
  ...
  content: [
    ...
    { type: 'h4', text: 'Step 3: Evaluation' },
    {
      ...
      items: [
        {
          title: '(A) Library cutbacks forced libraries to buy fewer popular novels.',
          text: 'Resolves the paradox. If libraries stock fewer new novels, readers who want those titles must *buy* them from bookstores. Book purchases rise even as overall reading falls, boosting bookstore revenue. **Eliminate.**',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(B) New antitheft equipment shielded bookstores from rising shoplifting.',
          text: 'Does NOT resolve the paradox. This explains why bookstore profits did not *decrease* due to shoplifting\u2014it is loss prevention, not profit growth. It leaves the core conflict untouched: reading is down, yet profits are *up*. Avoiding a new loss is not the same as generating a new gain. **This is the correct EXCEPT answer.**',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title: '(C) Many bookstores installed lucrative coffee bars.',
          text: 'Resolves the paradox. Coffee bars introduce a high-margin, non-book revenue stream. Profits can rise from coffee sales even if book sales are flat or declining. **Eliminate.**',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(D) Sales shifted from cheap paperbacks to lucrative hardbacks.',
          text: 'Resolves the paradox. Fewer units sold but higher profit per transaction. Revenue rises even as volume falls. **Eliminate.**',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(E) Consumers canceled magazine subscriptions, buying individual issues at bookstores.',
          text: 'Resolves the paradox. Magazine sales introduce non-book revenue, increasing store profits while per-capita book reading declines. **Eliminate.**',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
      ],
    ...
    { type: 'hr' },
    {
      ...
      title: 'Key Takeaway',
      variant: 'summary',
      text: "In difficult EXCEPT paradox questions, the correct answer often explains why a business *avoided a loss* rather than how it *achieved a gain*. The paradox here is about a surprising *increase* in profits. An explanation for why profits didn't *decrease* (avoiding shoplifting losses) addresses a different, hypothetical problem\u2014not the actual conflict in the stimulus. Always match the direction of the explanation to the direction of the paradox.",
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h3",
          "text": "Practice Drill: Explain EXCEPT"
        },
        {
          "type": "paragraph",
          "text": "An \"Explain EXCEPT\" question flips the usual task: instead of finding the one answer that resolves the paradox, you must find the four that *do* resolve it and eliminate them. The correct answer is the one that fails to explain the discrepancy. The hardest EXCEPT questions feature a correct answer that sounds topically relevant but is logically irrelevant to the specific conflict presented."
        ...
        {
          "type": "paragraph",
          "text": "Define the core conflict. The two facts move in opposite directions."
        },
        {
          "type": "list",
          "items": [
