...
export const Lesson3_Drill_NumbersVsPercentages: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'Watch for stimuli that juxtapose "the proportion of..." with "the total number of..." or that compare a specific subgroup to the overall population. The tension almost always hinges on the denominator.',
    },
    {
      type: 'table',
      headers: ['Stimulus Language', 'What to Suspect'],
      rows: [
        ...
        [
          '"among full-time workers..." vs "among all workers..."',
          'The excluded subgroup is skewing the overall average',
        ],
      ],
    },
    { type: 'hr' },
    ...
    {
      type: 'paragraph',
      text: "Something about part-time work must affect women's average more than men's. Either women are more likely to work part-time, or women's part-time earnings are disproportionately low, or both.",
    },
    { type: 'h4', text: 'Step 3: Evaluate Each Choice' },
    {
      ...
      items: [
        {
          title: '(A) Earnings gap increasing over 30 years.',
          text: 'Historical trend — does not explain why the full-time and all-worker statistics differ right now.',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(B) Women in same occupation earn nearly the same.',
          text: 'Narrows the subgroup further. Irrelevant to the full-time vs. all-worker discrepancy.',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(C) More women entering high-paying positions.',
          text: 'Deepens the paradox — better jobs should shrink the gap, not widen it.',
          badge: 'Incorrect',
          badgeColor: 'red',
        },
        {
          title: '(D) Women more likely to work part-time; part-time pays less.',
          text: "Resolves the paradox. Part-time workers' lower earnings pull the female average down far more than the male average, explaining the drop from 80% to 65%.",
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title: '(E) Other countries show 50-90% range.',
          text: "Out of scope — other countries cannot explain Naota's internal discrepancy.",
          badge: 'Incorrect',
          badgeColor: 'red',
        },
      ],
    ...
    { type: 'hr' },
    {
      ...
      variant: 'summary',
      title: 'Key Takeaway',
      text: 'When a stimulus compares a subgroup statistic to a whole-group statistic, the resolution lies in the excluded portion. Ask: "What is different about the people in the whole group but NOT in the subgroup?" Here, the answer was part-time workers — their lower pay and disproportionate representation among women explained the widening gap.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Numbers vs. Percentages Paradox"
        },
        {
          "type": "paragraph",
          "text": "One of the most common Paradox patterns on the LSAT exploits the gap between percentages and absolute numbers. A percentage can go up while the absolute number goes down — or vice versa — because the size of the underlying group (the denominator) changed. When you see a stimulus mixing rates with raw counts, immediately ask: \"Did the group size change?\""
        ...
        },
        {
          ...
          "rows": [
            [
              ...
              "The raw number may have decreased if the denominator shrank"
            ],
            [
              "\"the number increased\"",
              "The percentage may have decreased if the denominator grew faster"
            ],
            [
              "\"among full-time workers...\" vs \"among all workers...\"",
              "The excluded subgroup is skewing the overall average"
        ...
        {
          "type": "h4",
          "text": "Step 1: Identify Both Facts"
        },
        {
          "type": "list",
          "items": [
