...
export const Lesson10_ReferenceGuide: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'An answer that explains only Fact 1 is a half-explanation. An answer that explains only Fact 2 is also a half-explanation. An answer that makes the conflict worse is a trap. Only an answer that bridges both facts passes the test.',
    },
...

    {
      ...
      items: [
        ...
        {
          title: '3. Irrelevant Information',
        ...
        {
          title: '6. Explains the Wrong Direction',
        ...
        {
          title: '7. Confuses Correlation and Causation',
