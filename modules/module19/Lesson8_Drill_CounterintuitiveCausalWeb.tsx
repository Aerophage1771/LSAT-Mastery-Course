...
export const Lesson8_Drill_CounterintuitiveCausalWeb: Lesson = {
  ...
  content: [
    ...
    { type: 'h4', text: 'Step 2: Abstraction' },
    {
      ...
      variant: 'tip',
      text: 'An incentive structure affects everyone in the system, not just the person it targets. When an arrangement that should prevent a bad outcome paradoxically produces more of it, introduce a second actor whose vigilance changes in response to the perceived risk. The net effect of multiple actors\u2019 changing behavior explains the surprise.',
    },
