...
export const Lesson6_Question28: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-115-S-3-Q-28', questionType: 'Other Viewpoint', passageTitle: 'Digitalization and Copyright Law', passage: passageText, question: `Which one of the following views can most reasonably be attributed to the experts cited in the first sentence of the third paragraph?`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Other Viewpoint', text: 'Read the question stem carefully. Return to the passage for direct evidence before evaluating answer choices.' },
    ...
    { 
      ...
      items: [
        ...
        { title: "(B)", text: "This is unlikely. The proposal is to 'simply add' to the current law, not to fundamentally change it by removing long-standing exemptions. This would be a major revision, not a simple addition.", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(C)", text: "The passage presents the issue of secondary copies as an open 'question' raised by the experts' proposal. It does not state that the experts themselves hold a specific view on this issue.", badge: 'Out of Scope', badgeColor: "red" },
        { title: "(D)", text: "As with (C), this offers a specific opinion on a matter the passage only presents as an unresolved question. We cannot attribute this view to the experts.", badge: 'Partial Match', badgeColor: "red" },
        { title: "(E)", text: "Similar to (C) and (D), this attributes a specific stance to the experts on an issue the passage frames as a complex, open question.", badge: 'Misreading', badgeColor: "red" }
    ]
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question 28 Breakdown"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following views can most reasonably be attributed to the experts cited in the first sentence of the third paragraph?"
        },
        {
          "type": "options",
          "items": [
        ...
        },
        {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "This is a strong inference. If the proposal is to 'simply add' a new crime to the 'current law,' it follows that the new crime would be subject to the existing rules and exceptions of that law, including the exemptions for academic use.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B)",
              "text": "This is unlikely. The proposal is to 'simply add' to the current law, not to fundamentally change it by removing long-standing exemptions. This would be a major revision, not a simple addition.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "The passage presents the issue of secondary copies as an open 'question' raised by the experts' proposal. It does not state that the experts themselves hold a specific view on this issue.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "As with (C), this offers a specific opinion on a matter the passage only presents as an unresolved question. We cannot attribute this view to the experts.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "Similar to (C) and (D), this attributes a specific stance to the experts on an issue the passage frames as a complex, open question.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
