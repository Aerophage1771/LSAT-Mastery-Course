...
export const Lesson4_Question26: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-115-S-3-Q-26', questionType: 'Purpose of Paragraph', passageTitle: 'Digitalization and Copyright Law', passage: passageText, question: `The discussion in the second paragraph is intended primarily to explain which one of the following?`, options: [
    ...
    { 
      ...
      items: [
        { title: "(A)", text: "The paragraph explains a loophole that prevents something from being a crime; it does not discuss punishments.", badge: 'Too Extreme', badgeColor: "red" },
        ...
        { title: "(C)", text: "The first paragraph sets up the general conflict and the need for protection. The second paragraph focuses specifically on explaining the legal technicality.", badge: 'Out of Scope', badgeColor: "red" },
        { title: "(D)", text: "The proposals from experts are the topic of the third paragraph, not the second. The second paragraph explains the problem that these proposals are meant to solve.", badge: 'Partial Match', badgeColor: "red" },
        { title: "(E)", text: "The paragraph briefly defines digitalization but its main purpose is not technical. Its primary goal is to explain the legal implications of that technology.", badge: 'Misreading', badgeColor: "red" }
    ]
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "blockquote",
          "text": "**Question:** The discussion in the second paragraph is intended primarily to explain which one of the following?"
        },
        {
          "type": "options",
          "items": [
        ...
        },
        {
          ...
          "title": "Prediction",
          "variant": "tip",
          "text": "The second paragraph's job is to explain the specific legal problem. It describes the existing law (which covers 'material form') and the new technology (digitalization) and shows why they don't match up. Its primary function is to detail the legal loophole."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "The paragraph explains a loophole that prevents something from being a crime; it does not discuss punishments.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "This is a perfect summary of the paragraph's function. It explains that the law is based on 'material reproduction,' a concept that is 'not easily applicable to digitalization,' which creates the legal gray area.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(C)",
              "text": "The first paragraph sets up the general conflict and the need for protection. The second paragraph focuses specifically on explaining the legal technicality.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "The proposals from experts are the topic of the third paragraph, not the second. The second paragraph explains the problem that these proposals are meant to solve.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "The paragraph briefly defines digitalization but its main purpose is not technical. Its primary goal is to explain the legal implications of that technology.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
