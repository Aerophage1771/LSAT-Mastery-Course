...
export const Lesson2_Question24: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-115-S-3-Q-24', questionType: 'Main Idea', passageTitle: 'Digitalization and Copyright Law', passage: passageText, question: `Which one of the following most accurately expresses the main point of the passage?`, options: [
    ...
    { 
      ...
      items: [
        { title: "(A)", text: "The passage describes a philosophical conflict, but it never mentions internet users mounting 'legal challenges.' This is an unsupported detail.", badge: 'Too Narrow', badgeColor: "red" },
        ...
        { title: "(C)", text: "The passage doesn't suggest that a legal change is inevitable ('only a matter of time'). In fact, it emphasizes the deep-seated philosophical clash that will be 'hard to resolve,' making a solution uncertain.", badge: 'False Hierarchy', badgeColor: "red" },
        { title: "(D)", text: "The author describes the problem from a neutral, analytical perspective. They do not take a personal stance on what 'ought to be considered a crime.' This is a prescriptive statement the author does not make.", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(E)", text: "The passage mentions that 'some experts' propose criminalizing digitalization, not that there is a broad agreement among all experts. This overstates the level of consensus.", badge: 'Wrong Scope', badgeColor: "red" }
    ]
    },
    ...
    diff: {
      ...
      content: [
        ...
        },
        {
          ...
          "title": "Prediction",
          "variant": "tip",
          "text": "The passage has a problem-solution structure. Problem: The law is outdated. Proposed solution: Criminalize digitalization. Author's argument: This solution is not as simple as it seems and has many complications. The main point must capture this entire arc: the need for a solution and the difficulty of implementing it."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "The passage describes a philosophical conflict, but it never mentions internet users mounting 'legal challenges.' This is an unsupported detail.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "This is a perfect summary. It acknowledges the 'necessity of revising' the law (the problem) but focuses on the author's main argument that doing so is 'highly complicated' (the analysis in paragraph 3).",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(C)",
              "text": "The passage doesn't suggest that a legal change is inevitable ('only a matter of time'). In fact, it emphasizes the deep-seated philosophical clash that will be 'hard to resolve,' making a solution uncertain.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "The author describes the problem from a neutral, analytical perspective. They do not take a personal stance on what 'ought to be considered a crime.' This is a prescriptive statement the author does not make.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "The passage mentions that 'some experts' propose criminalizing digitalization, not that there is a broad agreement among all experts. This overstates the level of consensus.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
