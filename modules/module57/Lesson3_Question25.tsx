...
export const Lesson3_Question25: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-115-S-3-Q-25', questionType: 'Application', passageTitle: 'Digitalization and Copyright Law', passage: passageText, question: `Given the author’s argument, which one of the following additions to current Canadian copyright law would most likely be an agreeable compromise to both the Internet community and the publishing community?`, options: [
    ...
    { 
      ...
      items: [
        ...
        { title: "(B)", text: "This is not a good compromise. It completely shuts out the vast majority of internet users and doesn't address the publishers' issue with the academic users who already have 'generous exemptions.'", badge: 'Missed Condition', badgeColor: "red" },
        { title: "(C)", text: "This is a one-sided solution that completely favors the internet community. It offers nothing to the publishers.", badge: 'Wrong Domain', badgeColor: "red" },
        { title: "(D)", text: "This is a one-sided solution that completely favors the publishing community. It offers nothing to the internet users.", badge: 'Over-Application', badgeColor: "red" },
        { title: "(E)", text: "This is not a compromise because, as the passage notes, academics already have 'generous exemptions' under current law. This solution doesn't meaningfully change the status quo or resolve the broader conflict.", badge: 'Surface Match', badgeColor: "red" }
    ]
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "blockquote",
          "text": "**Question:** Given the author’s argument, which one of the following additions to current Canadian copyright law would most likely be an agreeable compromise to both the Internet community and the publishing community?"
        },
        {
          "type": "options",
          "items": [
        ...
        },
        {
          ...
          "title": "Prediction",
          "variant": "tip",
          "text": "A compromise must address the core desire of each group. The internet community wants 'free access to information.' The publishing community wants to protect against 'unauthorized and uncompensated distribution.' A successful compromise would give users access while giving creators compensation."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "This is a perfect compromise. Users get access to the material ('is permitted'), which satisfies the internet community's goal. Copyright holders get paid ('pay a small fee'), which satisfies the publishing community's need for compensation.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B)",
              "text": "This is not a good compromise. It completely shuts out the vast majority of internet users and doesn't address the publishers' issue with the academic users who already have 'generous exemptions.'",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "This is a one-sided solution that completely favors the internet community. It offers nothing to the publishers.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D)",
              "text": "This is a one-sided solution that completely favors the publishing community. It offers nothing to the internet users.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "This is not a compromise because, as the passage notes, academics already have 'generous exemptions' under current law. This solution doesn't meaningfully change the status quo or resolve the broader conflict.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
