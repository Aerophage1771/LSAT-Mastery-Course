...
export const Lesson5_Question27: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-115-S-3-Q-27', questionType: 'Inference', passageTitle: 'Digitalization and Copyright Law', passage: passageText, question: `The passage supports each of the following inferences EXCEPT:`, options: [
    ...
    { 
      ...
      items: [
        { title: "(A)", text: "**Supported.** The passage states that laws against digitalization might be 'virtually unenforceable' due to the millions of internet users and the simplicity of copying. This directly supports the inference that not every instance could be detected.", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(B)", text: "**Supported.** The publishing community views information as a 'commodity owned by its creator.' Criminalizing unauthorized use is a logical extension of protecting that commodity. This is a reasonable inference.", badge: 'Out of Scope', badgeColor: "red" },
        ...
        { title: "(D)", text: "**Supported.** The passage states that one reason enforcement is difficult is because copying is a 'relatively simple process.' It is a reasonable inference that if the process were made even simpler, the problem would become more widespread.", badge: 'Misattribution', badgeColor: "red" },
        { title: "(E)", text: "**Supported.** The passage explicitly states that 'current copyright law allows generous exemptions for those engaged in private study or research,' which directly supports this inference.", badge: 'Unsupported Leap', badgeColor: "red" }
    ]
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question 27 Breakdown"
        },
        {
          "type": "blockquote",
          "text": "**Question:** The passage supports each of the following inferences EXCEPT:"
        },
        {
          "type": "options",
          "items": [
        ...
        },
        {
          ...
          "title": "Prediction",
          "variant": "tip",
          "text": "This is an EXCEPT question, meaning four of the statements are supported by the text and one is not. We need to find the unsupported statement. The key is to check each one against the passage for direct evidence."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A)",
              "text": "**Supported.** The passage states that laws against digitalization might be 'virtually unenforceable' due to the millions of internet users and the simplicity of copying. This directly supports the inference that not every instance could be detected.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B)",
              "text": "**Supported.** The publishing community views information as a 'commodity owned by its creator.' Criminalizing unauthorized use is a logical extension of protecting that commodity. This is a reasonable inference.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C)",
              "text": "**Not Supported.** The passage presents this as an open, unresolved question. It explicitly asks whether 'only the act of digitalization itself be criminal, or should each copy... be considered a separate instance of piracy?' Since the passage frames this as a difficult question without providing an answer, we cannot infer what a future law will include.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(D)",
              "text": "**Supported.** The passage states that one reason enforcement is difficult is because copying is a 'relatively simple process.' It is a reasonable inference that if the process were made even simpler, the problem would become more widespread.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E)",
              "text": "**Supported.** The passage explicitly states that 'current copyright law allows generous exemptions for those engaged in private study or research,' which directly supports this inference.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
