...
export const Lesson4_TheConditionalChain: Lesson = {
  ...
  content: [
    ...
    {
      type: 'table',
      headers: ['Component', 'Abstract Form', 'Role in the Chain'],
      rows: [
    ...
    {
      type: 'table',
      headers: ['Natural Language', 'Symbolic Form', 'Trigger → Result'],
      rows: [
    ...
    {
      type: 'table',
      headers: ['Variation', 'Structure', 'Example', 'Key Feature'],
      rows: [
        [
          '**Basic Chain**',
          'A→B, B→C ∴ A→C',
    ...
    { type: 'h3', text: 'Wrong-Answer Analysis' },
    {
      ...
      items: [
        {
          title:
            '(A) Ruth planted only daffodils → yellow flowers. No flowers blooming → must not have planted daffodils.',
        ...
        {
          title:
            "(B) Shawn starts early → plenty of tomatoes. No tomatoes → either didn't start early or didn't plant early.",
        ...
        {
          title:
            '(D) If Li plants roses → beautiful garden. If beautiful → neighbors impressed. ∴ If roses → impressed.',
    ...
    {
      type: 'table',
      headers: ['Trap', 'What It Looks Like', 'How to Detect It'],
      rows: [
        [
