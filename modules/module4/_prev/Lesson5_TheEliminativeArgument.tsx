...
export const Lesson5_TheEliminativeArgument: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'This lesson focuses on a fundamental pattern of deductive reasoning: the **Eliminative Argument**, also known as a *disjunctive syllogism*. The argument begins by establishing a limited set of possibilities, then provides evidence that rules out all but one, and concludes that the remaining option must be true.',
    },

    {
      ...
      text: 'Eliminative arguments account for approximately **15% of Parallel Reasoning questions**. They are among the most straightforward patterns to identify and match — if you can spot the "either…or" setup and the elimination step, you can solve these quickly and confidently.',
    },
    ...
    {
      type: 'paragraph',
      text: 'An eliminative argument works like a detective narrowing down suspects. You start with a finite list of possibilities, rule out all but one, and conclude that the remaining option must be the answer.',
    },
    ...
    {
      type: 'process',
      title: 'How to Identify an Eliminative Argument',
      steps: [
    ...
    {
      type: 'paragraph',
      text: 'Eliminative arguments don\'t always use the words "either/or" explicitly. Here are the common ways the LSAT presents the disjunction:',
    },

    {
      type: 'table',
      headers: ['Phrasing', 'Translation', 'Example'],
      rows: [
        ['"Either A or B"', 'A ∨ B (explicit disjunction)', '"Either the butler or the gardener committed the crime"'],
        [
          '"The only possibilities are A and B"',
          'A ∨ B (explicit exhaustion)',
          '"The only possible causes are a virus or a bacterium"',
        ],
        [
          '"X stocks only A and B"',
          'A ∨ B (limited inventory)',
          '"The store stocks only two types: French Roast and Mocha Java"',
        ],
        ...
        [
          ...
          'A ∨ B ∨ C (enumeration)',
          '"The signal came from Mars, Venus, or an asteroid"',
        ],
      ],
    },
    ...
    {
      type: 'table',
      headers: ['Elimination Phrasing', 'What It Does'],
      rows: [
    ...
    {
      type: 'paragraph',
      text: 'The basic "Either A or B; Not A; Therefore B" pattern has several important variations that appear on the LSAT:',
    },

    { type: 'h3', text: '1. Binary Elimination (Basic Form)' },
    {
      type: 'table',
      headers: ['Component', 'Form'],
      rows: [
    ...
    {
      type: 'blockquote',
      text: '"The noise is coming from either the engine or the transmission. The mechanic confirmed the engine is fine. So the noise must be coming from the transmission."',
    },
    ...
    {
      type: 'blockquote',
      text: '"The artifact is from either the Roman, Greek, or Egyptian period. Carbon dating rules out the Roman period. The inscription style rules out the Greek period. Therefore, the artifact is from the Egyptian period."',
    },
    ...
    {
      type: 'blockquote',
      text: '"Carl\'s Coffee stocks only two decaf options: French Roast and Mocha Java. The coffee served was too smooth to be French Roast. So if the coffee came from Carl\'s, it was Mocha Java."',
    },

    {
      type: 'callout',
      variant: 'default',
      title: 'Conditional Framing Is Critical',
      text: 'Pay close attention to whether the conclusion is **definite** ("Therefore, B") or **conditional** ("If X, then B"). A stimulus with a conditional elimination conclusion can only be matched by an answer with a conditional conclusion. A definite conclusion cannot parallel a conditional one.',
    },
    ...
    { type: 'h3', text: 'Wrong-Answer Analysis' },
    {
      ...
      items: [
        {
          title: '(A) Samuel borrows sedan because it fits his friends',
          ...
          badge: 'Positive Selection',
          badgeColor: 'red',
        },
        {
          title: '(B) Anna must take Maple or Elm, but she drives instead',
          text: "The conclusion abandons the disjunction entirely — Anna doesn't choose either option. In the stimulus, the conclusion picks the remaining option. The entire point of an eliminative argument is to select the survivor, not reject both.",
          badge: 'Abandons Options',
          badgeColor: 'red',
        },
        {
          title: '(C) Rose takes July or October vacation; July is ruled out',
          text: 'Very close structurally, but the conditional framing is slightly different. "If Rose takes a vacation" is less precisely parallel to the stimulus\'s framework than (D)\'s "if he accepts one of these jobs." Both (C) and (D) are eliminative, but (D) more precisely mirrors the stimulus\'s framework of choosing within a specific supplier/set.',
          badge: 'Close but (D) is tighter',
          badgeColor: 'red',
        },
        {
          title: '(D) Arno chooses sales or research; sales eliminated by travel requirement',
          text: 'Two options within a defined set (Werdix\'s offer). One eliminated because it fails a personal constraint (won\'t travel). Conditional conclusion: "if he accepts one of these jobs, it will be research." Identical structure to the stimulus.',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title: '(E) Both options for Teresa lead to reduced efficiency',
          text: 'This is a **dilemma** (both paths lead to the same result), not an elimination (one path eliminated, the other selected). The structural pattern is entirely different: If A, then C. If ¬A, then C. Therefore C.',
          badge: 'Dilemma, Not Elimination',
          badgeColor: 'red',
        },
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'Test-makers use several strategies to create tempting wrong answers for eliminative argument questions:',
    },

    {
      ...
      rows: [
        [
          '**Positive Selection**',
          'Chooses an option because it passes a test, rather than eliminating the other for failing',
          'Ask: is the winning option chosen for its own merits, or is it the last one standing?',
        ],
        [
          '**The Dilemma**',
          'Both options lead to the same outcome — no real elimination occurs',
          'Check: does the conclusion pick one option, or does it assert an inevitable outcome?',
        ],
        [
          '**The Abandonment**',
          'Neither option is chosen — the argument escapes the disjunction entirely',
          'Check: does the conclusion select the remaining option or reject the whole framework?',
        ],
        [
          '**Wrong Conclusion Frame**',
          'The elimination is correct, but the conclusion is definite when it should be conditional (or vice versa)',
          'Compare the conclusion framing word-for-word: "if…then" vs. "therefore"',
        ],
        [
          '**Extra Options**',
          'Presents three or more options when the stimulus had two, or vice versa',
          'Count the options in the disjunction and compare',
        ],
      ],
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        {
          "type": "h2",
          "text": "Lesson 2: The Eliminative Argument (Parallel Reasoning)"
        },
        {
          "type": "paragraph",
          "text": "This lesson focuses on a fundamental pattern of deductive reasoning: the **Eliminative Argument**, also known as a *disjunctive syllogism*. The argument begins by establishing a limited set of possibilities, then provides evidence that rules out all but one, and concludes that the remaining option must be true."
        ...
        },
        {
          ...
          "rows": [
            [
              "Premise 1 (The Options)",
              "Either A or B (A ∨ B)",
              "Establishes the complete set of possibilities"
            ],
            [
              "Premise 2 (The Elimination)",
              "Not A (¬A)",
              "Rules out one possibility with evidence"
            ],
            [
              "Conclusion",
              "Therefore, B",
              "The remaining option must be true"
            ]
          ]
        },
        {
        ...
        {
          "type": "h2",
          "text": "How to Recognize Elimination Patterns"
        },
        {
          "type": "paragraph",
          "text": "Eliminative arguments don't always use the words \"either/or\" explicitly. Here are the common ways the LSAT presents the disjunction:"
        ...
        {
          "type": "paragraph",
          "text": "And here are common elimination phrasings:"
        },
        {
          "type": "table",
          "headers": [
            "Elimination Phrasing",
            "What It Does"
          ],
          "rows": [
            [
              "\"Not A\" / \"It cannot be A\"",
              "Direct denial"
            ],
            [
              "\"was too [adjective] to be A\"",
              "Indirect elimination via attribute mismatch"
            ],
            [
              "\"lacks the characteristics of A\"",
              "Elimination by disqualification"
            ],
            [
              "\"tests showed it was not A\"",
              "Elimination by evidence"
            ],
            [
              "\"A has been ruled out\"",
        ...
        {
          "type": "h2",
          "text": "Variations of the Eliminative Pattern"
        },
        {
          "type": "paragraph",
          "text": "The basic \"Either A or B; Not A; Therefore B\" pattern has several important variations that appear on the LSAT:"
        ...
        {
          "type": "h3",
          "text": "1. Binary Elimination (Basic Form)"
        },
        {
          "type": "table",
          "headers": [
        ...
        {
          "type": "h3",
          "text": "2. Multi-Option Elimination"
        },
        {
          "type": "table",
          "headers": [
        ...
        {
          "type": "h3",
          "text": "3. Conditional Elimination"
        },
        {
          "type": "table",
          "headers": [
        ...
        {
          "type": "paragraph",
          "text": "Let's apply the full method to an eliminative argument question."
        },
        {
          "type": "h3",
        ...
        {
          "type": "h2",
          "text": "Common Traps in Eliminative Questions"
        },
        {
          "type": "paragraph",
          "text": "Test-makers use several strategies to create tempting wrong answers for eliminative argument questions:"
