...
export const Lesson3_Question9: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-141-S-1-P-2-Q-9', questionType: 'Phrase Function', passageTitle: 'Julia Margaret Cameron', passage: passageText, question: `The author mentions the props employed in The Passing of Arthur as`, options: [
    ...
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
      ...
      { title: "(B) evidence of the transformative power of theater", text: "This is incorrect. The author argues in the second paragraph that still photography, unlike live theater, *cannot* fully transform its reality. We are always aware of the props and actors.", badge: 'Content Dump', badgeColor: "red" },
      { title: "(C) testimonies to Cameron’s ingenuity", text: "While one could see the props as ingenious, this is not the point the author is making. The author's focus is on how these props contribute to the \"amateurish\" feel of the work, which is a key component of its unique aesthetic, not on praising Cameron's cleverness.", badge: 'Wrong Function', badgeColor: "red" },
      { title: "(D) indications that the work is intended ironically", text: "The author's tone is one of sincere admiration, calling the picture \"magical and mysterious\" and something to be recalled with \"shameless delight.\" There is no suggestion of irony.", badge: 'Wrong Scope', badgeColor: "red" },
      { title: "(E) support for a negative appraisal of the work", text: "This is the opposite of the author's intent. The author explicitly states these amateurish details are \"insignificant\" compared to the overall magical effect. The props are used as part of a highly positive appraisal of the work.", badge: 'Partial Role', badgeColor: "red" }
    ]},
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-141-S-1-P-2-Q-9"
        },
        {
          "type": "blockquote",
          "text": "The author mentions the props employed in The Passing of Arthur as"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks for the purpose of mentioning the specific props in the photograph *The Passing of Arthur*. This is a \"purpose in context\" question, requiring us to understand the role this detail plays within the argument of the third paragraph.\n\nThe third paragraph begins by identifying the \"special quality\" of Cameron's pictures as their \"singular combination of **amateurism** and **artistry**.\" The author then uses *The Passing of Arthur* as a specific \"example\" to illustrate this point. The description of the props—\"the mast and oar... are obviously broomsticks and the water is white muslin drapery\"—serves as the direct evidence for the \"amateurism\" part of the author's claim. These makeshift props are the prime example of the \"homely truth\" that coexists with the \"romantic fantasy.\""
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) examples of amateurish aspects of the work",
              "text": "This aligns perfectly with the analysis. The author introduces the concept of \"amateurism\" and then immediately points to the broomsticks and drapery as the primary \"examples\" of this quality.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B) evidence of the transformative power of theater",
              "text": "This is incorrect. The author argues in the second paragraph that still photography, unlike live theater, *cannot* fully transform its reality. We are always aware of the props and actors.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) testimonies to Cameron’s ingenuity",
              "text": "While one could see the props as ingenious, this is not the point the author is making. The author's focus is on how these props contribute to the \"amateurish\" feel of the work, which is a key component of its unique aesthetic, not on praising Cameron's cleverness.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) indications that the work is intended ironically",
              "text": "The author's tone is one of sincere admiration, calling the picture \"magical and mysterious\" and something to be recalled with \"shameless delight.\" There is no suggestion of irony.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) support for a negative appraisal of the work",
              "text": "This is the opposite of the author's intent. The author explicitly states these amateurish details are \"insignificant\" compared to the overall magical effect. The props are used as part of a highly positive appraisal of the work.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
