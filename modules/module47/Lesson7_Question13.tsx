...
export const Lesson7_Question13: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-141-S-1-P-2-Q-13', questionType: 'Inference', passageTitle: 'Julia Margaret Cameron', passage: passageText, question: `The passage provides the most support for inferring that in Cameron’s era`, options: [
    ...
    { type: 'breakdown', labels: { title: 'Option', text: 'Analysis' }, items: [
      { title: "(A) there was little interest in photographs documenting contemporary life", text: "The passage only discusses Cameron's specific artistic project and provides no information about broader public tastes in photography. This is unsupported.", badge: 'Too Extreme', badgeColor: "red" },
      { title: "(B) photography was practiced mainly by wealthy amateurs", text: "The passage uses \"amateurism\" to describe a style, not the socioeconomic status of photographers. We cannot generalize from this to the entire field.", badge: 'Out of Scope', badgeColor: "red" },
      { title: "(C) publicity stills of actors were coming into vogue", text: "The passage mentions \"actors\" in a general sense but provides no information about professional theater or the practice of taking publicity stills.", badge: 'Misattribution', badgeColor: "red" },
      { title: "(D) there were no professional artist’s models", text: "The passage states that Cameron used her friends and family, but this does not allow us to conclude that professional models did not exist anywhere.", badge: 'Unsupported Leap', badgeColor: "red" },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-141-S-1-P-2-Q-13"
        },
        {
          "type": "blockquote",
          "text": "The passage provides the most support for inferring that in Cameron’s era"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This is an inference question asking what we can conclude about \"Cameron's era\" from the details in the passage. The answer must be a logical conclusion based on specific textual clues.\n\nThe passage provides several clues about the photographic process:\n*   An infant's face is \"blurred because they moved.\"\n*   Sitters are \"trying desperately hard to sit still.\"\n*   The sitting is described as an \"ordeal\" to be \"endured.\"\n\nThese clues all point to a single technological limitation. If slight movement causes blurring and people must struggle to remain motionless for what feels like an \"ordeal,\" it strongly implies that the camera's exposure time was not instantaneous. A substantial amount of time was required for the photographic plate to capture enough light to form an image."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) there was little interest in photographs documenting contemporary life",
              "text": "The passage only discusses Cameron's specific artistic project and provides no information about broader public tastes in photography. This is unsupported.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) photography was practiced mainly by wealthy amateurs",
              "text": "The passage uses \"amateurism\" to describe a style, not the socioeconomic status of photographers. We cannot generalize from this to the entire field.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) publicity stills of actors were coming into vogue",
              "text": "The passage mentions \"actors\" in a general sense but provides no information about professional theater or the practice of taking publicity stills.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) there were no professional artist’s models",
              "text": "The passage states that Cameron used her friends and family, but this does not allow us to conclude that professional models did not exist anywhere.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) the time required to take a picture was substantial",
              "text": "This is the most direct and well-supported inference. The blurring from movement, the desperate need to sit still, and the description of the sitting as an \"ordeal\" all logically point to a long exposure time.",
              "badge": "Correct",
              "badgeColor": "green"
            }
          ]
