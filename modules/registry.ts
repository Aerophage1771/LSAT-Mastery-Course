...
export const moduleRegistry: RegistryEntry[] = [
  ...
  // Unit 3: Evaluation
  entry({ id: 7, title: 'Evaluate the Argument', category: 'LR', description: 'Find the one question that can prove an argument right or wrong. This module bridges your Flaw analysis with Weaken and Strengthen by teaching you to isolate the specific vulnerability in an argument before attempting to manipulate it.', unit: 'Unit 3: Evaluation', lessonCount: 12 }, () => import('./Module7')),
  entry({ id: 8, title: 'Weaken', category: 'LR', description: "Find the fact that, if true, would undermine the argument or cast doubt on the conclusion. Building on Evaluate, this module shifts you from identifying gaps to actively attacking them by introducing evidence that severs the logical link between premise and conclusion.", unit: 'Unit 3: Evaluation', lessonCount: 12 }, () => import('./Module8')),
  entry({ id: 9, title: 'Strengthen', category: 'LR', description: "Select a new fact that makes the conclusion more likely to follow from the premises. The exact opposite of Weaken, this module teaches you to protect the argument by adding evidence that directly repairs the specific vulnerability you identified in your initial analysis.", unit: 'Unit 3: Evaluation', lessonCount: 12 }, () => import('./Module9')),
  entry({ id: 10, title: 'Sufficient Assumption', category: 'LR', description: "Provide a premise that, when added, makes the argument 100% logically valid. Unlike Strengthen which just helps the argument, Sufficient Assumption demands mathematical certainty. You will learn to guarantee the conclusion by finding the missing link that forces it to be true.", unit: 'Unit 3: Evaluation', lessonCount: 12 }, () => import('./Module10')),
  entry({ id: 11, title: 'Necessary Assumption', category: 'LR', description: 'Identify a premise the author must believe for the argument to have a chance of being valid. Unlike Sufficient Assumptions that guarantee the conclusion, Necessary Assumptions are the foundation that prevents the argument from immediately collapsing. You will learn the Negation Test to prove what the argument cannot survive without.', unit: 'Unit 3: Evaluation', lessonCount: 12 }, () => import('./Module11')),
