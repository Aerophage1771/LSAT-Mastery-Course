...
export const Lesson6_Question10: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-1-P-2-Q-10', questionType: 'Third-Party Viewpoint', passageTitle: 'Bankruptcy Laws', passage: passageText, question: `Which one of the following claims would a defender of the punitive theory of bankruptcy legislation be most likely to have made?`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Third-Party Viewpoint', text: 'Locate the named person or group. Isolate the exact sentences where views are attributed to them. Report only what the text says they believe.' },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-1-P-2-Q-10"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following claims would a defender of the punitive theory of bankruptcy legislation be most likely to have made?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question requires adopting the perspective of a \"defender of the punitive theory of bankruptcy\" and identifying a claim they would most likely make. The passage provides a clear description of this viewpoint in the second paragraph."
        },
        {
          "type": "paragraph",
          "text": "According to the passage, defenders of the punitive theory held these core beliefs:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "The central idea is that debt is a moral failing. The failure to pay is a character flaw, a broken promise that deserves to be punished by law. The justification is ethical and retributive, not economic or pragmatic."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) Debt that has become so great that repayment is impossible is ultimately a moral failing and thus a matter for which the law should provide punitive sanctions.",
              "text": "This statement is a perfect encapsulation of the punitive viewpoint. It explicitly links impossible debt to a \"moral failing\" and concludes that \"punitive sanctions\" are the appropriate legal response. This directly reflects the logic described in the second paragraph.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B) Because insolvency ultimately harms the entire economy, the law should provide a punitive deterrent to insolvency.",
              "text": "The reasoning here is incorrect for the punitive view. The concern for harming the \"entire economy\" is a hallmark of the modern, pragmatic view that focuses on the \"public good.\" The punitive theory's focus was on the individual moral contract, not on macroeconomic consequences.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) The insolvency of companies or individuals is tolerable if the debt is the result of risk-taking, profit-seeking ventures that might create considerable economic growth in the long run.",
              "text": "This reflects a modern, sophisticated understanding of economics and risk. A defender of the old punitive theory, who saw debt as simple \"negligence,\" would be highly unlikely to make such a nuanced distinction or tolerate insolvency for any reason.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) The dissolution of a large enterprise is costly to the economy as a whole and should not be allowed, even when that enterprise’s insolvency is the result of its own fiscal irresponsibility.",
              "text": "This is a direct statement of the modern argument against the punitive system. A defender of the punitive system would argue the exact opposite: that a \"fiscally irresponsible\" enterprise should be dissolved as punishment.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) The employees of a large bankrupt enterprise should be considered just as negligent as the owner of a bankrupt sole proprietorship.",
              "text": "The passage does not provide any information about how defenders of the punitive theory viewed the culpability of employees. Their focus was on the debtor (the individual or the enterprise itself). This claim goes beyond the information provided in the text.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
