...
export const Lesson4_Question8: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-1-P-2-Q-8', questionType: 'Author Attitude', passageTitle: 'Bankruptcy Laws', passage: passageText, question: `The author’s attitude toward the evolution of bankruptcy law can most accurately be described as`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Author Attitude', text: 'Locate where the author discusses the subject. Hunt for charged language — adjectives and adverbs. Characterize both direction and intensity.' },
    { type: 'paragraph', text: "This question asks us to identify the author's attitude toward the evolution of bankruptcy law. To answer, we must analyze the author's tone and word choices throughout the passage to infer their point of view." },
    ...
    { 
      ...
      items: [
        ...
        { title: "(C) neutrality toward laws that, while helpful to many, remain open to abuse", text: "The author's tone is the opposite of \"neutrality.\" Strong statements like \"must be resisted\" indicate a clear and decided viewpoint.", badge: 'Wrong Direction', badgeColor: "red" },
        { title: "(D) skepticism regarding the possibility of solutions to the problem of insolvency", text: "This is contrary to the author's tone. The author presents the modern system as a successful solution and defends it with confidence, not skepticism.", badge: 'Misattribution', badgeColor: "red" },
        { title: "(E) concern that inefficient laws may have been replaced by legislation too lenient to debtors", text: "This describes the viewpoint of the critics mentioned in the first paragraph, not the author. The author's entire argument is a rebuttal to this specific concern.", badge: 'False Neutrality', badgeColor: "red" }
    ]
    },
    { type: 'callout', variant: 'summary', title: 'Key Takeaway', text: 'Author Attitude answers must match both direction AND intensity. Precision in tone matters.' },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-1-P-2-Q-8"
        },
        {
          "type": "blockquote",
          "text": "**Question:** The author’s attitude toward the evolution of bankruptcy law can most accurately be described as"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks us to identify the author's attitude toward the evolution of bankruptcy law. To answer, we must analyze the author's tone and word choices throughout the passage to infer their point of view."
        },
        {
          "type": "paragraph",
          "text": "The author consistently uses positive language to describe the modern approach and negative language to describe the old, punitive system."
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "The overall attitude is one of clear approval for the change, based on the argument that the modern system is more pragmatic and effective than the inefficient system of the past."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) approval of changes that have been made to inefficient laws",
              "text": "This aligns perfectly with the analysis. The author clearly shows \"approval\" of the modern system. The passage dedicates significant space to explaining why the old laws were \"inefficient\"—they failed to benefit creditors and harmed society. This choice accurately describes both the author's positive stance and their justification for it.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B) confidence that further changes to today’s laws will be unnecessary",
              "text": "The passage does not support this. The author defends the current system in comparison to the past but makes no claims about its perfection or the impossibility of future improvements. This is an overstatement.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) neutrality toward laws that, while helpful to many, remain open to abuse",
              "text": "The author's tone is the opposite of \"neutrality.\" Strong statements like \"must be resisted\" indicate a clear and decided viewpoint.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) skepticism regarding the possibility of solutions to the problem of insolvency",
              "text": "This is contrary to the author's tone. The author presents the modern system as a successful solution and defends it with confidence, not skepticism.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) concern that inefficient laws may have been replaced by legislation too lenient to debtors",
              "text": "This describes the viewpoint of the critics mentioned in the first paragraph, not the author. The author's entire argument is a rebuttal to this specific concern.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
