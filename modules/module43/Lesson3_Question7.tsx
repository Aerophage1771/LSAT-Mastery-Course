...
export const Lesson3_Question7: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-1-P-2-Q-7', questionType: 'Inference', passageTitle: 'Bankruptcy Laws', passage: passageText, question: `In stating that bankruptcy laws have evolved “perhaps unexpectedly” (first sentence of the passage) as a remedy for creditors, the author implies that creditors`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Inference', text: 'Run two stem checks: whose perspective and what exact issue? Treat each answer as a claim to verify — find direct textual proof.' },
    ...
    { 
      ...
      items: [
        ...
        { title: "(E) were themselves active in the formulation of modern bankruptcy laws", text: "The passage provides no information about the specific individuals or groups involved in drafting bankruptcy legislation. This is pure speculation and is unsupported by the text.", badge: 'Unsupported Leap', badgeColor: "red" }
    ]
    },
    { type: 'callout', variant: 'summary', title: 'Key Takeaway', text: 'The correct inference requires the smallest logical leap. If you cannot point to a specific line as evidence, the answer is unsupported.' },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-1-P-2-Q-7"
        },
        {
          "type": "blockquote",
          "text": "**Question:** In stating that bankruptcy laws have evolved “perhaps unexpectedly” (first sentence of the passage) as a remedy for creditors, the author implies that creditors"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks for the implication of the phrase \"perhaps unexpectedly\" as it is used in the first sentence. The phrase modifies the claim that modern bankruptcy laws are a remedy \"for their creditors.\" The task is to understand why the author considers this benefit to creditors \"unexpected.\""
        },
        {
          "type": "paragraph",
          "text": "The conventional view of bankruptcy is that it primarily benefits debtors by absolving them of debt, which would seem to be a direct loss for creditors. The author's argument, however, is that this view is superficial. The modern, remedial system, by keeping the debtor economically productive, actually provides the creditor with the \"best hope of collecting\" some portion of the debt, which is a better outcome than the punitive alternative (where an imprisoned debtor can pay nothing)."
        },
        {
          "type": "paragraph",
          "text": "The phrase \"perhaps unexpectedly\" is used to flag this counterintuitive point for the reader. The benefit to creditors is not immediately obvious and runs contrary to a common assumption."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) are often surprised to receive compensation in bankruptcy courts",
              "text": "This is an overly literal interpretation. The author is making a general, conceptual point about the design of the law, not commenting on the emotional reaction of individual creditors during a specific legal proceeding.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) have unintentionally become the chief beneficiaries of bankruptcy laws",
              "text": "This is incorrect for two reasons. The passage does not claim creditors are the \"chief\" beneficiaries; it argues the laws serve the \"greatest number of citizens.\" Furthermore, the benefit is not \"unintentional,\" as the passage later implies that providing creditors with the \"best hope of collecting\" is a deliberate goal of the modern system.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) were a consideration, though not a primary one, in the formulation of bankruptcy laws",
              "text": "This understates the importance of creditors to the author's argument. The author's defense of the modern system relies heavily on the claim that it is a superior system for creditors compared to the old one, suggesting their interests were a significant consideration.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) are better served than is immediately apparent by laws designed in the first instance to provide a remedy for debtors",
              "text": "This choice accurately reflects the logic. The laws' obvious, first-instance purpose is to help debtors. The \"unexpected\" or not \"immediately apparent\" part is that this same system is also the most effective way to serve the interests of creditors. This aligns perfectly with the author's counterintuitive argument.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(E) were themselves active in the formulation of modern bankruptcy laws",
              "text": "The passage provides no information about the specific individuals or groups involved in drafting bankruptcy legislation. This is pure speculation and is unsupported by the text.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
