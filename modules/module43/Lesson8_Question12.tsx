...
export const Lesson8_Question12: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-1-P-2-Q-12', questionType: 'Inference', passageTitle: 'Bankruptcy Laws', passage: passageText, question: `The information in the passage most strongly suggests which one of the following about changes in bankruptcy laws?`, options: [
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-1-P-2-Q-12"
        },
        {
          "type": "blockquote",
          "text": "**Question:** The information in the passage most strongly suggests which one of the following about changes in bankruptcy laws?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This is an inference question asking what the passage most strongly suggests about the reason for the changes in bankruptcy laws. We need to synthesize the information given to arrive at the most logical conclusion."
        },
        {
          "type": "paragraph",
          "text": "The passage is structured as a problem-solution argument."
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "The clear implication is that the laws were changed precisely because the old system was not working. It was a practical failure on multiple fronts, failing to serve the interests of either creditors or the broader community."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) Bankruptcy laws always result from gradual changes in philosophy followed by sudden shifts in policy.",
              "text": "The word \"always\" makes this a huge generalization that is unsupported by the passage. We only have information about one specific historical shift, which is not enough to establish a universal rule.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) Changes in bankruptcy law were initiated by the courts and only grudgingly adopted by legislators.",
              "text": "The passage gives no details about the political process of the change. We do not know who initiated the laws or whether there was legislative resistance. This is speculation.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) The adjustment of bankruptcy laws away from a punitive focus was at first bitterly opposed by creditors.",
              "text": "The passage provides no evidence for this. In fact, the author's argument suggests that rational creditors should have supported the change, as the old system was ineffective for them.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) Bankruptcy laws underwent change because the traditional approach proved inadequate and contrary to the needs of society.",
              "text": "This aligns perfectly with the problem-solution structure of the passage. The author clearly lays out how the traditional approach was \"inadequate\" (for creditors) and \"contrary to the needs of society\" (causing unemployment and disruption), and presents the modern law as the solution to these shortcomings.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(E) The shift away from a punitive approach to insolvency was part of a more general trend in society toward rehabilitation and away from retribution.",
              "text": "While this might be historically true, the passage does not mention it. The author's explanation for the change is entirely self-contained within the economic and legal context of bankruptcy. The argument is based on pragmatism, not on a broader societal trend.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
