...
export const Lesson7_Question11: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-1-P-2-Q-11', questionType: 'Application', passageTitle: 'Bankruptcy Laws', passage: passageText, question: `Which one of the following sentences could most logically be appended to the end of the last paragraph of the passage?`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Application', text: 'Locate the specific rule. Break it into a checklist of conditions. The correct answer must satisfy every condition.' },
    ...
    { 
      ...
      items: [
        { title: "(A) Only when today’s bankruptcy laws are ultimately seen as inadequate on a large scale will bankruptcy legislation return to its original intent.", text: "This contradicts the author's entire argument. The author has argued that the \"original intent\" (punishment) was flawed and that the new intent is superior. They would not suggest a return to it.", badge: 'Missed Condition', badgeColor: "red" },
        ...
        { title: "(C) Since leniency serves the public interest in bankruptcy law, it is likely to do so in criminal law as well.", text: "This introduces a new and unrelated topic: criminal law. A concluding sentence should wrap up the existing discussion, not pivot to a different field of law.", badge: 'Wrong Domain', badgeColor: "red" },
        { title: "(D) Future bankruptcy legislation could include punitive measures, but only if such measures ultimately benefit creditors.", text: "This is speculative and runs counter to the author's main argument. The author has spent the passage arguing that non-punitive measures are what best benefit creditors. Suggesting a return to punitive measures would undermine the passage's core logic.", badge: 'Over-Application', badgeColor: "red" },
        { title: "(E) Today’s bankruptcy laws place the burden of insolvency squarely on the shoulders of creditors, in marked contrast to the antiquated laws that weighed heavily on debtors.", text: "This is a mischaracterization of the author's argument. The author claims the modern system gives creditors their \"best hope of collecting,\" not that it places the \"burden\" on them. It frames the system as a pragmatic solution for all parties, not a simple shifting of burdens.", badge: 'Surface Match', badgeColor: "red" }
    ]
    },
    { type: 'callout', variant: 'summary', title: 'Key Takeaway', text: 'Answers that fit two of three criteria but miss one are designed to trap fast readers.' },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-1-P-2-Q-11"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following sentences could most logically be appended to the end of the last paragraph of the passage?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks for the sentence that could most logically be appended to the end of the last paragraph. A fitting concluding sentence should summarize the key ideas of that paragraph and provide a sense of closure for the entire passage."
        },
        {
          "type": "paragraph",
          "text": "The final paragraph makes these key points:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "The central tension in the paragraph is the shift in the primary goal (from punishment to remedy) while acknowledging that some punitive side effects still exist. A good concluding sentence should capture this summary."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) Only when today’s bankruptcy laws are ultimately seen as inadequate on a large scale will bankruptcy legislation return to its original intent.",
              "text": "This contradicts the author's entire argument. The author has argued that the \"original intent\" (punishment) was flawed and that the new intent is superior. They would not suggest a return to it.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) Punishment is no longer the primary goal of bankruptcy law, even if some of its side effects still function punitively.",
              "text": "This is an excellent summary of the final paragraph. It restates the main point—that the primary goal is no longer punishment—while accurately incorporating the author's nuance that some punitive side effects remain. It provides a concise and logical conclusion.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(C) Since leniency serves the public interest in bankruptcy law, it is likely to do so in criminal law as well.",
              "text": "This introduces a new and unrelated topic: criminal law. A concluding sentence should wrap up the existing discussion, not pivot to a different field of law.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) Future bankruptcy legislation could include punitive measures, but only if such measures ultimately benefit creditors.",
              "text": "This is speculative and runs counter to the author's main argument. The author has spent the passage arguing that non-punitive measures are what best benefit creditors. Suggesting a return to punitive measures would undermine the passage's core logic.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) Today’s bankruptcy laws place the burden of insolvency squarely on the shoulders of creditors, in marked contrast to the antiquated laws that weighed heavily on debtors.",
              "text": "This is a mischaracterization of the author's argument. The author claims the modern system gives creditors their \"best hope of collecting,\" not that it places the \"burden\" on them. It frames the system as a pragmatic solution for all parties, not a simple shifting of burdens.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
