...
export const Lesson5_Question9: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-128-S-1-P-2-Q-9', questionType: 'Primary Purpose', passageTitle: 'Bankruptcy Laws', passage: passageText, question: `The primary purpose of the passage is to`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Primary Purpose', text: 'Read the question stem carefully. Return to the passage for direct evidence before evaluating answer choices.' },
    ...
    { 
      ...
      items: [
        { title: "(A) offer a critique of both past and present approaches to insolvency", text: "This is only half-correct. The author critiques the past approach but passionately defends the present approach. The purpose is not to critique both.", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(B) compare the practices of bankruptcy courts of the past with those of bankruptcy courts of the present", text: "Comparison is a method the author uses, but it is not the ultimate purpose. The comparison serves a larger goal: to argue that the present system is superior to the past one. \"Compare\" describes what the author does, but not why they do it.", badge: 'Out of Scope', badgeColor: "red" },
        { title: "(C) criticize those who would change the bankruptcy laws of today", text: "While the passage functions as a rebuttal to critics, its scope is broader than just criticism. The author spends significant time explaining the history and mechanics of the law to build a positive case. This choice is too narrow and focuses only on the negative aspect of the author's argument.", badge: 'Partial Match', badgeColor: "red" },
        { title: "(D) reexamine today’s bankruptcy laws in an effort to point to further improvements", text: "The author's focus is on defending the current system against a return to the past, not on suggesting future reforms. The passage does not point to any \"further improvements.\"", badge: 'Misreading', badgeColor: "red" },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question Breakdown: PT-128-S-1-P-2-Q-9"
        },
        {
          "type": "blockquote",
          "text": "**Question:** The primary purpose of the passage is to"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "This question asks for the primary purpose of the passage. This requires looking beyond the specific details to understand what the author is trying to achieve with the text as a whole. Is the main goal to inform, persuade, critique, or something else?"
        },
        {
          "type": "paragraph",
          "text": "The passage is structured as a persuasive argument. It begins by introducing a modern trend (the shift away from punishment) and acknowledging that it has faced criticism. The author then dedicates the body of the passage to building a case for why this trend is beneficial. This involves explaining the failures of the old system (paragraph 2) and the practical, economic logic of the new system (paragraph 3). The conclusion reinforces the author's stance that this new approach is superior and should be defended."
        },
        {
          "type": "paragraph",
          "text": "Therefore, the author's purpose is twofold: to explain the rationale behind contemporary bankruptcy laws and to defend them against criticism, arguing for their continuation."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) offer a critique of both past and present approaches to insolvency",
              "text": "This is only half-correct. The author critiques the past approach but passionately defends the present approach. The purpose is not to critique both.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) compare the practices of bankruptcy courts of the past with those of bankruptcy courts of the present",
              "text": "Comparison is a method the author uses, but it is not the ultimate purpose. The comparison serves a larger goal: to argue that the present system is superior to the past one. \"Compare\" describes what the author does, but not why they do it.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) criticize those who would change the bankruptcy laws of today",
              "text": "While the passage functions as a rebuttal to critics, its scope is broader than just criticism. The author spends significant time explaining the history and mechanics of the law to build a positive case. This choice is too narrow and focuses only on the negative aspect of the author's argument.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) reexamine today’s bankruptcy laws in an effort to point to further improvements",
              "text": "The author's focus is on defending the current system against a return to the past, not on suggesting future reforms. The passage does not point to any \"further improvements.\"",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) explain and defend contemporary bankruptcy laws",
              "text": "This choice perfectly captures the dual purpose of the passage. The author provides a detailed explanation of the logic and mechanisms of modern law (\"explain\") and constructs a robust argument for why this system is beneficial and should be preserved (\"defend\").",
              "badge": "Correct",
              "badgeColor": "green"
            }
          ]
