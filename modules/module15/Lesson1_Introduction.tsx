...
export const Lesson1_Introduction: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: "**Question Goal:** Determine the logical function of the missing phrase and select the answer choice that best completes the author's argument. The blank almost always represents the argument's conclusion, so your task is to synthesize the premises and predict the endpoint.",
    },
