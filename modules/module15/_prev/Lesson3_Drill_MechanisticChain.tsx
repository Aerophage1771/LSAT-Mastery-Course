...
export const Lesson3_Drill_MechanisticChain: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: "The critical verification step is to confirm that no link in your chain is missing or assumed. Every step must be explicitly stated in the stimulus. If you find yourself inferring a step that isn't written, you've gone beyond the evidence \u2014 and probably into a trap answer.",
    },
    ...
    {
      type: 'paragraph',
      text: 'This drill demonstrates the Mechanistic Chain pattern using a classic biology-based process. Your job is to trace the causal chain from the initial action to its final described effect and state the conclusion the mechanism demands.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: "Let's break the stimulus into its sequential causal steps using our Trace the Dominoes framework:",
    },
      ...
      items: [
        {
          ...
          text: 'A person goes on a low-calorie, low-cholesterol diet. This is the initial input that starts the chain. Note that the diet has a **stated goal**: lose weight and reduce blood cholesterol.',
          badge: 'Step 0',
          badgeColor: 'blue',
        },
        {
          title: 'Step 1: Weight Loss',
          text: 'The diet causes weight loss. This is implied by the stated goal and confirmed by the next premise, which describes what happens "when a person loses weight."',
          badge: 'Step 1',
          badgeColor: 'blue',
        },
        {
          title: 'Step 2: Fat Cells Shrink',
          text: '"The fat cells in that person\'s body decrease in size but not in number." Key detail: cells get smaller, but none are eliminated. This distinction matters because the cholesterol is stored in the cells.',
          badge: 'Step 2',
          badgeColor: 'blue',
        },
        {
          title: 'Step 3: Cholesterol Released',
          text: '"Fat cells spill the cholesterol they contain into the bloodstream." This is the final described effect. Shrinking cells release their stored cholesterol directly into the blood.',
          badge: 'Step 3',
          badgeColor: 'indigo',
        },
        {
          title: 'Endpoint (The Blank)',
          text: 'The "therefore" signals we need the conclusion. Given Step 3, the immediate result is that **blood cholesterol increases** \u2014 at least temporarily, as a direct mechanical consequence of the weight loss process.',
          badge: 'Conclusion',
          badgeColor: 'indigo',
        },
      ],
    ...
    {
      type: 'paragraph',
      text: 'The stimulus describes a straightforward biological process: Diet \u2192 Weight Loss \u2192 Fat Cells Shrink \u2192 Cholesterol Spills into Bloodstream \u2192 Blood Cholesterol Rises. Each step mechanically triggers the next.',
    },
    ...
    {
      type: 'paragraph',
      text: "This is a textbook Intention-Mechanism Split. The diet achieves one goal while mechanically undermining the other. The correct answer must reflect the mechanism's output (cholesterol increase), not the dieter's hope (cholesterol decrease).",
    },

    { type: 'h4', text: 'Step 3: Pre-Phrase the Answer' },
    {
      type: 'paragraph',
      text: 'Synthesize the chain: the immediate, mechanical result of the diet is that stored cholesterol enters the bloodstream. Therefore:',
    },
    {
      type: 'callout',
      title: 'Pre-Phrase',
      variant: 'tip',
      text: 'A person on this diet will experience a temporary increase in blood cholesterol as an immediate byproduct of the weight-loss process, even though reducing cholesterol was one of their goals.',
    },

    { type: 'h4', text: 'Step 4: Evaluate Each Answer' },
    {
      type: 'paragraph',
      text: 'Now apply the Chain Endpoint Test (Does this answer state the final mechanical result?) and the Goal Contradiction Test (Does it correctly contradict the stated intention?) to each choice.',
    },

    {
      ...
      items: [
        {
          title: '(A) might at first have an increased level of cholesterol in his or her blood',
          text: 'This perfectly captures the chain\'s endpoint. "Increased level of cholesterol in his or her blood" matches Step 3 (cholesterol spilling into the bloodstream). The qualifier "at first" correctly limits the effect to the immediate, process-related timeframe \u2014 the stimulus only describes what happens during weight loss, not long-term outcomes. The qualifier "might" is appropriately modest. **Passes both the Chain Endpoint Test and the Goal Contradiction Test.**',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title: '(B) will not lose weight any faster than will a person whose diet is high in calories',
          text: 'The stimulus provides zero information about the **rate** of weight loss or about comparisons to other diet types. This answer introduces an entirely new dimension (speed of weight loss, high-calorie diets) that the mechanism does not address. The chain is about cholesterol, not about comparative weight-loss rates.',
          badge: 'Out-of-Scope Comparison',
          badgeColor: 'red',
        },
        {
          title: '(C) might lose more weight by going on a low-calorie, high-cholesterol diet...',
          text: "This answer compares two diets, but the stimulus only describes one process. No information is given about what a high-cholesterol diet would do. The chain traces the effects of *this* diet; it does not compare it to alternatives. This answer also redirects attention to weight loss rather than the cholesterol mechanism that is the chain's endpoint.",
          badge: 'Unsupported Comparison',
          badgeColor: 'red',
        },
        {
          title: '(D) will not decrease the size of his or her fat cells',
          text: 'This directly **contradicts** Step 2 of the chain. The stimulus explicitly states that fat cells "decrease in size" when a person loses weight. Choosing this answer requires ignoring a stated premise. This is a contradiction trap \u2014 it tests whether you read the stimulus carefully.',
          badge: 'Contradicts Premise',
          badgeColor: 'red',
        },
        {
          title: '(E) will both decrease the level of cholesterol in his or her blood and gain weight',
          text: 'This answer gets both conclusions backward. The mechanism shows cholesterol **increasing** (not decreasing) and the diet causes weight **loss** (not gain). It aligns with neither the mechanism nor the stated goals. This is a double-contradiction trap designed to catch test-takers who confuse the direction of the chain.',
          badge: 'Double Contradiction',
          badgeColor: 'red',
        },
      ],
    },
    ...
    {
      type: 'table',
      headers: ['Answer', 'What It Claims', 'Chain Support?', 'Verdict'],
      rows: [
        [
          '**(A) Cholesterol increases at first**',
          '**Blood cholesterol rises temporarily**',
          '**\u2713 \u2014 Direct endpoint of the chain**',
          '**Correct \u2713**',
        ],
        [
          '(B) No faster weight loss',
          'Rate comparison to other diets',
          '\u2717 \u2014 No rate or comparison data given',
          'Out of Scope',
        ],
        ['(C) High-cholesterol diet better', 'Diet comparison', '\u2717 \u2014 Only one diet described', 'Unsupported'],
        [
          "(D) Fat cells don't shrink",
          'No size decrease',
          '\u2717 \u2014 Directly contradicts premise',
          'Contradiction',
        ],
        [
          '(E) Lower cholesterol + weight gain',
          'Opposite of mechanism',
    ...
    {
      type: 'paragraph',
      text: 'Mechanistic Chain stimuli generate a specific set of traps that recur across many questions. Be alert to these:',
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          ...
          text: "The answer states a result that aligns with the actors' **stated intentions** rather than the mechanism's actual output. Ask: \"Does the mechanism support this, or does only the actors' hope support it?\" If the mechanism contradicts the goal, goal-aligned answers are wrong.",
          badge: 'Most Common',
          badgeColor: 'blue',
        },
        {
          title: 'Scope Expansion',
          text: "The answer introduces a **comparison, rate, or long-term outcome** not discussed in the stimulus. The chain only describes what happens next; it does not compare diets, predict timelines, or project permanent results. If the answer discusses something the stimulus doesn't, it has left the chain.",
          badge: 'Common',
          badgeColor: 'blue',
        },
        {
          title: 'Premise Contradiction',
          text: 'The answer **denies a stated fact** from the stimulus. This is the simplest trap to catch: re-read the premises and verify that each claim in the answer is consistent with them. Any answer that says "X doesn\'t happen" when the stimulus says "X happens" is instantly eliminable.',
          badge: 'Easy to Catch',
          badgeColor: 'slate',
        },
        {
          title: 'Direction Reversal',
          text: "The answer **flips the direction** of the chain's output. If the chain leads to an increase, the answer claims a decrease (or vice versa). Check the polarity of the final step against each answer choice.",
          badge: 'Moderate',
          badgeColor: 'slate',
        },
      ],
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "What Makes the Mechanistic Chain Distinctive"
        },
        {
          "type": "paragraph",
          "text": "In a Mechanistic Chain completion, the correct answer must:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h3",
          "text": "Key Strategy: Trace the Dominoes"
        },
        {
          "type": "paragraph",
          "text": "The strategy for Mechanistic Chain completions is a linear, three-phase process:"
        },
        {
          "type": "process",
          "title": "Trace the Dominoes",
        ...
        {
          "type": "h3",
          "text": "Drill: Mechanistic Chain (PT-102-S-2-Q-3)"
        },
        {
          "type": "paragraph",
          "text": "This drill demonstrates the Mechanistic Chain pattern using a classic biology-based process. Your job is to trace the causal chain from the initial action to its final described effect and state the conclusion the mechanism demands."
        ...
        {
          "type": "h4",
          "text": "Step 1: Map the Causal Chain"
        },
        {
          "type": "paragraph",
          "text": "Let's break the stimulus into its sequential causal steps using our Trace the Dominoes framework:"
        ...
        {
          "type": "h4",
          "text": "Step 2: Identify the Intention-Mechanism Split"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "paragraph",
          "text": "**Where is the goal contradiction?**"
        },
        {
          "type": "paragraph",
          "text": "The dieters' two goals are:"
        },
        {
          "type": "list",
          "items": [
        ...
        },
        {
          ...
          "rows": [
            ...
            [
              "(C) High-cholesterol diet better",
              "Diet comparison",
              "✗ — Only one diet described",
              "Unsupported"
            ],
            [
              "(D) Fat cells don't shrink",
        ...
        {
          "type": "h3",
          "text": "Mechanistic Chain: Common Traps"
        },
        {
          "type": "paragraph",
          "text": "Mechanistic Chain stimuli generate a specific set of traps that recur across many questions. Be alert to these:"
