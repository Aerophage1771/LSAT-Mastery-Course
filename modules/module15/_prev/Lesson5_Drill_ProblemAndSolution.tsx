...
export const Lesson5_Drill_ProblemAndSolution: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'The strategy for Problem and Solution completions follows a strict four-step decomposition:',
    },
    {
      type: 'process',
      title: 'Problem \u2192 Solution \u2192 Obstacle \u2192 Reversal',
      steps: [
    ...
    {
      type: 'paragraph',
      text: "This drill demonstrates the Problem and Solution pattern using a classic collective-action dilemma. Your job is to trace the argument's structure, identify the precise obstacle, and find the answer that reverses it.",
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: "Let's apply our Problem \u2192 Solution \u2192 Obstacle \u2192 Reversal framework to this stimulus:",
    },

    {
      ...
      items: [
        {
          title: 'The Problem',
          text: 'Excessive atmospheric buildup of carbon dioxide threatens global welfare. This is the bad outcome the argument wants to prevent.',
          badge: 'Problem',
          badgeColor: 'red',
        },
        {
          title: 'The Solution',
          text: 'Reduce the burning of fossil fuels. The stimulus explicitly states this is the **only** way to stop the buildup. This word is critical \u2014 it closes off alternative solutions.',
          badge: 'Solution',
          badgeColor: 'blue',
        },
        {
          title: 'The Cost',
          text: 'Any country imposing the required emission standards would reduce its GDP. This is the price of implementing the solution.',
          badge: 'Cost',
          badgeColor: 'slate',
        },
        {
          title: 'The Obstacle',
          text: '"No nation will be willing to bear **singlehandedly** the costs of an action that will benefit everyone." This is the specific barrier: the collective-action problem. Each nation bears the full cost but shares the benefit with all others.',
          badge: 'The Key Barrier',
          badgeColor: 'indigo',
        },
        {
          title: 'The Conclusion',
          text: '"Catastrophic consequences are unavoidable UNLESS _______." The blank must state the condition that removes the obstacle, enabling the solution.',
    ...
    {
      type: 'paragraph',
      text: 'This is a classic collective-action dilemma, also known as a free-rider problem. The structure is:',
    },
    {
      type: 'list',
      items: [
...

    {
      ...
      title: 'Pre-Phrase',
      variant: 'tip',
      text: '"...unless nations collectively agree to impose emission standards together, so that no single nation bears the cost alone."',
    },

    { type: 'h4', text: 'Step 4: Evaluate Each Answer' },
    {
      type: 'paragraph',
      text: 'Apply the Obstacle Reversal Test to each choice: does this answer directly neutralize the "no nation will act singlehandedly" barrier?',
    },

    {
      ...
      items: [
        {
          title: '(A) all nations become less concerned with pollution than with the economic burdens of preventing it',
          text: 'This makes the situation **worse**, not better. If nations care more about economic burdens than pollution, they are even less likely to impose emission standards. This answer moves in the opposite direction from the needed reversal.',
          badge: 'Opposite Effect',
          badgeColor: 'red',
        },
        {
          title: '(B) multinational corporations agree to voluntary strict emission standards',
          text: 'Two problems. First, it shifts the agent from **nations** to **corporations** \u2014 but the obstacle is about nations\' GDP calculations, not corporate behavior. Second, the standards are "voluntary," which does not guarantee the binding commitment needed to solve the collective-action problem. A voluntary system still allows free-riding.',
          badge: 'Agent Shift + Too Weak',
          badgeColor: 'red',
        },
        {
          title: '(C) international agreements produce industrial emission standards',
          text: 'This directly reverses the obstacle. International **agreements** ensure that multiple nations commit simultaneously, removing the "singlehandedly" barrier. The standards are produced through a binding mechanism (agreements), not voluntarily. The agent remains **nations** acting through international channels. The scope matches: the argument requires emission standards, and this answer provides exactly that. **Passes the Obstacle Reversal Test.**',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title: '(D) distrust among nations is eliminated',
          text: 'The argument never mentions distrust as the obstacle. The barrier is a rational economic calculation: no nation wants to pay alone for a shared benefit. Even if nations trusted each other completely, the free-rider incentive would remain. Eliminating distrust might be a *precondition* for cooperation, but it is not itself the cooperation the argument requires.',
          badge: 'Wrong Obstacle',
          badgeColor: 'red',
        },
        {
          title: '(E) a world government is established',
          text: "This would solve the problem, but it goes far beyond what the argument requires. The obstacle is about coordination, not sovereignty. International agreements can produce emission standards without requiring a world government. This answer is like using a sledgehammer to hang a picture frame \u2014 functionally overkill and not what the argument's logic demands.",
          badge: 'Too Extreme',
          badgeColor: 'red',
        },
      ],
    ...
    {
      type: 'table',
      headers: ['Answer', 'What It Targets', 'Matches Obstacle?', 'Verdict'],
      rows: [
        [
          '(A) Less concerned with pollution',
          'Reverses priorities',
          '\u2717 \u2014 Makes obstacle worse',
          'Opposite Effect',
        ],
        [
          '(B) Voluntary corporate standards',
          'Different agent + voluntary',
          '\u2717 \u2014 Corporations, not nations',
          'Agent Shift',
        ],
        [
          '**(C) International agreements**',
          '**Coordinated national action**',
          '**\u2713 \u2014 Directly reverses "singlehandedly"**',
          '**Correct \u2713**',
        ],
        [
          '(D) Eliminate distrust',
          'A precondition, not the barrier',
          '\u2717 \u2014 Obstacle is economic, not trust',
          'Wrong Obstacle',
        ],
        [
          '(E) World government',
          'Eliminates national sovereignty',
          '\u2717 \u2014 Overkill; agreements suffice',
          'Too Extreme',
        ],
      ],
    },
    ...
    {
      type: 'paragraph',
      text: 'Problem and Solution completions generate a specific set of traps that recur across many questions. Be alert to these:',
    },
    {
      type: 'breakdown',
      ...
      items: [
        {
          ...
          text: 'The answer describes a condition that would make the obstacle **harder** to overcome, not easier. To spot this: check whether the condition moves in the same direction as the needed reversal. If it makes cooperation less likely, action more costly, or the problem worse, it fails.',
          badge: 'Most Common',
          badgeColor: 'blue',
        },
        {
          title: 'Agent Shift',
          text: 'The answer shifts responsibility to a **different actor** than the one identified in the obstacle (e.g., corporations instead of nations, individuals instead of governments). To spot this: verify that the actor in the answer matches the actor in the obstacle clause.',
          badge: 'Common',
          badgeColor: 'blue',
        },
        {
          title: 'Overkill Solution',
          text: "The answer proposes something that would work but goes **far beyond** what the argument requires. These answers are not wrong because they are false \u2014 they are wrong because the argument's logic does not demand something so extreme. To spot this: ask whether a simpler mechanism would suffice.",
          badge: 'Moderate',
          badgeColor: 'slate',
        },
        {
          title: 'Wrong Obstacle',
          text: 'The answer addresses a barrier that **was not stated** in the argument. The argument identifies one specific obstacle; the answer must target that one. If the answer solves a problem you had to infer rather than one that was explicitly stated, it is likely wrong.',
          badge: 'Moderate',
          badgeColor: 'slate',
        },
      ],
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "What Makes Problem and Solution Distinctive"
        },
        {
          "type": "paragraph",
          "text": "In a Problem and Solution completion, the correct answer must:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h3",
          "text": "Key Strategy: Problem → Solution → Obstacle → Reversal"
        },
        {
          "type": "paragraph",
          "text": "The strategy for Problem and Solution completions follows a strict four-step decomposition:"
        ...
        {
          "type": "h3",
          "text": "Drill: Problem and Solution (PT-125-S-2-Q-7)"
        },
        {
          "type": "paragraph",
          "text": "This drill demonstrates the Problem and Solution pattern using a classic collective-action dilemma. Your job is to trace the argument's structure, identify the precise obstacle, and find the answer that reverses it."
        ...
        {
          "type": "h3",
          "text": "Problem and Solution: Common Traps"
        },
        {
          "type": "paragraph",
          "text": "Problem and Solution completions generate a specific set of traps that recur across many questions. Be alert to these:"
