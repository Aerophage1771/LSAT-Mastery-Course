...
export const Lesson1_Introduction: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'Weaken is one of the **most frequently tested** question types on the LSAT Logical Reasoning section. On a typical scored section, you will see two to four Weaken questions — sometimes more. Because of this high frequency, your ability to quickly and accurately identify weakeners has a direct and measurable impact on your overall score.',
    },
    {
      type: 'paragraph',
      text: 'Weaken questions also test a skill that underpins several other question types. The same gap-identification ability required here is essential for Strengthen, Evaluate, Necessary Assumption, and Sufficient Assumption questions. Mastering Weaken, therefore, does not just help you on Weaken questions — it accelerates your progress across the entire Logical Reasoning section.',
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'Frequency',
      text: 'Expect **2–4 Weaken questions per scored section**. Combined with Strengthen (which uses the same core skill in reverse), gap-based questions account for roughly one-third of all Logical Reasoning questions. Time invested here pays dividends across the board.',
    },
    ...
    {
      type: 'paragraph',
      text: 'You can recognize Weaken questions by the phrase "if true" combined with language pointing toward damage, doubt, or undermining. The stem always asks you to find the answer choice that hurts the argument.',
    },
    {
      type: 'table',
      ...
      rows: [
        ...
        [
          ...
          'Asks what **most undermines**',
        ],
        [
          '"Which one of the following, if true, casts the most doubt on the conclusion drawn above?"',
          'Asks what **casts doubt**',
        ],
        [
          '"Which one of the following, if true, most seriously calls into question the claim made above?"',
          'Asks what **calls into question**',
        ],
        ['"Which one of the following, if true, most weakens the argument above?"', 'Standard **weakens** phrasing'],
        [
          '"Which one of the following, if true, is the most serious criticism of the plan outlined above?"',
          'Asks for a **criticism** of a plan',
        ],
      ],
    },
    {
    ...
    {
      type: 'paragraph',
      text: 'The premise is a **correlation** (more fast food, more obesity). The conclusion claims **causation** (fast food causes obesity). A strong weakener would introduce an **alternative cause** — for example, that low-income neighborhoods attract both fast-food chains and have less access to fresh groceries, meaning a third factor drives both observations.',
    },
    ...
    {
      type: 'process',
      title: 'Module 8 Roadmap',
      steps: [
        '**Foundations** — The Gap Model for Weaken questions, how Weaken differs from Flaw and Strengthen, common weakening strategies, and a full worked example.',
        '**Step-by-Step Guide** — A repeatable process for solving any Weaken question under timed conditions.',
        '**Drills** — Targeted practice sets for scope-shift flaws, baseline flaws, attacking the data, reverse causal reasoning, composition flaws, process of elimination, and Weaken EXCEPT formats.',
        '**Advanced Concepts** — Traits of high-difficulty Weaken questions and strategies for the hardest variants.',
        '**Reference Guide** — A quick-lookup resource consolidating all weakening strategies, stem patterns, and common traps.',
      ],
    },
...

    {
      ...
      variant: 'summary',
      title: 'Key Takeaway',
      text: 'Weaken questions ask you to find a **new fact** that damages the argument\'s reasoning. The core skill is the same gap-identification used for Strengthen and Assumption questions: find the conclusion, find the premises, find the leap between them. Recognize Weaken stems by the phrase **"if true"** combined with damage language ("weakens," "undermines," "casts doubt"). Always treat every answer choice as 100% true and test its impact on the gap.',
    },
  ],
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "diff-note",
          "text": "{{+add+}} The website 8-1 packs five teaching goals into one lesson: recognition, Gap Model, Weaken vs. Flaw, Weaken vs. Strengthen, all six strategies, and a worked example. The Mastery content version correctly trims the introduction and pushes the detailed content here. Consider whether the diff alternate should keep all of this or guide the reader to the Foundations lesson (1b) for the Gap Model and comparisons.",
          "variant": "comment"
        },
        {
          "type": "h2",
        ...
        },
        {
          ...
          "rows": [
            ...
            [
              ...
              "Labels the gap",
              "Widens the gap with new evidence"
            ]
          ]
        },
        {
        ...
        },
        {
          ...
          "title": "Flip Drill",
          "variant": "tip",
          "text": "When practicing, try this exercise: after solving a Weaken question, ask yourself what the correct Strengthen answer would be for the same argument. This \"flip drill\" deepens your understanding of the gap and reinforces the mirror-image relationship between the two question types. {{+add+}} Include a concrete mini-exercise here: 'The weakener for the fast-food argument introduces an alternative cause. What would the strengthener be? Write it in one sentence before reading on.'"
        },
        {
          "type": "hr"
        },
        {
          "type": "h2",
          "text": "Common Weakening Strategies"
        },
        {
          "type": "paragraph",
        ...
        },
        {
          ...
          "rows": [
            ...
            [
              ...
              "Show that a recommended plan has a cost, consequence, or obstacle that outweighs its benefit.",
              "The argument recommends a course of action and assumes it will achieve its goal without problems."
            ],
            [
              "**Scope Shift Attack**",
        ...
        },
        {
          ...
          "variant": "default",
          "text": "These strategies are not rigid templates. Real LSAT questions often blend multiple patterns or present the gap in unexpected ways. Use these categories as starting points for your prephrase, not as a checklist to mechanically apply. The goal is to train your instinct for where arguments are vulnerable. {{~change~}} Reframe this callout to focus on how to blend strategies rather than 'don't rely on them' -- the current wording can feel deflating right after presenting six powerful tools."
        },
        {
          "type": "hr"
        },
        ...
        {
          "type": "paragraph",
          "text": "Let's apply everything from this lesson to a complete Weaken question."
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "h4",
          "text": "Step 4: Test the Prephrase"
        },
        {
          "type": "paragraph",
        ...
        {
          "type": "diff-note",
          "text": "{{+add+}} A lightweight question-card or mini-exercise should follow this worked example. Students have read ~45 blocks of theory without any interactive practice. Even a short stimulus with 'identify the gap and prephrase the weakener' would close this engagement gap.",
          "variant": "comment"
        },
        {
          "type": "hr"
    ...
    glance: {
      label: 'At a Glance',
      content: [
        { type: 'h3', text: 'Weaken — At a Glance' },
        {
          type: 'paragraph',
          text: '**Goal:** Find the answer choice that most damages the argument\'s conclusion. **Frequency:** ~8% of LR questions.',
        },
        {
          type: 'table',
          headers: ['Stem Pattern', 'Core Skill', 'Common Trap'],
          rows: [
            ['"...most seriously weakens the argument?"', 'Gap identification', 'Strengthener in disguise'],
            ['"...most undermines the reasoning above?"', 'Gap identification', 'Attacks premise not conclusion'],
            ['"...casts the most doubt on the conclusion?"', 'Gap identification', 'Irrelevant scope'],
            ['"...most seriously calls into question the claim?"', 'Gap identification', 'Too extreme'],
          ],
        },
        {
          type: 'blockquote',
          text: '"A city health department found that neighborhoods with more fast-food restaurants have higher rates of obesity. The department concluded that fast-food restaurants are a significant cause of obesity in those neighborhoods."',
        },
        {
          type: 'paragraph',
          text: 'The argument leaps from correlation (more fast food, more obesity) to causation — a strong weakener introduces an alternative cause such as low income driving both observations.',
        },
        { type: 'h4', text: 'What\'s in This Module' },
        {
          type: 'list',
          items: [
            'Gap Model and how Weaken differs from Flaw',
            'Four-step method for timed solving',
            'Seven targeted drill sets with real patterns',
            'Advanced strategies for high-difficulty variants',
            'Quick-reference guide for test day',
          ],
        },
      ],
    },
