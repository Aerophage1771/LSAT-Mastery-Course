...
export const Lesson4_Drill_ApplyingDefinitions: Lesson = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      text: 'This drill demonstrates the definition-application pattern in a contract-law context. The stimulus provides nested rules and an architectural fact that, when combined, produce a clear exclusion.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'breakdown',
      labels: { title: 'Layer', text: 'Content' },
      items: [
        {
          title: 'Rule 1: Liability Scope',
          text: 'Jones is responsible only for "major structural defects." He is not responsible for any other repairs.',
          badge: 'Rule Layer',
          badgeColor: 'blue',
        },
        {
          title: 'Rule 2: Definition',
          text: 'A "major structural defect" is defined as a defect in the roof or roof-supporting components.',
          badge: 'Rule Layer',
          badgeColor: 'blue',
        },
        { title: 'Fact 1: Roof Type', text: 'The house has a truss roof.', badge: 'Fact Layer', badgeColor: 'indigo' },
        {
          title: 'Fact 2: Architectural Implication',
          text: 'Because of the truss roof, the only walls that support the roof are the exterior walls.',
          badge: 'Fact Layer',
          badgeColor: 'indigo',
        },
      ],
    ...
    {
      type: 'paragraph',
      text: 'Now connect the layers. The definition says Jones is liable for defects in "roof-supporting components." The architectural fact tells us that only exterior walls are roof-supporting. Therefore, nonexterior (interior) walls are not roof-supporting components and do not fall under the definition of "major structural defects." Since Jones is responsible only for major structural defects, he has no obligation to repair interior walls.',
    },

    {
      type: 'paragraph',
      text: 'Notice how the inference works by exclusion: we are not concluding something about what Jones must repair, but about what he does not have to repair. The restrictive word "only" in both the liability rule and the architectural fact creates a clean boundary.',
    },
    ...
    { type: 'h4', text: 'Step 3: Evaluate Each Answer' },
    {
      ...
      items: [
        {
          title: '(A) Jones did not know of any defects...',
          text: "The contract describes future liability obligations. It tells us nothing about Jones's current or past knowledge of defects. Knowledge and legal obligation are separate concepts.",
          badge: 'State of Mind Trap',
          badgeColor: 'red',
        },
        {
          title: '(B) ...the roof and roof-supporting components are currently free from such defects.',
          text: 'A contract to repair future defects does not prove the item is currently defect-free. Jones might know about existing defects; the contract simply assigns responsibility for repair.',
          badge: 'Current Condition Trap',
          badgeColor: 'red',
        },
        {
          title: "(C) The contract does not oblige Jones to repair any defects in the house's nonexterior walls...",
          text: 'This follows directly from the definition chain. Nonexterior walls are not roof-supporting \u2192 defects in them are not "major structural defects" \u2192 Jones is not responsible. This is the mechanical output of applying the rules to the facts.',
          badge: 'Correct',
          badgeColor: 'green',
        },
        {
          title: '(D) Smith will be obliged to repair all structural defects...',
          text: "The stimulus defines Jones's obligations. It says nothing about Smith's obligations. Just because Jones is not required to make a repair does not mean Smith is legally required to do so.",
          badge: 'False Obligation Trap',
          badgeColor: 'red',
        },
        {
          title: '(E) In the past Jones has had to make repairs...',
          text: 'The stimulus provides no historical information about the house. This answer introduces a temporal dimension the stimulus never addresses.',
          badge: 'Past Event Trap',
          badgeColor: 'red',
        },
      ],
    },
    ...
    { type: 'h3', text: 'Common Traps in Definition-Application Questions' },
    {
      ...
      rows: [
        [
          'State of Mind',
          'Infers knowledge or intent from a legal rule',
          'Look for words like "knew," "intended," or "believed" when the stimulus only states rules',
        ],
        [
          'Current Condition',
          'Assumes current perfection from a future-repair clause',
          'A repair obligation says nothing about present condition',
        ],
        [
          'False Obligation',
          'Assigns duties to a party the stimulus does not address',
          "Check: does the stimulus actually describe this party's obligations?",
        ],
        [
          'Past Event',
          'Introduces historical claims unsupported by the stimulus',
          'Look for past-tense claims when the stimulus is entirely forward-looking',
        ],
      ],
    },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "The Two-Layer Structure"
        },
        {
          "type": "paragraph",
          "text": "Definition-application stimuli always contain two layers:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "h3",
          "text": "Drill: Applying Strict Definitions (PT-101-S-3-Q-8)"
        },
        {
          "type": "paragraph",
          "text": "This drill demonstrates the definition-application pattern in a contract-law context. The stimulus provides nested rules and an architectural fact that, when combined, produce a clear exclusion."
        ...
        {
          "type": "h4",
          "text": "Step 1: Identify the Two Layers"
        },
        {
          "type": "paragraph",
          "text": "Separate the stimulus into its Rule Layer and Fact Layer:"
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            ...
            {
              "title": "Fact 1: Roof Type",
              "text": "The house has a truss roof.",
              "badge": "Fact Layer",
              "badgeColor": "indigo"
            },
            {
        ...
        {
          "type": "h4",
          "text": "Step 2: Apply the Definition"
        },
        {
          "type": "paragraph",
          "text": "Now connect the layers. The definition says Jones is liable for defects in \"roof-supporting components.\" The architectural fact tells us that only exterior walls are roof-supporting. Therefore, nonexterior (interior) walls are not roof-supporting components and do not fall under the definition of \"major structural defects.\" Since Jones is responsible only for major structural defects, he has no obligation to repair interior walls."
        ...
        {
          "type": "h3",
          "text": "Common Traps in Definition-Application Questions"
        },
        {
          "type": "table",
          "headers": [
