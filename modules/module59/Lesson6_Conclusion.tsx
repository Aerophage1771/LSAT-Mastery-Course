...

    {
      ...
      items: [
        ...
        },
        {
          ...
          text: '**Cue:** Subgroup averages are combined without considering group sizes.\n**Ask:** "Do these groups carry equal weight?"\n**Lesson:** 3 — Averages',
          badge: 'Lesson 3',
          badgeColor: 'indigo',
        },
        {
          title: 'Base Rate Neglect',
          text: '**Cue:** Test accuracy or frequency is discussed without the underlying prevalence.\n**Ask:** "How common is the condition overall?"\n**Lesson:** 4 — Invalid Mathematical Reasoning',
          badge: 'Lesson 4',
          badgeColor: 'red',
        },
        {
          title: 'Overlapping Sets',
          text: '**Cue:** Percentages or counts from multiple groups are added together.\n**Ask:** "Can one case belong to both categories?"\n**Lesson:** 4 — Invalid Mathematical Reasoning',
          badge: 'Lesson 4',
          badgeColor: 'red',
        },
        {
          title: "Gambler's Fallacy",
          text: '**Cue:** An outcome is described as "due" because of a streak.\n**Ask:** "Are these events independent?"\n**Lesson:** 5 — Flawed Predictions',
          badge: 'Lesson 5',
          badgeColor: 'slate',
        },
        {
          title: 'Hot Hand Fallacy',
          text: '**Cue:** A streak is used to predict continued success.\n**Ask:** "Does the past performance actually change the next probability?"\n**Lesson:** 5 — Flawed Predictions',
          badge: 'Lesson 5',
          badgeColor: 'slate',
        },
      ],
