...
export const Lesson4_Question11: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-119-S-1-Q-11', questionType: 'Inference (Heroism)', passageTitle: 'Obasan', passage: passageText, question: `It can be inferred that the heroism Naomi gains in the course of Obasan is manifested in her`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Inference (Heroism)', text: 'Read the question stem carefully. Return to the passage for direct evidence before evaluating answer choices.' },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question 11 Breakdown"
        },
        {
          "type": "blockquote",
          "text": "**Question:** It can be inferred that the heroism Naomi gains in the course of Obasan is manifested in her"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "In other words, how does Naomi *show* her heroism? What is the ultimate act or state of being that represents her transformation from victim to hero?"
        },
        {
          "type": "paragraph",
          "text": "To answer this, we need to go back to the second paragraph, where the author lays out the \"rites of passage\" structure. The author explicitly says that this three-stage process \"has the effect of transforming a society’s victim into a hero.\" So, to find the manifestation of her heroism, we need to look at the *end* of that process, the final stage."
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "So, the text directly links her heroic transformation to this final act of breaking the silence and coming to terms with her difficult past. Her heroism is an act of internal courage and reconciliation."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) reconciliation with her past",
              "text": "Does the text support this? Yes, absolutely and directly. The passage says the heroic transformation culminates when Naomi \"reconciles herself with her history.\" This is a perfect match for the evidence we found.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(B) careful deployment of structure and symbol",
              "text": "This is a classic trap that confuses the author with the character. Who is carefully deploying structure and symbol? The author of the passage tells us it's the novelist, **Joy Kogawa**. Naomi is the character *experiencing* the story; she isn't the one writing it.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) relationship with her surrogate family",
              "text": "Where does her relationship with her surrogate family fit into the three-stage process? The passage places it squarely in Stage 2, the \"alienation\" phase. It says she joins the surrogate family in Slocan, and that this family \"nurtures Naomi as she develops **toward** a final integration.\" So, the surrogate family is a crucial part of her journey, but her heroism is the *result* of that journey, which manifests in the final stage of reconciliation. This choice points to the process, not the final heroic act.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) renewal of her religious beliefs",
              "text": "The passage mentions \"Christian rituals and symbols,\" but in what context? It's a tool the *author*, Kogawa, uses to critique the majority culture. The passage never says anything about Naomi's personal religious beliefs or any kind of renewal. This is unsupported by the text.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) denunciation of the majority culture",
              "text": "This is another subtle but important distinction. The passage says the *novel* critiques the majority culture. But is Naomi's heroic act a \"denunciation\"? The passage describes her heroism as something internal and personal: she \"breaks through... silence,\" \"reconciles herself with her history,\" and achieves \"integration... with herself.\" It's an act of healing and understanding, not an act of outward political denunciation.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
