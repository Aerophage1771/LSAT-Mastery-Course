...
export const Lesson3_Question10: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-119-S-1-Q-10', questionType: 'Organization', passageTitle: 'Obasan', passage: passageText, question: `Which one of the following most accurately describes the organization of the passage?`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Organization', text: 'Read the question stem carefully. Return to the passage for direct evidence before evaluating answer choices.' },
    ...
    { 
      ...
      items: [
        { title: "(A) Two points are made about a novel, the first supported with a brief example, the second reasserted without support.", text: "This is wrong on two counts. The support for the first point is extended, not brief. And the second point *is* supported with an example; it's not just \"reasserted.\"", badge: 'Too Extreme', badgeColor: "red" },
        { title: "(B) Two points are made about a novel, the first supported with an extended analogy, the second reasserted without support.", text: "This gets the first half right—the support *is* an extended analogy. But it gets the second half wrong. The second point is supported with the \"stone into bread\" example.", badge: 'Out of Scope', badgeColor: "red" },
        { title: "(C) Two points are made about a novel, the first reasserted without support, the second supported with an extended analogy.", text: "This gets both parts wrong. The first point is heavily supported, and the support for the second point is a brief example, not an extended analogy.", badge: 'Partial Match', badgeColor: "red" },
        { title: "(D) Two points are made about a novel, the first supported with a brief example, the second supported with an extended analogy.", text: "This choice correctly identifies that both points are supported, but it reverses the *types* of support. It claims the first point gets a \"brief example\" and the second gets an \"extended analogy.\" The passage does the exact opposite.", badge: 'Misreading', badgeColor: "red" },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question 10 Breakdown"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Which one of the following most accurately describes the organization of the passage?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "To answer this, we need to be architects of the text. We need to look at its blueprint. The best way to do this is to break down the author's argument into its component parts and see how they are arranged."
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "So, the organizational pattern is: **Thesis with two points -> Extended analogy to support the first point -> Brief example to support the second point.**"
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) Two points are made about a novel, the first supported with a brief example, the second reasserted without support.",
              "text": "This is wrong on two counts. The support for the first point is extended, not brief. And the second point *is* supported with an example; it's not just \"reasserted.\"",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) Two points are made about a novel, the first supported with an extended analogy, the second reasserted without support.",
              "text": "This gets the first half right—the support *is* an extended analogy. But it gets the second half wrong. The second point is supported with the \"stone into bread\" example.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) Two points are made about a novel, the first reasserted without support, the second supported with an extended analogy.",
              "text": "This gets both parts wrong. The first point is heavily supported, and the support for the second point is a brief example, not an extended analogy.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) Two points are made about a novel, the first supported with a brief example, the second supported with an extended analogy.",
              "text": "This choice correctly identifies that both points are supported, but it reverses the *types* of support. It claims the first point gets a \"brief example\" and the second gets an \"extended analogy.\" The passage does the exact opposite.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) Two points are made about a novel, the first supported with an extended analogy, the second supported with a brief example.",
              "text": "Let's check this against our blueprint. \"Two points are made...\" (Yes). \"...the first supported with an extended analogy...\" (Yes, the rites of passage). \"...the second supported with a brief example.\" (Yes, the stone into bread). This choice perfectly and accurately describes the structure of the author's argument.",
              "badge": "Correct",
              "badgeColor": "green"
            }
          ]
