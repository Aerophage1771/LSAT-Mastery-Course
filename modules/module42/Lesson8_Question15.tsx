...
export const Lesson8_Question15: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-119-S-1-Q-15', questionType: 'Author', passageTitle: 'Obasan', passage: passageText, question: `Based on the passage, which one of the following aspects of Kogawa’s work does the author of the passage appear to value most highly?`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Author', text: 'Read the question stem carefully. Return to the passage for direct evidence before evaluating answer choices.' },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question 15 Breakdown"
        },
        {
          "type": "blockquote",
          "text": "**Question:** Based on the passage, which one of the following aspects of Kogawa’s work does the author of the passage appear to value most highly?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "In other words, what is it about this book that most impresses our critic? What are they spending the entire passage praising?"
        },
        {
          "type": "paragraph",
          "text": "The author's focus is relentlessly on the *how*. They are not just saying, \"This book is about a hero and it criticizes society.\" They are saying, \"Look at the brilliant *way* Kogawa uses literary craft—these specific, subtle techniques—to achieve these effects.\" The author's admiration is clearly for Kogawa's skill as a literary artist."
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) her willingness to make political statements",
              "text": "The passage certainly acknowledges the novel's political critique. But is the author's praise for the mere *willingness* to be political? No. The praise is for the *subtle* and *skillful* way the critique is delivered through symbolism. The value is placed on the craft, not just the courage.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) her imaginative development of characters",
              "text": "The passage discusses Naomi's transformation into a hero. But does it praise Kogawa for her general \"imaginative development of characters\"? The author is much more specific. They attribute Naomi's heroic arc to a very particular literary device: the novel's three-part structure that mimics a rite of passage. Again, the praise is for the specific technique, not a general quality like character development.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(C) her subtle use of literary techniques",
              "text": "Let's check this against our prediction. This seems to hit the nail on the head. The author's entire analysis is a deep dive into Kogawa's \"subtle techniques\"—specifically form and symbolism. The passage begins and ends by praising this aspect of her work. This seems to be the exact focus of the author's admiration.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(D) her knowledge of Christian rituals and symbols",
              "text": "This is a classic \"too narrow\" trap. The author *does* discuss her use of Christian symbols, but that's only *one* of the two major techniques they analyze. Answering this would be to ignore the entire second paragraph, which is dedicated to the novel's structure.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) her objectivity in describing Naomi’s tragic life",
              "text": "Does the author praise Kogawa for being \"objective\"? No. In fact, the argument is the opposite. The author praises Kogawa for shaping the narrative to \"emphasize her major character's heroism\" and transform a \"victim into a hero.\" This is a very specific, subjective shaping of the story, not an objective, neutral reporting of events.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
