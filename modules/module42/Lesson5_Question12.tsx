...
export const Lesson5_Question12: Lesson = {
  ...
  content: [
    { type: 'question-passage-card', id: 'PT-119-S-1-Q-12', questionType: 'Detail Hunt', passageTitle: 'Obasan', passage: passageText, question: `According to the anthropologists cited by the author, rites of passage are best described by which one of the following sequences of stages?`, options: [
    ...
    { type: 'callout', variant: 'tip', title: 'Approach: Detail Hunt', text: 'Read the question stem carefully. Return to the passage for direct evidence before evaluating answer choices.' },
    ...
    { 
      ...
      items: [
        { title: "(A) alienation, dislocation, integration", text: "This is incorrect. It starts with \"alienation,\" which the passage clearly states is the second stage. It also uses the word \"dislocation,\" which is not one of the specific anthropological terms used for the stages.", badge: 'Too Extreme', badgeColor: "red" },
  ...
  alternates: {
    diff: {
      ...
      content: [
        ...
        {
          "type": "h3",
          "text": "Question 12 Breakdown"
        },
        {
          "type": "blockquote",
          "text": "**Question:** According to the anthropologists cited by the author, rites of passage are best described by which one of the following sequences of stages?"
        },
        {
          "type": "options",
          "items": [
        ...
        {
          "type": "paragraph",
          "text": "The key here is that we are being asked about the view of the **\"anthropologists cited by the author.\"** Our job is to go back to the text, find the sentence where the author is explaining what these anthropologists believe, and copy down the sequence of stages they list."
        },
        {
          "type": "paragraph",
          "text": "Let's go directly to the second paragraph. The second sentence is our target: \"According to these anthropologists, a rite of passage **begins with separation** from a position of security...; **proceeds to alienation** in a deathlike state...; and **concludes with reintegration** into society...\""
        },
        {
          "type": "breakdown",
          "labels": {
          ...
          "items": [
            {
              "title": "(A) alienation, dislocation, integration",
              "text": "This is incorrect. It starts with \"alienation,\" which the passage clearly states is the second stage. It also uses the word \"dislocation,\" which is not one of the specific anthropological terms used for the stages.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(B) separation, alienation, reintegration",
              "text": "Let's check this against our list. 1. Separation? Yes. 2. Alienation? Yes. 3. Reintegration? Yes. The terms are correct, and the order is correct. This is a perfect match.",
              "badge": "Correct",
              "badgeColor": "green"
            },
            {
              "title": "(C) integration, alienation, disintegration",
              "text": "This is incorrect. It starts with \"integration,\" which the passage says is the final stage. It also uses \"disintegration,\" which is not one of the three anthropological terms.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(D) dislocation, reconciliation, reintegration",
              "text": "This choice uses words that are relevant to the story (\"dislocation,\" \"reconciliation\"), but they are not the specific, technical terms that the passage attributes to the anthropologists. The question is asking for the anthropologists' terminology.",
              "badge": "Incorrect",
              "badgeColor": "red"
            },
            {
              "title": "(E) disintegration, transformation, reintegration",
              "text": "This is also incorrect. It uses \"disintegration,\" which is not one of the terms. It also lists \"transformation\" as a stage. The passage is very clear that transformation is the *effect* or *result* of the three-stage process, not a stage itself.",
              "badge": "Incorrect",
              "badgeColor": "red"
            }
          ]
