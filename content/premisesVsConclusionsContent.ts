...
/** Shared Premises vs. Conclusions lesson content (single source for Module 1 Lesson 4 and Module 100 format showcase). */
export const premisesVsConclusionsContent: ContentBlock[] = [
  { type: 'h2', text: 'Premises vs. Conclusions' },
  ...
  { type: 'accordion', title: 'Question · PT-107-S-4-Q-15', content: [
